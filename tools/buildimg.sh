...
$CONTAINER_CMD build -t ghcr.io/$GITHUB_REPOSITORY/maestro-cli:$VERSION -f Dockerfile-cli --build-arg MAESTRO_VERSION=$VERSION --build-arg MAESTRO_REPOSITORY=$GITHUB_REPOSITORY .
