...
tool_data['run_qunasys_quri_chemistry'] = {
...
tool_data['get_quri_chemistry_job_status'] = {
...
tool_data['get_quri_chemistry_job_result'] = {
...
tool_data['get_optimizer_job_status'] = {
...
tool_data['get_optimizer_result'] = {
    ...
    def test_each_tool(self):
        async def test():
            ...
            for tool in tools_result.tools:
                assert tool_data[tool.name]["name"] == tool.name
                assert tool_data[tool.name]["description"] == tool.description
                assert tool_data[tool.name]["inputSchema"] == tool.inputSchema
        asyncio.run(test())
