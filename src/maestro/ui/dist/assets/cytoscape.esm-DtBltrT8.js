...
function gt(r, e, t) {
  return e && tc(r.prototype, e), Object.defineProperty(r, "prototype", { writable: false }), r;
}
function kr(r, e) {
...
function Jl(r, e, t) {
  return (e = jl(e)) in r ? Object.defineProperty(r, e, { value: t, enumerable: true, configurable: true, writable: true }) : r[e] = t, r;
}
function ac(r) {
...
var Vc = Fc(), Fa = Oa(Vc), ci = rr ? rr.performance : null, lv = ci && ci.now ? function() {
  return ci.now();
} : function() {
  return Date.now();
}, qc = (function() {
  ...
  for (var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Tt, a = t, n; n = e.next(), !n.done; ) a = a * vv + n.value | 0;
  return a;
}, Ca = function(e) {
  ...
  var a = { value: 0, done: false }, n = 0, i = e.length, s = { next: function() {
...
var _o = true, Uc = console.warn != null, Kc = console.trace != null, Js = Number.MAX_SAFE_INTEGER || 9007199254740991, dv = function() {
...
})(), Xr = typeof Map < "u" ? Map : Jc, jc = "undefined", ed = (function() {
  function r(e) {
  ...
  return gt(r, [{ key: "instanceString", value: function() {
    return "set";
  ...
  } }, { key: "forEach", value: function(t, a) {
  ...
  return e = { bfs: e.bfs || !e.dfs, dfs: e.dfs || !e.bfs }, function(a, n, i) {
    var s;
    ...
    for (var C = function() {
      ...
      if (G = n(A, I, V, d++, L), G === true) return y = A, 1;
      if (G === false) return 1;
...
}, Sa = { breadthFirstSearch: Ho({ bfs: true }), depthFirstSearch: Ho({ dfs: true }) };
  ...
  return Wo || (Wo = 1, (function(r, e) {
    (function() {
      ...
      n = Math.floor, f = Math.min, a = function(p, m) {
        ...
        var w, E, C, x, T;
        for (b == null && (b = a), E = p.length, T = m, C = p[m], w = 2 * m + 1; w < E; ) x = w + 1, x < E && !(b(p[w], p[x]) < 0) && (w = x), p[m] = p[w], m = w, w = 2 * m + 1;
...
var nd = ad(), Va = Oa(nd), id = cr({ root: null, weight: function(e) {
  return 1;
}, directed: false }), sd = { dijkstra: function(e) {
  if (!Le(e)) {
    var t = arguments;
  ...
  for (var E = function(I, M) {
    ...
    if (c[T] = x, x !== 1 / 0) for (var k = C.neighborhood().intersect(d), D = 0; D < k.length; D++) {
      var B = k[D], P = B.id(), A = E(C, B), R = x + A.dist;
      R < g(B) && (p(B, R), f[P] = { node: C, edge: A.edge });
    }
  }
  return { distanceTo: function(I) {
  ...
  return o;
} }, ud = cr({ root: null, goal: null, weight: function(e) {
  return 1;
}, heuristic: function(e) {
  return 0;
}, directed: false }), ld = { aStar: function(e) {
...
} }, vd = cr({ weight: function(e) {
  return 1;
}, directed: false }), fd = { floydWarshall: function(e) {
  ...
  return N;
} }, cd = cr({ weight: function(e) {
  return 1;
}, directed: false, root: null }), dd = { bellmanFord: function(e) {
  ...
  if (k) for (var V = [], G = 0; G < p; G++) {
    ...
    if (K + Q < j || !i && j + Q < K) if (y || (Ve("Graph contains a negative weight cycle for Bellman-Ford"), y = true), e.findNegativeWeightCycles !== false) {
      var re = [];
  ...
  }, I = [L(k), L(D)], M = { cut: T, components: I, partition1: k, partition2: D };
  return M;
} }, gi, yd = function(e) {
  return { x: e.x, y: e.y };
}, On = function(e, t, a) {
  ...
  var i = { x: t.x - e.x, y: t.y - e.y }, s = Bt(e, t), o = { x: i.x / s, y: i.y / s };
...
function Pd(r, e) {
  ...
  for (var v = u.length, f = [], c = 0; c < v; c++) {
    var h = u[c], d = u[(c + 1) % v], y = a(d, h), g = s({ x: y.y, y: -y.x });
    f.push(g);
  }
...
var wv = function(e, t, a, n, i, s, o) {
  ...
  if (c) {
    ...
    if (d = it(e, t, a, n, y, g, p, m, false), d.length > 0) return d;
  }
  if (h) {
    var b = a + v + o, w = n - f + u - o, E = b, C = n + f - u + o;
    if (d = it(e, t, a, n, b, w, E, C, false), d.length > 0) return d;
  }
  if (c) {
    var x = a - v + u - o, T = n + f + o, k = a + v - u + o, D = T;
    if (d = it(e, t, a, n, x, T, k, D, false), d.length > 0) return d;
  }
  if (h) {
    var B = a - v - o, P = n - f + u - o, A = B, R = n + f - u + o;
    if (d = it(e, t, a, n, B, P, A, R, false), d.length > 0) return d;
  }
  var L;
  {
    var I = a - v + u, M = n - f + u;
  ...
  var v = { x1: Math.min(a, o, i) - u, x2: Math.max(a, o, i) + u, y1: Math.min(n, l, s) - u, y2: Math.max(n, l, s) + u };
  ...
  for (var u = new Array(a.length * 2), v = 0; v < l.length; v++) {
    ...
    if (c <= Math.pow(f.radius, 2)) return true;
  }
  return Sr(e, t, u);
}, En = function(e) {
  ...
  for (var h = 0; h < c.length / 4; h++) f = it(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], false), f.length !== 0 && v.push(f[0], f[1]);
  if (v.length > 2) {
...
function yi(r, e) {
  function t(f) {
    for (var c = [], h = 0; h < f.length; h++) {
      var d = f[h], y = f[(h + 1) % f.length], g = { x: y.x - d.x, y: y.y - d.y }, p = { x: -g.y, y: g.x }, m = Math.sqrt(p.x * p.x + p.y * p.y);
...
var Gd = cr({ dampingFactor: 0.8, precision: 1e-6, iterations: 200, weight: function(e) {
  return 1;
  ...
  return z;
} }, Xo = cr({ root: null, weight: function(e) {
  return 1;
}, directed: false, alpha: 0 }), Xt = { degreeCentralityNormalized: function(e) {
  e = Xo(e);
...
var Yo = cr({ harmonic: true, weight: function() {
  return 1;
}, directed: false, root: null }), Yt = { closenessCentralityNormalized: function(e) {
  for (var t = Yo(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, l = 0, u = this.nodes(), v = this.floydWarshall({ weight: n, directed: i }), f = 0; f < u.length; f++) {
  ...
  a = this.filter(a)[0];
  for (var o = this.dijkstra({ root: a, weight: n, directed: i }), l = 0, u = this.nodes(), v = 0; v < u.length; v++) {
    var f = u[v];
    if (!f.same(a)) {
...
var Wd = cr({ weight: null, directed: false }), Rs = { betweennessCentrality: function(e) {
  for (var t = Wd(e), a = t.directed, n = t.weight, i = n != null, s = this.cy(), o = this.nodes(), l = {}, u = {}, v = 0, f = { set: function(b, w) {
    u[b] = w, w > v && (v = w);
  }, get: function(b) {
    return u[b];
  } }, c = 0; c < o.length; c++) {
...
var $d = cr({ expandFactor: 2, inflateFactor: 2, multFactor: 1, maxIterations: 20, attributes: [function(r) {
  return 1;
}] }), Ud = function(e) {
  return $d(e);
}, Kd = function(e, t) {
  ...
  for (var m = true, b = 0; m && b < i.maxIterations; ) m = false, f = Zd(v, l, i.expandFactor), v = Qd(f, l, i.inflateFactor), Jd(v, f, u, 4) || (m = true), b++;
  var w = jd(v, l, t, n);
  return w = rh(w), w;
}, th = { markovClustering: Zo, mcl: Zo }, ah = function(e) {
  return e;
}, Tv = function(e, t) {
  return Math.abs(t - e);
}, Qo = function(e, t, a) {
...
var sh = cr({ k: 2, m: 2, sensitivityThreshold: 1e-4, distance: "euclidean", maxIterations: 10, attributes: [], testMode: false, testCentroids: null }), io = function(e) {
  return sh(e);
  ...
  for (var f = true, c = 0; f && c < i.maxIterations; ) {
    ...
    for (var d = 0; d < o.length; d++) {
      ...
      if (y.length !== 0) {
        ...
        for (var g = 0; g < y.length; g++) u = eu(y[g], y, i.attributes), u < v[d] && (v[d] = u, o[d] = y[g], f = true);
        s[d] = t.collection(y);
      }
    }
    c++;
  ...
  for (var m = true, b = 0; m && b < n.maxIterations; ) m = false, ch(s, a, o, u, n), dh(o, l, s, a, n), uh(o, l, n.sensitivityThreshold) || (m = true), b++;
  return i = hh(a, o, n, t), { clusters: i, degreeOfMembership: o };
}, gh = { kMeans: vh, kMedoids: fh, fuzzyCMeans: ru, fcm: ru }, ph = cr({ distance: "euclidean", linkage: "min", mode: "threshold", threshold: 1 / 0, addDendrogram: false, dendrogramDepth: 0, attributes: [] }), yh = { single: "min", complete: "max" }, mh = function(e) {
  ...
  var d = t[s], y = t[n[s]], g;
  i.mode === "dendrogram" ? g = { left: d, right: y, key: d.key } : g = { value: d.value.concat(y.value), key: d.key }, e[d.index] = g, e.splice(y.index, 1), t[d.key] = g;
  ...
  if (!e) return "";
  if (e.left && e.right) {
    var a = Ms(e.left, t), n = Ms(e.right, t), i = t.add({ group: "nodes", data: { id: a + "," + n } });
...
}, bh = { hierarchicalClustering: au, hca: au }, wh = cr({ distance: "euclidean", preference: "median", damping: 0.8, maxIterations: 1e3, minIterations: 100, attributes: [] }), xh = function(e) {
  ...
  for (k = 0; k < n.maxIterations; k++) {
    for (var D = 0; D < o; D++) {
      for (var B = -1 / 0, P = -1 / 0, A = -1, R = 0, L = 0; L < o; L++) b[L] = f[D * o + L], R = c[D * o + L] + u[D * o + L], R >= B ? (P = B, B = R, A = L) : R > P && (P = R);
  ...
  return te;
}, kh = { affinityPropagation: iu, ap: iu }, Dh = cr({ root: void 0, directed: false }), Bh = { hierholzer: function(e) {
  if (!Le(e)) {
    var t = arguments;
  ...
  var h = { found: false, trail: void 0 };
  if (o) return h;
  if (u && l) if (i) {
    if (v && u != v) return h;
    v = u;
  ...
  var e = this, t = {}, a = 0, n = 0, i = [], s = [], o = {}, l = function(c, h) {
    ...
    c === d && (n += 1), t[h] = { id: a, low: a++, cutVertex: false };
    var y = e.getElementById(h).connectedEdges().intersection(e);
    if (y.size() === 0) i.push(e.spawn(e.getElementById(h)));
    else {
      var g, p, m, b;
      y.forEach(function(w) {
        g = w.source().id(), p = w.target().id(), m = g === h ? p : g, m !== d && (b = w.id(), o[b] || (o[b] = true, s.push({ x: h, y: m, edge: w })), m in t ? t[h].low = Math.min(t[h].low, t[m].id) : (u(c, m, h), t[h].low = Math.min(t[h].low, t[m].low), t[h].id <= t[m].low && (t[h].cutVertex = true, l(h, m))));
      });
    }
  };
...
}, Ph = { hopcroftTarjanBiconnected: Qa, htbc: Qa, htb: Qa, hopcroftTarjanBiconnectedComponents: Qa }, Ja = function() {
  var e = this, t = {}, a = 0, n = [], i = [], s = e.spawn(e), o = function(u) {
    ...
    if (v.forEach(function(y) {
      ...
      for (var f = e.spawn(); ; ) {
        var c = i.pop();
        if (f.merge(e.getElementById(c)), t[c].low = t[u].index, t[c].explored = true, c === u) break;
      }
...
}, Ah = { tarjanStronglyConnected: Ja, tsc: Ja, tscc: Ja, tarjanStronglyConnectedComponents: Ja }, Dv = {};
...
Nr.prototype = { fulfill: function(e) {
...
var Rh = { animated: function() {
  ...
  return function(t, a) {
    ...
    for (var l = 0; l < s.length; l++) {
      var u = s[l], v = u.animated() && (t.queue === void 0 || t.queue), f = u.animation(t, v ? { queue: true } : void 0);
      f.play();
    }
    return this;
  };
...
var Eg = xg(), Cg = Oa(Eg), Tg = { data: function(e) {
  var t = { field: "data", bindingEvent: "data", allowBinding: false, allowSetting: false, allowGetting: false, settingEvent: "data", settingTriggersEvent: false, triggerFnName: "trigger", immutableKeys: {}, updateStyle: false, beforeGet: function(n) {
...
var kg = { animate: Fe.animate(), animation: Fe.animation(), animated: Fe.animated(), clearQueue: Fe.clearQueue(), delay: Fe.delay(), delayAnimation: Fe.delayAnimation(), stop: Fe.stop() }, vn = { classes: function(e) {
  var t = this;
  if (e === void 0) {
    var a = [];
  ...
  _e(e) || (e = e.match(/\S+/g) || []);
  for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++) for (var l = a[s], u = l._private.classes, v = false, f = 0; f < e.length; f++) {
...
var Me = { metaChar: "[\\!\\\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\]\\^\\`\\{\\|\\}\\~]", comparatorOp: "=|\\!=|>|>=|<|<=|\\$=|\\^=|\\*=", boolOp: "\\?|\\!|\\^", string: `"(?:\\\\"|[^"])*"|'(?:\\\\'|[^'])*'`, number: tr, meta: "degree|indegree|outdegree", separator: "\\s*,\\s*", descendant: "\\s+", child: "\\s+>\\s+", subject: "\\$", group: "node|edge|\\*", directedEdge: "\\s+->\\s+", undirectedEdge: "\\s+<->\\s+" };
...
var qe = function() {
  return { checks: [] };
}, se = { GROUP: 0, COLLECTION: 1, FILTER: 2, DATA_COMPARE: 3, DATA_EXIST: 4, DATA_BOOL: 5, META_COMPARE: 6, STATE: 7, ID: 8, CLASS: 9, UNDIRECTED_EDGE: 10, DIRECTED_EDGE: 11, NODE_SOURCE: 12, NODE_TARGET: 13, NODE_NEIGHBOR: 14, CHILD: 15, DESCENDANT: 16, PARENT: 17, ANCESTOR: 18, COMPOUND_SPLIT: 19, TRUE: 20 }, Os = [{ selector: ":selected", matches: function(e) {
  return e.selected();
  ...
  e[e.length - 1] = a;
}, Ns = [{ name: "group", query: true, regex: "(" + Me.group + ")", populate: function(e, t, a) {
  var n = Je(a, 1), i = n[0];
  ...
  l ? o = o.substring(1, o.length - 1) : o = parseFloat(o), t.checks.push({ type: se.DATA_COMPARE, field: Ot(i), operator: s, value: o });
  ...
  var o = e[e.length++] = qe();
  return o;
} }, { name: "directedEdge", separator: true, regex: Me.directedEdge, populate: function(e, t) {
...
} }, { name: "undirectedEdge", separator: true, regex: Me.undirectedEdge, populate: function(e, t) {
  if (e.currentSubject == null) {
    var a = qe(), n = t, i = qe();
...
} }, { name: "child", separator: true, regex: Me.child, populate: function(e, t) {
  if (e.currentSubject == null) {
    ...
    return s.checks.push({ type: se.COMPOUND_SPLIT, left: o, right: l, subject: u }), u.checks = t.checks, t.checks = [{ type: se.TRUE }], f.checks.push({ type: se.TRUE }), l.checks.push({ type: se.PARENT, parent: f, child: v }), rt(e, o, s), e.currentSubject = u, e.compoundCount++, v;
  } else {
    var c = qe(), h = qe(), d = [{ type: se.PARENT, parent: c, child: h }];
    return c.checks = t.checks, t.checks = d, e.compoundCount++, h;
  }
} }, { name: "descendant", separator: true, regex: Me.descendant, populate: function(e, t) {
  if (e.currentSubject == null) {
    var a = qe(), n = qe(), i = e[e.length - 1];
    return a.checks.push({ type: se.DESCENDANT, ancestor: i, descendant: n }), rt(e, t, a), e.compoundCount++, n;
  } else if (e.currentSubject === t) {
    var s = qe(), o = e[e.length - 1], l = qe(), u = qe(), v = qe(), f = qe();
    return s.checks.push({ type: se.COMPOUND_SPLIT, left: o, right: l, subject: u }), u.checks = t.checks, t.checks = [{ type: se.TRUE }], f.checks.push({ type: se.TRUE }), l.checks.push({ type: se.ANCESTOR, ancestor: f, descendant: v }), rt(e, o, s), e.currentSubject = u, e.compoundCount++, v;
  } else {
    var c = qe(), h = qe(), d = [{ type: se.ANCESTOR, ancestor: c, descendant: h }];
    return c.checks = t.checks, t.checks = d, e.compoundCount++, h;
  }
} }, { name: "subject", modifier: true, regex: Me.subject, populate: function(e, t) {
  if (e.currentSubject != null && e.currentSubject !== t) return Ve("Redefinition of subject in selector `" + e.toString() + "`"), false;
  e.currentSubject = t;
...
var Ag = function(e) {
  ...
  for (t.length = 1, a = Rg(a); ; ) {
    var i = Ag(a);
    if (i.expr == null) return Ve("The selector `" + e + "`is invalid"), false;
  ...
  for (var u = 0; u < t.length; u++) {
    var v = t[u];
    if (v.compoundCount > 0 && v.edgeCount > 0) return Ve("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), false;
    if (v.edgeCount > 1) return Ve("The selector `" + e + "` is invalid because it uses multiple edge selectors"), false;
...
}, Ig = { parse: Mg, toString: Lg }, Fv = function(e, t, a) {
...
be(_n, { minDegree: Nt("degree", function(r, e) {
  return r < e;
...
}, sl = { field: "position", bindingEvent: "position", allowBinding: true, allowSetting: true, settingEvent: "position", settingTriggersEvent: true, triggerFnName: "emitAndNotify", allowGetting: true, validKeys: ["x", "y"], beforeGet: function(e) {
...
Or = Gv = { position: Fe.data(sl), silentPosition: Fe.data(be({}, sl, { allowBinding: false, allowSetting: true, settingTriggersEvent: false, allowGetting: false, beforeSet: function(e, t) {
  Hv(e, t, true);
}, onSet: function(e) {
  e.dirtyCompoundBoundsCache();
  ...
  var n;
  if (Le(e) ? (n = { x: ae(e.x) ? e.x : 0, y: ae(e.y) ? e.y : 0 }, a = t) : ge(e) && ae(t) && (n = { x: 0, y: 0 }, n[e] = t), n != null) {
    var i = this.cy();
    i.startBatch();
...
pt.updateCompoundBounds = function() {
  ...
  function t(s) {
    ...
    var o = s._private, l = s.children(), u = s.pstyle("compound-sizing-wrt-labels").value === "include", v = { width: { val: s.pstyle("min-width").pfValue, left: s.pstyle("min-width-bias-left"), right: s.pstyle("min-width-bias-right") }, height: { val: s.pstyle("min-height").pfValue, top: s.pstyle("min-height-bias-top"), bottom: s.pstyle("min-height-bias-bottom") } }, f = l.boundingBox({ includeLabels: u, includeOverlays: false, useCache: false }), c = o.position;
    (f.w === 0 || f.h === 0) && (f = { w: s.pstyle("width").pfValue, h: s.pstyle("height").pfValue }, f.x1 = c.x - f.w / 2, f.x2 = c.x + f.w / 2, f.y1 = c.y - f.h / 2, f.y2 = c.y + f.h / 2);
    function h(k, D, B) {
      var P = 0, A = 0, R = D + B;
...
var Ar = function(e) {
  ...
  return n;
}, Pa = { includeNodes: true, includeEdges: true, includeLabels: true, includeMainLabels: true, includeSourceLabels: true, includeTargetLabels: true, includeOverlays: true, includeUnderlays: true, includeOutlines: true, useCache: true }, ll = $v(Pa), vl = cr(Pa);
...
}, fl = { controlPoints: { get: Qg, mult: true }, segmentPoints: { get: Jg, mult: true }, sourceEndpoint: { get: jg }, targetEndpoint: { get: ep }, midpoint: { get: rp } }, tp = function(e) {
...
Xv.prototype = { instanceString: function() {
  return "event";
...
var Yv = /^([^.]+)(\.(?:[^.]+))?$/, ip = ".*", Zv = { qualifierCompare: function(e, t) {
  return e === t;
  ...
  return null;
}, context: null }, cl = Object.keys(Zv), sp = {};
function Gn() {
...
var dt = Gn.prototype, Qv = function(e, t, a, n, i, s, o) {
  ...
  for (var n = _e(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
    ...
    if (!ut(s)) {
      var o = s.match(Yv);
      if (o) {
        var l = o[1], u = o[2] ? o[2] : null, v = dl(e, { type: l, namespace: u, target: e.context });
        t(e, v);
      }
    }
  }
...
dt.removeListener = dt.off = function(r, e, t, a) {
  ...
  for (var i = this.listeners, s = function(u) {
    ...
    Qv(n, function(f, c, h, d, y, g) {
      if ((v.type === h || r === "*") && (!d && v.namespace !== ".*" || v.namespace === d) && (!y || f.qualifierCompare(v.qualifier, y)) && (!g || v.callback === g)) return i.splice(u, 1), false;
    }, r, e, t, a);
...
var up = { qualifierCompare: function(e, t) {
...
vp();
var fp = cr({ nodeDimensionsIncludeLabels: false }), fn = { layoutDimensions: function(e) {
  e = fp(e);
  var t;
  ...
  var u = function(C, x, T) {
    var k = { x: x.x1 + x.w / 2, y: x.y1 + x.h / 2 }, D = { x: (T.x - k.x) * C, y: (T.y - k.y) * C };
  ...
  if (t.animate) {
    ...
    if (t.fit) {
      var b = i.animation({ fit: { boundingBox: s.boundingBoxAt(h), padding: t.padding }, duration: t.animationDuration, easing: t.animationEasing });
      e.animations.push(b);
    ...
    e.animations.forEach(function(E) {
      return E.play();
    }), e.one("layoutready", t.ready), e.emit({ type: "layoutready", layout: e }), ta.all(e.animations.map(function(E) {
      return E.promise();
    })).then(function() {
      e.one("layoutstop", t.stop), e.emit({ type: "layoutstop", layout: e });
    });
  } else n.positions(h), t.fit && i.fit(t.eles, t.padding), t.zoom != null && i.zoom(t.zoom), t.pan && i.pan(t.pan), e.one("layoutready", t.ready), e.emit({ type: "layoutready", layout: e }), e.one("layoutstop", t.stop), e.emit({ type: "layoutstop", layout: e });
  return this;
}, layout: function(e) {
  var t = this.cy();
...
function na(r) {
  ...
  }, ot[r.on] = hl({ event: r.on, field: r.field, ableField: r.ableField, overrideAble: r.overrideAble, value: true }), ot[r.off] = hl({ event: r.off, field: r.field, ableField: r.ableField, overrideAble: r.overrideAble, value: false });
}
na({ field: "locked", overrideField: function(e) {
  return e.cy().autolock() ? true : void 0;
}, on: "lock", off: "unlock" });
na({ field: "grabbable", overrideField: function(e) {
  return e.cy().autoungrabify() || e.pannable() ? false : void 0;
}, on: "grabify", off: "ungrabify" });
na({ field: "selected", ableField: "selectable", overrideAble: function(e) {
  return e.cy().autounselectify() ? false : void 0;
}, on: "select", off: "unselect" });
na({ field: "selectable", overrideField: function(e) {
  return e.cy().autounselectify() ? false : void 0;
...
be(gr, { roots: gl({ noIncomingEdges: true }), leaves: gl({ noOutgoingEdges: true }), outgoers: Rr(pl({ outgoing: true }), "outgoers"), successors: yl({ outgoing: true }), incomers: Rr(pl({ incoming: true }), "incomers"), predecessors: yl({}) });
be(gr, { neighborhood: Rr(function(r) {
...
}, "target"), sources: ml({ attr: "source" }), targets: ml({ attr: "target" }) });
function ml(r) {
  return function(t) {
...
be(gr, { edgesWith: Rr(bl(), "edgesWith"), edgesTo: Rr(bl({ thisIsSrc: true }), "edgesTo") });
function bl(r) {
  return function(t) {
...
be(gr, { connectedEdges: Rr(function(r) {
  ...
  return this.spawn(e, true).filter(r);
}, "connectedNodes"), parallelEdges: Rr(wl(), "parallelEdges"), codirectedEdges: Rr(wl({ codirected: true }), "codirectedEdges") });
function wl(r) {
...
be(gr, { components: function(e) {
  ...
  var l = function() {
    ...
    s.push(v);
    var f = i[0];
    o(f, v), t.bfs({ directed: false, roots: f, visit: function(h) {
      return o(h, v);
...
He.json = function(r) {
  ...
  if (e != null) {
    ...
    if (Le(r)) {
      ...
      var c = { data: qr(a.data), position: qr(a.position), group: a.group, removed: a.removed, selected: a.selected, selectable: a.selectable, locked: a.locked, grabbable: a.grabbable, pannable: a.pannable, classes: null };
      c.classes = "";
      var h = 0;
...
He.restore = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    d.map = new Xr(), d.map.set(g, { ele: h, index: 0 }), d.removed = false, e && a.addToPool(h);
  }
...
var mp = /* @__PURE__ */ (function() {
  ...
  function t(a, n) {
    var i = { dx: a.v, dv: r(a) }, s = e(a, n * 0.5, i), o = e(a, n * 0.5, s), l = e(a, n, o), u = 1 / 6 * (i.dx + 2 * (s.dx + o.dx) + l.dx), v = 1 / 6 * (i.dv + 2 * (s.dv + o.dv) + l.dv);
    return a.x = a.x + u * n, a.v = a.v + v * n, a;
  }
  return function a(n, i, s) {
    var o = { x: -1, v: 0, tension: null, friction: null }, l = [0], u = 0, v = 1 / 1e4, f = 16 / 1e3, c, h, d;
...
}, cn = { linear: function(e, t, a) {
  return e + (t - e) * a;
}, ease: Ge(0.25, 0.1, 0.25, 1), "ease-in": Ge(0.42, 0, 1, 1), "ease-out": Ge(0, 0, 0.58, 1), "ease-in-out": Ge(0.42, 0, 0.58, 1), "ease-in-sine": Ge(0.47, 0, 0.745, 0.715), "ease-out-sine": Ge(0.39, 0.575, 0.565, 1), "ease-in-out-sine": Ge(0.445, 0.05, 0.55, 0.95), "ease-in-quad": Ge(0.55, 0.085, 0.68, 0.53), "ease-out-quad": Ge(0.25, 0.46, 0.45, 0.94), "ease-in-out-quad": Ge(0.455, 0.03, 0.515, 0.955), "ease-in-cubic": Ge(0.55, 0.055, 0.675, 0.19), "ease-out-cubic": Ge(0.215, 0.61, 0.355, 1), "ease-in-out-cubic": Ge(0.645, 0.045, 0.355, 1), "ease-in-quart": Ge(0.895, 0.03, 0.685, 0.22), "ease-out-quart": Ge(0.165, 0.84, 0.44, 1), "ease-in-out-quart": Ge(0.77, 0, 0.175, 1), "ease-in-quint": Ge(0.755, 0.05, 0.855, 0.06), "ease-out-quint": Ge(0.23, 1, 0.32, 1), "ease-in-out-quint": Ge(0.86, 0, 0.07, 1), "ease-in-expo": Ge(0.95, 0.05, 0.795, 0.035), "ease-out-expo": Ge(0.19, 1, 0.22, 1), "ease-in-out-expo": Ge(1, 0, 0, 1), "ease-in-circ": Ge(0.6, 0.04, 0.98, 0.335), "ease-out-circ": Ge(0.075, 0.82, 0.165, 1), "ease-in-out-circ": Ge(0.785, 0.135, 0.15, 0.86), spring: function(e, t, a) {
...
} }, Ep = { qualifierCompare: function(e, t) {
  return e == null || t == null ? e == null && t == null : e.sameText(t);
}, eventMatches: function(e, t, a) {
  var n = t.qualifier;
  return n != null ? e !== a.target && Ia(a.target) && n.matches(a.target) : true;
...
} }, Tp = cr({ hideEdgesOnViewport: false, textureOnViewport: false, motionBlur: false, motionBlurOpacity: 0.05, pixelRatio: void 0, desktopTapThreshold: 4, touchTapThreshold: 8, wheelSensitivity: 1, debug: false, showFps: false, webgl: false, webglDebug: false, webglDebugShowAtlases: false, webglTexSize: 2048, webglTexRows: 36, webglTexRowsNodes: 18, webglBatchSize: 2048, webglTexPerBatch: 14, webglBgColor: [255, 255, 255] }), Fs = { renderTo: function(e, t, a, n) {
...
var hn = { collection: function(e, t) {
...
ur.applyContextStyle = function(r, e, t) {
  for (var a = this, n = r.diffPropNames, i = {}, s = a.types, o = 0; o < n.length; o++) {
    ...
    if (!u) if (v) v.bypass ? u = { name: l, deleteBypassed: true } : u = { name: l, delete: true };
    else continue;
    if (v !== u) {
...
ur.applyParsedProperty = function(r, e) {
  ...
  if (e.name === "curve-style" && r.isEdge() && (e.value !== "bezier" && r.isLoop() || e.value === "haystack" && (r.source().isParent() || r.target().isParent())) && (a = e = this.parse(e.name, "bezier", l)), a.delete) return n[a.name] = void 0, d(), true;
  if (a.deleteBypassed) return u ? u.bypass ? (u.bypassed = void 0, d(), true) : false : (d(), true);
  if (a.deleteBypass) return u ? u.bypass ? (n[a.name] = u.bypassed, d(), true) : false : (d(), true);
  var y = function() {
  ...
  switch (a.mapped) {
    case s.mapData: {
      ...
      if (p == null) return y(), false;
      var w;
      if (ae(p)) {
        var E = a.fieldMax - a.fieldMin;
        E === 0 ? w = 0 : w = (p - a.fieldMin) / E;
      } else return Ve("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), false;
    ...
    case s.data: {
      ...
      if (M != null && (i = this.parse(a.name, M, a.bypass, c)), !i) return y(), false;
      i.mapping = a, a = i;
      break;
    }
    case s.fn: {
      var G = a.value, N = a.fnValue != null ? a.fnValue : G(r);
      if (a.prevFnValue = N, N == null) return Ve("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), false;
      if (i = this.parse(a.name, N, a.bypass, c), !i) return Ve("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), false;
      i.mapping = qr(a), a = i;
      break;
    }
    case void 0:
...
_a.removeBypasses = function(r, e, t) {
  for (var a = true, n = 0; n < r.length; n++) {
    for (var i = r[n], s = {}, o = 0; o < e.length; o++) {
      ...
      if (!(!v || !v.bypass)) {
        var f = "", c = this.parse(l, f, true), h = s[u.name] = { prev: v };
...
_r.getNonDefaultPropertiesHash = function(r, e, t) {
  ...
  for (l = 0; l < e.length; l++) if (n = e[l], i = r.pstyle(n, false), i != null) if (i.pfValue != null) a[0] = Ca(o, a[0]), a[1] = Ta(o, a[1]);
...
(function() {
  ...
  } }, easing: { regexes: ["^(spring)\\s*\\(\\s*(" + r + ")\\s*,\\s*(" + r + ")\\s*\\)$", "^(cubic-bezier)\\s*\\(\\s*(" + r + ")\\s*,\\s*(" + r + ")\\s*,\\s*(" + r + ")\\s*,\\s*(" + r + ")\\s*\\)$"], enums: ["linear", "ease", "ease-in", "ease-out", "ease-in-out", "ease-in-sine", "ease-out-sine", "ease-in-out-sine", "ease-in-quad", "ease-out-quad", "ease-in-out-quad", "ease-in-cubic", "ease-out-cubic", "ease-in-out-cubic", "ease-in-quart", "ease-out-quart", "ease-in-out-quart", "ease-in-quint", "ease-out-quint", "ease-in-out-quint", "ease-in-expo", "ease-out-expo", "ease-in-out-expo", "ease-in-circ", "ease-out-circ", "ease-in-out-circ"] }, gradientDirection: { enums: ["to-bottom", "to-top", "to-left", "to-right", "to-bottom-right", "to-bottom-left", "to-top-right", "to-top-left", "to-right-bottom", "to-left-bottom", "to-right-top", "to-left-top"] }, boundsExpansion: { number: true, multiple: true, min: 0, validate: function(q) {
    var H = q.length;
    return H === 1 || H === 2 || H === 4;
  } } };
  var l = { zeroNonZero: function(q, H) {
  ...
  for (var j = 0; j < U.length; j++) {
    var re = U[j], ne = V[re.pointsTo], J = { name: re.name, alias: true, pointsTo: ne };
...
Un.parseImpl = function(r, e, t, a) {
  ...
  if (!(!l || a || e.length < 7 || e[1] !== "a")) {
    if (e.length >= 7 && e[0] === "d" && (v = new RegExp(o.data.regex).exec(e))) {
      ...
      if (u.color) {
        var g = d.value, p = y.value, m = g[0] === p[0] && g[1] === p[1] && g[2] === p[2] && (g[3] === p[3] || (g[3] == null || g[3] === 1) && (p[3] == null || p[3] === 1));
        if (m) return false;
      }
      return { name: r, value: f, strValue: "" + e, mapped: h, field: f[1], fieldMin: parseFloat(f[2]), fieldMax: parseFloat(f[3]), valueMin: d.value, valueMax: y.value, bypass: t };
    }
  }
  ...
  if (u.number) {
    ...
    var F = iv(e);
    return F ? { name: r, value: F, pfValue: F, strValue: "rgb(" + F[0] + "," + F[1] + "," + F[2] + ")", bypass: t } : null;
...
var kp = { style: function(e) {
...
} }, Dp = "single", At = { autolock: function(e) {
  ...
  var t = this._private;
  if (t.selectionType == null && (t.selectionType = Dp), e !== void 0) (e === "additive" || e === "single") && (t.selectionType = e);
  ...
  if (t.zoomingEnabled || (o = true), ae(e) ? s = e : Le(e) && (s = e.level, e.position != null ? i = On(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = true)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y))) return null;
  if (i != null) {
    var l = a, u = n, v = s, f = { x: -v / u * (i.x - l.x) + i.x, y: -v / u * (i.y - l.y) + i.y };
  ...
  if (!e) return this;
  if (ae(e.zoom) || (a = false), Le(e.pan) || (n = false), !a && !n) return this;
  if (a) {
    var l = e.zoom;
...
be(kn, { instanceString: function() {
  ...
  if (e != null) {
    ...
    return !bn(e) && bn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = true, t.invalidateSize(), t.initRenderer(be({}, n, n.renderer, { name: n.renderer.name === "null" ? "canvas" : n.renderer.name })), t.startAnimationLoop(), t.style(n.style), t.emit("mount"), t;
  }
}, unmount: function() {
  var e = this;
    ...
    if (t.startBatch(), e.elements) {
      var s = {}, o = function(w, E) {
        for (var C = [], x = [], T = 0; T < w.length; T++) {
          ...
          s[D] = true, B.length !== 0 ? x.push({ ele: B, json: k }) : (E && (k.group = E), C.push(k));
        }
        t.add(C);
...
var Bp = { fit: true, directed: false, direction: "downward", padding: 30, circle: false, grid: false, spacingFactor: 1.75, boundingBox: void 0, avoidOverlap: true, nodeDimensionsIncludeLabels: false, roots: void 0, depthSort: void 0, animate: false, animationDuration: 500, animationEasing: void 0, animateFilter: function(e, t) {
  return true;
}, ready: void 0, stop: void 0, transform: function(e, t) {
  return t;
} }, Pp = { maximal: false, acyclic: false }, Ft = function(e) {
...
af.prototype.run = function() {
  ...
  var H = { x: l.x1 + l.w / 2, y: l.y1 + l.h / 2 }, Y = a.reduce(function(ye, ie) {
    return (function(de) {
      return { w: ye.w === -1 ? de.w : (ye.w + de.w) / 2, h: ye.h === -1 ? de.h : (ye.h + de.h) / 2 };
    })(ie.boundingBox({ includeLabels: r.nodeDimensionsIncludeLabels }));
  }, { w: -1, h: -1 }), te = Math.max(K === 1 ? 0 : o ? (l.h - r.padding * 2 - Y.h) / (K - 1) : (l.h - r.padding * 2 - Y.h) / (K + 1), I), ce = p.reduce(function(ye, ie) {
    ...
    if (r.circle) {
      ...
      var Oe = p[he].length, Ne = Math.max(Oe === 1 ? 0 : o ? (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) - 1) : (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) + 1), I), ze = { x: H.x + (Ee + 1 - (Oe + 1) / 2) * Ne, y: H.y + (he + 1 - (K + 1) / 2) * te };
      return ze;
    }
...
var Ap = { fit: true, padding: 30, boundingBox: void 0, avoidOverlap: true, nodeDimensionsIncludeLabels: false, spacingFactor: void 0, radius: void 0, startAngle: 3 / 2 * Math.PI, sweep: void 0, clockwise: true, sort: void 0, animate: false, animationDuration: 500, animationEasing: void 0, animateFilter: function(e, t) {
  return true;
}, ready: void 0, stop: void 0, transform: function(e, t) {
  return t;
} };
...
nf.prototype.run = function() {
  ...
  for (var s = wr(e.boundingBox ? e.boundingBox : { x1: 0, y1: 0, w: t.width(), h: t.height() }), o = { x: s.x1 + s.w / 2, y: s.y1 + s.h / 2 }, l = e.sweep === void 0 ? 2 * Math.PI - 2 * Math.PI / i.length : e.sweep, u = l / Math.max(1, i.length - 1), v, f = 0, c = 0; c < i.length; c++) {
  ...
  var w = function(C, x) {
    var T = e.startAngle + x * u * (n ? 1 : -1), k = v * Math.cos(T), D = v * Math.sin(T), B = { x: o.x + k, y: o.y + D };
    return B;
  };
  return a.nodes().layoutPositions(this, e, w), this;
};
var Rp = { fit: true, padding: 30, startAngle: 3 / 2 * Math.PI, sweep: void 0, clockwise: true, equidistant: false, minNodeSpacing: 10, boundingBox: void 0, avoidOverlap: true, nodeDimensionsIncludeLabels: false, height: void 0, width: void 0, spacingFactor: void 0, concentric: function(e) {
  return e.degree();
}, levelWidth: function(e) {
  return e.maxDegree() / 4;
}, animate: false, animationDuration: 500, animationEasing: void 0, animateFilter: function(e, t) {
  return true;
}, ready: void 0, stop: void 0, transform: function(e, t) {
  return t;
} };
...
sf.prototype.run = function() {
  for (var r = this.options, e = r, t = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = r.cy, n = e.eles, i = n.nodes().not(":parent"), s = wr(e.boundingBox ? e.boundingBox : { x1: 0, y1: 0, w: a.width(), h: a.height() }), o = { x: s.x1 + s.w / 2, y: s.y1 + s.h / 2 }, l = [], u = 0, v = 0; v < i.length; v++) {
    var f = i[v], c = void 0;
  ...
  for (var K = {}, j = 0; j < p.length; j++) for (var re = p[j], ne = re.dTheta, J = re.r, z = 0; z < re.length; z++) {
    var q = re[z], H = e.startAngle + (t ? 1 : -1) * ne * z, Y = { x: o.x + J * Math.cos(H), y: o.y + J * Math.sin(H) };
    K[q.node.id()] = Y;
  }
...
var bs, Mp = { ready: function() {
}, stop: function() {
}, animate: true, animationEasing: void 0, animationDuration: void 0, animateFilter: function(e, t) {
  return true;
}, animationThreshold: 250, refresh: 20, fit: true, padding: 30, boundingBox: void 0, nodeDimensionsIncludeLabels: false, randomize: false, componentSpacing: 40, nodeRepulsion: function(e) {
  return 2048;
}, nodeOverlap: 4, idealEdgeLength: function(e) {
  return 32;
...
Kn.prototype.run = function() {
  ...
  t.stopped = false, (r.animate === true || r.animate === false) && t.emit({ type: "layoutstart", layout: t }), r.debug === true ? bs = true : bs = false;
  var a = Lp(e, t, r);
...
var Lp = function(e, t, a) {
  for (var n = a.eles.edges(), i = a.eles.nodes(), s = wr(a.boundingBox ? a.boundingBox : { x1: 0, y1: 0, w: e.width(), h: e.height() }), o = { isCompound: e.hasCompoundNodes(), layoutNodes: [], idToIndex: {}, nodeSize: i.size(), graphSet: [], indexToGraph: [], layoutEdges: [], edgeSize: n.size(), temperature: a.initialTemp, clientWidth: s.w, clientHeight: s.h, boundingBox: s }, l = a.eles.components(), u = {}, v = 0; v < l.length; v++) for (var f = l[v], c = 0; c < f.length; c++) {
    var h = f[c];
    u[h.id()] = v;
  }
  ...
  if (a != null) {
    ...
    if ((n.maxX == null || e.maxX + n.padRight > n.maxX) && (n.maxX = e.maxX + n.padRight, i = true), (n.minX == null || e.minX - n.padLeft < n.minX) && (n.minX = e.minX - n.padLeft, i = true), (n.maxY == null || e.maxY + n.padBottom > n.maxY) && (n.maxY = e.maxY + n.padBottom, i = true), (n.minY == null || e.minY - n.padTop < n.minY) && (n.minY = e.minY - n.padTop, i = true), i) return lf(n, t);
  }
}, kl = function(e, t) {
...
}, Kp = { fit: true, padding: 30, boundingBox: void 0, avoidOverlap: true, avoidOverlapPadding: 10, nodeDimensionsIncludeLabels: false, spacingFactor: void 0, condense: false, rows: void 0, cols: void 0, position: function(e) {
}, sort: void 0, animate: false, animationDuration: 500, animationEasing: void 0, animateFilter: function(e, t) {
  return true;
}, ready: void 0, stop: void 0, transform: function(e, t) {
  return t;
} };
...
vf.prototype.run = function() {
  ...
  if (i.h === 0 || i.w === 0) a.nodes().layoutPositions(this, e, function(U) {
    ...
    var F = function(Q, K) {
      var j, re;
      if (Q.locked() || Q.isParent()) return false;
      var ne = M[Q.id()];
...
var Yp = { positions: void 0, zoom: void 0, pan: void 0, fit: true, padding: 30, spacingFactor: void 0, animate: false, animationDuration: 500, animationEasing: void 0, animateFilter: function(e, t) {
  return true;
}, ready: void 0, stop: void 0, transform: function(e, t) {
  return t;
} };
...
var Zp = { fit: true, padding: 30, boundingBox: void 0, animate: false, animationDuration: 500, animationEasing: void 0, animateFilter: function(e, t) {
  return true;
}, ready: void 0, stop: void 0, transform: function(e, t) {
  return t;
} };
...
cf.prototype.run = function() {
  var r = this.options, e = r.cy, t = r.eles, a = wr(r.boundingBox ? r.boundingBox : { x1: 0, y1: 0, w: e.width(), h: e.height() }), n = function(s, o) {
    return { x: a.x1 + Math.round(Math.random() * a.w), y: a.y1 + Math.round(Math.random() * a.h) };
  };
  return t.nodes().layoutPositions(this, r, n), this;
};
var Qp = [{ name: "breadthfirst", impl: af }, { name: "circle", impl: nf }, { name: "concentric", impl: sf }, { name: "cose", impl: Kn }, { name: "grid", impl: vf }, { name: "null", impl: ho }, { name: "preset", impl: ff }, { name: "random", impl: cf }];
function df(r) {
...
df.prototype = { recalculateRenderedStyle: Dl, notify: function() {
  this.notifications++;
}, init: Dl, isHeadless: function() {
  return true;
}, png: Bl, jpg: Bl };
var go = {};
...
go.registerArrowShapes = function() {
  var r = this.arrowShapes = {}, e = this, t = function(u, v, f, c, h, d, y) {
    ...
    ge(v) && (v = r[v]), r[u] = be({ name: u, points: [-0.15, -0.3, 0.15, -0.3, 0.15, 0.3, -0.15, 0.3], collide: function(c, h, d, y, g, p) {
      var m = i(n(this.points, d + 2 * p, y, g)), b = Sr(c, h, m);
      return b;
    }, roughCollide: t, draw: function(c, h, d, y) {
  ...
  o("none", { collide: xn, roughCollide: xn, draw: js, spacing: Go, gap: Go }), o("triangle", { points: [-0.15, -0.3, 0, 0, 0.15, -0.3] }), o("arrow", "triangle"), o("triangle-backcurve", { points: r.triangle.points, controlPoint: [0, -0.15], roughCollide: t, draw: function(u, v, f, c, h) {
    var d = n(this.points, v, f, c), y = this.controlPoint, g = a(y[0], y[1], v, f, c);
    e.arrowShapeImpl(this.name)(u, d, g);
  }, gap: function(u) {
    return s(u) * 0.8;
  } }), o("triangle-tee", { points: [0, 0, 0.15, -0.3, -0.15, -0.3, 0, 0], pointsTee: [-0.15, -0.4, -0.15, -0.5, 0.15, -0.5, 0.15, -0.4], collide: function(u, v, f, c, h, d, y) {
  ...
  } }), o("circle-triangle", { radius: 0.15, pointsTr: [0, -0.15, 0.15, -0.45, -0.15, -0.45, 0, -0.15], collide: function(u, v, f, c, h, d, y) {
  ...
  } }), o("triangle-cross", { points: [0, 0, 0.15, -0.3, -0.15, -0.3, 0, 0], baseCrossLinePts: [-0.15, -0.4, -0.15, -0.4, 0.15, -0.4, 0.15, -0.4], crossLinePts: function(u, v) {
    ...
    e.arrowShapeImpl(this.name)(u, d, y);
  } }), o("vee", { points: [-0.15, -0.3, 0, 0, 0.15, -0.3, 0, -0.15], gap: function(u) {
    return s(u) * 0.525;
  } }), o("circle", { radius: 0.15, collide: function(u, v, f, c, h, d, y) {
    ...
    return e.getArrowWidth(u.pstyle("width").pfValue, u.pstyle("arrow-scale").value) * this.radius;
  } }), o("tee", { points: [-0.15, 0, -0.15, -0.1, 0.15, -0.1, 0.15, 0], spacing: function(u) {
    return 1;
  }, gap: function(u) {
    return 1;
  } }), o("square", { points: [-0.15, 0, 0.15, 0, 0.15, -0.3, -0.15, -0.3] }), o("diamond", { points: [-0.15, -0.15, 0, -0.3, 0.15, -0.15, 0, 0], gap: function(u) {
    return u.pstyle("width").pfValue * u.pstyle("arrow-scale").value;
  } }), o("chevron", { points: [0, 0, -0.15, -0.15, -0.1, -0.2, 0, -0.1, 0.1, -0.2, 0.15, -0.15], gap: function(u) {
...
Mt.findContainerClientCoords = function() {
  ...
  }, n = { left: a("padding-left"), right: a("padding-right"), top: a("padding-top"), bottom: a("padding-bottom") }, i = { left: a("border-left-width"), right: a("border-right-width"), top: a("border-top-width"), bottom: a("border-bottom-width") }, s = r.clientWidth, o = r.clientHeight, l = n.left + n.right, u = n.top + n.bottom, v = i.left + i.right, f = e.width / (s + v), c = s - l, h = o - u, d = e.left + n.left + i.left, y = e.top + n.top + i.top;
...
Mt.findNearestElements = function(r, e, t, a) {
  ...
  function p(x) {
    ...
    if (P.x - D <= r && r <= P.x + D && P.y - B <= e && e <= P.y + B) {
      ...
      if (L.checkPoint(r, e, 0, T, k, P.x, P.y, A, R)) return g(x, 0), true;
    }
  }
  function m(x) {
    ...
    if (k.edgeType === "segments" || k.edgeType === "straight" || k.edgeType === "haystack") {
      for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2) if (Rd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) && A > (L = Nd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3]))) return g(x, L), true;
    } else if (k.edgeType === "bezier" || k.edgeType === "multibezier" || k.edgeType === "self" || k.edgeType === "compound") {
      for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4) if (Md(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) && A > (L = Od(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5]))) return g(x, L), true;
    }
    for (var O = O || T.source, V = V || T.target, G = n.getArrowWidth(D, B), N = [{ name: "source", x: k.arrowStartX, y: k.arrowStartY, angle: k.srcArrowAngle }, { name: "target", x: k.arrowEndX, y: k.arrowEndY, angle: k.tgtArrowAngle }, { name: "mid-source", x: k.midX, y: k.midY, angle: k.midsrcArrowAngle }, { name: "mid-target", x: k.midX, y: k.midY, angle: k.midtgtArrowAngle }], M = 0; M < N.length; M++) {
      var F = N[M], U = i.arrowShapes[x.pstyle(F.name + "-arrow-shape").value], Q = x.pstyle("width").pfValue;
      if (U.roughCollide(r, e, G, F.angle, { x: F.x, y: F.y }, Q, v) && U.collide(r, e, G, F.angle, { x: F.x, y: F.y }, Q, v)) return g(x), true;
    }
  ...
  function w(x, T) {
    ...
    if (!(!R || !A)) {
      ...
      if (M) {
        ...
        }, re = j(G, F), ne = j(G, U), J = j(N, F), z = j(N, U), q = [re.x + O, re.y + V, J.x + O, J.y + V, z.x + O, z.y + V, ne.x + O, ne.y + V];
        if (Sr(r, e, q)) return g(x), true;
      } else if (nt(P, r, e)) return g(x), true;
    }
  }
...
Mt.getAllInBox = function(r, e, t, a) {
  ...
  r = l, t = u, e = v, a = f;
  var c = wr({ x1: r, y1: e, x2: t, y2: a }), h = [{ x: c.x1, y: c.y1 }, { x: c.x2, y: c.y1 }, { x: c.x2, y: c.y2 }, { x: c.x1, y: c.y2 }], d = [[h[0], h[1]], [h[1], h[2]], [h[2], h[3]], [h[3], h[0]]];
  function y(Y, te, ce) {
    return Tr(Y, te, ce);
  }
  function g(Y, te) {
    ...
    } else return [{ x: pe, y: Re }, { x: Se, y: Re }, { x: Se, y: Oe }, { x: pe, y: Oe }];
  }
  ...
  for (var m = 0; m < n.length; m++) {
    ...
    if (b.isNode()) {
      ...
      if (C === "none") continue;
      var T = (C === "overlap" || x) && E, k = w.boundingBox({ includeNodes: true, includeEdges: false, includeLabels: T });
      if (C === "contain") {
        var D = false;
        if (x && E) {
          var B = g(w);
        ...
        var P = w.boundingBox({ includeNodes: true, includeEdges: true, includeLabels: false, includeMainLabels: false, includeSourceLabels: false, includeTargetLabels: false }), A = [{ x: P.x1, y: P.y1 }, { x: P.x2, y: P.y1 }, { x: P.x2, y: P.y2 }, { x: P.x1, y: P.y2 }];
        if (yi(A, h)) o.push(w);
        else {
          var R = g(w);
          R && yi(R, h) && o.push(w);
      ...
      if (O === "contain") {
        ...
        if (M.edgeType === "bezier" || M.edgeType === "multibezier" || M.edgeType === "self" || M.edgeType === "compound" || M.edgeType === "segments" || M.edgeType === "haystack") {
          for (var V = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, G = true, N = 0; N < V.length; N++) if (!Ko(c, V[N])) {
            G = false;
            break;
          }
          G && o.push(L);
        ...
        var F = false;
        if (M.startX != null && M.startY != null && M.endX != null && M.endY != null && (nt(c, M.startX, M.startY) || nt(c, M.endX, M.endY))) o.push(L), F = true;
        ...
        if (!F) {
          ...
          if ((!K || K.length < 2) && M.edgeType === "straight" && M.startX != null && M.startY != null && M.endX != null && M.endY != null && (K = [{ x: M.startX, y: M.startY }, { x: M.endX, y: M.endY }]), !K || K.length < 2) continue;
...
yr.findMidptPtsEtc = function(r, e) {
  ...
  switch (v) {
    ...
    case "endpoints": {
      if (l) {
        var f = this.manualEndptToPx(r.source()[0], s), c = Je(f, 2), h = c[0], d = c[1], y = this.manualEndptToPx(r.target()[0], o), g = Je(y, 2), p = g[0], m = g[1], b = { x1: h, y1: d, x2: p, y2: m };
        n = u(h, d, p, m), i = b;
...
yr.findSegmentsPoints = function(r, e) {
  ...
  for (var v = 0; v < o; v++) {
    var f = a.pfValue[v], c = n.pfValue[v], h = 1 - f, d = f, y = this.findMidptPtsEtc(r, e), g = y.midptPts, p = y.vectorNormInverse, m = { x: g.x1 * h + g.x2 * d, y: g.y1 * h + g.y2 * d };
...
yr.findCompoundLoopPoints = function(r, e, t, a) {
  ...
  a && (d = 0, y = h);
  var g = 50, p = { x: i.x - o / 2, y: i.y - l / 2 }, m = { x: s.x - u / 2, y: s.y - v / 2 }, b = { x: Math.min(p.x, m.x), y: Math.min(p.y, m.y) }, w = 0.5, E = Math.max(w, Math.log(o * Ma)), C = Math.max(w, Math.log(u * Ma));
...
yr.findBezierPoints = function(r, e, t, a, n) {
  ...
  for (var h = 0; h < u; h++) {
    ...
    var p = y !== void 0 ? y : d, m = 1 - f, b = f, w = this.findMidptPtsEtc(r, e), E = w.midptPts, C = w.vectorNormInverse, x = { x: E.x1 * m + E.x2 * b, y: E.y1 * m + E.y2 * b };
  ...
  if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
    ...
    if (e.segpts.length % 4 === 0) {
      ...
      if (!e.isRound) e.midX = e.segpts[v], e.midY = e.segpts[v + 1];
        ...
        var f = { x: e.segpts[v], y: e.segpts[v + 1] }, c = e.roundCorners[v / 2];
        if (c.radius === 0) {
  ...
  if (!(!r || r.length === 0)) {
    for (var t = this, a = t.cy, n = a.hasCompoundNodes(), i = new Xr(), s = function(k, D) {
      ...
      if (!(v.removed() || !v.takesUpSpace())) {
        ...
        E == null && (E = { eles: [] }, o.push({ pairId: b, edgeIsUnbundled: h }), i.set(w, E)), E.eles.push(v), h && (E.hasUnbundled = true), d && (E.hasBezier = true);
      }
    }
    for (var C = function() {
      ...
      A.dirCounts = { north: 0, west: 0, south: 0, east: 0, northwest: 0, southwest: 0, northeast: 0, southeast: 0 };
  ...
  if (i.mid || i.source || i.target) {
    ...
    var l = function() {
      ...
      for (var f = [], c = 0; c + 5 < a.allpts.length; c += 4) {
        var h = { x: a.allpts[c], y: a.allpts[c + 1] }, d = { x: a.allpts[c + 2], y: a.allpts[c + 3] }, y = { x: a.allpts[c + 4], y: a.allpts[c + 5] };
      ...
      function m(x, T, k, D, B) {
        var P = Bt(T, k), A = x.segments[x.segments.length - 1], R = { p0: T, p1: k, t0: D, t1: B, startDist: A ? A.startDist + A.length : 0, length: P };
...
wf.getNodeShape = function(r) {
  ...
  if (t === "cutrectangle" && (r.width() < Ll || r.height() < Ll)) return Il || (Ve("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Il = true), "rectangle";
...
ia.binder = function(r) {
  ...
  var s = function(l, u, v) {
    ...
    return a && e.supportsPassiveEvents && (f[2] = { capture: v ?? false, passive: false, once: false }), e.bindings.push({ target: r, args: f }), (r.addEventListener || r.on).apply(r, f), this;
  };
...
ia.load = function() {
  ...
  }), r.container.parentNode && r.removeObserver.observe(r.container.parentNode, { childList: true })) : r.registerBinding(r.container, "DOMNodeRemoved", function(X) {
    r.destroy();
  });
  var C = Fa(function() {
    r.cy.resize();
  }, 100);
  w && (r.styleObserver = new MutationObserver(C), r.styleObserver.observe(r.container, { attributes: true })), r.registerBinding(e, "resize", C), E && (r.resizeObserver = new ResizeObserver(C), r.resizeObserver.observe(r.container));
  var x = function(S, _) {
  ...
  r.registerBinding(r.container, "mousedown", function(S) {
    if (D(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
      ...
      if (S.which == 3) {
        ...
        n(ee, ["mousedown", "tapstart", "vmousedown"], S, { x: $[0], y: $[1] }), ee == null ? (Z[4] = 1, r.data.bgActivePosistion = { x: $[0], y: $[1] }, r.redrawHint("select", true), r.redraw()) : ee.pannable() && (Z[4] = 1), me();
      }
      Z[0] = Z[2] = $[0], Z[1] = Z[3] = $[1];
    }
  }, false);
  ...
  r.registerBinding([e, B], "mousemove", function(S) {
    ...
    if (!(!_ && !D(S))) {
      ...
      W = true, n(De, ["mousemove", "vmousemove", "tapdrag"], S, { x: ee[0], y: ee[1] });
      var Ze = function(Br) {
      ...
      if (r.hoverData.which === 3) {
        ...
        if (W = true, $.panningEnabled() && $.userPanningEnabled()) {
          ...
          if (r.hoverData.justStartedPan) {
            ...
            It = { x: (ee[0] - $a[0]) * Z, y: (ee[1] - $a[1]) * Z }, r.hoverData.justStartedPan = false;
        ...
        if (fe && fe.pannable() && fe.active() && fe.unactivate(), (!fe || !fe.grabbed()) && De != Te && (Te && n(Te, ["mouseout", "tapdragout"], S, { x: ee[0], y: ee[1] }), De && n(De, ["mouseover", "tapdragover"], S, { x: ee[0], y: ee[1] }), r.hoverData.last = De), fe) if (je) {
          if ($.boxSelectionEnabled() && lr) fe && fe.grabbed() && (p(Be), fe.emit(Ze("freeon")), Be.emit(Ze("free")), r.dragData.didDrag && (fe.emit(Ze("dragfreeon")), Be.emit(Ze("dragfree")))), Wr();
            ...
            Er && r.redrawHint("eles", true), r.dragData.didDrag = true, r.hoverData.draggingEles || y(Be, { inDragLayer: true });
            var hr = { x: 0, y: 0 };
      ...
      if (me[2] = ee[0], me[3] = ee[1], W) return S.stopPropagation && S.stopPropagation(), S.preventDefault && S.preventDefault(), false;
    }
  }, false);
  var P, A, R;
  ...
  var L = [], I = 4, M, O = 1e5, V = function(S, _) {
    for (var W = 0; W < S.length; W++) if (S[W] % _ !== 0) return false;
    return true;
  }, G = function(S) {
    for (var _ = Math.abs(S[0]), W = 1; W < S.length; W++) if (Math.abs(S[W]) !== _) return false;
    return true;
  }, N = function(S) {
    ...
    if (W == null && (S.wheelDeltaY != null ? W = S.wheelDeltaY / 4 : S.wheelDelta != null && (W = S.wheelDelta / 4)), W !== 0) {
      ...
      if (!r.scrollingPage) {
        ...
        if (ee.panningEnabled() && ee.userPanningEnabled() && ee.zoomingEnabled() && ee.userZoomingEnabled()) {
          ...
          S.type === "gesturechange" && (Pe = r.gestureStartZoom * S.scale), ee.zoom({ level: Pe, renderedPosition: { x: De[0], y: De[1] } }), ee.emit({ type: S.type === "gesturechange" ? "pinchzoom" : "scrollzoom", originalEvent: S, position: { x: me[0], y: me[1] } });
        }
      }
    }
  };
    ...
    if (r.hasTouchStarted = true, !!D(S)) {
      ...
      if (S.touches[2]) _.boxSelectionEnabled() && S.preventDefault();
        ...
        if (S.touches[0]) {
          ...
          n(Be, ["touchstart", "tapstart", "vmousedown"], S, { x: W[0], y: W[1] }), Be == null && (r.data.bgActivePosistion = { x: Z[0], y: Z[1] }, r.redrawHint("select", true), r.redraw()), r.touchData.singleTouchMoved = false, r.touchData.singleTouchStartTime = +/* @__PURE__ */ new Date(), clearTimeout(r.touchData.tapholdTimeout), r.touchData.tapholdTimeout = setTimeout(function() {
            r.touchData.singleTouchMoved === false && !r.pinching && !r.touchData.selecting && n(r.touchData.start, ["taphold"], S, { x: W[0], y: W[1] });
          }, r.tapholdDuration);
        }
      }
      if (S.touches.length >= 1) {
        for (var mr = r.touchData.startPosition = [null, null, null, null, null, null], Ye = 0; Ye < W.length; Ye++) mr[Ye] = $[Ye] = W[Ye];
        var ir = S.touches[0];
  ...
  r.registerBinding(e, "touchmove", we = function(S) {
    ...
    if (!(!_ && !D(S))) {
      ...
      if (_ && r.touchData.cxt) {
        ...
        if (te) {
          var $f = Ye - F, Uf = ir - U, Kf = er - Q, Xf = lr - K, Yf = ($f + Kf) / 2, Zf = (Uf + Xf) / 2, ua = $.zoom(), Zn = ua * Wf, Ua = $.pan(), xo = J[0] * ua + Ua.x, Eo = J[1] * ua + Ua.y, Qf = { x: -Zn / ua * (xo - Ua.x - Yf) + xo, y: -Zn / ua * (Eo - Ua.y - Zf) + Eo };
          if (Br && Br.active()) {
            var hr = r.dragData.touchDragEles;
          ...
          $.viewport({ zoom: Zn, pan: Qf, cancelOnFailedZoom: true }), $.emit(le("pinchzoom")), j = wo, F = Ye, U = ir, Q = er, K = lr, r.pinching = true;
        }
        if (S.touches[0]) {
          var ve = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          Z[0] = ve[0], Z[1] = ve[1];
        ...
        if (!r.hoverData.draggingEles && !r.swipePanning && (Er = r.findNearestElement(Z[0], Z[1], true, true)), _ && Mr != null && S.preventDefault(), _ && Mr != null && r.nodeIsDraggable(Mr)) if (De) {
          var hr = r.dragData.touchDragEles, Co = !r.dragData.didDrag;
          Co && y(hr, { inDragLayer: true }), r.dragData.didDrag = true;
          var la = { x: 0, y: 0 };
        ...
        if (n(Mr || Er, ["touchmove", "tapdrag", "vmousemove"], S, { x: Z[0], y: Z[1] }), (!Mr || !Mr.grabbed()) && Er != Qn && (Qn && Qn.emit(le("tapdragout")), Er && Er.emit(le("tapdragover"))), r.touchData.last = Er, _) for (var Cr = 0; Cr < Z.length; Cr++) Z[Cr] && r.touchData.startPosition[Cr] && De && (r.touchData.singleTouchMoved = true);
        if (_ && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
          var Jf = s(Mr, r.touchData.starts);
          Jf && (S.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Wt(r.touchData.startPosition)), r.swipePanning ? ($.panBy({ x: Te[0] * ee, y: Te[1] * ee }), $.emit(le("dragpan"))) : De && (r.swipePanning = true, $.panBy({ x: Pe * ee, y: je * ee }), $.emit(le("dragpan")), Mr && (Mr.unactivate(), r.redrawHint("select", true), r.touchData.start = null)));
          var ve = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          Z[0] = ve[0], Z[1] = ve[1];
        }
      }
  ...
  if (r.registerBinding(e, "touchend", ie = function(S) {
    ...
    if (W) S.touches.length === 0 && (r.touchData.capture = false), S.preventDefault();
    else return;
    var $ = r.selection;
    ...
    if (_ == null ? void 0 : _.unactivate(), S.touches[2]) r.data.bgActivePosistion = void 0, r.redrawHint("select", true);
    else if (!S.touches[1]) {
      if (!S.touches[0]) {
        if (!S.touches[0]) {
          ...
          if (_ != null) {
            ...
            p(Be), r.redrawHint("drag", true), r.redrawHint("eles", true), je && (_.emit(me("freeon")), Be.emit(me("free")), r.dragData.didDrag && (_.emit(me("dragfreeon")), Be.emit(me("dragfree")))), n(_, ["touchend", "tapend", "vmouseup", "tapdragout"], S, { x: ee[0], y: ee[1] }), _.unactivate(), r.touchData.start = null;
          } else {
          ...
          r.touchData.singleTouchMoved || (_ || Z.$(":selected").unselect(["tapunselect"]), n(_, ["tap", "vclick"], S, { x: ee[0], y: ee[1] }), de = false, S.timeStamp - Ee <= Z.multiClickDebounceTime() ? (he && clearTimeout(he), de = true, Ee = null, n(_, ["dbltap", "vdblclick"], S, { x: ee[0], y: ee[1] })) : (he = setTimeout(function() {
    ...
    var pe = [], Se = function(S) {
      return { clientX: S.clientX, clientY: S.clientY, force: 1, identifier: S.pointerId, pageX: S.pageX, pageY: S.pageY, radiusX: S.width / 2, radiusY: S.height / 2, screenX: S.screenX, screenY: S.screenY, target: S.target };
    }, Re = function(S) {
...
Qr.generatePolygon = function(r, e) {
  return this.nodeShapes[r] = { renderer: this, name: r, points: e, draw: function(a, n, i, s, o, l) {
  ...
  }, hasMiterBounds: r !== "rectangle", miterBounds: function(a, n, i, s, o, l) {
    return Ad(this.points, a, n, i, s, o);
  } };
};
Qr.generateEllipse = function() {
  return this.nodeShapes.ellipse = { renderer: this, name: "ellipse", draw: function(e, t, a, n, i, s) {
...
Qr.generateRoundPolygon = function(r, e) {
  return this.nodeShapes[r] = { renderer: this, name: r, points: e, getOrCreateCorners: function(a, n, i, s, o, l, u) {
    if (l[u] !== void 0 && l[u + "-cx"] === a && l[u + "-cy"] === n) return l[u];
    l[u] = new Array(e.length / 2), l[u + "-cx"] = a, l[u + "-cy"] = n;
    var v = i / 2, f = s / 2;
    o = o === "auto" ? Ev(i, s) : o;
    for (var c = new Array(e.length / 2), h = 0; h < e.length / 2; h++) c[h] = { x: a + v * e[h * 2], y: n + f * e[h * 2 + 1] };
...
Qr.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = { renderer: this, name: "round-rectangle", points: br(4, 0), draw: function(e, t, a, n, i, s) {
...
Qr.generateCutRectangle = function() {
  return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = { renderer: this, name: "cut-rectangle", cornerLength: no(), points: br(4, 0), draw: function(e, t, a, n, i, s) {
    ...
    if (Zr(e, t, this.points, s, o, n, i - 2 * u, [0, -1], a) || Zr(e, t, this.points, s, o, n - 2 * u, i, [0, -1], a)) return true;
...
Qr.generateBarrel = function() {
  return this.nodeShapes.barrel = { renderer: this, name: "barrel", points: br(4, 0), draw: function(e, t, a, n, i, s) {
    this.renderer.nodeShapeImpl(this.name, e, t, a, n, i);
  }, intersectLine: function(e, t, a, n, i, s, o, l) {
    var u = 0.15, v = 0.5, f = 0.85, c = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, t), h = function(g) {
      var p = Kt({ x: g[0], y: g[1] }, { x: g[2], y: g[3] }, { x: g[4], y: g[5] }, u), m = Kt({ x: g[0], y: g[1] }, { x: g[2], y: g[3] }, { x: g[4], y: g[5] }, v), b = Kt({ x: g[0], y: g[1] }, { x: g[2], y: g[3] }, { x: g[4], y: g[5] }, f);
    ...
    var i = t / 2, s = e / 2, o = a - s, l = a + s, u = n - i, v = n + i, f = As(e, t), c = f.heightOffset, h = f.widthOffset, d = f.ctrlPtOffsetPct * e, y = { topLeft: [o, u + c, o + d, u, o + h, u], topRight: [l - h, u, l - d, u, l, u + c], bottomRight: [l, v - c, l - d, v, l - h, v], bottomLeft: [o + h, v, o + d, v, o, v - c] };
    ...
    if (Zr(e, t, this.points, s, o, n, i - 2 * v, [0, -1], a) || Zr(e, t, this.points, s, o, n - 2 * f, i, [0, -1], a)) return true;
...
Qr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = { renderer: this, name: "bottom-round-rectangle", points: br(4, 0), draw: function(e, t, a, n, i, s) {
    this.renderer.nodeShapeImpl(this.name, e, t, a, n, i, this.points, s);
  }, intersectLine: function(e, t, a, n, i, s, o, l) {
    ...
    l = l === "auto" ? vt(n, i) : l;
    var u = 2 * l;
    if (Zr(e, t, this.points, s, o, n, i - u, [0, -1], a) || Zr(e, t, this.points, s, o, n - u, i, [0, -1], a)) return true;
...
var ws = 1e3 / 60, Tf = { setupDequeueing: function(e) {
  ...
  return gt(r, [{ key: "getIdsFor", value: function(t) {
  ...
  } }, { key: "getNumberOfIdsForKey", value: function(t) {
    return t == null ? 0 : this.getIdsFor(t).size;
  } }, { key: "updateKeyMappingFor", value: function(t) {
    ...
    return i;
  } }, { key: "hasCache", value: function(t, a) {
    return this.getCachesAt(a).has(t);
  } }, { key: "has", value: function(t, a) {
    var n = this.getKey(t);
    return this.hasCache(n, a);
  } }, { key: "setCache", value: function(t, a, n) {
    n.key = t, this.getCachesAt(a).set(t, n);
  } }, { key: "set", value: function(t, a, n) {
    var i = this.getKey(t);
    this.setCache(i, a, n), this.updateKeyMappingFor(t);
  } }, { key: "deleteCache", value: function(t, a) {
    this.getCachesAt(a).delete(t);
  } }, { key: "delete", value: function(t, a) {
    var n = this.getKey(t);
    this.deleteCache(n, a);
  } }, { key: "invalidateKey", value: function(t) {
    var a = this;
    this.lvls.forEach(function(n) {
      return a.deleteCache(t, n);
    });
  } }, { key: "invalidate", value: function(t) {
    var a = t.id(), n = this.keyForId.get(a);
    this.deleteKeyMappingFor(t);
    var i = this.doesEleInvalidateKey(t);
    return i && this.invalidateKey(n), i || this.getNumberOfIdsForKey(n) === 0;
  } }]);
})(), Nl = 25, nn = 50, pn = -4, Hs = 3, Sf = 7.99, iy = 8, sy = 1024, oy = 1024, uy = 1024, ly = 0.2, vy = 0.8, fy = 10, cy = 0.15, dy = 0.1, hy = 0.9, gy = 0.9, py = 100, yy = 1, Ut = { dequeue: "dequeue", downscale: "downscale", highQuality: "highQuality" }, my = cr({ getKey: null, doesEleInvalidateKey: xn, drawElement: null, getBoundingBox: null, getRotationPoint: null, getRotationOffset: null, isVisible: dv, allowEdgeTxrCaching: true, allowParentTxrCaching: true }), ba = function(e, t) {
  var a = this;
...
nr.getElement = function(r, e, t, a, n) {
  ...
  var h = l.get(r, a);
  if (h && h.invalidated && (h.invalidated = false, h.texture.invalidatedWidth -= h.width), h) return h;
  var d;
  ...
  return h = { x: g.usedWidth, texture: g, level: a, scale: u, width: f, height: v, scaledLabelShown: c }, g.usedWidth += Math.ceil(f + iy), g.eleCaches.push(h), l.set(r, a, h), i.checkTextureFullness(g), h;
};
...
nr.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e) return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, eo(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), lt(n, s), a.push(s), s;
  }
};
...
nr.setupDequeueing = Tf.setupDequeueing({ deqRedrawThreshold: py, deqCost: cy, deqAvgCost: dy, deqNoDrawCost: hy, deqFastCost: gy, deq: function(e, t, a) {
...
dr.makeLayer = function(r, e) {
  var t = Math.pow(2, e), a = Math.ceil(r.w * t), n = Math.ceil(r.h * t), i = this.renderer.makeOffscreenCanvas(a, n), s = { id: Vl = ++Vl % Ay, bb: r, level: e, width: a, height: n, canvas: i, context: i.getContext("2d"), eles: [], elesQueue: [], reqs: 0 }, o = s.context, l = -s.bb.x1, u = -s.bb.y1;
...
dr.getLayers = function(r, e, t) {
  ...
  var l = a.layersByLevel, u = Math.pow(2, t), v = l[t] = l[t] || [], f, c = a.levelIsComplete(t, r), h, d = function() {
    var D = function(L) {
      if (a.validateLayersElesOrdering(L, r), a.levelIsComplete(L, r)) return h = l[L], true;
    }, B = function(L) {
  ...
  for (var p = null, m = r.length / by, b = !o, w = 0; w < r.length; w++) {
    ...
    if ((!p || p.eles.length >= m || !bv(p.bb, E.boundingBox())) && (p = g({ insert: true, after: p }), !p)) return null;
...
dr.setupDequeueing = Tf.setupDequeueing({ deqRedrawThreshold: xy, deqCost: Cy, deqAvgCost: Ty, deqNoDrawCost: Sy, deqFastCost: ky, deq: function(e, t) {
  return e.dequeue(t);
}, onDeqd: js, shouldRedraw: dv, priority: function(e) {
...
Df.arrowShapeImpl = function(r) {
  return (ql || (ql = { polygon: Ry, "triangle-backcurve": My, "triangle-tee": _l, "circle-triangle": Ly, "triangle-cross": _l, circle: Iy }))[r];
};
var Hr = {};
...
Jr.drawArrowShape = function(r, e, t, a, n, i, s, o, l) {
  var u = this, v = this.usePaths() && n !== "triangle-cross", f = false, c, h = e, d = { x: s, y: o }, y = r.pstyle("arrow-scale").value, g = this.getArrowWidth(a, y), p = u.arrowShapes[n];
  if (v) {
    var m = u.arrowPathCache = u.arrowPathCache || [], b = Dt(n), w = m[b];
    w != null ? (c = e = w, f = true) : (c = e = new Path2D(), m[b] = c);
  }
  f || (e.beginPath && e.beginPath(), v ? p.draw(e, 1, 0, { x: 0, y: 0 }, 1) : p.draw(e, g, l, d, a), e.closePath && e.closePath()), e = h, v && (e.translate(s, o), e.rotate(l), e.scale(g, g)), (t === "filled" || t === "both") && (v ? e.fill(c) : e.fill()), (t === "hollow" || t === "both") && (e.lineWidth = i / (v ? g : 1), e.lineJoin = "miter", v ? e.stroke(c) : e.stroke()), v && (e.scale(1 / g, 1 / g), e.rotate(-l), e.translate(-s, -o));
};
var mo = {};
...
mo.drawInscribedImage = function(r, e, t, a, n) {
  ...
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? D = v(t, "background-width", "pfValue", a) * g : D = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? B = v(t, "background-height", "pfValue", a) * p : B = v(t, "background-height", "pfValue", a)), !(D === 0 || B === 0)) {
    ...
    if (C === "no" && Q ? (i.setImgSmoothing(r, false), K = true) : C === "yes" && !Q && (i.setImgSmoothing(r, true), K = true), c === "no-repeat") w && (r.save(), m.pathCache ? r.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, g, p, x, m), r.clip())), i.safeDrawImage(r, e, 0, 0, T, k, A, O, D, B), w && r.restore();
    else {
...
yt.drawNode = function(r, e, t) {
  ...
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    ...
    var ne = function() {
      ...
      return Z != null ? (oe = Z, ee = true, v.pathCache = oe) : (oe = new Path2D(), W[$] = v.pathCache = oe), { path: oe, cacheHit: ee };
    ...
    var ce = function() {
      ...
      if (F > 0) {
        ...
        if (X === "ellipse") s.drawEllipsePath(ee || r, ue.x, ue.y, $, Z);
          ...
          for (var Te = $ / 2, fe = Z / 2, Pe = re + (S + F + j) / 2, Be = new Array(oe.length / 2), je = new Array(oe.length / 2), Ke = 0; Ke < oe.length / 2; Ke++) Be[Ke] = { x: ue.x + me + Te * oe[Ke * 2], y: ue.y + De + fe * oe[Ke * 2 + 1] };
...
yt.drawPie = function(r, e, t, a) {
  ...
  if (y && (l = 0, u = 0), i.units === "%" ? c = c * i.pfValue : i.pfValue !== void 0 && (c = i.pfValue / 2), s.units === "%" ? h = c * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= c)) for (var g = 1; g <= n.pieBackgroundN; g++) {
...
xr.createGradientStyleFor = function(r, e, t, a, n) {
  ...
  if (a === "radial-gradient") if (t.isEdge()) {
    ...
    var d = s ? { x: 0, y: 0 } : t.position(), y = t.paddedWidth(), g = t.paddedHeight();
    ...
    var b = s ? { x: 0, y: 0 } : t.position(), w = t.paddedWidth(), E = t.paddedHeight(), C = w / 2, x = E / 2, T = t.pstyle("background-gradient-direction").value;
    switch (T) {
      case "to-bottom":
...
xr.render = function(r) {
  ...
  var m = t.style(), b = t.zoom(), w = s !== void 0 ? s : b, E = t.pan(), C = { x: E.x, y: E.y }, x = { zoom: b, pan: { x: E.x, y: E.y } }, T = e.prevViewport, k = T === void 0 || x.zoom !== T.zoom || x.pan.x !== T.pan.x || x.pan.y !== T.pan.y;
  ...
  if (f || (e.textureDrawLastFrame = false), f) {
    if (e.textureDrawLastFrame = true, !e.textureCache) {
      ...
      A.setTransform(1, 0, 0, 1, 0, 0), A.clearRect(0, 0, e.canvasWidth * e.textureMult, e.canvasHeight * e.textureMult), e.render({ forcedContext: A, drawOnlyNodeLayer: true, forcedPxRatio: l * e.textureMult });
      var x = e.textureCache.viewport = { zoom: t.zoom(), pan: t.pan(), width: e.canvasWidth, height: e.canvasHeight };
...
function Jy(r, e, t) {
  ...
  for (var u = 0; u < 3; u++) {
    var v = t + u;
    r.enableVertexAttribArray(v), r.vertexAttribPointer(v, 3, r.FLOAT, false, 36, u * 12), r.vertexAttribDivisor(v, 1);
  }
...
var tm = (function() {
  function r(e, t, a, n) {
    ht(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = true, this.locked = false, this.texture = null, this.needsBuffer = true, this.freePointer = { x: 0, row: 0 }, this.keyToLocation = /* @__PURE__ */ new Map(), this.canvas = n(e, t, t), this.scratch = n(e, t, this.texHeight, "scratch");
  }
  return gt(r, [{ key: "lock", value: function() {
    this.locked = true;
    ...
    var s = this.texSize, o = this.texRows, l = this.texHeight, u = this.getScale(a), v = u.scale, f = u.texW, c = u.texH, h = function(b, w) {
      ...
      h(i.freePointer, i.canvas), d[0] = { x: i.freePointer.x, y: i.freePointer.row * l, w: f, h: c }, d[1] = { x: i.freePointer.x + f, y: i.freePointer.row * l, w: 0, h: c }, i.freePointer.x += f, i.freePointer.x == s && (i.freePointer.x = 0, i.freePointer.row++);
    }, g = function() {
  ...
  return gt(r, [{ key: "getKeys", value: function() {
  ...
  } }, { key: "getAtlas", value: function(t) {
    return this.styleKeyToAtlas.get(t);
  } }, { key: "hasAtlas", value: function(t) {
    return this.styleKeyToAtlas.has(t);
  } }, { key: "markKeyForGC", value: function(t) {
        ...
        try {
          for (d.s(); !(y = d.n()).done; ) {
            ...
            if (!h.has(g)) {
              ...
              s.canFit({ w: b.w + w.w, h: b.h }) || (s.lock(), s = t._createAtlas(), n.push(s)), f.canvas && (t._copyTextureToNewAtlas(g, f, s), i.set(g, s));
            }
          }
        } catch (E) {
          d.e(E);
...
var im = (function() {
  ...
  return gt(r, [{ key: "getAtlasSize", value: function() {
    return this.atlasSize;
  } }, { key: "addAtlasCollection", value: function(t, a) {
    ...
    var i = this.collections.get(n), s = be({ type: t, atlasCollection: i }, a);
    this.renderTypes.set(t, s);
  } }, { key: "getRenderTypeOpts", value: function(t) {
    return this.renderTypes.get(t);
  } }, { key: "getAtlasCollection", value: function(t) {
    return this.collections.get(t);
  } }, { key: "_cacheScratchCanvas", value: function(t) {
    var a = -1, n = -1, i = null;
    return function(s, o, l, u) {
      return u ? ((!i || o != a || l != n) && (a = o, n = l, i = t(s, o, l)), i) : t(s, o, l);
    };
  } }, { key: "_key", value: function(t, a) {
  ...
  return gt(r, [{ key: "getMaxAtlasesPerBatch", value: function() {
...
`, Ea = { SCREEN: { name: "screen", screen: true }, PICKING: { name: "picking", picking: true } }, An = { IGNORE: 1, USE_BB: 2 }, Cs = 0, Kl = 1, Xl = 2, Ts = 3, _t = 4, sn = 5, ga = 6, pa = 7, fm = (function() {
  function r(e, t, a) {
  ...
  return gt(r, [{ key: "addAtlasCollection", value: function(t, a) {
    this.atlasManager.addAtlasCollection(t, a);
  } }, { key: "addTextureAtlasRenderType", value: function(t, a) {
    this.atlasManager.addRenderType(t, a);
  } }, { key: "addSimpleShapeRenderType", value: function(t, a) {
    this.simpleShapeOptions.set(t, a);
  } }, { key: "invalidate", value: function(t) {
    var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = a.type, i = this.atlasManager;
    return n ? i.invalidate(t, { filterType: function(o) {
      return o === n;
    }, forceRedraw: true }) : i.invalidate(t);
  } }, { key: "gc", value: function() {
    this.atlasManager.gc();
  } }, { key: "_createShaderProgram", value: function(t) {
  ...
  } }, { key: "startFrame", value: function(t) {
    ...
    this.endBatch();
  } }, { key: "_isVisible", value: function(t, a) {
    return t.visible() ? a && a.isVisible ? a.isVisible(t) : true : false;
  } }, { key: "drawTexture", value: function(t, a, n) {
  ...
  } }, { key: "setTransformMatrix", value: function(t, a, n, i) {
    ...
    var f = 0, c = l * i;
    return n && i < 1 ? l = c : !n && i < 1 && (f = l - c, s += f, l = c), { x1: s, y1: o, w: l, h: u, xOffset: f, yOffset: v };
  ...
  } }, { key: "drawNode", value: function(t, a, n) {
  ...
  } }, { key: "_getVertTypeForShape", value: function(t, a) {
  ...
  } }, { key: "drawEdgeArrow", value: function(t, a, n) {
    if (t.visible()) {
  ...
  } }, { key: "drawEdgeLine", value: function(t, a) {
    if (t.visible()) {
  ...
  } }, { key: "_getNumSegments", value: function(t) {
    var a = 15;
    return Math.min(Math.max(a, 5), this.maxInstances);
  } }, { key: "_getCurveSegmentPoints", value: function(t, a) {
    ...
    return n;
  } }, { key: "_setCurvePoint", value: function(t, a, n, i) {
    ...
    if (i !== 0) {
      ...
      t.uniform4fv(s.uBGColor, h), t.drawArraysInstanced(t.TRIANGLES, 0, n, i), t.bindVertexArray(null), t.bindTexture(t.TEXTURE_2D, null), this.debug && this.batchDebugInfo.push({ count: i, atlasCount: v.length }), this.startBatch();
    }
  } }, { key: "getDebugInfo", value: function() {
...
function Vf(r) {
  ...
  r.webgl && (ke.CANVAS_LAYERS = e.CANVAS_LAYERS = 4, console.log("webgl rendering enabled")), e.data = { canvases: new Array(ke.CANVAS_LAYERS), contexts: new Array(ke.CANVAS_LAYERS), canvasNeedsRedraw: new Array(ke.CANVAS_LAYERS), bufferCanvases: new Array(ke.BUFFER_COUNT), bufferContexts: new Array(ke.CANVAS_LAYERS) };
  ...
  var c = wr(), h = function(z) {
    ...
    return H;
  }, U = e.data.eleTxrCache = new ba(e, { getKey: g, doesEleInvalidateKey: y, drawElement: w, getBoundingBox: T, getRotationPoint: A, getRotationOffset: V, allowEdgeTxrCaching: false, allowParentTxrCaching: false }), Q = e.data.lblTxrCache = new ba(e, { getKey: p, drawElement: E, getBoundingBox: k, getRotationPoint: I, getRotationOffset: F, isVisible: P }), K = e.data.slbTxrCache = new ba(e, { getKey: m, drawElement: C, getBoundingBox: D, getRotationPoint: M, getRotationOffset: G, isVisible: P }), j = e.data.tlbTxrCache = new ba(e, { getKey: b, drawElement: x, getBoundingBox: B, getRotationPoint: O, getRotationOffset: N, isVisible: P }), re = e.data.lyrTxrCache = new kf(e);
...
var Sm = [{ name: "null", impl: df }, { name: "base", impl: Cf }, { name: "canvas", impl: Cm }], km = [{ type: "layout", extensions: Qp }, { type: "renderer", extensions: Sm }], qf = {}, _f = {};
function Gf(r, e, t) {
