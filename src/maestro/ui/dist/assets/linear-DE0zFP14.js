import { aM as j, aN as p, aO as w, aP as q, aQ as k } from "./index-CTgvlc8H.js";
import { i as D } from "./init-Gi6I4Gst.js";
import { e as M, f as F, a as P, b as z } from "./defaultLocale-C4B-KCzX.js";
function g(n, r) {
...
function d(n, r) {
  var t = typeof r, e;
  return r == null || t === "boolean" ? j(r) : (t === "number" ? p : t === "string" ? (e = k(r)) ? (r = e, w) : q : r instanceof k ? w : r instanceof Date ? K : H(r) ? G : Array.isArray(r) ? J : typeof r.valueOf != "function" && typeof r.toString != "function" || isNaN(r) ? L : p)(n, r);
}
function U(n, r) {
...
function rn(n, r, t) {
  ...
  for (n[e] < n[0] && (n = n.slice().reverse(), r = r.slice().reverse()); ++a < e; ) u[a] = N(n[a], n[a + 1]), f[a] = t(r[a], r[a + 1]);
  return function(o) {
    var c = $(n, o, 1, e) - 1;
    return f[c](u[c](o));
  };
