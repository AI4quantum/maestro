...
function xa(r5) {
  return String(r5).replace(ya, (e) => ba[e]);
}
var vr = function r(e) {
...
}, q = { contains: fa, deflt: pa, escape: xa, hyphenate: ga, getBaseElem: vr, isCharacterBox: wa, protocolFromUrl: Sa }, ze = { displayMode: { type: "boolean", description: "Render math in display mode, which puts the math in display style (so \\int and \\sum are large, for example), and centers the math on the page on its own line.", cli: "-d, --display-mode" }, output: { type: { enum: ["htmlAndMathml", "html", "mathml"] }, description: "Determines the markup language of the output.", cli: "-F, --format <type>" }, leqno: { type: "boolean", description: "Render display math in leqno style (left-justified tags)." }, fleqn: { type: "boolean", description: "Render display math flush left." }, throwOnError: { type: "boolean", default: true, cli: "-t, --no-throw-on-error", cliDescription: "Render errors (in the color given by --error-color) instead of throwing a ParseError exception when encountering an error." }, errorColor: { type: "string", default: "#cc0000", cli: "-c, --error-color <color>", cliDescription: "A color string given in the format 'rgb' or 'rrggbb' (no #). This option determines the color of errors rendered by the -t option.", cliProcessor: (r5) => "#" + r5 }, macros: { type: "object", cli: "-m, --macro <def>", cliDescription: "Define custom macro of the form '\\foo:expansion' (use multiple -m arguments for multiple macros).", cliDefault: [], cliProcessor: (r5, e) => (e.push(r5), e) }, minRuleThickness: { type: "number", description: "Specifies a minimum thickness, in ems, for fraction lines, `\\sqrt` top lines, `{array}` vertical lines, `\\hline`, `\\hdashline`, `\\underline`, `\\overline`, and the borders of `\\fbox`, `\\boxed`, and `\\fcolorbox`.", processor: (r5) => Math.max(0, r5), cli: "--min-rule-thickness <size>", cliProcessor: parseFloat }, colorIsTextColor: { type: "boolean", description: "Makes \\color behave like LaTeX's 2-argument \\textcolor, instead of LaTeX's one-argument \\color mode change.", cli: "-b, --color-is-text-color" }, strict: { type: [{ enum: ["warn", "ignore", "error"] }, "boolean", "function"], description: "Turn on strict / LaTeX faithfulness mode, which throws an error if the input uses features that are not supported by LaTeX.", cli: "-S, --strict", cliDefault: false }, trust: { type: ["boolean", "function"], description: "Trust the input, enabling all HTML features such as \\url.", cli: "-T, --trust" }, maxSize: { type: "number", default: 1 / 0, description: "If non-zero, all user-specified sizes, e.g. in \\rule{500em}{500em}, will be capped to maxSize ems. Otherwise, elements and spaces can be arbitrarily large", processor: (r5) => Math.max(0, r5), cli: "-s, --max-size <n>", cliProcessor: parseInt }, maxExpand: { type: "number", default: 1e3, description: "Limit the number of macro expansions to the specified number, to prevent e.g. infinite macro loops. If set to Infinity, the macro expander will try to fully expand as in LaTeX.", processor: (r5) => Math.max(0, r5), cli: "-e, --max-expand <n>", cliProcessor: (r5) => r5 === "Infinity" ? 1 / 0 : parseInt(r5) }, globalGroup: { type: "boolean", cli: false } };
function Ma(r5) {
...
var ft = 0, Te = 1, ee = 2, B0 = 3, le = 4, d0 = 5, te = 6, n0 = 7, y0 = [new O0(ft, 0, false), new O0(Te, 0, true), new O0(ee, 1, false), new O0(B0, 1, true), new O0(le, 2, false), new O0(d0, 2, true), new O0(te, 3, false), new O0(n0, 3, true)], za = [le, d0, le, d0, te, n0, te, n0], Aa = [d0, d0, d0, d0, n0, n0, n0, n0], Ta = [ee, B0, le, d0, te, n0, te, n0], Ba = [B0, B0, d0, d0, n0, n0, n0, n0], Da = [Te, Te, B0, B0, d0, d0, n0, n0], Ca = [ft, Te, ee, B0, ee, B0, ee, B0], R = { DISPLAY: y0[ft], TEXT: y0[ee], SCRIPT: y0[le], SCRIPTSCRIPT: y0[te] }, nt = [{ name: "latin", blocks: [[256, 591], [768, 879]] }, { name: "cyrillic", blocks: [[1024, 1279]] }, { name: "armenian", blocks: [[1328, 1423]] }, { name: "brahmic", blocks: [[2304, 4255]] }, { name: "georgian", blocks: [[4256, 4351]] }, { name: "cjk", blocks: [[12288, 12543], [19968, 40879], [65280, 65376]] }, { name: "hangul", blocks: [[44032, 55215]] }];
function Na(r5) {
  for (var e = 0; e < nt.length; e++) for (var t = nt[e], a = 0; a < t.blocks.length; a++) {
    var n = t.blocks[a];
...
var Ae = [];
nt.forEach((r5) => r5.blocks.forEach((e) => Ae.push(...e)));
function gr(r5) {
  for (var e = 0; e < Ae.length; e += 2) if (r5 >= Ae[e] && r5 <= Ae[e + 1]) return true;
  return false;
}
...
-231c-3.3,-9.3,-6,-14.7,-8,-16c-2,-1.3,-7,-2,-15,-2c-10.7,0,-16.7,2,-18,6
c-2,2.7,-1,9.7,3,21c15.3,42,36.7,81.8,64,119.5c27.3,37.7,58,69.2,92,94.5z
M500 241 v40 H399408 v-40z M500 435 v40 H400000 v-40z` }, Ga = function(e, t) {
  switch (e) {
    case "lbrack":
...
function pt(r5, e, t) {
  ...
  if (!n && r5[0] in Ot && (a = Ot[r5[0]].charCodeAt(0), n = x0[e][a]), !n && t === "text" && gr(a) && (n = x0[e][77]), n) return { depth: n[0], height: n[1], italic: n[2], skew: n[3], width: n[4] };
}
var Ue = {};
function Ua(r5) {
  var e;
...
var Ya = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]], Ht = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], Lt = function(e, t) {
...
T0.BASESIZE = 6;
var it = { pt: 1, mm: 7227 / 2540, cm: 7227 / 254, in: 72.27, bp: 803 / 800, pc: 12, dd: 1238 / 1157, cc: 14856 / 1157, nd: 685 / 642, nc: 1370 / 107, sp: 1 / 65536, px: 803 / 800 }, Xa = { ex: true, em: true, mu: true }, br = function(e) {
  ...
  for (var s in this.attributes) if (this.attributes.hasOwnProperty(s)) {
    if ($a.test(s)) throw new M("Invalid attribute name '" + s + "'");
...
class p0 {
  ...
  toMarkup() {
    var e = false, t = "<span";
    this.classes.length && (e = true, t += ' class="', t += q.escape(P0(this.classes)), t += '"');
    var a = "";
...
class C0 {
  ...
  toMarkup() {
    ...
    for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + '="' + q.escape(this.attributes[t]) + '"');
    e += ">";
...
function Pt(r5) {
  if (r5 instanceof p0) return r5;
  throw new Error("Expected symbolNode but got " + String(r5) + ".");
}
function Za(r5) {
  if (r5 instanceof he) return r5;
  throw new Error("Expected span<HtmlDomNode> but got " + String(r5) + ".");
}
var Ka = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 }, Ja = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 }, $ = { math: {}, text: {} };
function i(r5, e, t, a, n, s) {
  $[r5][n] = { font: e, group: t, replace: a }, s && a && ($[r5][a] = $[r5][n]);
}
...
i(l, u, m0, "\u23B0", "\\lmoustache", true);
i(l, u, i0, "\u27EF", "\\rgroup", true);
i(l, u, m0, "\u27EE", "\\lgroup", true);
i(l, u, D, "\u2213", "\\mp", true);
i(l, u, D, "\u2296", "\\ominus", true);
i(l, u, D, "\u228E", "\\uplus", true);
i(l, u, D, "\u2293", "\\sqcap", true);
...
i(l, d, v, "\u25A1", "\\Box");
i(l, d, v, "\u25CA", "\\Diamond");
i(l, d, v, "\xA5", "\\yen", true);
i(k, d, v, "\xA5", "\\yen", true);
...
i(l, d, v, "\u03F0", "\\varkappa");
i(l, d, m0, "\u250C", "\\@ulcorner", true);
i(l, d, i0, "\u2510", "\\@urcorner", true);
i(l, d, m0, "\u2514", "\\@llcorner", true);
...
i(l, u, D, "\u22C5", "\\cdot", true);
i(l, u, D, "\u2218", "\\circ", true);
i(l, u, D, "\xF7", "\\div", true);
i(l, u, D, "\xB1", "\\pm", true);
i(l, u, D, "\xD7", "\\times", true);
i(l, u, D, "\u2229", "\\cap", true);
i(l, u, D, "\u222A", "\\cup", true);
...
i(l, u, v, "\xB0", "\\degree", true);
i(k, u, v, "\xB0", "\\degree");
i(k, u, v, "\xB0", "\\textdegree", true);
i(l, u, v, "\xA3", "\\pounds");
i(l, u, v, "\xA3", "\\mathsterling", true);
i(k, u, v, "\xA3", "\\pounds");
i(k, u, v, "\xA3", "\\textsterling", true);
i(l, d, v, "\u2720", "\\maltese");
i(k, d, v, "\u2720", "\\maltese");
var Gt = '0123456789/@."';
...
var ye = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]], Xt = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]], Qa = function(e, t) {
  ...
  return $[a][e] && $[a][e].replace && (e = $[a][e].replace), { value: e, metrics: pt(e, t, a) };
  ...
  } else typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + a + "'")), c = new p0(e, 0, 0, 0, 0, 0, s);
  if (n) {
  ...
  return s !== "textord" && Ee(e, "Math-BoldItalic", t).metrics ? { fontName: "Math-BoldItalic", fontClass: "boldsymbol" } : { fontName: "Main-Bold", fontClass: "mathbf" };
}, t1 = function(e, t, a) {
  var n = e.mode, s = e.text, o = ["mord"], h = n === "math" || n === "text" && t.font, c = h ? t.font : t.fontFamily, p = "", g = "";
  if (s.charCodeAt(0) === 55349 && ([p, g] = Qa(s, n)), p.length > 0) return b0(s, p, n, t, o.concat(g));
  if (c) {
    var y, w;
    if (c === "boldsymbol") {
      var x = e1(s, n, t, o, a);
  ...
  if (P0(r5.classes) !== P0(e.classes) || r5.skew !== e.skew || r5.maxFontSize !== e.maxFontSize) return false;
  ...
  for (var e = 0; e < r5.length - 1; e++) {
    var t = r5[e], a = r5[e + 1];
    t instanceof p0 && a instanceof p0 && r1(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r5.splice(e + 1, 1), e--);
  }
  return r5;
}, gt = function(e) {
  ...
  return gt(s), s;
}, Sr = (r5, e, t, a) => new he(r5, e, t, a), n1 = function(e, t, a) {
  var n = l0([e], [], t);
...
}, zr = { mathbf: { variant: "bold", fontName: "Main-Bold" }, mathrm: { variant: "normal", fontName: "Main-Regular" }, textit: { variant: "italic", fontName: "Main-Italic" }, mathit: { variant: "italic", fontName: "Main-Italic" }, mathnormal: { variant: "italic", fontName: "Math-Italic" }, mathsfit: { variant: "sans-serif-italic", fontName: "SansSerif-Italic" }, mathbb: { variant: "double-struck", fontName: "AMS-Regular" }, mathcal: { variant: "script", fontName: "Caligraphic-Regular" }, mathfrak: { variant: "fraktur", fontName: "Fraktur-Regular" }, mathscr: { variant: "script", fontName: "Script-Regular" }, mathsf: { variant: "sans-serif", fontName: "SansSerif-Regular" }, mathtt: { variant: "monospace", fontName: "Typewriter-Regular" } }, Ar = { vec: ["vec", 0.471, 0.714], oiintSize1: ["oiintSize1", 0.957, 0.499], oiintSize2: ["oiintSize2", 1.472, 0.659], oiiintSize1: ["oiiintSize1", 1.304, 0.499], oiiintSize2: ["oiiintSize2", 1.98, 0.659] }, h1 = function(e, t) {
  var [a, n, s] = Ar[e], o = new G0(a), h = new C0([o], { width: A(n), height: A(s), style: "width:" + A(n), viewBox: "0 0 " + 1e3 * n + " " + 1e3 * s, preserveAspectRatio: "xMinYMin" }), c = Sr(["overlay"], [h], t);
  return c.height = s, c.style.height = A(s), c.style.width = A(n), c;
}, b = { fontMap: zr, makeSymbol: b0, mathsym: _a, makeSpan: l0, makeSvgSpan: Sr, makeLineSpan: n1, makeAnchor: i1, makeFragment: Mr, wrapFragment: s1, makeVList: o1, makeOrd: t1, makeGlue: u1, staticSvg: h1, svgData: Ar, tryCombineChars: a1 }, Z = { number: 3, unit: "mu" }, $0 = { number: 4, unit: "mu" }, A0 = { number: 5, unit: "mu" }, m1 = { mord: { mop: Z, mbin: $0, mrel: A0, minner: Z }, mop: { mord: Z, mop: Z, mrel: A0, minner: Z }, mbin: { mord: $0, mop: $0, mopen: $0, minner: $0 }, mrel: { mord: A0, mop: A0, mopen: A0, minner: A0 }, mopen: {}, mclose: { mop: Z, mbin: $0, mrel: A0, minner: Z }, mpunct: { mord: Z, mop: Z, mrel: A0, mopen: Z, mclose: Z, mpunct: Z, minner: Z }, minner: { mord: Z, mop: Z, mbin: $0, mrel: A0, mopen: Z, mpunct: Z, minner: Z } }, c1 = { mord: { mop: Z }, mop: { mord: Z, mop: Z }, mbin: {}, mrel: {}, mopen: {}, mclose: { mop: Z }, mpunct: {}, minner: { mop: Z } }, Tr = {}, De = {}, Ce = {};
function B(r5) {
  for (var { type: e, names: t, props: a, handler: n, htmlBuilder: s, mathmlBuilder: o } = r5, h = { type: e, numArgs: a.numArgs, argTypes: a.argTypes, allowedInArgument: !!a.allowedInArgument, allowedInText: !!a.allowedInText, allowedInMath: a.allowedInMath === void 0 ? true : a.allowedInMath, numOptionalArgs: a.numOptionalArgs || 0, infix: !!a.infix, primitive: !!a.primitive, handler: n }, c = 0; c < t.length; ++c) Tr[t[c]] = h;
  e && (s && (De[e] = s), o && (Ce[e] = o));
}
function W0(r5) {
...
var Ne = function(e) {
...
}, N0 = b.makeSpan, d1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], f1 = ["rightmost", "mrel", "mclose", "mpunct"], p1 = { display: R.DISPLAY, text: R.TEXT, script: R.SCRIPT, scriptscript: R.SCRIPTSCRIPT }, v1 = { mord: "mord", mop: "mop", mbin: "mbin", mrel: "mrel", mopen: "mopen", mclose: "mclose", mpunct: "mpunct", minner: "minner" }, t0 = function(e, t, a, n) {
  ...
  return $t(s, (z, T) => {
    ...
    if (F) return b.makeGlue(F, p);
  }, { node: y }, w, x), s;
}, $t = function r2(e, t, a, n, s) {
  n && e.push(n);
...
class h0 {
  ...
  toNode() {
    ...
    for (var a = 0; a < this.children.length; a++) if (this.children[a] instanceof w0 && this.children[a + 1] instanceof w0) {
      for (var n = this.children[a].toText() + this.children[++a].toText(); this.children[a + 1] instanceof w0; ) n += this.children[++a].toText();
  ...
  toMarkup() {
    var e = "<" + this.type;
    for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + '="', e += q.escape(this.attributes[t]), e += '"');
...
var S = { MathNode: h0, TextNode: w0, SpaceNode: b1, newDocumentFragment: Dr }, v0 = function(e, t, a) {
  ...
  for (var s = [], o, h = 0; h < e.length; h++) {
    ...
    if (c instanceof h0 && o instanceof h0) {
      if (c.type === "mtext" && o.type === "mtext" && c.getAttribute("mathvariant") === o.getAttribute("mathvariant")) {
        ...
        o.children.push(...c.children);
        continue;
      } else if (c.type === "mn" && je(o)) c.children = [...o.children, ...c.children], s.pop();
...
var Cr = function(e) {
  return new T0({ style: e.displayMode ? R.DISPLAY : R.TEXT, maxSize: e.maxSize, minRuleThickness: e.minRuleThickness });
}, Nr = function(e, t) {
  if (t.displayMode) {
    var a = ["katex-display"];
  ...
  var n = Cr(a), s;
  if (a.output === "mathml") return Wt(e, t, n, a.displayMode, true);
  if (a.output === "html") {
    var o = ut(e, n);
    s = b.makeSpan(["katex"], [o]);
  } else {
    var h = Wt(e, t, n, a.displayMode, false), c = ut(e, n);
  ...
  function a() {
    ...
    if (q.contains(["widehat", "widecheck", "widetilde", "utilde"], c)) {
      ...
      if (g > 5) c === "widehat" || c === "widecheck" ? (y = 420, h = 2364, x = 0.42, w = c + "4") : (y = 312, h = 2340, x = 0.34, w = "tilde4");
      else {
        var z = [1, 1, 2, 2, 3, 3][g];
      ...
      var T = new G0(w), C = new C0([T], { width: "100%", height: A(x), viewBox: "0 0 " + h + " " + y, preserveAspectRatio: "none" });
      ...
      for (var r0 = 0; r0 < G; r0++) {
        var e0 = new G0(O[r0]), Y0 = new C0([e0], { width: "400em", height: A(U), viewBox: "0 0 " + h + " " + L, preserveAspectRatio: Y[r0] + " slice" }), s0 = b.makeSvgSpan([j[r0]], [Y0], t);
  ...
  if (/fbox|color|angl/.test(t)) {
    ...
    var p = [];
    /^[bx]cancel$/.test(t) && p.push(new st({ x1: "0", y1: "0", x2: "100%", y2: "100%", "stroke-width": "0.046em" })), /^x?cancel$/.test(t) && p.push(new st({ x1: "0", y1: "100%", x2: "100%", y2: "0", "stroke-width": "0.046em" }));
    var g = new C0(p, { width: "100%", height: A(h) });
    o = b.makeSvgSpan([], [g], s);
  }
  return o.height = h, o.style.height = A(h), o;
}, q0 = { encloseSpan: A1, mathMLnode: k1, svgSpan: z1 };
function H(r5, e) {
...
function Re(r5) {
  return r5 && (r5.type === "atom" || Ja.hasOwnProperty(r5.type)) ? r5 : null;
}
var wt = (r5, e) => {
  var t, a, n;
  r5 && r5.type === "supsub" ? (a = H(r5.base, "accent"), t = a.base, r5.base = t, n = Za(P(r5, e)), r5.base = a) : (a = H(r5, "accent"), t = a.base);
  ...
  if (a.isStretchy) w = q0.svgSpan(a, e), w = b.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: s }, { type: "elem", elem: w, wrapperClasses: ["svg-align"], wrapperStyle: h > 0 ? { width: "calc(100% - " + A(2 * h) + ")", marginLeft: A(2 * h) } : void 0 }] }, e);
  else {
    var x, z;
    a.label === "\\vec" ? (x = b.staticSvg("vec", e), z = b.svgData.vec[1]) : (x = b.makeOrd({ mode: a.mode, text: a.label }, e, "textord"), x = Pt(x), x.italic = 0, z = x.width, g && (y += x.depth)), w = b.makeSpan(["accent-body"], [x]);
    var T = a.label === "\\textcircled";
    T && (w.classes.push("accent-full"), y = s.height);
    var C = h;
    T || (C -= z / 2), w.style.left = A(C), a.label === "\\textcircled" && (w.style.top = ".2em"), w = b.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: s }, { type: "kern", size: -y }, { type: "elem", elem: w }] }, e);
  }
  var N = b.makeSpan(["mord", "accent"], [w], e);
  return n ? (n.children[0] = N, n.height = Math.max(N.height, n.height), n.classes[0] = "mord", n) : N;
}, qr = (r5, e) => {
  var t = r5.isStretchy ? q0.mathMLnode(r5.label) : new S.MathNode("mo", [v0(r5.label, r5.mode)]), a = new S.MathNode("mover", [X(r5.base, e), t]);
  return a.setAttribute("accent", "true"), a;
}, T1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r5) => "\\" + r5).join("|"));
B({ type: "accent", names: ["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring", "\\widecheck", "\\widehat", "\\widetilde", "\\overrightarrow", "\\overleftarrow", "\\Overrightarrow", "\\overleftrightarrow", "\\overgroup", "\\overlinesegment", "\\overleftharpoon", "\\overrightharpoon"], props: { numArgs: 1 }, handler: (r5, e) => {
  var t = Ne(e[0]), a = !T1.test(r5.funcName), n = !a || r5.funcName === "\\widehat" || r5.funcName === "\\widetilde" || r5.funcName === "\\widecheck";
  return { type: "accent", mode: r5.parser.mode, label: r5.funcName, isStretchy: a, isShifty: n, base: t };
}, htmlBuilder: wt, mathmlBuilder: qr });
B({ type: "accent", names: ["\\'", "\\`", "\\^", "\\~", "\\=", "\\u", "\\.", '\\"', "\\c", "\\r", "\\H", "\\v", "\\textcircled"], props: { numArgs: 1, allowedInText: true, allowedInMath: true, argTypes: ["primitive"] }, handler: (r5, e) => {
...
B({ type: "accentUnder", names: ["\\underleftarrow", "\\underrightarrow", "\\underleftrightarrow", "\\undergroup", "\\underlinesegment", "\\utilde"], props: { numArgs: 1 }, handler: (r5, e) => {
  var { parser: t, funcName: a } = r5, n = e[0];
  return { type: "accentUnder", mode: t.mode, label: a, base: n };
}, htmlBuilder: (r5, e) => {
  var t = P(r5.base, e), a = q0.svgSpan(r5, e), n = r5.label === "\\utilde" ? 0.12 : 0, s = b.makeVList({ positionType: "top", positionData: t.height, children: [{ type: "elem", elem: a, wrapperClasses: ["svg-align"] }, { type: "kern", size: n }, { type: "elem", elem: t }] }, e);
  return b.makeSpan(["mord", "accentunder"], [s], e);
}, mathmlBuilder: (r5, e) => {
  var t = q0.mathMLnode(r5.label), a = new S.MathNode("munder", [X(r5.base, e), t]);
...
B({ type: "xArrow", names: ["\\xleftarrow", "\\xrightarrow", "\\xLeftarrow", "\\xRightarrow", "\\xleftrightarrow", "\\xLeftrightarrow", "\\xhookleftarrow", "\\xhookrightarrow", "\\xmapsto", "\\xrightharpoondown", "\\xrightharpoonup", "\\xleftharpoondown", "\\xleftharpoonup", "\\xrightleftharpoons", "\\xleftrightharpoons", "\\xlongequal", "\\xtwoheadrightarrow", "\\xtwoheadleftarrow", "\\xtofrom", "\\xrightleftarrows", "\\xrightequilibrium", "\\xleftequilibrium", "\\\\cdrightarrow", "\\\\cdleftarrow", "\\\\cdlongequal"], props: { numArgs: 1, numOptionalArgs: 1 }, handler(r5, e, t) {
  ...
  var h = q0.svgSpan(r5, e), c = -e.fontMetrics().axisHeight + 0.5 * h.height, p = -e.fontMetrics().axisHeight - 0.5 * h.height - 0.111;
  (n.depth > 0.25 || r5.label === "\\xleftequilibrium") && (p -= n.depth);
  var g;
  if (o) {
    var y = -e.fontMetrics().axisHeight + o.height + 0.5 * h.height + 0.111;
    g = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: n, shift: p }, { type: "elem", elem: h, shift: c }, { type: "elem", elem: o, shift: y }] }, e);
  } else g = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: n, shift: p }, { type: "elem", elem: h, shift: c }] }, e);
  return g.children[0].children[0].children[1].classes.push("svg-align"), b.makeSpan(["mrel", "x-arrow"], [g], e);
}, mathmlBuilder(r5, e) {
  var t = q0.mathMLnode(r5.label);
...
B({ type: "mclass", names: ["\\mathord", "\\mathbin", "\\mathrel", "\\mathopen", "\\mathclose", "\\mathpunct", "\\mathinner"], props: { numArgs: 1, primitive: true }, handler(r5, e) {
  var { parser: t, funcName: a } = r5, n = e[0];
  return { type: "mclass", mode: t.mode, mclass: "m" + a.slice(5), body: Q(n), isCharacterBox: q.isCharacterBox(n) };
}, htmlBuilder: Er, mathmlBuilder: Rr });
var Ie = (r5) => {
  var e = r5.type === "ordgroup" && r5.body.length ? r5.body[0] : r5;
  return e.type === "atom" && (e.family === "bin" || e.family === "rel") ? "m" + e.family : "mord";
};
B({ type: "mclass", names: ["\\@binrel"], props: { numArgs: 2 }, handler(r5, e) {
  var { parser: t } = r5;
  return { type: "mclass", mode: t.mode, mclass: Ie(e[0]), body: Q(e[1]), isCharacterBox: q.isCharacterBox(e[1]) };
} });
B({ type: "mclass", names: ["\\stackrel", "\\overset", "\\underset"], props: { numArgs: 2 }, handler(r5, e) {
  var { parser: t, funcName: a } = r5, n = e[1], s = e[0], o;
  a !== "\\stackrel" ? o = Ie(n) : o = "mrel";
  var h = { type: "op", mode: n.mode, limits: true, alwaysHandleSupSub: true, parentIsSupSub: false, symbol: false, suppressBaseShift: a !== "\\stackrel", body: Q(n) }, c = { type: "supsub", mode: s.mode, base: h, sup: a === "\\underset" ? null : s, sub: a === "\\underset" ? s : null };
  return { type: "mclass", mode: t.mode, mclass: o, body: [c], isCharacterBox: q.isCharacterBox(c) };
}, htmlBuilder: Er, mathmlBuilder: Rr });
B({ type: "pmb", names: ["\\pmb"], props: { numArgs: 1, allowedInText: true }, handler(r5, e) {
  var { parser: t } = r5;
...
var D1 = { ">": "\\\\cdrightarrow", "<": "\\\\cdleftarrow", "=": "\\\\cdlongequal", A: "\\uparrow", V: "\\downarrow", "|": "\\Vert", ".": "no arrow" }, jt = () => ({ type: "styling", body: [], mode: "math", style: "display" }), Zt = (r5) => r5.type === "textord" && r5.text === "@", C1 = (r5, e) => (r5.type === "mathord" || r5.type === "atom") && r5.text === e;
function N1(r5, e, t) {
  var a = D1[r5];
  switch (a) {
    case "\\\\cdrightarrow":
...
function q1(r5) {
  ...
  for (r5.gullet.beginGroup(), r5.gullet.macros.set("\\cr", "\\\\\\relax"), r5.gullet.beginGroup(); ; ) {
    ...
    if (t === "&" || t === "\\\\") r5.consume();
      ...
      break;
    } else throw new M("Expected \\\\ or \\cr or \\end", r5.nextToken);
  }
  for (var a = [], n = [a], s = 0; s < e.length; s++) {
    for (var o = e[s], h = jt(), c = 0; c < o.length; c++) if (!Zt(o[c])) h.body.push(o[c]);
    else {
      a.push(h), c += 1;
      var p = xt(o[c]).text, g = new Array(2);
      if (g[0] = { type: "ordgroup", mode: "math", body: [] }, g[1] = { type: "ordgroup", mode: "math", body: [] }, !("=|.".indexOf(p) > -1)) if ("<>AV".indexOf(p) > -1) for (var y = 0; y < 2; y++) {
        for (var w = true, x = c + 1; x < o.length; x++) {
          if (C1(o[x], p)) {
            w = false, c = x;
            break;
          }
          if (Zt(o[x])) throw new M("Missing a " + p + " character to complete a CD arrow.", o[x]);
          g[y].body.push(o[x]);
        }
        if (w) throw new M("Missing a " + p + " character to complete a CD arrow.", o[c]);
      }
      else throw new M('Expected one of "<>AV=|." after @', o[c]);
      var z = N1(p, g, r5), T = { type: "styling", body: [z], mode: "math", style: "display" };
      a.push(T), h = jt();
    }
...
B({ type: "cdlabel", names: ["\\\\cdleft", "\\\\cdright"], props: { numArgs: 1 }, handler(r5, e) {
...
B({ type: "cdlabelparent", names: ["\\\\cdparent"], props: { numArgs: 1 }, handler(r5, e) {
  var { parser: t } = r5;
...
B({ type: "textord", names: ["\\@char"], props: { numArgs: 1, allowedInText: true }, handler(r5, e) {
  for (var { parser: t } = r5, a = H(e[0], "ordgroup"), n = a.body, s = "", o = 0; o < n.length; o++) {
    var h = H(n[o], "textord");
    s += h.text;
  }
  var c = parseInt(s), p;
  ...
  return c <= 65535 ? p = String.fromCharCode(c) : (c -= 65536, p = String.fromCharCode((c >> 10) + 55296, (c & 1023) + 56320)), { type: "textord", mode: t.mode, text: p };
} });
var Ir = (r5, e) => {
...
B({ type: "color", names: ["\\textcolor"], props: { numArgs: 2, allowedInText: true, argTypes: ["color", "original"] }, handler(r5, e) {
  var { parser: t } = r5, a = H(e[0], "color-token").color, n = e[1];
  return { type: "color", mode: t.mode, color: a, body: Q(n) };
}, htmlBuilder: Ir, mathmlBuilder: Fr });
B({ type: "color", names: ["\\color"], props: { numArgs: 1, allowedInText: true, argTypes: ["color"] }, handler(r5, e) {
...
B({ type: "cr", names: ["\\\\"], props: { numArgs: 0, numOptionalArgs: 0, allowedInText: true }, handler(r5, e, t) {
...
var ht = { "\\global": "\\global", "\\long": "\\\\globallong", "\\\\globallong": "\\\\globallong", "\\def": "\\gdef", "\\gdef": "\\gdef", "\\edef": "\\xdef", "\\xdef": "\\xdef", "\\let": "\\\\globallet", "\\futurelet": "\\\\globalfuture" }, Or = (r5) => {
  var e = r5.text;
  if (/^(?:[\\{}$&#^_]|EOF)$/.test(e)) throw new M("Expected a control sequence", r5);
  return e;
}, E1 = (r5) => {
...
B({ type: "internal", names: ["\\global", "\\long", "\\\\globallong"], props: { numArgs: 0, allowedInText: true }, handler(r5) {
  var { parser: e, funcName: t } = r5;
  e.consumeSpaces();
  var a = e.fetch();
  if (ht[a.text]) return (t === "\\global" || t === "\\\\globallong") && (a.text = ht[a.text]), H(e.parseFunction(), "internal");
  throw new M("Invalid token after macro prefix", a);
} });
B({ type: "internal", names: ["\\def", "\\gdef", "\\edef", "\\xdef"], props: { numArgs: 0, allowedInText: true, primitive: true }, handler(r5) {
  ...
  return o && c.unshift(o), (t === "\\edef" || t === "\\xdef") && (c = e.gullet.expandTokens(c), c.reverse()), e.gullet.macros.set(n, { tokens: c, numArgs: s, delimiters: h }, t === ht[t]), { type: "internal", mode: e.mode };
} });
B({ type: "internal", names: ["\\let", "\\\\globallet"], props: { numArgs: 0, allowedInText: true, primitive: true }, handler(r5) {
  var { parser: e, funcName: t } = r5, a = Or(e.gullet.popToken());
  e.gullet.consumeSpaces();
  var n = E1(e);
  return Hr(e, a, n, t === "\\\\globallet"), { type: "internal", mode: e.mode };
} });
B({ type: "internal", names: ["\\futurelet", "\\\\globalfuture"], props: { numArgs: 0, allowedInText: true, primitive: true }, handler(r5) {
  var { parser: e, funcName: t } = r5, a = Or(e.gullet.popToken()), n = e.gullet.popToken(), s = e.gullet.popToken();
...
var ie = function(e, t, a) {
  ...
  var n = x0["Size4-Regular"][e.charCodeAt(0)] ? x0["Size4-Regular"][e.charCodeAt(0)][4] : x0["Size1-Regular"][e.charCodeAt(0)][4], s = new G0("inner", Pa(e, Math.round(1e3 * t))), o = new C0([s], { width: A(n), height: A(t), style: "width:" + A(n), viewBox: "0 0 " + 1e3 * n + " " + Math.round(1e3 * t), preserveAspectRatio: "xMinYMin" }), h = b.makeSvgSpan([], [o], a);
  return h.height = t, h.style.height = A(t), h.style.width = A(n), { type: "elem", elem: h };
}, mt = 8e-3, Se = { type: "kern", size: -1 * mt }, F1 = ["|", "\\lvert", "\\rvert", "\\vert"], O1 = ["\\|", "\\lVert", "\\rVert", "\\Vert"], Gr = function(e, t, a, n, s, o) {
  var h, c, p, g, y = "", w = 0;
  h = p = g = e, c = null;
  var x = "Size1-Regular";
  ...
  var r0 = Y / 2 - z0, e0 = [];
  if (y.length > 0) {
    var Y0 = Y - T - O, s0 = Math.round(Y * 1e3), g0 = Ga(y, Math.round(Y0 * 1e3)), R0 = new G0(y, g0), j0 = (w / 1e3).toFixed(3) + "em", Z0 = (s0 / 1e3).toFixed(3) + "em", Le = new C0([R0], { width: j0, height: Z0, viewBox: "0 0 " + w + " " + s0 }), I0 = b.makeSvgSpan([], [Le], n);
    I0.height = s0 / 1e3, I0.style.width = j0, I0.style.height = Z0, e0.push({ type: "elem", elem: I0 });
  } else {
  ...
  var ne = n.havingBaseStyle(R.TEXT), Pe = b.makeVList({ positionType: "bottom", positionData: r0, children: e0 }, ne);
  return kt(b.makeSpan(["delimsizing", "mult"], [Pe], ne), R.TEXT, n, o);
}, Je = 80, Qe = 0.08, _e = function(e, t, a, n, s) {
  var o = La(e, n, a), h = new G0(e, o), c = new C0([h], { width: "400em", height: A(t), viewBox: "0 0 400000 " + a, preserveAspectRatio: "xMinYMin slice" });
  ...
  if (e === "<" || e === "\\lt" || e === "\u27E8" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle"), q.contains(Vr, e) || q.contains(Ur, e)) return Pr(e, t, false, a, n, s);
  if (q.contains(L1, e)) return Gr(e, se[t], false, a, n, s);
  throw new M("Illegal delimiter: '" + e + "'");
}, G1 = [{ type: "small", style: R.SCRIPTSCRIPT }, { type: "small", style: R.SCRIPT }, { type: "small", style: R.TEXT }, { type: "large", size: 1 }, { type: "large", size: 2 }, { type: "large", size: 3 }, { type: "large", size: 4 }], V1 = [{ type: "small", style: R.SCRIPTSCRIPT }, { type: "small", style: R.SCRIPT }, { type: "small", style: R.TEXT }, { type: "stack" }], Yr = [{ type: "small", style: R.SCRIPTSCRIPT }, { type: "small", style: R.SCRIPT }, { type: "small", style: R.TEXT }, { type: "large", size: 1 }, { type: "large", size: 2 }, { type: "large", size: 3 }, { type: "large", size: 4 }, { type: "stack" }], U1 = function(e) {
  ...
  var h = n.fontMetrics().axisHeight * n.sizeMultiplier, c = 901, p = 5 / n.fontMetrics().ptPerEm, g = Math.max(t - h, a + h), y = Math.max(g / 500 * c, 2 * g - p);
  return $r(e, y, true, n, s, o);
}, D0 = { sqrtImage: H1, sizedDelim: P1, sizeToMaxHeight: se, customSizedDelim: $r, leftRightDelim: Y1 }, Kt = { "\\bigl": { mclass: "mopen", size: 1 }, "\\Bigl": { mclass: "mopen", size: 2 }, "\\biggl": { mclass: "mopen", size: 3 }, "\\Biggl": { mclass: "mopen", size: 4 }, "\\bigr": { mclass: "mclose", size: 1 }, "\\Bigr": { mclass: "mclose", size: 2 }, "\\biggr": { mclass: "mclose", size: 3 }, "\\Biggr": { mclass: "mclose", size: 4 }, "\\bigm": { mclass: "mrel", size: 1 }, "\\Bigm": { mclass: "mrel", size: 2 }, "\\biggm": { mclass: "mrel", size: 3 }, "\\Biggm": { mclass: "mrel", size: 4 }, "\\big": { mclass: "mord", size: 1 }, "\\Big": { mclass: "mord", size: 2 }, "\\bigg": { mclass: "mord", size: 3 }, "\\Bigg": { mclass: "mord", size: 4 } }, X1 = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230A", "\u230B", "\\lceil", "\\rceil", "\u2308", "\u2309", "<", ">", "\\langle", "\u27E8", "\\rangle", "\u27E9", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27EE", "\u27EF", "\\lmoustache", "\\rmoustache", "\u23B0", "\u23B1", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
function Fe(r5, e) {
  var t = Re(r5);
  if (t && q.contains(X1, t.text)) return t;
  throw t ? new M("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", r5) : new M("Invalid delimiter type '" + r5.type + "'", r5);
}
B({ type: "delimsizing", names: ["\\bigl", "\\Bigl", "\\biggl", "\\Biggl", "\\bigr", "\\Bigr", "\\biggr", "\\Biggr", "\\bigm", "\\Bigm", "\\biggm", "\\Biggm", "\\big", "\\Big", "\\bigg", "\\Bigg"], props: { numArgs: 1, argTypes: ["primitive"] }, handler: (r5, e) => {
  var t = Fe(e[0], r5);
  return { type: "delimsizing", mode: r5.parser.mode, size: Kt[r5.funcName].size, mclass: Kt[r5.funcName].mclass, delim: t.text };
}, htmlBuilder: (r5, e) => r5.delim === "." ? b.makeSpan([r5.mclass]) : D0.sizedDelim(r5.delim, r5.size, e, r5.mode, [r5.mclass]), mathmlBuilder: (r5) => {
  var e = [];
  ...
  var a = A(D0.sizeToMaxHeight[r5.size]);
...
B({ type: "leftright-right", names: ["\\right"], props: { numArgs: 1, primitive: true }, handler: (r5, e) => {
  var t = r5.parser.gullet.macros.get("\\current@color");
  if (t && typeof t != "string") throw new M("\\current@color set to non-string in \\right");
  return { type: "leftright-right", mode: r5.parser.mode, delim: Fe(e[0], r5).text, color: t };
} });
B({ type: "leftright", names: ["\\left"], props: { numArgs: 1, primitive: true }, handler: (r5, e) => {
  var t = Fe(e[0], r5), a = r5.parser;
  ++a.leftrightDepth;
  ...
  Jt(r5);
  for (var t = t0(r5.body, e, true, ["mopen", "mclose"]), a = 0, n = 0, s = false, o = 0; o < t.length; o++) t[o].isMiddle ? s = true : (a = Math.max(t[o].height, a), n = Math.max(t[o].depth, n));
  a *= e.sizeMultiplier, n *= e.sizeMultiplier;
  var h;
  if (r5.left === "." ? h = oe(e, ["mopen"]) : h = D0.leftRightDelim(r5.left, a, n, e, r5.mode, ["mopen"]), t.unshift(h), s) for (var c = 1; c < t.length; c++) {
    var p = t[c], g = p.isMiddle;
    g && (t[c] = D0.leftRightDelim(g.delim, a, n, g.options, r5.mode, []));
  }
  var y;
  if (r5.right === ".") y = oe(e, ["mclose"]);
  else {
    var w = r5.rightColor ? e.withColor(r5.rightColor) : e;
    y = D0.leftRightDelim(r5.right, a, n, w, r5.mode, ["mclose"]);
  }
...
B({ type: "middle", names: ["\\middle"], props: { numArgs: 1, primitive: true }, handler: (r5, e) => {
  var t = Fe(e[0], r5);
  if (!r5.parser.leftrightDepth) throw new M("\\middle without preceding \\left", t);
  return { type: "middle", mode: r5.parser.mode, delim: t.text };
}, htmlBuilder: (r5, e) => {
  var t;
  if (r5.delim === ".") t = oe(e, []);
  else {
    t = D0.sizedDelim(r5.delim, 1, e, r5.mode, []);
...
var St = (r5, e) => {
  ...
  if (a === "sout") s = b.makeSpan(["stretchy", "sout"]), s.height = e.fontMetrics().defaultRuleThickness / n, o = -0.5 * e.fontMetrics().xHeight;
  else if (a === "phase") {
    var c = K({ number: 0.6, unit: "pt" }, e), p = K({ number: 0.35, unit: "ex" }, e), g = e.havingBaseSizing();
    n = n / g.sizeMultiplier;
    var y = t.height + t.depth + c + p;
    t.style.paddingLeft = A(y / 2 + c);
    var w = Math.floor(1e3 * y * n), x = Oa(w), z = new C0([new G0("phase", x)], { width: "400em", height: A(w / 1e3), viewBox: "0 0 400000 " + w, preserveAspectRatio: "xMinYMin slice" });
  ...
  var F;
  if (r5.backgroundColor) F = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: s, shift: o }, { type: "elem", elem: t, shift: 0 }] }, e);
  else {
    var O = /cancel|phase/.test(a) ? ["svg-align"] : [];
    F = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: t, shift: 0 }, { type: "elem", elem: s, shift: o, wrapperClasses: O }] }, e);
  }
...
B({ type: "enclose", names: ["\\colorbox"], props: { numArgs: 2, allowedInText: true, argTypes: ["color", "text"] }, handler(r5, e, t) {
  var { parser: a, funcName: n } = r5, s = H(e[0], "color-token").color, o = e[1];
  return { type: "enclose", mode: a.mode, label: n, backgroundColor: s, body: o };
}, htmlBuilder: St, mathmlBuilder: Mt });
B({ type: "enclose", names: ["\\fcolorbox"], props: { numArgs: 3, allowedInText: true, argTypes: ["color", "color", "text"] }, handler(r5, e, t) {
  var { parser: a, funcName: n } = r5, s = H(e[0], "color-token").color, o = H(e[1], "color-token").color, h = e[2];
  return { type: "enclose", mode: a.mode, label: n, backgroundColor: o, borderColor: s, body: h };
}, htmlBuilder: St, mathmlBuilder: Mt });
B({ type: "enclose", names: ["\\fbox"], props: { numArgs: 1, argTypes: ["hbox"], allowedInText: true }, handler(r5, e) {
  var { parser: t } = r5;
  return { type: "enclose", mode: t.mode, label: "\\fbox", body: e[0] };
} });
B({ type: "enclose", names: ["\\cancel", "\\bcancel", "\\xcancel", "\\sout", "\\phase"], props: { numArgs: 1 }, handler(r5, e) {
  var { parser: t, funcName: a } = r5, n = e[0];
  return { type: "enclose", mode: t.mode, label: a, body: n };
}, htmlBuilder: St, mathmlBuilder: Mt });
B({ type: "enclose", names: ["\\angl"], props: { numArgs: 1, argTypes: ["hbox"], allowedInText: false }, handler(r5, e) {
  var { parser: t } = r5;
  return { type: "enclose", mode: t.mode, label: "\\angl", body: e[0] };
} });
var Wr = {};
function k0(r5) {
  for (var { type: e, names: t, props: a, handler: n, htmlBuilder: s, mathmlBuilder: o } = r5, h = { type: e, numArgs: a.numArgs || 0, allowedInText: false, numOptionalArgs: 0, handler: n }, c = 0; c < t.length; ++c) Wr[t[c]] = h;
  s && (De[e] = s), o && (Ce[e] = o);
}
var jr = {};
function m(r5, e) {
...
var Oe = (r5) => {
  ...
  if (!e.displayMode) throw new M("{" + r5.envName + "} can be used only in display mode.");
};
function zt(r5) {
...
function U0(r5, e, t) {
  ...
  function V() {
    F && (r5.gullet.macros.get("\\df@tag") ? (F.push(r5.subparse([new f0("\\df@tag")])), r5.gullet.macros.set("\\df@tag", void 0, true)) : F.push(!!c && r5.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (O(), N.push(Qt(r5)); ; ) {
    var L = r5.parseExpression(false, p ? "\\end" : "\\\\");
    r5.gullet.endGroup(), r5.gullet.beginGroup(), L = { type: "ordgroup", mode: r5.mode, body: L }, t && (L = { type: "styling", mode: r5.mode, style: t, body: [L] }), z.push(L);
    var U = r5.fetch().text;
    if (U === "&") {
      if (y && z.length === y) {
        if (p || h) throw new M("Too many tab characters: &", r5.nextToken);
      ...
      r5.consume();
      var G = void 0;
      r5.gullet.future().text !== " " && (G = r5.parseSizeGroup(true)), C.push(G ? G.value : null), V(), N.push(Qt(r5)), z = [], T.push(z), O();
    } else throw new M("Expected & or \\\\ or \\cr or \\end", r5.nextToken);
  }
  return r5.gullet.endGroup(), r5.gullet.endGroup(), { type: "array", mode: r5.mode, addJot: n, arraystretch: o, body: T, cols: s, rowGaps: C, hskipBeforeAndAfter: a, hLinesBeforeRow: N, colSeparationType: h, tags: F, leqno: w };
}
function At(r5) {
...
var S0 = function(e, t) {
  ...
  var z = e.colSeparationType === "CD" ? K({ number: 3, unit: "ex" }, t) : 12 * y, T = 3 * y, C = e.arraystretch * z, N = 0.7 * C, F = 0.3 * C, O = 0;
  function V(fe) {
    for (var pe = 0; pe < fe.length; ++pe) pe > 0 && (O += 0.25), p.push({ pos: O, isDashed: fe[pe] });
  }
  ...
  if (e.tags && e.tags.some((fe) => fe)) for (a = 0; a < s; ++a) {
    var Z0 = c[a], Le = Z0.pos - e0, I0 = e.tags[a], F0 = void 0;
    I0 === true ? F0 = b.makeSpan(["eqn-num"], [], t) : I0 === false ? F0 = b.makeSpan([], [], t) : F0 = b.makeSpan([], t0(I0, t, true), t), F0.depth = Z0.depth, F0.height = Z0.height, j0.push({ type: "elem", elem: F0, shift: Le });
  }
  for (n = 0, R0 = 0; n < h || R0 < Y0.length; ++n, ++R0) {
    for (var c0 = Y0[R0] || {}, ne = true; c0.type === "separator"; ) {
      ...
      } else throw new M("Invalid separator type: " + c0.separator);
      R0++, c0 = Y0[R0] || {}, ne = false;
    }
    if (!(n >= h)) {
      var J0 = void 0;
      ...
      for (a = 0; a < s; ++a) {
        ...
        if (de) {
          var ma = ce.pos - e0;
          de.depth = ce.depth, de.height = ce.height, Q0.push({ type: "elem", elem: de, shift: ma });
        }
      }
      Q0 = b.makeVList({ positionType: "individualShift", children: Q0 }, t), Q0 = b.makeSpan(["col-align-" + (c0.align || "c")], [Q0]), s0.push(Q0), (n < h - 1 || e.hskipBeforeAndAfter) && (J0 = q.deflt(c0.postgap, w), J0 !== 0 && (g0 = b.makeSpan(["arraycolsep"], []), g0.style.width = A(J0), s0.push(g0)));
    }
  }
  if (c = b.makeSpan(["mtable"], s0), p.length > 0) {
    for (var ca = b.makeLineSpan("hline", t, g), da = b.makeLineSpan("hdashline", t, g), Ge = [{ type: "elem", elem: c, shift: 0 }]; p.length > 0; ) {
      var Rt = p.pop(), It = Rt.pos - e0;
      Rt.isDashed ? Ge.push({ type: "elem", elem: da, shift: It }) : Ge.push({ type: "elem", elem: ca, shift: It });
    }
    c = b.makeVList({ positionType: "individualShift", children: Ge }, t);
  }
  if (j0.length === 0) return b.makeSpan(["mord"], [c], t);
  var Ve = b.makeVList({ positionType: "individualShift", children: j0 }, t);
  return Ve = b.makeSpan(["tag"], [Ve], t), b.makeFragment([c, Ve]);
}, $1 = { c: "center ", l: "left ", r: "right " }, M0 = function(e, t) {
  ...
  if (e.cols && e.cols.length > 0) {
    var z = e.cols, T = "", C = false, N = 0, F = z.length;
    z[0].type === "separator" && (w += "top ", N = 1), z[z.length - 1].type === "separator" && (w += "bottom ", F -= 1);
    for (var O = N; O < F; O++) z[O].type === "align" ? (x += $1[z[O].align], C && (T += "none "), C = true) : z[O].type === "separator" && C && (T += z[O].separator === "|" ? "solid " : "dashed ", C = false);
  ...
  var a = [], n = e.envName.indexOf("at") > -1 ? "alignat" : "align", s = e.envName === "split", o = U0(e.parser, { cols: a, addJot: true, autoTag: s ? void 0 : zt(e.envName), emptySingleRow: true, colSeparationType: n, maxNumCols: s ? 2 : void 0, leqno: e.parser.settings.leqno }, "display"), h, c = 0, p = { type: "ordgroup", mode: e.mode, body: [] };
...
k0({ type: "array", names: ["array", "darray"], props: { numArgs: 1 }, handler(r5, e) {
  ...
  return U0(r5.parser, s, At(r5.envName));
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["matrix", "pmatrix", "bmatrix", "Bmatrix", "vmatrix", "Vmatrix", "matrix*", "pmatrix*", "bmatrix*", "Bmatrix*", "vmatrix*", "Vmatrix*"], props: { numArgs: 0 }, handler(r5) {
  ...
  var s = U0(r5.parser, a, At(r5.envName)), o = Math.max(0, ...s.body.map((h) => h.length));
  return s.cols = new Array(o).fill({ type: "align", align: t }), e ? { type: "leftright", mode: r5.mode, body: [s], left: e[0], right: e[1], rightColor: void 0 } : s;
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["smallmatrix"], props: { numArgs: 0 }, handler(r5) {
  var e = { arraystretch: 0.5 }, t = U0(r5.parser, e, "script");
  return t.colSeparationType = "small", t;
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["subarray"], props: { numArgs: 1 }, handler(r5, e) {
  var t = Re(e[0]), a = t ? [e[0]] : H(e[0], "ordgroup").body, n = a.map(function(o) {
    var h = xt(o), c = h.text;
  ...
  if (s = U0(r5.parser, s, "script"), s.body.length > 0 && s.body[0].length > 1) throw new M("{subarray} can contain only one column");
  return s;
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["cases", "dcases", "rcases", "drcases"], props: { numArgs: 0 }, handler(r5) {
  var e = { arraystretch: 1.2, cols: [{ type: "align", align: "l", pregap: 0, postgap: 1 }, { type: "align", align: "l", pregap: 0, postgap: 0 }] }, t = U0(r5.parser, e, At(r5.envName));
  return { type: "leftright", mode: r5.mode, body: [t], left: r5.envName.indexOf("r") > -1 ? "." : "\\{", right: r5.envName.indexOf("r") > -1 ? "\\}" : ".", rightColor: void 0 };
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["align", "align*", "aligned", "split"], props: { numArgs: 0 }, handler: Zr, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["gathered", "gather", "gather*"], props: { numArgs: 0 }, handler(r5) {
  q.contains(["gather", "gather*"], r5.envName) && Oe(r5);
  var e = { cols: [{ type: "align", align: "c" }], addJot: true, colSeparationType: "gather", autoTag: zt(r5.envName), emptySingleRow: true, leqno: r5.parser.settings.leqno };
  return U0(r5.parser, e, "display");
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["alignat", "alignat*", "alignedat"], props: { numArgs: 1 }, handler: Zr, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["equation", "equation*"], props: { numArgs: 0 }, handler(r5) {
  Oe(r5);
  var e = { autoTag: zt(r5.envName), emptySingleRow: true, singleRow: true, maxNumCols: 1, leqno: r5.parser.settings.leqno };
  return U0(r5.parser, e, "display");
}, htmlBuilder: S0, mathmlBuilder: M0 });
k0({ type: "array", names: ["CD"], props: { numArgs: 0 }, handler(r5) {
  return Oe(r5), q1(r5.parser);
}, htmlBuilder: S0, mathmlBuilder: M0 });
m("\\nonumber", "\\gdef\\@eqnsw{0}");
m("\\notag", "\\nonumber");
B({ type: "text", names: ["\\hline", "\\hdashline"], props: { numArgs: 0, allowedInText: true, allowedInMath: true }, handler(r5, e) {
  throw new M(r5.funcName + " valid only within array environment");
} });
var _t = Wr;
B({ type: "environment", names: ["\\begin", "\\end"], props: { numArgs: 1, argTypes: ["text"] }, handler(r5, e) {
  var { parser: t, funcName: a } = r5, n = e[0];
  if (n.type !== "ordgroup") throw new M("Invalid environment name", n);
  for (var s = "", o = 0; o < n.body.length; ++o) s += H(n.body[o], "textord").text;
  if (a === "\\begin") {
    if (!_t.hasOwnProperty(s)) throw new M("No such environment: " + s, n);
    var h = _t[s], { args: c, optArgs: p } = t.parseArguments("\\begin{" + s + "}", h), g = { mode: t.mode, envName: s, parser: t }, y = h.handler(g, c, p);
    t.expect("\\end", false);
...
var Kr = (r5, e) => {
  ...
  var t = r5.font, a = e.withFont(t);
  return X(r5.body, a);
}, er = { "\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol" };
B({ type: "font", names: ["\\mathrm", "\\mathit", "\\mathbf", "\\mathnormal", "\\mathsfit", "\\mathbb", "\\mathcal", "\\mathfrak", "\\mathscr", "\\mathsf", "\\mathtt", "\\Bbb", "\\bold", "\\frak"], props: { numArgs: 1, allowedInArgument: true }, handler: (r5, e) => {
  var { parser: t, funcName: a } = r5, n = Ne(e[0]), s = a;
  return s in er && (s = er[s]), { type: "font", mode: t.mode, font: s.slice(1), body: n };
}, htmlBuilder: Kr, mathmlBuilder: Jr });
B({ type: "mclass", names: ["\\boldsymbol", "\\bm"], props: { numArgs: 1 }, handler: (r5, e) => {
  var { parser: t } = r5, a = e[0], n = q.isCharacterBox(a);
  return { type: "mclass", mode: t.mode, mclass: Ie(a), body: [{ type: "font", mode: t.mode, font: "boldsymbol", body: a }], isCharacterBox: n };
} });
B({ type: "font", names: ["\\rm", "\\sf", "\\tt", "\\bf", "\\it", "\\cal"], props: { numArgs: 0, allowedInText: true }, handler: (r5, e) => {
...
var Qr = (r5, e) => {
  ...
  var t = Qr(r5.size, e.style), a = t.fracNum(), n = t.fracDen(), s;
  s = e.havingStyle(a);
  ...
  if (g) {
    ...
    var O = -(F - 0.5 * y);
    C = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: p, shift: T }, { type: "elem", elem: g, shift: O }, { type: "elem", elem: o, shift: -x }] }, e);
  } else {
    var N = x - o.depth - (p.height - T);
    N < z && (x += 0.5 * (z - N), T += 0.5 * (z - N)), C = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: p, shift: T }, { type: "elem", elem: o, shift: -x }] }, e);
  }
  ...
  var L, U;
  return r5.leftDelim == null ? L = oe(e, ["mopen"]) : L = D0.customSizedDelim(r5.leftDelim, V, true, e.havingStyle(t), r5.mode, ["mopen"]), r5.continued ? U = b.makeSpan([]) : r5.rightDelim == null ? U = oe(e, ["mclose"]) : U = D0.customSizedDelim(r5.rightDelim, V, true, e.havingStyle(t), r5.mode, ["mclose"]), b.makeSpan(["mord"].concat(s.sizingClasses(e)), [L, b.makeSpan(["mfrac"], [C]), U], e);
}, Bt = (r5, e) => {
...
B({ type: "genfrac", names: ["\\dfrac", "\\frac", "\\tfrac", "\\dbinom", "\\binom", "\\tbinom", "\\\\atopfrac", "\\\\bracefrac", "\\\\brackfrac"], props: { numArgs: 2, allowedInArgument: true }, handler: (r5, e) => {
  var { parser: t, funcName: a } = r5, n = e[0], s = e[1], o, h = null, c = null, p = "auto";
  switch (a) {
    case "\\dfrac":
    case "\\frac":
    case "\\tfrac":
  ...
  return { type: "genfrac", mode: t.mode, continued: false, numer: n, denom: s, hasBarLine: o, leftDelim: h, rightDelim: c, size: p, barSize: null };
}, htmlBuilder: Tt, mathmlBuilder: Bt });
B({ type: "genfrac", names: ["\\cfrac"], props: { numArgs: 2 }, handler: (r5, e) => {
...
B({ type: "infix", names: ["\\over", "\\choose", "\\atop", "\\brace", "\\brack"], props: { numArgs: 0, infix: true }, handler(r5) {
...
B({ type: "genfrac", names: ["\\genfrac"], props: { numArgs: 6, allowedInArgument: true, argTypes: ["math", "math", "size", "text", "math", "math"] }, handler(r5, e) {
  var { parser: t } = r5, a = e[4], n = e[5], s = Ne(e[0]), o = s.type === "atom" && s.family === "open" ? rr(s.text) : null, h = Ne(e[1]), c = h.type === "atom" && h.family === "close" ? rr(h.text) : null, p = H(e[2], "size"), g, y = null;
  ...
  } else x = H(x, "textord"), w = tr[Number(x.text)];
  return { type: "genfrac", mode: t.mode, numer: a, denom: n, continued: false, hasBarLine: g, barSize: y, leftDelim: o, rightDelim: c, size: w };
}, htmlBuilder: Tt, mathmlBuilder: Bt });
B({ type: "infix", names: ["\\above"], props: { numArgs: 1, argTypes: ["size"], infix: true }, handler(r5, e) {
  var { parser: t, funcName: a, token: n } = r5;
  return { type: "infix", mode: t.mode, replaceWith: "\\\\abovefrac", size: H(e[0], "size").value, token: n };
} });
B({ type: "genfrac", names: ["\\\\abovefrac"], props: { numArgs: 3, argTypes: ["math", "size", "math"] }, handler: (r5, e) => {
  var { parser: t, funcName: a } = r5, n = e[0], s = ka(H(e[1], "infix").size), o = e[2], h = s.number > 0;
...
var _r = (r5, e) => {
  ...
  if (n.isOver ? (h = b.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: s }, { type: "kern", size: 0.1 }, { type: "elem", elem: o }] }, e), h.children[0].children[0].children[1].classes.push("svg-align")) : (h = b.makeVList({ positionType: "bottom", positionData: s.depth + 0.1 + o.height, children: [{ type: "elem", elem: o }, { type: "kern", size: 0.1 }, { type: "elem", elem: s }] }, e), h.children[0].children[0].children[0].classes.push("svg-align")), a) {
    var c = b.makeSpan(["mord", n.isOver ? "mover" : "munder"], [h], e);
    n.isOver ? h = b.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: c }, { type: "kern", size: 0.2 }, { type: "elem", elem: a }] }, e) : h = b.makeVList({ positionType: "bottom", positionData: c.depth + 0.2 + a.height + a.depth, children: [{ type: "elem", elem: a }, { type: "kern", size: 0.2 }, { type: "elem", elem: c }] }, e);
  }
...
B({ type: "horizBrace", names: ["\\overbrace", "\\underbrace"], props: { numArgs: 1 }, handler(r5, e) {
  var { parser: t, funcName: a } = r5;
  return { type: "horizBrace", mode: t.mode, label: a, isOver: /^\\over/.test(a), base: e[0] };
}, htmlBuilder: _r, mathmlBuilder: W1 });
B({ type: "href", names: ["\\href"], props: { numArgs: 2, argTypes: ["url", "original"], allowedInText: true }, handler: (r5, e) => {
  var { parser: t } = r5, a = e[1], n = H(e[0], "url").url;
  return t.settings.isTrusted({ command: "\\href", url: n }) ? { type: "href", mode: t.mode, href: n, body: Q(a) } : t.formatUnsupportedCmd("\\href");
}, htmlBuilder: (r5, e) => {
  var t = t0(r5.body, e, false);
  return b.makeAnchor(r5.href, [], t, e);
}, mathmlBuilder: (r5, e) => {
  var t = V0(r5.body, e);
  return t instanceof h0 || (t = new h0("mrow", [t])), t.setAttribute("href", r5.href), t;
} });
B({ type: "href", names: ["\\url"], props: { numArgs: 1, argTypes: ["url"], allowedInText: true }, handler: (r5, e) => {
...
B({ type: "hbox", names: ["\\hbox"], props: { numArgs: 1, argTypes: ["text"], allowedInText: true, primitive: true }, handler(r5, e) {
  var { parser: t } = r5;
...
B({ type: "html", names: ["\\htmlClass", "\\htmlId", "\\htmlStyle", "\\htmlData"], props: { numArgs: 2, argTypes: ["raw", "original"], allowedInText: true }, handler: (r5, e) => {
  var { parser: t, funcName: a, token: n } = r5, s = H(e[0], "raw").string, o = e[1];
  ...
  return n;
}, mathmlBuilder: (r5, e) => V0(r5.body, e) });
B({ type: "htmlmathml", names: ["\\html@mathml"], props: { numArgs: 2, allowedInText: true }, handler: (r5, e) => {
  var { parser: t } = r5;
  return { type: "htmlmathml", mode: t.mode, html: Q(e[0]), mathml: Q(e[1]) };
}, htmlBuilder: (r5, e) => {
  var t = t0(r5.html, e, false);
  return b.makeFragment(t);
}, mathmlBuilder: (r5, e) => V0(r5.mathml, e) });
var et = function(e) {
  ...
  if (!br(a)) throw new M("Invalid unit: '" + a.unit + "' in \\includegraphics.");
  return a;
};
B({ type: "includegraphics", names: ["\\includegraphics"], props: { numArgs: 1, numOptionalArgs: 1, argTypes: ["raw", "url"], allowedInText: false }, handler: (r5, e, t) => {
  var { parser: a } = r5, n = { number: 0, unit: "em" }, s = { number: 0.9, unit: "em" }, o = { number: 0, unit: "em" }, h = "";
  if (t[0]) for (var c = H(t[0], "raw").string, p = c.split(","), g = 0; g < p.length; g++) {
    var y = p[g].split("=");
    if (y.length === 2) {
      var w = y[1].trim();
      switch (y[0].trim()) {
  ...
  var x = H(e[0], "url").url;
  return h === "" && (h = x, h = h.replace(/^.*[\\/]/, ""), h = h.substring(0, h.lastIndexOf("."))), a.settings.isTrusted({ command: "\\includegraphics", url: x }) ? { type: "includegraphics", mode: a.mode, alt: h, width: n, height: s, totalheight: o, src: x } : a.formatUnsupportedCmd("\\includegraphics");
}, htmlBuilder: (r5, e) => {
...
B({ type: "kern", names: ["\\kern", "\\mkern", "\\hskip", "\\mskip"], props: { numArgs: 1, argTypes: ["size"], primitive: true, allowedInText: true }, handler(r5, e) {
...
B({ type: "lap", names: ["\\mathllap", "\\mathrlap", "\\mathclap"], props: { numArgs: 1, allowedInText: true }, handler: (r5, e) => {
  var { parser: t, funcName: a } = r5, n = e[0];
...
B({ type: "styling", names: ["\\(", "$"], props: { numArgs: 0, allowedInText: true, allowedInMath: false }, handler(r5, e) {
...
B({ type: "text", names: ["\\)", "\\]"], props: { numArgs: 0, allowedInText: true, allowedInMath: false }, handler(r5, e) {
...
B({ type: "mathchoice", names: ["\\mathchoice"], props: { numArgs: 4, primitive: true }, handler: (r5, e) => {
  var { parser: t } = r5;
  return { type: "mathchoice", mode: t.mode, display: Q(e[0]), text: Q(e[1]), script: Q(e[2]), scriptscript: Q(e[3]) };
}, htmlBuilder: (r5, e) => {
  var t = ar(r5, e), a = t0(t, e, false);
  return b.makeFragment(a);
}, mathmlBuilder: (r5, e) => {
  var t = ar(r5, e);
  return V0(t, e);
} });
var ea = (r5, e, t, a, n, s, o) => {
  r5 = b.makeSpan([], [r5]);
  ...
  if (p && c) {
    ...
    w = b.makeVList({ positionType: "bottom", positionData: x, children: [{ type: "kern", size: a.fontMetrics().bigOpSpacing5 }, { type: "elem", elem: c.elem, marginLeft: A(-s) }, { type: "kern", size: c.kern }, { type: "elem", elem: r5 }, { type: "kern", size: p.kern }, { type: "elem", elem: p.elem, marginLeft: A(s) }, { type: "kern", size: a.fontMetrics().bigOpSpacing5 }] }, a);
  } else if (c) {
    var z = r5.height - o;
    w = b.makeVList({ positionType: "top", positionData: z, children: [{ type: "kern", size: a.fontMetrics().bigOpSpacing5 }, { type: "elem", elem: c.elem, marginLeft: A(-s) }, { type: "kern", size: c.kern }, { type: "elem", elem: r5 }] }, a);
  } else if (p) {
    var T = r5.depth + o;
    w = b.makeVList({ positionType: "bottom", positionData: T, children: [{ type: "elem", elem: r5 }, { type: "kern", size: p.kern }, { type: "elem", elem: p.elem, marginLeft: A(s) }, { type: "kern", size: a.fontMetrics().bigOpSpacing5 }] }, a);
  } else return r5;
  var C = [w];
  if (c && s !== 0 && !h) {
  ...
  o.size === R.DISPLAY.size && s.symbol && !q.contains(ta, s.name) && (h = true);
  var c;
  if (s.symbol) {
    ...
    if ((s.name === "\\oiint" || s.name === "\\oiiint") && (g = s.name.slice(1), s.name = g === "oiint" ? "\\iint" : "\\iiint"), c = b.makeSymbol(s.name, p, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"]), g.length > 0) {
      ...
      c = b.makeVList({ positionType: "individualShift", children: [{ type: "elem", elem: c, shift: 0 }, { type: "elem", elem: w, shift: h ? 0.08 : 0 }] }, e), s.name = "\\" + g, c.classes.unshift("mop"), c.italic = y;
    }
  } else if (s.body) {
  ...
  var t;
  if (r5.symbol) t = new h0("mo", [v0(r5.name, r5.mode)]), q.contains(ta, r5.name) && t.setAttribute("largeop", "false");
  else if (r5.body) t = new h0("mo", o0(r5.body, e));
  else {
    t = new h0("mi", [new w0(r5.name.slice(1))]);
    var a = new h0("mo", [v0("\u2061", "text")]);
    r5.parentIsSupSub ? t = new h0("mrow", [t, a]) : t = Dr([t, a]);
  }
  return t;
}, j1 = { "\u220F": "\\prod", "\u2210": "\\coprod", "\u2211": "\\sum", "\u22C0": "\\bigwedge", "\u22C1": "\\bigvee", "\u22C2": "\\bigcap", "\u22C3": "\\bigcup", "\u2A00": "\\bigodot", "\u2A01": "\\bigoplus", "\u2A02": "\\bigotimes", "\u2A04": "\\biguplus", "\u2A06": "\\bigsqcup" };
B({ type: "op", names: ["\\coprod", "\\bigvee", "\\bigwedge", "\\biguplus", "\\bigcap", "\\bigcup", "\\intop", "\\prod", "\\sum", "\\bigotimes", "\\bigoplus", "\\bigodot", "\\bigsqcup", "\\smallint", "\u220F", "\u2210", "\u2211", "\u22C0", "\u22C1", "\u22C2", "\u22C3", "\u2A00", "\u2A01", "\u2A02", "\u2A04", "\u2A06"], props: { numArgs: 0 }, handler: (r5, e) => {
...
}, htmlBuilder: ae, mathmlBuilder: me });
B({ type: "op", names: ["\\mathop"], props: { numArgs: 1, primitive: true }, handler: (r5, e) => {
  var { parser: t } = r5, a = e[0];
  return { type: "op", mode: t.mode, limits: false, parentIsSupSub: false, symbol: false, body: Q(a) };
}, htmlBuilder: ae, mathmlBuilder: me });
var Z1 = { "\u222B": "\\int", "\u222C": "\\iint", "\u222D": "\\iiint", "\u222E": "\\oint", "\u222F": "\\oiint", "\u2230": "\\oiiint" };
B({ type: "op", names: ["\\arcsin", "\\arccos", "\\arctan", "\\arctg", "\\arcctg", "\\arg", "\\ch", "\\cos", "\\cosec", "\\cosh", "\\cot", "\\cotg", "\\coth", "\\csc", "\\ctg", "\\cth", "\\deg", "\\dim", "\\exp", "\\hom", "\\ker", "\\lg", "\\ln", "\\log", "\\sec", "\\sin", "\\sinh", "\\sh", "\\tan", "\\tanh", "\\tg", "\\th"], props: { numArgs: 0 }, handler(r5) {
  var { parser: e, funcName: t } = r5;
  return { type: "op", mode: e.mode, limits: false, parentIsSupSub: false, symbol: false, name: t };
}, htmlBuilder: ae, mathmlBuilder: me });
B({ type: "op", names: ["\\det", "\\gcd", "\\inf", "\\lim", "\\max", "\\min", "\\Pr", "\\sup"], props: { numArgs: 0 }, handler(r5) {
  var { parser: e, funcName: t } = r5;
  return { type: "op", mode: e.mode, limits: true, parentIsSupSub: false, symbol: false, name: t };
}, htmlBuilder: ae, mathmlBuilder: me });
B({ type: "op", names: ["\\int", "\\iint", "\\iiint", "\\oint", "\\oiint", "\\oiiint", "\u222B", "\u222C", "\u222D", "\u222E", "\u222F", "\u2230"], props: { numArgs: 0 }, handler(r5) {
  var { parser: e, funcName: t } = r5, a = t;
  return a.length === 1 && (a = Z1[a]), { type: "op", mode: e.mode, limits: false, parentIsSupSub: false, symbol: true, name: a };
}, htmlBuilder: ae, mathmlBuilder: me });
var ra = (r5, e) => {
  var t, a, n = false, s;
...
B({ type: "operatorname", names: ["\\operatorname@", "\\operatornamewithlimits"], props: { numArgs: 1 }, handler: (r5, e) => {
  var { parser: t, funcName: a } = r5, n = e[0];
  return { type: "operatorname", mode: t.mode, body: Q(n), alwaysHandleSupSub: a === "\\operatornamewithlimits", limits: false, parentIsSupSub: false };
}, htmlBuilder: ra, mathmlBuilder: K1 });
m("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@");
W0({ type: "ordgroup", htmlBuilder(r5, e) {
  return r5.semisimple ? b.makeFragment(t0(r5.body, e, false)) : b.makeSpan(["mord"], t0(r5.body, e, true), e);
}, mathmlBuilder(r5, e) {
  return V0(r5.body, e, true);
} });
B({ type: "overline", names: ["\\overline"], props: { numArgs: 1 }, handler(r5, e) {
  var { parser: t } = r5, a = e[0];
  return { type: "overline", mode: t.mode, body: a };
}, htmlBuilder(r5, e) {
  var t = P(r5.body, e.havingCrampedStyle()), a = b.makeLineSpan("overline-line", e), n = e.fontMetrics().defaultRuleThickness, s = b.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: t }, { type: "kern", size: 3 * n }, { type: "elem", elem: a }, { type: "kern", size: n }] }, e);
...
B({ type: "phantom", names: ["\\phantom"], props: { numArgs: 1, allowedInText: true }, handler: (r5, e) => {
  var { parser: t } = r5, a = e[0];
...
B({ type: "hphantom", names: ["\\hphantom"], props: { numArgs: 1, allowedInText: true }, handler: (r5, e) => {
  var { parser: t } = r5, a = e[0];
...
B({ type: "vphantom", names: ["\\vphantom"], props: { numArgs: 1, allowedInText: true }, handler: (r5, e) => {
  var { parser: t } = r5, a = e[0];
...
B({ type: "raisebox", names: ["\\raisebox"], props: { numArgs: 2, argTypes: ["size", "hbox"], allowedInText: true }, handler(r5, e) {
...
B({ type: "internal", names: ["\\relax"], props: { numArgs: 0, allowedInText: true, allowedInArgument: true }, handler(r5) {
  var { parser: e } = r5;
  return { type: "internal", mode: e.mode };
} });
B({ type: "rule", names: ["\\rule"], props: { numArgs: 2, numOptionalArgs: 1, allowedInText: true, allowedInMath: true, argTypes: ["size", "size", "size"] }, handler(r5, e, t) {
  var { parser: a } = r5, n = t[0], s = H(e[0], "size"), o = H(e[1], "size");
  return { type: "rule", mode: a.mode, shift: n && H(n, "size").value, width: s.value, height: o.value };
}, htmlBuilder(r5, e) {
...
var nr = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"], J1 = (r5, e) => {
  var t = e.havingSize(r5.size);
  return aa(r5.body, t, e);
};
B({ type: "sizing", names: nr, props: { numArgs: 0, allowedInText: true }, handler: (r5, e) => {
  var { breakOnTokenText: t, funcName: a, parser: n } = r5, s = n.parseExpression(false, t);
  return { type: "sizing", mode: n.mode, size: nr.indexOf(a) + 1, body: s };
}, htmlBuilder: J1, mathmlBuilder: (r5, e) => {
  var t = e.havingSize(r5.size), a = o0(r5.body, t), n = new S.MathNode("mstyle", a);
  return n.setAttribute("mathsize", A(t.sizeMultiplier)), n;
} });
B({ type: "smash", names: ["\\smash"], props: { numArgs: 1, numOptionalArgs: 1, allowedInText: true }, handler: (r5, e, t) => {
  var { parser: a } = r5, n = false, s = false, o = t[0] && H(t[0], "ordgroup");
...
B({ type: "sqrt", names: ["\\sqrt"], props: { numArgs: 1, numOptionalArgs: 1 }, handler(r5, e, t) {
  ...
  var o = n + s / 4, h = t.height + t.depth + o + n, { span: c, ruleWidth: p, advanceWidth: g } = D0.sqrtImage(h, e), y = c.height - p;
  y > t.height + t.depth + o && (o = (o + y - t.height - t.depth) / 2);
  var w = c.height - t.height - o - p;
  t.style.paddingLeft = A(g);
  var x = b.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: t, wrapperClasses: ["svg-align"] }, { type: "kern", size: -(t.height + w) }, { type: "elem", elem: c }, { type: "kern", size: p }] }, e);
  if (r5.index) {
    var z = e.havingStyle(R.SCRIPTSCRIPT), T = P(r5.index, z, e), C = 0.6 * (x.height - x.depth), N = b.makeVList({ positionType: "shift", positionData: -C, children: [{ type: "elem", elem: T }] }, e), F = b.makeSpan(["root"], [N]);
...
var ir = { display: R.DISPLAY, text: R.TEXT, script: R.SCRIPT, scriptscript: R.SCRIPTSCRIPT };
B({ type: "styling", names: ["\\displaystyle", "\\textstyle", "\\scriptstyle", "\\scriptscriptstyle"], props: { numArgs: 0, allowedInText: true, primitive: true }, handler(r5, e) {
  ...
  var t = ir[r5.style], a = e.havingStyle(t).withFont("");
  return aa(r5.body, a, e);
}, mathmlBuilder(r5, e) {
  var t = ir[r5.style], a = e.havingStyle(t), n = o0(r5.body, a), s = new S.MathNode("mstyle", n), o = { display: ["0", "true"], text: ["0", "false"], script: ["1", "false"], scriptscript: ["2", "false"] }, h = o[r5.style];
...
var Q1 = function(e, t) {
  ...
  if (a) if (a.type === "op") {
    ...
    if (a.type === "accent") return q.isCharacterBox(a.base) ? wt : null;
...
W0({ type: "supsub", htmlBuilder(r5, e) {
  var t = Q1(r5, e);
  if (t) return t(r5, e);
  var { base: a, sup: n, sub: s } = r5, o = P(a, e), h, c, p = e.fontMetrics(), g = 0, y = 0, w = a && q.isCharacterBox(a);
  if (n) {
  ...
  if (c) {
    var O = r5.base && r5.base.type === "op" && r5.base.name && (r5.base.name === "\\oiint" || r5.base.name === "\\oiiint");
  ...
  if (h && c) {
    ...
    var j = [{ type: "elem", elem: c, shift: y, marginRight: N, marginLeft: F }, { type: "elem", elem: h, shift: -g, marginRight: N }];
    V = b.makeVList({ positionType: "individualShift", children: j }, e);
  } else if (c) {
    y = Math.max(y, p.sub1, c.height - 0.8 * p.xHeight);
    var Y = [{ type: "elem", elem: c, marginLeft: F, marginRight: N }];
    V = b.makeVList({ positionType: "shift", positionData: y, children: Y }, e);
  } else if (h) g = Math.max(g, T, h.depth + 0.25 * p.xHeight), V = b.makeVList({ positionType: "shift", positionData: -g, children: [{ type: "elem", elem: h, marginRight: N }] }, e);
...
var na = { mi: "italic", mn: "normal", mtext: "normal" };
W0({ type: "mathord", htmlBuilder(r5, e) {
  return b.makeOrd(r5, e, "mathord");
}, mathmlBuilder(r5, e) {
  var t = new S.MathNode("mi", [v0(r5.text, r5.mode, e)]), a = yt(r5, e) || "italic";
  return a !== na[t.type] && t.setAttribute("mathvariant", a), t;
} });
W0({ type: "textord", htmlBuilder(r5, e) {
  return b.makeOrd(r5, e, "textord");
}, mathmlBuilder(r5, e) {
  var t = v0(r5.text, r5.mode, e), a = yt(r5, e) || "normal", n;
  return r5.mode === "text" ? n = new S.MathNode("mtext", [t]) : /[0-9]/.test(r5.text) ? n = new S.MathNode("mn", [t]) : r5.text === "\\prime" ? n = new S.MathNode("mo", [t]) : n = new S.MathNode("mi", [t]), a !== na[n.type] && n.setAttribute("mathvariant", a), n;
} });
var tt = { "\\nobreak": "nobreak", "\\allowbreak": "allowbreak" }, rt = { " ": {}, "\\ ": {}, "~": { className: "nobreak" }, "\\space": {}, "\\nobreakspace": { className: "nobreak" } };
W0({ type: "spacing", htmlBuilder(r5, e) {
  if (rt.hasOwnProperty(r5.text)) {
    var t = rt[r5.text].className || "";
    if (r5.mode === "text") {
      var a = b.makeOrd(r5, e, "textord");
      return a.classes.push(t), a;
    } else return b.makeSpan(["mspace", t], [b.mathsym(r5.text, r5.mode, e)], e);
  } else {
    if (tt.hasOwnProperty(r5.text)) return b.makeSpan(["mspace", tt[r5.text]], [], e);
    throw new M('Unknown type of space "' + r5.text + '"');
  }
}, mathmlBuilder(r5, e) {
  var t;
  if (rt.hasOwnProperty(r5.text)) t = new S.MathNode("mtext", [new S.TextNode("\xA0")]);
  else {
    if (tt.hasOwnProperty(r5.text)) return new S.MathNode("mspace");
    throw new M('Unknown type of space "' + r5.text + '"');
  }
  return t;
} });
...
W0({ type: "tag", mathmlBuilder(r5, e) {
  var t = new S.MathNode("mtable", [new S.MathNode("mtr", [sr(), new S.MathNode("mtd", [V0(r5.body, e)]), sr(), new S.MathNode("mtd", [V0(r5.tag, e)])])]);
  return t.setAttribute("width", "100%"), t;
} });
var lr = { "\\text": void 0, "\\textrm": "textrm", "\\textsf": "textsf", "\\texttt": "texttt", "\\textnormal": "textrm" }, or = { "\\textbf": "textbf", "\\textmd": "textmd" }, _1 = { "\\textit": "textit", "\\textup": "textup" }, ur = (r5, e) => {
  var t = r5.font;
  if (t) {
    if (lr[t]) return e.withTextFontFamily(lr[t]);
...
B({ type: "text", names: ["\\text", "\\textrm", "\\textsf", "\\texttt", "\\textnormal", "\\textbf", "\\textmd", "\\textit", "\\textup", "\\emph"], props: { numArgs: 1, argTypes: ["text"], allowedInArgument: true, allowedInText: true }, handler(r5, e) {
  var { parser: t, funcName: a } = r5, n = e[0];
  return { type: "text", mode: t.mode, body: Q(n), font: a };
}, htmlBuilder(r5, e) {
  var t = ur(r5, e), a = t0(r5.body, t, true);
  return b.makeSpan(["mord", "text"], a, t);
}, mathmlBuilder(r5, e) {
  var t = ur(r5, e);
  return V0(r5.body, t);
} });
B({ type: "underline", names: ["\\underline"], props: { numArgs: 1, allowedInText: true }, handler(r5, e) {
  var { parser: t } = r5;
  return { type: "underline", mode: t.mode, body: e[0] };
}, htmlBuilder(r5, e) {
  var t = P(r5.body, e), a = b.makeLineSpan("underline-line", e), n = e.fontMetrics().defaultRuleThickness, s = b.makeVList({ positionType: "top", positionData: t.height, children: [{ type: "kern", size: n }, { type: "elem", elem: a }, { type: "kern", size: 3 * n }, { type: "elem", elem: t }] }, e);
...
B({ type: "vcenter", names: ["\\vcenter"], props: { numArgs: 1, argTypes: ["original"], allowedInText: false }, handler(r5, e) {
  var { parser: t } = r5;
...
B({ type: "verb", names: ["\\verb"], props: { numArgs: 0, allowedInText: true }, handler(r5, e, t) {
  throw new M("\\verb ended by end of line instead of matching delimiter");
}, htmlBuilder(r5, e) {
  for (var t = hr(r5), a = [], n = e.havingStyle(e.style.text()), s = 0; s < t.length; s++) {
    var o = t[s];
  ...
  var t = new S.TextNode(hr(r5)), a = new S.MathNode("mtext", [t]);
  return a.setAttribute("mathvariant", "monospace"), a;
} });
var hr = (r5) => r5.body.replace(/ /g, r5.star ? "\u2423" : "\xA0"), L0 = Tr, ia = `[ \r
	]`, e4 = "\\\\[a-zA-Z@]+", t4 = "\\\\[^\uD800-\uDFFF]", r4 = "(" + e4 + ")" + ia + "*", a4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, ct = "[\u0300-\u036F]", n4 = new RegExp(ct + "+$"), i4 = "(" + ia + "+)|" + (a4 + "|") + "([!-\\[\\]-\u2027\u202A-\uD7FF\uF900-\uFFFF]" + (ct + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (ct + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + r4) + ("|" + t4 + ")");
class mr {
  constructor(e, t) {
    this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = new RegExp(i4, "g"), this.catcodes = { "%": 14, "~": 13 };
  }
  setCatcode(e, t) {
    this.catcodes[e] = t;
  }
...
m("\\char", function(r5) {
  ...
  if (t) {
    if (a = cr[e.text], a == null || a >= t) throw new M("Invalid base-" + t + " digit " + e.text);
    for (var n; (n = cr[r5.future().text]) != null && n < t; ) a *= t, a += n, r5.popToken();
  }
  return "\\@char{" + a + "}";
});
var Dt = (r5, e, t, a) => {
  ...
  var s = n[0].text, o = r5.isDefined(s);
  if (o && !e) throw new M("\\newcommand{" + s + "} attempting to redefine " + (s + "; use \\renewcommand"));
  if (!o && !t) throw new M("\\renewcommand{" + s + "} when command " + s + " does not yet exist; use \\newcommand");
  var h = 0;
  if (n = r5.consumeArg().tokens, n.length === 1 && n[0].text === "[") {
    for (var c = "", p = r5.expandNextToken(); p.text !== "]" && p.text !== "EOF"; ) c += p.text, p = r5.expandNextToken();
    if (!c.match(/^\s*[0-9]+\s*$/)) throw new M("Invalid number of arguments: " + c);
    h = parseInt(c), n = r5.consumeArg().tokens;
  }
  return o && a || r5.macros.set(s, { tokens: n, numArgs: h }), "";
};
m("\\newcommand", (r5) => Dt(r5, false, true, false));
m("\\renewcommand", (r5) => Dt(r5, true, false, false));
m("\\providecommand", (r5) => Dt(r5, true, true, true));
m("\\message", (r5) => {
...
m("\\show", (r5) => {
  ...
  return console.log(e, r5.macros.get(t), L0[t], $.math[t], $.text[t]), "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
var Ct = { ")": true, "]": true, "\\rbrack": true, "\\}": true, "\\rbrace": true, "\\rangle": true, "\\rceil": true, "\\rfloor": true, "\\rgroup": true, "\\rmoustache": true, "\\right": true, "\\bigr": true, "\\biggr": true, "\\Bigr": true, "\\Biggr": true, $: true, ";": true, ".": true, ",": true };
m("\\dotso", function(r5) {
...
m("\\tag@literal", (r5) => {
  if (r5.macros.get("\\df@tag")) throw new M("Multiple \\tag");
...
var la = (r5) => (e) => {
  ...
  var p = e.consumeArg().tokens, g = e.expandTokens([...s, ...p, ...t]);
...
var oa = { "^": true, _: true, "\\limits": true, "\\nolimits": true };
class o4 {
  constructor(e, t, a) {
...
class He {
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (He.endOfExpression.indexOf(n.text) !== -1 || t && n.text === t || e && L0[n.text] && L0[n.text].infix) break;
  ...
  callFunction(e, t, a, n, s) {
    var o = { funcName: e, parser: this, token: n, breakOnTokenText: s }, h = L0[e];
  ...
  parseSizeGroup(e) {
    ...
    if (!br(s)) throw new M("Invalid unit: '" + s.unit + "'", t);
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      this.expect(o), this.gullet.endGroup(), s = { type: "ordgroup", mode: this.mode, loc: u0.range(a, c), body: h, semisimple: n === "\\begingroup" || void 0 };
  ...
  formLigatures(e) {
    for (var t = e.length - 1, a = 0; a < t; ++a) {
      var n = e[a], s = n.text;
      s === "-" && e[a + 1].text === "-" && (a + 1 < t && e[a + 2].text === "-" ? (e.splice(a, 3, { type: "textord", mode: "text", loc: u0.range(n, e[a + 2]), text: "---" }), t -= 2) : (e.splice(a, 2, { type: "textord", mode: "text", loc: u0.range(n, e[a + 1]), text: "--" }), t -= 1)), (s === "'" || s === "`") && e[a + 1].text === s && (e.splice(a, 2, { type: "textord", mode: "text", loc: u0.range(n, e[a + 1]), text: s + s }), t -= 1);
    }
  }
  parseSymbol() {
    ...
    if ($[this.mode][t]) {
      ...
      o = p;
    } else if (t.charCodeAt(0) >= 128) this.settings.strict && (gr(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)), o = { type: "textord", mode: "text", loc: u0.range(e), text: t };
    else return null;
    if (this.consume(), s) for (var y = 0; y < s[0].length; y++) {
      var w = s[0][y];
      if (!at[w]) throw new M("Unknown accent ' " + w + "'", e);
      var x = at[w][this.mode] || at[w].text;
      if (!x) throw new M("Accent " + w + " unsupported in " + this.mode + " mode", e);
      o = { type: "accent", mode: this.mode, loc: u0.range(e), label: x, isStretchy: false, isShifty: true, base: o };
    }
    return o;
  }
}
...
}, c4 = "0.16.22", d4 = { Span: he, Anchor: vt, SymbolNode: p0, SvgNode: C0, PathNode: G0, LineNode: st }, f4 = { version: c4, render: ua, renderToString: u4, ParseError: M, SETTINGS_SCHEMA: ze, __parse: h4, __renderToDomTree: qt, __renderToHTMLTree: m4, __setFontMetrics: Va, __defineSymbol: i, __defineFunction: B, __defineMacro: m, __domTree: d4 };
export {
  M as ParseError,
