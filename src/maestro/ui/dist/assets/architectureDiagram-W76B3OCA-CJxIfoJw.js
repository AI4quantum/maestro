var _a;
import { aI as $e, _ as dt, H as ke, V as Ze, l as Re, b as qe, a as Qe, p as Je, q as Ke, g as je, s as _e, y as tr, D as er, E as rr, F as ir, c as ye, ak as Ee, aJ as ve, i as ar, d as nr, aK as or, aL as sr } from "./index-CTgvlc8H.js";
import { p as hr } from "./chunk-4BX2VUAB-HC4hRP6X.js";
import { p as lr } from "./treemap-75Q7IDZK-BYqNGg4h.js";
import { c as Se } from "./cytoscape.esm-DtBltrT8.js";
    ...
    (function(G, N) {
      ...
      return (function(M) {
        ...
        function N(d) {
          ...
          var h = G[d] = { i: d, l: false, exports: {} };
          return M[d].call(h.exports, h, h.exports, N), h.l = true, h.exports;
        }
        return N.m = M, N.c = G, N.i = function(d) {
          return d;
        }, N.d = function(d, h, a) {
          N.o(d, h) || Object.defineProperty(d, h, { configurable: false, enumerable: true, get: a });
        }, N.n = function(d) {
          var h = d && d.__esModule ? function() {
            return d.default;
          } : function() {
            return d;
          };
        ...
        i.prototype.getEdges = function() {
          ...
          if (t.add(this), this.child != null) for (var c = this.child.getNodes(), f = 0; f < c.length; f++) o = c[f], s = o.withChildren(), s.forEach(function(T) {
            t.add(T);
          });
          return t;
          ...
          if (this.getChild().getNodes().length != 0) {
            var t = this.getChild();
            if (t.updateBounds(true), this.rect.x = t.getLeft(), this.rect.y = t.getTop(), this.setWidth(t.getRight() - t.getLeft()), this.setHeight(t.getBottom() - t.getTop()), e.NODE_DIMENSIONS_INCLUDE_LABELS) {
        ...
        o.prototype.getNodes = function() {
          ...
          if (f == null && T == null) {
            ...
            var v = c;
            if (!(this.getNodes().indexOf(f) > -1 && this.getNodes().indexOf(T) > -1)) throw "Source or target not in graph!";
            if (!(f.owner == T.owner && f.owner == this)) throw "Both owners must be this graph!";
          ...
          if (c instanceof r) {
            ...
            for (var T = f.edges.slice(), g, v = T.length, L = 0; L < v; L++) g = T[L], g.isInterGraph ? this.graphManager.remove(g) : g.source.owner.remove(g);
            ...
            var A = g.source.edges.indexOf(g), b = g.target.edges.indexOf(g);
            if (!(A > -1 && b > -1)) throw "Source and/or target doesn't know this edge!";
            g.source.edges.splice(A, 1), g.target != g.source && g.target.edges.splice(b, 1);
          ...
          for (var c = h.MAX_VALUE, f = h.MAX_VALUE, T, g, v, L = this.getNodes(), F = L.length, A = 0; A < F; A++) {
            var b = L[A];
            T = b.getTop(), g = b.getLeft(), c > T && (c = T), f > g && (f = g);
          }
          return c == h.MAX_VALUE ? null : (L[0].getParent().paddingLeft != null ? v = L[0].getParent().paddingLeft : v = this.margin, this.left = f - v, this.top = c - v, new u(this.left, this.top));
        }, o.prototype.updateBounds = function(c) {
          for (var f = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, v = -h.MAX_VALUE, L, F, A, b, Z, U = this.nodes, K = U.length, D = 0; D < K; D++) {
            var it = U[D];
            c && it.child != null && it.updateBounds(), L = it.getLeft(), F = it.getRight(), A = it.getTop(), b = it.getBottom(), f > L && (f = L), T < F && (T = F), g > A && (g = A), v < b && (v = b);
          }
          var n = new i(f, g, T - f, v - g);
          f == h.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), U[0].getParent().paddingLeft != null ? Z = U[0].getParent().paddingLeft : Z = this.margin, this.left = n.x - Z, this.right = n.x + n.width + Z, this.top = n.y - Z, this.bottom = n.y + n.height + Z;
        }, o.calculateBounds = function(c) {
          for (var f = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, v = -h.MAX_VALUE, L, F, A, b, Z = c.length, U = 0; U < Z; U++) {
            var K = c[U];
            L = K.getLeft(), F = K.getRight(), A = K.getTop(), b = K.getBottom(), f > L && (f = L), T < F && (T = F), g > A && (g = A), v < b && (v = b);
          }
          ...
          var f = new t(), T = /* @__PURE__ */ new Set(), g = this.nodes[0], v, L, F = g.withChildren();
        ...
        a.prototype.addRoot = function() {
          ...
          if (l == null && i == null && u == null) {
            ...
            if (t == o) return l.isInterGraph = false, t.add(l, i, u);
            if (l.isInterGraph = true, l.source = i, l.target = u, this.edges.indexOf(l) > -1) throw "Edge already in inter-graph edge list!";
          ...
          if (e instanceof d) {
            ...
            if (!(r == this.rootGraph || r.parent != null && r.parent.graphManager == this)) throw "Invalid parent node!";
            var l = [];
          ...
          if (this.allNodes == null) {
            for (var e = [], r = this.getGraphs(), l = r.length, i = 0; i < l; i++) e = e.concat(r[i].getNodes());
            this.allNodes = e;
          }
          ...
          for (var l, i = e.getNodes(), u = i.length, t = 0; t < u; t++) l = i[t], l.inclusionTreeDepth = r, l.child != null && this.calcInclusionTreeDepths(l.child, r + 1);
        }, a.prototype.includesInvalidEdge = function() {
          for (var e, r = [], l = this.edges.length, i = 0; i < l; i++) e = this.edges[i], this.isOneAncestorOfOther(e.source, e.target) && r.push(e);
        ...
        h.calcSeparationAmount = function(a, e, r, l) {
          ...
          var l = a.getCenterX(), i = a.getCenterY(), u = e.getCenterX(), t = e.getCenterY();
          if (a.intersects(e)) return r[0] = l, r[1] = i, r[2] = u, r[3] = t, true;
          var o = a.getX(), s = a.getY(), c = a.getRight(), f = a.getX(), T = a.getBottom(), g = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), F = e.getX(), A = e.getY(), b = e.getRight(), Z = e.getX(), U = e.getBottom(), K = e.getRight(), D = e.getWidthHalf(), it = e.getHeightHalf(), n = false, m = false;
          if (l === u) {
            if (i > t) return r[0] = l, r[1] = s, r[2] = u, r[3] = U, false;
            if (i < t) return r[0] = l, r[1] = T, r[2] = u, r[3] = A, false;
          } else if (i === t) {
            if (l > u) return r[0] = o, r[1] = i, r[2] = b, r[3] = t, false;
            if (l < u) return r[0] = c, r[1] = i, r[2] = F, r[3] = t, false;
          } else {
            var p = a.height / a.width, E = e.height / e.width, y = (t - i) / (u - l), I = void 0, w = void 0, R = void 0, W = void 0, x = void 0, q = void 0;
            if (-p === y ? l > u ? (r[0] = f, r[1] = T, n = true) : (r[0] = c, r[1] = s, n = true) : p === y && (l > u ? (r[0] = o, r[1] = s, n = true) : (r[0] = g, r[1] = T, n = true)), -E === y ? u > l ? (r[2] = Z, r[3] = U, m = true) : (r[2] = b, r[3] = A, m = true) : E === y && (u > l ? (r[2] = F, r[3] = A, m = true) : (r[2] = K, r[3] = U, m = true)), n && m) return false;
            if (l > u ? i > t ? (I = this.getCardinalDirection(p, y, 4), w = this.getCardinalDirection(E, y, 2)) : (I = this.getCardinalDirection(-p, y, 3), w = this.getCardinalDirection(-E, y, 1)) : i > t ? (I = this.getCardinalDirection(-p, y, 1), w = this.getCardinalDirection(-E, y, 3)) : (I = this.getCardinalDirection(p, y, 2), w = this.getCardinalDirection(E, y, 4)), !n) switch (I) {
              case 1:
          ...
          var i = a.x, u = a.y, t = e.x, o = e.y, s = r.x, c = r.y, f = l.x, T = l.y, g = void 0, v = void 0, L = void 0, F = void 0, A = void 0, b = void 0, Z = void 0, U = void 0, K = void 0;
          return L = o - u, A = i - t, Z = t * u - i * o, F = T - c, b = s - f, U = f * c - s * T, K = L * b - F * A, K === 0 ? null : (g = (A * U - b * Z) / K, v = (F * Z - L * U) / K, new d(g, v));
          ...
          var i = a.x, u = a.y, t = e.x, o = e.y, s = r.x, c = r.y, f = l.x, T = l.y, g = (t - i) * (T - c) - (f - s) * (o - u);
          if (g === 0) return false;
          var v = ((T - c) * (f - i) + (s - f) * (T - u)) / g, L = ((u - o) * (f - i) + (t - i) * (T - u)) / g;
          return 0 < v && v < 1 && 0 < L && L < 1;
        }, h.findCircleLineIntersections = function(a, e, r, l, i, u, t) {
          var o = (r - a) * (r - a) + (l - e) * (l - e), s = 2 * ((a - i) * (r - a) + (e - u) * (l - e)), c = (a - i) * (a - i) + (e - u) * (e - u) - t * t, f = s * s - 4 * o * c;
          if (f >= 0) {
            var T = (-s + Math.sqrt(s * s - 4 * o * c)) / (2 * o), g = (-s - Math.sqrt(s * s - 4 * o * c)) / (2 * o), v = null;
        ...
        var d = /* @__PURE__ */ (function() {
          function i(u, t) {
            for (var o = 0; o < t.length; o++) {
              var s = t[o];
              s.enumerable = s.enumerable || false, s.configurable = true, "value" in s && (s.writable = true), Object.defineProperty(u, s.key, s);
            }
          }
        ...
        var a = function(u) {
          ...
          return u !== null ? u.next = t : s.head = t, o !== null ? o.prev = t : s.tail = t, t.prev = u, t.next = o, s.length++, t;
        }, r = function(u, t) {
          ...
          return d(i, [{ key: "size", value: function() {
            return this.length;
          } }, { key: "insertBefore", value: function(t, o) {
            return e(o.prev, a(t), o, this);
          } }, { key: "insertAfter", value: function(t, o) {
            return e(o, a(t), o.next, this);
          } }, { key: "insertNodeBefore", value: function(t, o) {
            return e(o.prev, t, o, this);
          } }, { key: "insertNodeAfter", value: function(t, o) {
          ...
          } }, { key: "get_object_at", value: function(t) {
            if (t <= this.length()) {
              for (var o = 1, s = this.head; o < t; ) s = s.next, o++;
              return s.value;
            }
          } }, { key: "set_object_at", value: function(t, o) {
            if (t <= this.length()) {
        ...
        var h = N(0), a = N(7), e = N(3), r = N(1), l = N(6), i = N(5), u = N(17), t = N(29);
        function o(s) {
        ...
        o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
          ...
          if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
            ...
            for (var f = this.graphManager.getRoot().getNodes(), c = 0; c < f.length; c++) f[c];
          ...
          if (s == null) this.update2();
            ...
            var c = s;
            if (c.getChild() != null) for (var f = c.getChild().getNodes(), T = 0; T < f.length; T++) update(f[T]);
          ...
          if (s == null) this.transform(new i(0, 0));
            ...
            var c = new u(), f = this.graphManager.getRoot().updateLeftTop();
            if (f != null) {
          ...
          if (s == null) this.positionNodesRandomly(this.getGraphManager().getRoot()), this.getGraphManager().getRoot().updateBounds(true);
          else for (var c, f, T = s.getNodes(), g = 0; g < T.length; g++) c = T[g], f = c.getChild(), f == null || f.getNodes().length == 0 ? c.scatter() : (this.positionNodesRandomly(f), c.updateBounds());
        }, o.prototype.getFlatForest = function() {
          for (var s = [], c = true, f = this.graphManager.getRoot().getNodes(), T = true, g = 0; g < f.length; g++) f[g].getChild() != null && (T = false);
          if (!T) return s;
          var v = /* @__PURE__ */ new Set(), L = [], F = /* @__PURE__ */ new Map(), A = [];
          for (A = A.concat(f); A.length > 0 && c; ) {
            for (L.push(A[0]); L.length > 0 && c; ) {
              ...
              for (var Z = b.getEdges(), g = 0; g < Z.length; g++) {
                ...
                if (F.get(b) != U) if (!v.has(U)) L.push(U), F.set(U, b);
                else {
                  c = false;
                  break;
                }
            ...
            if (!c) s = [];
              ...
              for (var g = 0; g < K.length; g++) {
                var D = K[g], it = A.indexOf(D);
                it > -1 && A.splice(it, 1);
              }
              v = /* @__PURE__ */ new Set(), F = /* @__PURE__ */ new Map();
            }
          }
          return s;
        }, o.prototype.createDummyNodesForBendpoints = function(s) {
          for (var c = [], f = s.source, T = this.graphManager.calcLowestCommonAncestor(s.source, s.target), g = 0; g < s.bendpoints.length; g++) {
          ...
          var s = [];
          s = s.concat(this.graphManager.getAllEdges()), s = [].concat(d(this.edgeToDummyNodes.keys())).concat(s);
          for (var c = 0; c < s.length; c++) {
            var f = s[c];
            if (f.bendpoints.length > 0) {
              for (var T = this.edgeToDummyNodes.get(f), g = 0; g < T.length; g++) {
                var v = T[g], L = new i(v.getCenterX(), v.getCenterY()), F = f.bendpoints.get(g);
          ...
          var c = [];
          c = c.concat(s);
          var f = [], T = /* @__PURE__ */ new Map(), g = false, v = null;
          (c.length == 1 || c.length == 2) && (g = true, v = c[0]);
          for (var L = 0; L < c.length; L++) {
            var F = c[L], A = F.getNeighborsList().size;
          ...
          for (b = b.concat(f); !g; ) {
            ...
            f = f.concat(b), (c.length == 1 || c.length == 2) && (g = true, v = c[0]);
          }
          return v;
        ...
        i.prototype.initParameters = function() {
          ...
          for (var t, o, s, c, f, T, g, v = this.getGraphManager().getAllEdges(), L = 0; L < v.length; L++) t = v[L], o = t.idealLength, t.isInterGraph && (c = t.getSource(), f = t.getTarget(), T = t.getSourceInLca().getEstimatedSize(), g = t.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (t.idealLength += T + g - 2 * e.SIMPLE_NODE_SIZE), s = t.getLca().getInclusionTreeDepth(), t.idealLength += o * a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (c.getInclusionTreeDepth() + f.getInclusionTreeDepth() - 2 * s));
          ...
          var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, s, c, f, T, g = this.getAllNodes(), v;
          if (this.useFRGridVariant) for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), v = /* @__PURE__ */ new Set(), s = 0; s < g.length; s++) f = g[s], this.calculateRepulsionForceOfANode(f, v, t, o), v.add(f);
          else for (s = 0; s < g.length; s++) for (f = g[s], c = s + 1; c < g.length; c++) T = g[c], f.getOwner() == T.getOwner() && this.calcRepulsionForce(f, T);
          ...
          var s = t.getSource(), c = t.getTarget(), f, T, g, v;
          ...
          f = t.getLength(), f != 0 && (T = t.edgeElasticity * (f - o), g = T * (t.lengthX / f), v = T * (t.lengthY / f), s.springForceX += g, s.springForceY += v, c.springForceX -= g, c.springForceY -= v);
        }, i.prototype.calcRepulsionForce = function(t, o) {
          var s = t.getRect(), c = o.getRect(), f = new Array(2), T = new Array(4), g, v, L, F, A, b, Z;
          if (s.intersects(c)) {
            r.calcSeparationAmount(s, c, f, a.DEFAULT_EDGE_LENGTH / 2), b = 2 * f[0], Z = 2 * f[1];
            var U = t.noOfChildren * o.noOfChildren / (t.noOfChildren + o.noOfChildren);
            t.repulsionForceX -= U * b, t.repulsionForceY -= U * Z, o.repulsionForceX += U * b, o.repulsionForceY += U * Z;
          } else this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null ? (g = c.getCenterX() - s.getCenterX(), v = c.getCenterY() - s.getCenterY()) : (r.getIntersection(s, c, T), g = T[2] - T[0], v = T[3] - T[1]), Math.abs(g) < a.MIN_REPULSION_DIST && (g = l.sign(g) * a.MIN_REPULSION_DIST), Math.abs(v) < a.MIN_REPULSION_DIST && (v = l.sign(v) * a.MIN_REPULSION_DIST), L = g * g + v * v, F = Math.sqrt(L), A = (t.nodeRepulsion / 2 + o.nodeRepulsion / 2) * t.noOfChildren * o.noOfChildren / L, b = A * g / F, Z = A * v / F, t.repulsionForceX -= b, t.repulsionForceY -= Z, o.repulsionForceX += b, o.repulsionForceY += Z;
          ...
          var c = 0, f = 0, T = 0, g = 0;
          c = parseInt(Math.floor((t.getRect().x - o) / this.repulsionRange)), f = parseInt(Math.floor((t.getRect().width + t.getRect().x - o) / this.repulsionRange)), T = parseInt(Math.floor((t.getRect().y - s) / this.repulsionRange)), g = parseInt(Math.floor((t.getRect().height + t.getRect().y - s) / this.repulsionRange));
          for (var v = c; v <= f; v++) for (var L = T; L <= g; L++) this.grid[v][L].push(t), t.setGridCoordinates(c, f, T, g);
          ...
          if (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && s || c) {
            ...
            for (var T, g = this.grid, v = t.startX - 1; v < t.finishX + 2; v++) for (var L = t.startY - 1; L < t.finishY + 2; L++) if (!(v < 0 || L < 0 || v >= g.length || L >= g[0].length)) {
              for (var F = 0; F < g[v][L].length; F++) if (T = g[v][L][F], !(t.getOwner() != T.getOwner() || t == T) && !o.has(T) && !f.has(T)) {
                var A = Math.abs(t.getCenterX() - T.getCenterX()) - (t.getWidth() / 2 + T.getWidth() / 2), b = Math.abs(t.getCenterY() - T.getCenterY()) - (t.getHeight() / 2 + T.getHeight() / 2);
        ...
        var d = /* @__PURE__ */ (function() {
          function r(l, i) {
            for (var u = 0; u < i.length; u++) {
              var t = i[u];
              t.enumerable = t.enumerable || false, t.configurable = true, "value" in t && (t.writable = true), Object.defineProperty(l, t.key, t);
            }
          }
        ...
        var a = N(11), e = (function() {
          function r(l, i) {
            ...
            var u = void 0;
            l instanceof a ? u = l.size() : u = l.length, this._quicksort(l, 0, u - 1);
          }
          return d(r, [{ key: "_quicksort", value: function(i, u, t) {
            if (u < t) {
              var o = this._partition(i, u, t);
              this._quicksort(i, u, o), this._quicksort(i, o + 1, t);
            }
          } }, { key: "_partition", value: function(i, u, t) {
          ...
          } }, { key: "_get", value: function(i, u) {
            return i instanceof a ? i.get_object_at(u) : i[u];
          } }, { key: "_set", value: function(i, u, t) {
            i instanceof a ? i.set_object_at(u, t) : i[u] = t;
          } }, { key: "_swap", value: function(i, u, t) {
            var o = this._get(i, u);
            this._set(i, u, this._get(i, t)), this._set(i, t, o);
          } }, { key: "_defaultCompareFunction", value: function(i, u) {
            return u > i;
          } }]), r;
        })();
        M.exports = e;
        ...
        d.svd = function(h) {
          ...
          for (var e = (function(Tt) {
            ...
            if (/* @__PURE__ */ (function(Tt, Ct) {
              return Ct;
            })(l, t < i)) for (var v = t; v < this.m; v++) this.U[v][t] = h[v][t];
            if (t < u) {
              e[t] = 0;
              ...
              if (e[t] = -e[t], /* @__PURE__ */ (function(Tt, Ct) {
                ...
                for (var b = t + 1; b < this.n; b++) for (var Z = t + 1; Z < this.m; Z++) r[Z] += e[b] * h[Z][b];
                for (var U = t + 1; U < this.n; U++) for (var K = -e[U] / e[t + 1], D = t + 1; D < this.m; D++) h[D][U] += K * r[D];
              }
              for (var it = t + 1; it < this.n; it++) this.V[it][t] = e[it];
            }
          }
          var n = Math.min(this.n, this.m + 1);
          i < this.n && (this.s[i] = h[i][i]), this.m < n && (this.s[n - 1] = 0), u + 1 < n && (e[u] = h[u][n - 1]), e[n - 1] = 0;
          {
            for (var m = i; m < a; m++) {
              for (var p = 0; p < this.m; p++) this.U[p][m] = 0;
              this.U[m][m] = 1;
            }
            for (var E = i - 1; E >= 0; E--) if (this.s[E] !== 0) {
              for (var y = E + 1; y < a; y++) {
          ...
          for (var B = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
            ...
            for (Q = n - 2; Q >= -1 && Q !== -1; Q--) if (Math.abs(e[Q]) <= ht + _ * (Math.abs(this.s[Q]) + Math.abs(this.s[Q + 1]))) {
              e[Q] = 0;
              break;
            }
            if (Q === n - 2) It = 4;
            ...
            switch (Q++, It) {
              case 1:
                {
                  ...
                  for (var gt = n - 2; gt >= Q; gt--) {
                    var mt = d.hypot(this.s[gt], rt), At = this.s[gt] / mt, Ot = rt / mt;
                    this.s[gt] = mt, gt !== Q && (rt = -Ot * e[gt - 1], e[gt - 1] = At * e[gt - 1]);
                    for (var Et = 0; Et < this.n; Et++) mt = At * this.V[Et][gt] + Ot * this.V[Et][n - 1], this.V[Et][n - 1] = -Ot * this.V[Et][gt] + At * this.V[Et][n - 1], this.V[Et][gt] = mt;
                  }
                }
                break;
              case 2:
                {
                  ...
                  for (var Rt = Q; Rt < n; Rt++) {
                    var Ht = d.hypot(this.s[Rt], Dt), Ut = this.s[Rt] / Ht, Pt = Dt / Ht;
              ...
              case 3:
                {
                  var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(e[n - 2])), Math.abs(this.s[Q])), Math.abs(e[Q])), Vt = this.s[n - 1] / Yt, S = this.s[n - 2] / Yt, P = e[n - 2] / Yt, $ = this.s[Q] / Yt, J = e[Q] / Yt, k = ((S + Vt) * (S - Vt) + P * P) / 2, at = Vt * P * (Vt * P), ct = 0;
                  /* @__PURE__ */ (function(Tt, Ct) {
                    return Tt || Ct;
                  })(k !== 0, at !== 0) && (ct = Math.sqrt(k * k + at), k < 0 && (ct = -ct), ct = at / (k + ct));
                  for (var nt = ($ + Vt) * ($ - Vt) + ct, tt = $ * J, j = Q; j < n - 1; j++) {
                    var ut = d.hypot(nt, tt), Mt = nt / ut, pt = tt / ut;
                    ...
                    if (ut = d.hypot(nt, tt), Mt = nt / ut, pt = tt / ut, this.s[j] = ut, nt = Mt * e[j] + pt * this.s[j + 1], this.s[j + 1] = -pt * e[j] + Mt * this.s[j + 1], tt = pt * e[j + 1], e[j + 1] = Mt * e[j + 1], j < this.m - 1) for (var lt = 0; lt < this.m; lt++) ut = Mt * this.U[lt][j] + pt * this.U[lt][j + 1], this.U[lt][j + 1] = -pt * this.U[lt][j] + Mt * this.U[lt][j + 1], this.U[lt][j] = ut;
                  }
                  e[n - 2] = nt;
                }
                break;
        ...
        var d = /* @__PURE__ */ (function() {
          function e(r, l) {
            for (var i = 0; i < l.length; i++) {
              var u = l[i];
              u.enumerable = u.enumerable || false, u.configurable = true, "value" in u && (u.writable = true), Object.defineProperty(r, u.key, u);
            }
          }
        ...
        var a = (function() {
          function e(r, l) {
            ...
            for (var c = 0; c < this.iMax; c++) {
              ...
              for (var f = 0; f < this.jMax; f++) this.tracebackGrid[c][f] = [null, null, null];
            }
            this.alignments = [], this.score = -1, this.computeGrids();
          }
          return d(e, [{ key: "getScore", value: function() {
            return this.score;
          } }, { key: "getAlignments", value: function() {
            return this.alignments;
          } }, { key: "computeGrids", value: function() {
            for (var l = 1; l < this.jMax; l++) this.grid[0][l] = this.grid[0][l - 1] + this.gap_penalty, this.tracebackGrid[0][l] = [false, false, true];
            for (var i = 1; i < this.iMax; i++) this.grid[i][0] = this.grid[i - 1][0] + this.gap_penalty, this.tracebackGrid[i][0] = [false, true, false];
            for (var u = 1; u < this.iMax; u++) for (var t = 1; t < this.jMax; t++) {
              var o = void 0;
              this.sequence1[u - 1] === this.sequence2[t - 1] ? o = this.grid[u - 1][t - 1] + this.match_score : o = this.grid[u - 1][t - 1] + this.mismatch_penalty;
              var s = this.grid[u - 1][t] + this.gap_penalty, c = this.grid[u][t - 1] + this.gap_penalty, f = [o, s, c], T = this.arrayAllMaxIndexes(f);
              this.grid[u][t] = f[T[0]], this.tracebackGrid[u][t] = [T.includes(0), T.includes(1), T.includes(2)];
            }
            this.score = this.grid[this.iMax - 1][this.jMax - 1];
          } }, { key: "alignmentTraceback", value: function() {
            var l = [];
            for (l.push({ pos: [this.sequence1.length, this.sequence2.length], seq1: "", seq2: "" }); l[0]; ) {
              var i = l[0], u = this.tracebackGrid[i.pos[0]][i.pos[1]];
              u[0] && l.push({ pos: [i.pos[0] - 1, i.pos[1] - 1], seq1: this.sequence1[i.pos[0] - 1] + i.seq1, seq2: this.sequence2[i.pos[1] - 1] + i.seq2 }), u[1] && l.push({ pos: [i.pos[0] - 1, i.pos[1]], seq1: this.sequence1[i.pos[0] - 1] + i.seq1, seq2: "-" + i.seq2 }), u[2] && l.push({ pos: [i.pos[0], i.pos[1] - 1], seq1: "-" + i.seq1, seq2: this.sequence2[i.pos[1] - 1] + i.seq2 }), i.pos[0] === 0 && i.pos[1] === 0 && this.alignments.push({ sequence1: i.seq1, sequence2: i.seq2 }), l.shift();
            }
            return this.alignments;
          } }, { key: "getAllIndexes", value: function(l, i) {
            for (var u = [], t = -1; (t = l.indexOf(i, t + 1)) !== -1; ) u.push(t);
            return u;
          } }, { key: "arrayAllMaxIndexes", value: function(l) {
    ...
    (function(G, N) {
      ...
      return (() => {
        var G = { 45: ((a, e, r) => {
          ...
          var l = r(551).FDLayout, i = r(578), u = r(880), t = r(991), o = r(767), s = r(806), c = r(902), f = r(551).FDLayoutConstants, T = r(551).LayoutConstants, g = r(551).Point, v = r(551).PointD, L = r(551).DimensionD, F = r(551).Layout, A = r(551).Integer, b = r(551).IGeometry, Z = r(551).LGraph, U = r(551).Transform, K = r(551).LinkedList;
          function D() {
          ...
          D.prototype.newGraphManager = function() {
            ...
            for (var n = this.getAllNodes(), m, p = 0; p < n.length; p++) m = n[p], m.calculateDisplacement();
            ...
            var y = function O(H) {
              for (var B = H.getChild().getNodes(), _, ht = 0, Q = 0; Q < B.length; Q++) _ = B[Q], _.getChild() == null ? n.fixedNodeSet.has(_.id) && (ht += 100) : ht += O(_);
              return ht;
            };
            if (this.constraints.fixedNodeConstraint) {
              ...
              for (var m = this.graphManager.getAllNodes(), E, p = 0; p < m.length; p++) if (E = m[p], E.getChild() != null) {
                var I = y(E);
            ...
            if (this.constraints.relativePlacementConstraint) {
              ...
              if (s.RELAX_MOVEMENT_ON_CONSTRAINTS) this.shuffle = function(O) {
                var H, B, _;
                for (_ = O.length - 1; _ >= 2 * O.length / 3; _--) H = Math.floor(Math.random() * (_ + 1)), B = O[_], O[_] = O[H], O[H] = B;
                return O;
                  ...
                  return H.forEach(function(vt, rt) {
                    if (!It.has(rt)) {
                      ...
                      for (Q.push(gt), It.add(gt), _[Nt].push(gt); Q.length != 0; ) {
                        gt = Q.shift(), B.has(gt) && (ht[Nt] = true);
                        var mt = H.get(gt);
            ...
            if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(z) {
              ...
              if (this.constraints.alignmentConstraint.vertical) for (var m = this.constraints.alignmentConstraint.vertical, p = 0; p < m.length; p++) {
                ...
                for (var I = E / m[p].length, y = 0; y < m[p].length; y++) this.idToNodeMap.get(m[p][y]).displacementX = I;
              }
              if (this.constraints.alignmentConstraint.horizontal) for (var w = this.constraints.alignmentConstraint.horizontal, p = 0; p < w.length; p++) {
                ...
                for (var W = R / w[p].length, y = 0; y < w[p].length; y++) this.idToNodeMap.get(w[p][y]).displacementY = W;
              }
            }
            if (this.constraints.relativePlacementConstraint) if (s.RELAX_MOVEMENT_ON_CONSTRAINTS) this.totalIterations % 10 == 0 && (this.shuffle(this.nodesInRelativeHorizontal), this.shuffle(this.nodesInRelativeVertical)), this.nodesInRelativeHorizontal.forEach(function(z) {
              ...
              for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
                ...
                if (this.fixedComponentsOnHorizontal[p]) for (var y = 0; y < x.length; y++) this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
                  ...
                  for (var q = 0, V = 0, y = 0; y < x.length; y++) if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
                  ...
                  for (var et = q / V, y = 0; y < x.length; y++) this.dummyToNodeForVerticalAlignment.has(x[y]) ? this.dummyToNodeForVerticalAlignment.get(x[y]).forEach(function(H) {
              ...
              for (var p = 0; p < this.componentsOnVertical.length; p++) {
                ...
                if (this.fixedComponentsOnVertical[p]) for (var y = 0; y < x.length; y++) this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(B) {
                  ...
                  for (var q = 0, V = 0, y = 0; y < x.length; y++) if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
                  ...
                  for (var et = q / V, y = 0; y < x.length; y++) this.dummyToNodeForHorizontalAlignment.has(x[y]) ? this.dummyToNodeForHorizontalAlignment.get(x[y]).forEach(function(Q) {
            ...
            for (y = 0; y < E; y++) m = p[y], m.updateConnected(), m.isConnected || (n = n.concat(m.getNodes()));
            return n;
            ...
            for (p = 0; p < n.length; p++) {
              ...
              if (!m.has(E)) {
                ...
                if (y == I) E.getBendpoints().push(new v()), E.getBendpoints().push(new v()), this.createDummyNodesForBendpoints(E), m.add(E);
                else {
                  var w = [];
            ...
            for (var m = new g(0, 0), p = Math.ceil(Math.sqrt(n.length)), E = 0, y = 0, I = 0, w = new v(0, 0), R = 0; R < n.length; R++) {
            ...
            var y = Z.calculateBounds(n), I = new U();
            ...
            var w = (E - p + 1) / 2;
            w < 0 && (w += 180);
            var R = (w + p) % 360, W = R * b.TWO_PI / 360, x = y * Math.cos(W), q = y * Math.sin(W);
            n.setCenter(x, q);
            var V = [];
            ...
            for (var p = 0; p < this.compoundOrder.length; p++) m[this.compoundOrder[p].id] = this.compoundOrder[p], n[this.compoundOrder[p].id] = [].concat(this.compoundOrder[p].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[p].getChild()), this.compoundOrder[p].child = null;
            ...
            for (var E = p.getNodes(), y = 0; y < E.length; y++) {
              var I = E[y];
              if (this.getNodeDegree(I) > 0) return this.toBeTiled[m] = false, false;
              if (I.getChild() == null) {
                this.toBeTiled[I.id] = false;
                continue;
              }
              if (!this.getToBeTiled(I)) return this.toBeTiled[m] = false, false;
            }
            ...
            var E = s.TILING_PADDING_VERTICAL, y = s.TILING_PADDING_HORIZONTAL, I = s.TILING_COMPARE_BY, w = { rows: [], rowWidth: [], rowHeight: [], width: 0, height: m, verticalPadding: E, horizontalPadding: y, centerX: 0, centerY: 0 };
            ...
            for (var m = -1, p = Number.MAX_VALUE, E = 0; E < n.rows.length; E++) n.rowWidth[E] < p && (m = E, p = n.rowWidth[E]);
            return m;
          }, D.prototype.getLongestRowIndex = function(n) {
            for (var m = -1, p = Number.MIN_VALUE, E = 0; E < n.rows.length; E++) n.rowWidth[E] > p && (m = E, p = n.rowWidth[E]);
            return m;
            ...
            if (n.width - n.rowWidth[p] > I && m != p) {
              ...
              for (var w = Number.MIN_VALUE, R = 0; R < E.length; R++) E[R].height > w && (w = E[R].height);
            ...
            for (var n = [], m = true, p; m; ) {
              ...
              m = false;
              for (var I = 0; I < E.length; I++) if (p = E[I], p.getEdges().length == 1 && !p.getEdges()[0].isInterGraph && p.getChild() == null) {
                if (s.PURE_INCREMENTAL) {
                  var w = p.getEdges()[0].getOtherEnd(p), R = new L(p.getCenterX() - w.getCenterX(), p.getCenterY() - w.getCenterY());
            ...
            for (var m = n.length, p = n[m - 1], E, y = 0; y < p.length; y++) E = p[y], this.findPlaceforPrunedNode(E), E[2].add(E[0]), E[2].add(E[1], E[1].source, E[1].target);
            ...
            var m, p, E = n[0];
            if (E == n[1].source ? p = n[1].target : p = n[1].source, s.PURE_INCREMENTAL) E.setCenter(p.getCenterX() + n[3].getWidth(), p.getCenterY() + n[3].getHeight());
            else {
              var y = p.startX, I = p.finishX, w = p.startY, R = p.finishY, W = 0, x = 0, q = 0, V = 0, Y = [W, q, x, V];
              if (w > 0) for (var et = y; et <= I; et++) Y[0] += this.grid[et][w - 1].length + this.grid[et][w].length - 1;
              if (I < this.grid.length - 1) for (var et = w; et <= R; et++) Y[1] += this.grid[I + 1][et].length + this.grid[I][et].length - 1;
              if (R < this.grid[0].length - 1) for (var et = y; et <= I; et++) Y[2] += this.grid[et][R + 1].length + this.grid[et][R].length - 1;
              if (y > 0) for (var et = w; et <= R; et++) Y[3] += this.grid[y - 1][et].length + this.grid[y][et].length - 1;
              for (var z = A.MAX_VALUE, O, H, B = 0; B < Y.length; B++) Y[B] < z ? (z = Y[B], O = 1, H = B) : Y[B] == z && O++;
              if (O == 3 && z == 0) Y[0] == 0 && Y[1] == 0 && Y[2] == 0 ? m = 1 : Y[0] == 0 && Y[1] == 0 && Y[3] == 0 ? m = 0 : Y[0] == 0 && Y[2] == 0 && Y[3] == 0 ? m = 3 : Y[1] == 0 && Y[2] == 0 && Y[3] == 0 && (m = 2);
              else if (O == 2 && z == 0) {
          ...
          u.prototype.calculateDisplacement = function() {
            ...
            for (var c = this.getChild().getNodes(), f, T = 0; T < c.length; T++) f = c[T], f.getChild() == null ? (f.displacementX += o, f.displacementY += s) : f.propogateDisplacementToChildren(o, s);
          ...
          var i = r(806), u = r(551).LinkedList, t = r(551).Matrix, o = r(551).SVD;
          function s() {
          }
          s.handleConstraints = function(c) {
            ...
            for (var T = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), v = [], L = [], F = c.getAllNodes(), A = 0, b = 0; b < F.length; b++) {
              var Z = F[b];
              Z.getChild() == null && (g.set(Z.id, A++), v.push(Z.getCenterX()), L.push(Z.getCenterY()), T.set(Z.id, Z));
            }
            f.relativePlacementConstraint && f.relativePlacementConstraint.forEach(function(S) {
            ...
            var U = function(P, $) {
              ...
              return P.forEach(function(k) {
                $ += v[g.get(k)], J += L[g.get(k)];
              }), { x: $ / P.size, y: J / P.size };
            }, D = function(P, $, J, k, at) {
              function ct(lt, ot) {
                var Lt = new Set(lt), ft = true, st = false, Xt = void 0;
                try {
              ...
              var tt = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), ut = new u();
              nt.forEach(function(lt, ot) {
                lt == 0 ? (ut.push(ot), J || ($ == "horizontal" ? tt.set(ot, g.has(ot) ? v[g.get(ot)] : k.get(ot)) : tt.set(ot, g.has(ot) ? L[g.get(ot)] : k.get(ot)))) : tt.set(ot, Number.NEGATIVE_INFINITY), J && j.set(ot, /* @__PURE__ */ new Set([ot]));
                ...
                if (lt.forEach(function(st) {
                  ...
                  ot.forEach(function(st) {
                    $ == "horizontal" ? (tt.set(st, g.has(st) ? v[g.get(st)] : k.get(st)), Lt += tt.get(st)) : (tt.set(st, g.has(st) ? L[g.get(st)] : k.get(st)), Lt += tt.get(st));
                  ...
                  lt.forEach(function(st) {
                    $ == "horizontal" ? ft += g.has(st) ? v[g.get(st)] : k.get(st) : ft += g.has(st) ? L[g.get(st)] : k.get(st);
              ...
              for (var Mt = function() {
                ...
                Lt.forEach(function(ft) {
                  if (tt.get(ft.id) < tt.get(ot) + ft.gap) if (J && J.has(ft.id)) {
                    var st = void 0;
                    if ($ == "horizontal" ? st = g.has(ft.id) ? v[g.get(ft.id)] : k.get(ft.id) : st = g.has(ft.id) ? L[g.get(ft.id)] : k.get(ft.id), tt.set(ft.id, st), st < tt.get(ot) + ft.gap) {
              ...
              if (J) {
                ...
                j.forEach(function(lt, ot) {
                  if (pt.has(ot)) {
                    var Lt = false, ft = true, st = false, Xt = void 0;
                    try {
                  ...
                  var Lt = Number.POSITIVE_INFINITY, ft = Number.POSITIVE_INFINITY, st = Number.NEGATIVE_INFINITY, Xt = Number.NEGATIVE_INFINITY, Tt = true, Ct = false, Bt = void 0;
                  try {
                    for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = true) {
                      var St = zt.value, kt = void 0;
                      $ == "horizontal" ? kt = g.has(St) ? v[g.get(St)] : k.get(St) : kt = g.has(St) ? L[g.get(St)] : k.get(St);
                      var Kt = tt.get(St);
                  ...
                  var fe = (Lt + st) / 2 - (ft + Xt) / 2, Qt = true, jt = false, _t = void 0;
                  try {
                    for (var Jt = lt[Symbol.iterator](), ne; !(Qt = (ne = Jt.next()).done); Qt = true) {
                      var te = ne.value;
              ...
              if (P.forEach(function(j) {
                j.left ? v[g.get(j.left)] - v[g.get(j.right)] >= 0 ? $++ : J++ : L[g.get(j.top)] - L[g.get(j.bottom)] >= 0 ? k++ : at++;
              }), $ > J && k > at) for (var ct = 0; ct < g.size; ct++) v[ct] = -1 * v[ct], L[ct] = -1 * L[ct];
              else if ($ > J) for (var nt = 0; nt < g.size; nt++) v[nt] = -1 * v[nt];
              else if (k > at) for (var tt = 0; tt < g.size; tt++) L[tt] = -1 * L[tt];
            }, n = function(P) {
              var $ = [], J = new u(), k = /* @__PURE__ */ new Set(), at = 0;
            ...
            if (f.fixedNodeConstraint && f.fixedNodeConstraint.forEach(function(S) {
              R.add(S.nodeId);
            }), f.relativePlacementConstraint && (f.relativePlacementConstraint.forEach(function(S) {
              ...
              if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 1) f.fixedNodeConstraint.forEach(function(S, P) {
                E[P] = [S.position.x, S.position.y], y[P] = [v[g.get(S.nodeId)], L[g.get(S.nodeId)]];
              }), I = true;
              else if (f.alignmentConstraint) (function() {
                var S = 0;
                if (f.alignmentConstraint.vertical) {
                  for (var P = f.alignmentConstraint.vertical, $ = function(tt) {
                    ...
                    ut.size > 0 ? Mt = v[g.get(ut.values().next().value)] : Mt = K(j).x, P[tt].forEach(function(pt) {
                      E[S] = [Mt, L[g.get(pt)]], y[S] = [v[g.get(pt)], L[g.get(pt)]], S++;
                    });
                  }, J = 0; J < P.length; J++) $(J);
                  I = true;
                }
                if (f.alignmentConstraint.horizontal) {
                  for (var k = f.alignmentConstraint.horizontal, at = function(tt) {
                    ...
                    ut.size > 0 ? Mt = v[g.get(ut.values().next().value)] : Mt = K(j).y, k[tt].forEach(function(pt) {
                      E[S] = [v[g.get(pt)], Mt], y[S] = [v[g.get(pt)], L[g.get(pt)]], S++;
                    });
                  }, ct = 0; ct < k.length; ct++) at(ct);
                  I = true;
                }
                f.relativePlacementConstraint && (w = true);
              })();
              else if (f.relativePlacementConstraint) {
                for (var V = 0, Y = 0, et = 0; et < q.length; et++) q[et].length > V && (V = q[et].length, Y = et);
                if (V < x.size / 2) it(f.relativePlacementConstraint), I = false, w = false;
                else {
                  var z = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), H = [];
                  q[Y].forEach(function(S) {
                    W.get(S).forEach(function(P) {
                      P.direction == "horizontal" ? (z.has(S) ? z.get(S).push(P) : z.set(S, [P]), z.has(P.id) || z.set(P.id, []), H.push({ left: S, right: P.id })) : (O.has(S) ? O.get(S).push(P) : O.set(S, [P]), O.has(P.id) || O.set(P.id, []), H.push({ top: S, bottom: P.id }));
                    });
                  }), it(H), w = false;
                  var B = D(z, "horizontal"), _ = D(O, "vertical");
                  q[Y].forEach(function(S, P) {
                    y[P] = [v[g.get(S)], L[g.get(S)]], E[P] = [], B.has(S) ? E[P][0] = B.get(S) : E[P][0] = v[g.get(S)], _.has(S) ? E[P][1] = _.get(S) : E[P][1] = L[g.get(S)];
                  }), I = true;
                }
              }
              if (I) {
                for (var ht = void 0, Q = t.transpose(E), It = t.transpose(y), Nt = 0; Nt < Q.length; Nt++) Q[Nt] = t.multGamma(Q[Nt]), It[Nt] = t.multGamma(It[Nt]);
            ...
            if (i.ENFORCE_CONSTRAINTS) {
              if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 0) {
                ...
                f.fixedNodeConstraint.forEach(function(S, P) {
                  var $ = { x: v[g.get(S.nodeId)], y: L[g.get(S.nodeId)] }, J = S.position, k = U(J, $);
                  Et.x += k.x, Et.y += k.y;
                }), Et.x /= f.fixedNodeConstraint.length, Et.y /= f.fixedNodeConstraint.length, v.forEach(function(S, P) {
                  v[P] += Et.x;
                }), L.forEach(function(S, P) {
                  L[P] += Et.y;
                }), f.fixedNodeConstraint.forEach(function(S) {
                  v[g.get(S.nodeId)] = S.position.x, L[g.get(S.nodeId)] = S.position.y;
                });
              }
              if (f.alignmentConstraint) {
                if (f.alignmentConstraint.vertical) for (var Dt = f.alignmentConstraint.vertical, Rt = function(P) {
                  ...
                  J.size > 0 ? k = v[g.get(J.values().next().value)] : k = K($).x, $.forEach(function(at) {
                    R.has(at) || (v[g.get(at)] = k);
                  });
                }, Ht = 0; Ht < Dt.length; Ht++) Rt(Ht);
                if (f.alignmentConstraint.horizontal) for (var Ut = f.alignmentConstraint.horizontal, Pt = function(P) {
                  var $ = /* @__PURE__ */ new Set();
                  ...
                  J.size > 0 ? k = L[g.get(J.values().next().value)] : k = K($).y, $.forEach(function(at) {
                    R.has(at) || (L[g.get(at)] = k);
                  });
                }, Ft = 0; Ft < Ut.length; Ft++) Pt(Ft);
              }
              f.relativePlacementConstraint && (function() {
                var S = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                if (R.forEach(function(Gt) {
                  ct.add(Gt), nt.add(Gt);
                }), f.alignmentConstraint) {
                  if (f.alignmentConstraint.vertical) for (var tt = f.alignmentConstraint.vertical, j = function(yt) {
                    $.set("dummy" + yt, []), tt[yt].forEach(function(wt) {
                      S.set(wt, "dummy" + yt), $.get("dummy" + yt).push(wt), R.has(wt) && ct.add("dummy" + yt);
                    }), k.set("dummy" + yt, v[g.get(tt[yt][0])]);
                  }, ut = 0; ut < tt.length; ut++) j(ut);
                  if (f.alignmentConstraint.horizontal) for (var Mt = f.alignmentConstraint.horizontal, pt = function(yt) {
                    J.set("dummy" + yt, []), Mt[yt].forEach(function(wt) {
                      P.set(wt, "dummy" + yt), J.get("dummy" + yt).push(wt), R.has(wt) && nt.add("dummy" + yt);
                ...
                var lt = /* @__PURE__ */ new Map(), ot = /* @__PURE__ */ new Map(), Lt = function(yt) {
                  W.get(yt).forEach(function(wt) {
                    ...
                    wt.direction == "horizontal" ? (Zt = S.get(yt) ? S.get(yt) : yt, S.get(wt.id) ? $t = { id: S.get(wt.id), gap: wt.gap, direction: wt.direction } : $t = wt, lt.has(Zt) ? lt.get(Zt).push($t) : lt.set(Zt, [$t]), lt.has($t.id) || lt.set($t.id, [])) : (Zt = P.get(yt) ? P.get(yt) : yt, P.get(wt.id) ? $t = { id: P.get(wt.id), gap: wt.gap, direction: wt.direction } : $t = wt, ot.has(Zt) ? ot.get(Zt).push($t) : ot.set(Zt, [$t]), ot.has($t.id) || ot.set($t.id, []));
                  });
                }, ft = true, st = false, Xt = void 0;
                try {
                ...
                var _t = D(lt, "horizontal", ct, k, Qt), Jt = D(ot, "vertical", nt, at, jt), ne = function(yt) {
                  $.get(yt) ? $.get(yt).forEach(function(wt) {
                    v[g.get(wt)] = _t.get(yt);
                  }) : v[g.get(yt)] = _t.get(yt);
                }, te = true, ee = false, Te = void 0;
                try {
                  for (var ce = _t.keys()[Symbol.iterator](), Ne; !(te = (Ne = ce.next()).done); te = true) {
                    var ge = Ne.value;
                    ne(ge);
                  }
                } catch (Gt) {
                ...
                }, ue = true, Le = false, Ce = void 0;
                try {
                  for (var de = Jt.keys()[Symbol.iterator](), Ae; !(ue = (Ae = de.next()).done); ue = true) {
                    var ge = Ae.value;
                    Be(ge);
                  }
                } catch (Gt) {
      ...
      return (() => {
        var G = { 658: ((a) => {
          ...
          u.getTopMostNodes = function(t) {
            for (var o = {}, s = 0; s < t.length; s++) o[t[s].id()] = true;
            var c = t.filter(function(f, T) {
              typeof f == "number" && (f = T);
              for (var g = f.parent()[0]; g != null; ) {
                if (o[g.id()]) return false;
                g = g.parent()[0];
              }
              return true;
            });
            ...
            var f = new i(), T = /* @__PURE__ */ new Set(), g = [], v = void 0, L = void 0, F = void 0, A = false, b = 1, Z = [], U = [], K = function() {
              var it = t.collection();
              U.push(it);
              ...
              for (var p = function() {
                ...
                for (var w = 0; w < I.length; w++) {
                  var R = I[w];
                  if (v = s.intersection(R.union(R.ancestors())), v != null && !T.has(v[0])) {
              ...
              }), g.length == s.length && (A = true), !A || A && b > 1) {
                L = g[0], F = L.connectedEdges().length, g.forEach(function(y) {
                  y.connectedEdges().length < F && (F = y.connectedEdges().length, L = y);
                }), Z.push(L.id());
                var E = t.collection();
                E.merge(g[0]), g.forEach(function(y) {
                  E.merge(y);
                }), g = [], s = s.difference(E), b++;
              }
            };
            do
              K();
            ...
            if (!s.fixedNodeConstraint) {
              var c = Number.POSITIVE_INFINITY, f = Number.NEGATIVE_INFINITY, T = Number.POSITIVE_INFINITY, g = Number.NEGATIVE_INFINITY;
              if (s.quality == "draft") {
                var v = true, L = false, F = void 0;
                try {
                  for (var A = o.nodeIndexes[Symbol.iterator](), b; !(v = (b = A.next()).done); v = true) {
                    var Z = b.value, U = l(Z, 2), K = U[0], D = U[1], it = s.cy.getElementById(K);
                    if (it) {
                      var n = it.boundingBox(), m = o.xCoords[D] - n.w / 2, p = o.xCoords[D] + n.w / 2, E = o.yCoords[D] - n.h / 2, y = o.yCoords[D] + n.h / 2;
                      m < c && (c = m), p > f && (f = p), E < T && (T = E), y > g && (g = y);
                    }
                  }
                } catch (x) {
                  L = true, F = x;
                ...
                Object.keys(o).forEach(function(x) {
                  ...
                  V < c && (c = V), Y > f && (f = Y), et < T && (T = et), z > g && (g = z);
                });
                var R = t.x - (f + c) / 2, W = t.y - (g + T) / 2;
                Object.keys(o).forEach(function(x) {
                  var q = o[x];
            ...
            for (var f = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, g = Number.MAX_SAFE_INTEGER, v = Number.MIN_SAFE_INTEGER, L = void 0, F = void 0, A = void 0, b = void 0, Z = t.descendants().not(":parent"), U = Z.length, K = 0; K < U; K++) {
              var D = Z[K];
              L = o[c.get(D.id())] - D.width() / 2, F = o[c.get(D.id())] + D.width() / 2, A = s[c.get(D.id())] - D.height() / 2, b = s[c.get(D.id())] + D.height() / 2, f > L && (f = L), T < F && (T = F), g > A && (g = A), v < b && (v = b);
            }
            var it = {};
            return it.topLeftX = f, it.topLeftY = g, it.width = T - f, it.height = v - g, it;
          ...
          var l = r(548), i = r(140).CoSELayout, u = r(140).CoSENode, t = r(140).layoutBase.PointD, o = r(140).layoutBase.DimensionD, s = r(140).layoutBase.LayoutConstants, c = r(140).layoutBase.FDLayoutConstants, f = r(140).CoSEConstants, T = function(v, L) {
            var F = v.cy, A = v.eles, b = A.nodes(), Z = A.edges(), U = void 0, K = void 0, D = void 0, it = {};
            v.randomize && (U = L.nodeIndexes, K = L.xCoords, D = L.yCoords);
            var n = function(x) {
              return typeof x == "function";
            }, m = function(x, q) {
              return n(x) ? x(q) : x;
            }, p = l.calcParentsWithoutChildren(F, A), E = function W(x, q, V, Y) {
              for (var et = q.length, z = 0; z < et; z++) {
                var O = q[z], H = null;
                O.intersection(p).length == 0 && (H = O.children());
                var B = void 0, _ = O.layoutDimensions({ nodeDimensionsIncludeLabels: Y.nodeDimensionsIncludeLabels });
                if (O.outerWidth() != null && O.outerHeight() != null) if (Y.randomize) if (!O.isParent()) B = x.add(new u(V.graphManager, new t(K[U.get(O.id())] - _.w / 2, D[U.get(O.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                else {
                  var ht = l.calcBoundingBox(O, K, D, U);
                  O.intersection(p).length == 0 ? B = x.add(new u(V.graphManager, new t(ht.topLeftX, ht.topLeftY), new o(ht.width, ht.height))) : B = x.add(new u(V.graphManager, new t(ht.topLeftX, ht.topLeftY), new o(parseFloat(_.w), parseFloat(_.h))));
                }
                else B = x.add(new u(V.graphManager, new t(O.position("x") - _.w / 2, O.position("y") - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                else B = x.add(new u(this.graphManager));
                if (B.id = O.data("id"), B.nodeRepulsion = m(Y.nodeRepulsion, O), B.paddingLeft = parseInt(O.css("padding")), B.paddingTop = parseInt(O.css("padding")), B.paddingRight = parseInt(O.css("padding")), B.paddingBottom = parseInt(O.css("padding")), Y.nodeDimensionsIncludeLabels && (B.labelWidth = O.boundingBox({ includeLabels: true, includeNodes: false, includeOverlays: false }).w, B.labelHeight = O.boundingBox({ includeLabels: true, includeNodes: false, includeOverlays: false }).h, B.labelPosVertical = O.css("text-valign"), B.labelPosHorizontal = O.css("text-halign")), it[O.data("id")] = B, isNaN(B.rect.x) && (B.rect.x = 0), isNaN(B.rect.y) && (B.rect.y = 0), H != null && H.length > 0) {
                  var Q = void 0;
              ...
              for (var Y = 0, et = 0, z = 0; z < V.length; z++) {
                var O = V[z], H = it[O.data("source")], B = it[O.data("target")];
                if (H && B && H !== B && H.getEdgesBetween(B).length == 0) {
                  var _ = q.add(x.newEdge(), H, B);
                  _.id = O.id(), _.idealLength = m(v.idealEdgeLength, O), _.edgeElasticity = m(v.edgeElasticity, O), Y += _.idealLength, et++;
                }
              }
              v.idealEdgeLength != null && (et > 0 ? f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = Y / et : n(v.idealEdgeLength) ? f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50 : f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = v.idealEdgeLength, f.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST = c.DEFAULT_EDGE_LENGTH / 10, f.DEFAULT_RADIAL_SEPARATION = c.DEFAULT_EDGE_LENGTH);
            }, I = function(x, q) {
            ...
            return E(R.addRoot(), l.getTopMostNodes(b), w, v), y(w, R, Z), I(w, v), w.runLayout(), it;
          };
          ...
          var l = /* @__PURE__ */ (function() {
            function v(L, F) {
              for (var A = 0; A < F.length; A++) {
                var b = F[A];
                b.enumerable = b.enumerable || false, b.configurable = true, "value" in b && (b.writable = true), Object.defineProperty(L, b.key, b);
              }
            }
          ...
          var u = r(658), t = r(548), o = r(657), s = o.spectralLayout, c = r(816), f = c.coseLayout, T = Object.freeze({ quality: "default", randomize: true, animate: true, animationDuration: 1e3, animationEasing: void 0, fit: true, padding: 30, nodeDimensionsIncludeLabels: false, uniformNodeDimensions: false, packComponents: true, step: "all", samplingType: true, sampleSize: 25, nodeSeparation: 75, piTol: 1e-7, nodeRepulsion: function(L) {
            ...
            return l(v, [{ key: "run", value: function() {
              var F = this, A = this.options, b = A.cy, Z = A.eles, U = [], K = [], D = void 0, it = [];
              ...
              if (b.layoutUtilities && A.packComponents && (m = b.layoutUtilities("get"), m || (m = b.layoutUtilities()), p = true), Z.nodes().length > 0) if (p) {
                var I = t.getTopMostNodes(A.eles.nodes());
                if (D = t.connectComponents(b, A.eles, I), D.forEach(function(vt) {
                  ...
                  if (A.tile) {
                    ...
                    if (D.forEach(function(vt, rt) {
                      ...
                      it.push({ x: et.x1 + et.w / 2, y: et.y1 + et.h / 2 }), D.push(w), U.push(V);
                      for (var z = Y.length - 1; z >= 0; z--) D.splice(Y[z], 1), U.splice(Y[z], 1), it.splice(Y[z], 1);
                    }
                  }
                  D.forEach(function(vt, rt) {
                    A.eles = vt, K.push(f(A, U[rt])), t.relocateComponent(it[rt], K[rt], A);
                  });
                } else D.forEach(function(vt, rt) {
                ...
                if (D.length > 1) {
                  ...
                  D.forEach(function(vt, rt) {
                    var gt = void 0;
                    if (A.quality == "draft" && (gt = U[rt].nodeIndexes), vt.nodes().not(B).length > 0) {
                      var mt = {};
                      mt.edges = [], mt.nodes = [];
                      var At = void 0;
                      vt.nodes().not(B).forEach(function(Ot) {
                        if (A.quality == "draft") if (!Ot.isParent()) At = gt.get(Ot.id()), mt.nodes.push({ x: U[rt].xCoords[At] - Ot.boundingbox().w / 2, y: U[rt].yCoords[At] - Ot.boundingbox().h / 2, width: Ot.boundingbox().w, height: Ot.boundingbox().h });
                        else {
                          var Et = t.calcBoundingBox(Ot, U[rt].xCoords, U[rt].yCoords, gt);
                          mt.nodes.push({ x: Et.topLeftX, y: Et.topLeftY, width: Et.width, height: Et.height });
                        }
                        else K[rt][Ot.id()] && mt.nodes.push({ x: K[rt][Ot.id()].getLeft(), y: K[rt][Ot.id()].getTop(), width: K[rt][Ot.id()].getWidth(), height: K[rt][Ot.id()].getHeight() });
                      }), vt.edges().forEach(function(Ot) {
                        var Et = Ot.source(), Dt = Ot.target();
                        if (Et.css("display") != "none" && Dt.css("display") != "none") if (A.quality == "draft") {
                          var Rt = gt.get(Et.id()), Ht = gt.get(Dt.id()), Ut = [], Pt = [];
                          if (Et.isParent()) {
                            var Ft = t.calcBoundingBox(Et, U[rt].xCoords, U[rt].yCoords, gt);
                            Ut.push(Ft.topLeftX + Ft.width / 2), Ut.push(Ft.topLeftY + Ft.height / 2);
                          } else Ut.push(U[rt].xCoords[Rt]), Ut.push(U[rt].yCoords[Rt]);
                          if (Dt.isParent()) {
                            var Yt = t.calcBoundingBox(Dt, U[rt].xCoords, U[rt].yCoords, gt);
                            Pt.push(Yt.topLeftX + Yt.width / 2), Pt.push(Yt.topLeftY + Yt.height / 2);
                          } else Pt.push(U[rt].xCoords[Ht]), Pt.push(U[rt].yCoords[Ht]);
                          mt.edges.push({ startX: Ut[0], startY: Ut[1], endX: Pt[0], endY: Pt[1] });
                        } else K[rt][Et.id()] && K[rt][Dt.id()] && mt.edges.push({ startX: K[rt][Et.id()].getCenterX(), startY: K[rt][Et.id()].getCenterY(), endX: K[rt][Dt.id()].getCenterX(), endY: K[rt][Dt.id()].getCenterY() });
                      }), mt.nodes.length > 0 && (H.push(mt), O.add(rt));
                    }
                  });
                  var _ = m.packComponents(H, A.randomize).shifts;
                  if (A.quality == "draft") U.forEach(function(vt, rt) {
                ...
                if (it.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), A.randomize) {
                  var y = s(A);
                  U.push(y);
                }
                A.quality == "default" || A.quality == "proof" ? (K.push(f(A, U[0])), t.relocateComponent(it[0], K[0], A)) : t.relocateComponent(it[0], U[0], A);
              }
              var Q = function(rt, gt) {
                if (A.quality == "default" || A.quality == "proof") {
                  ...
                  }), A.nodeDimensionsIncludeLabels && (At.labelWidth && (At.labelPosHorizontal == "left" ? mt.x += At.labelWidth / 2 : At.labelPosHorizontal == "right" && (mt.x -= At.labelWidth / 2)), At.labelHeight && (At.labelPosVertical == "top" ? mt.y += At.labelHeight / 2 : At.labelPosVertical == "bottom" && (mt.y -= At.labelHeight / 2))), mt == null && (mt = { x: rt.position("x"), y: rt.position("y") }), { x: mt.x, y: mt.y };
                } else {
                  var Et = void 0;
                  return U.forEach(function(Dt) {
                    var Rt = Dt.nodeIndexes.get(rt.id());
                    Rt != null && (Et = { x: Dt.xCoords[Rt], y: Dt.yCoords[Rt] });
                  }), Et == null && (Et = { x: rt.position("x"), y: rt.position("y") }), { x: Et.x, y: Et.y };
                }
              };
              if (A.quality == "default" || A.quality == "proof" || A.randomize) {
                var It = t.calcParentsWithoutChildren(b, Z), Nt = Z.filter(function(vt) {
                  return vt.css("display") == "none";
                });
                A.eles = Z.not(Nt), Z.nodes().not(":parent").not(Nt).layoutPositions(F, A, Q), It.length > 0 && It.forEach(function(vt) {
                  vt.position(Q(vt));
                });
          ...
          var l = r(548), i = r(140).layoutBase.Matrix, u = r(140).layoutBase.SVD, t = function(s) {
            var c = s.cy, f = s.eles, T = f.nodes(), g = f.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), A = [], b = [], Z = [], U = [], K = [], D = [], it = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, I = s.samplingType, w = s.nodeSeparation, R = void 0, W = function() {
              for (var P = 0, $ = 0, J = false; $ < R; ) {
                P = Math.floor(Math.random() * m), J = false;
                for (var k = 0; k < $; k++) if (U[k] == P) {
                  J = true;
                  break;
                }
                if (!J) U[$] = P, $++;
              ...
              for (var k = [], at = 0, ct = 0, nt = 0, tt = void 0, j = [], ut = 0, Mt = 1, pt = 0; pt < m; pt++) j[pt] = p;
              for (k[ct] = P, j[P] = 0; ct >= at; ) {
                nt = k[at++];
                for (var xt = A[nt], lt = 0; lt < xt.length; lt++) tt = L.get(xt[lt]), j[tt] == p && (j[tt] = j[nt] + 1, k[++ct] = tt);
                D[nt][$] = j[nt] * w;
              }
              if (J) {
                for (var ot = 0; ot < m; ot++) D[ot][$] < K[ot] && (K[ot] = D[ot][$]);
              ...
              if (P) {
                ...
                for (var at = 0; at < R; at++) U[at] = $, $ = x($, at, P);
              } else {
                W();
                for (var J = 0; J < R; J++) x(U[J], J, P);
              }
              for (var ct = 0; ct < m; ct++) for (var nt = 0; nt < R; nt++) D[ct][nt] *= D[ct][nt];
              for (var tt = 0; tt < R; tt++) it[tt] = [];
              for (var j = 0; j < R; j++) for (var ut = 0; ut < R; ut++) it[j][ut] = D[U[ut]][j];
            }, V = function() {
              for (var P = u.svd(it), $ = P.S, J = P.U, k = P.V, at = $[0] * $[0] * $[0], ct = [], nt = 0; nt < R; nt++) {
                ct[nt] = [];
                for (var tt = 0; tt < R; tt++) ct[nt][tt] = 0, nt == tt && (ct[nt][tt] = $[nt] / ($[nt] * $[nt] + at / ($[nt] * $[nt])));
              }
              n = i.multMat(i.multMat(k, ct), i.transpose(J));
            }, Y = function() {
              for (var P = void 0, $ = void 0, J = [], k = [], at = [], ct = [], nt = 0; nt < m; nt++) J[nt] = Math.random(), k[nt] = Math.random();
              J = i.normalize(J), k = i.normalize(k);
              for (var tt = E, j = E, ut = void 0; ; ) {
                for (var Mt = 0; Mt < m; Mt++) at[Mt] = J[Mt];
                if (J = i.multGamma(i.multL(i.multGamma(at), D, n)), P = i.dotProduct(at, J), J = i.normalize(J), tt = i.dotProduct(at, J), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1) break;
                j = tt;
              }
              for (var pt = 0; pt < m; pt++) at[pt] = J[pt];
              for (j = E; ; ) {
                for (var xt = 0; xt < m; xt++) ct[xt] = k[xt];
                if (ct = i.minusOp(ct, i.multCons(at, i.dotProduct(at, ct))), k = i.multGamma(i.multL(i.multGamma(ct), D, n)), $ = i.dotProduct(ct, k), k = i.normalize(k), tt = i.dotProduct(ct, k), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1) break;
                j = tt;
              }
              for (var lt = 0; lt < m; lt++) ct[lt] = k[lt];
              b = i.multCons(at, Math.sqrt(Math.abs(P))), Z = i.multCons(ct, Math.sqrt(Math.abs($)));
            };
            l.connectComponents(c, f, l.getTopMostNodes(T), v), g.forEach(function(S) {
              l.connectComponents(c, f, l.getTopMostNodes(S.descendants().intersection(f)), v);
            });
            for (var et = 0, z = 0; z < T.length; z++) T[z].isParent() || L.set(T[z].id(), et++);
            var O = true, H = false, B = void 0;
            try {
              for (var _ = v.keys()[Symbol.iterator](), ht; !(O = (ht = _.next()).done); O = true) {
                var Q = ht.value;
                L.set(Q, et++);
              }
            } catch (S) {
            ...
            g.forEach(function(S) {
              for (var P = S.children().intersection(f); P.nodes(":childless").length == 0; ) P = P.nodes()[0].children().intersection(f);
              var $ = 0, J = P.nodes(":childless")[0].connectedEdges().length;
              P.nodes(":childless").forEach(function(k, at) {
                k.connectedEdges().length < J && (J = k.connectedEdges().length, $ = at);
              }), F.set(S.id(), P.nodes(":childless")[$].id());
            }), T.forEach(function(S) {
              var P = void 0;
              S.isParent() ? P = L.get(F.get(S.id())) : P = L.get(S.id()), S.neighborhood().nodes().forEach(function($) {
                f.intersection(S.edgesWith($)).length > 0 && ($.isParent() ? A[P].push(F.get($.id())) : A[P].push($.id()));
              });
            });
            var Nt = function(P) {
              var $ = L.get(P), J = void 0;
              v.get(P).forEach(function(k) {
                c.getElementById(k).isParent() ? J = F.get(k) : J = k, A[$].push(J), A[L.get(J)].push(P);
              });
            ...
            if (m > 2) {
              ...
              return s.quality == "draft" || s.step == "all" ? (q(I), V(), Y(), Et = { nodeIndexes: L, xCoords: b, yCoords: Z }) : (L.forEach(function(S, P) {
                b.push(c.getElementById(P).position("x")), Z.push(c.getElementById(P).position("y"));
              }), Et = { nodeIndexes: L, xCoords: b, yCoords: Z }), Et;
            } else {
...
var pr = vr();
const yr = $e(pr);
var De = { L: "left", R: "right", T: "top", B: "bottom" }, xe = { L: dt((C) => `${C},${C / 2} 0,${C} 0,0`, "L"), R: dt((C) => `0,${C / 2} ${C},0 ${C},${C}`, "R"), T: dt((C) => `0,0 ${C},0 ${C / 2},${C}`, "T"), B: dt((C) => `${C / 2},0 ${C},${C} 0,${C}`, "B") }, oe = { L: dt((C, X) => C - X + 2, "L"), R: dt((C, X) => C - 2, "R"), T: dt((C, X) => C - X + 2, "T"), B: dt((C, X) => C - 2, "B") }, Er = dt(function(C) {
  return Wt(C) ? C === "L" ? "R" : "L" : C === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), Ie = dt(function(C) {
  const X = C;
  return X === "L" || X === "R" || X === "T" || X === "B";
}, "isArchitectureDirection"), Wt = dt(function(C) {
  const X = C;
  return X === "L" || X === "R";
}, "isArchitectureDirectionX"), qt = dt(function(C) {
  const X = C;
  return X === "T" || X === "B";
}, "isArchitectureDirectionY"), me = dt(function(C, X) {
  const M = Wt(C) && qt(X), G = qt(C) && Wt(X);
  return M || G;
}, "isArchitectureDirectionXY"), mr = dt(function(C) {
  const X = C[0], M = C[1], G = Wt(X) && qt(M), N = qt(X) && Wt(M);
  return G || N;
}, "isArchitecturePairXY"), Tr = dt(function(C) {
  return C !== "LL" && C !== "RR" && C !== "TT" && C !== "BB";
}, "isValidArchitectureDirectionPair"), pe = dt(function(C, X) {
  const M = `${C}${X}`;
  return Tr(M) ? M : void 0;
}, "getArchitectureDirectionPair"), Nr = dt(function([C, X], M) {
  const G = M[0], N = M[1];
  return Wt(G) ? qt(N) ? [C + (G === "L" ? -1 : 1), X + (N === "T" ? 1 : -1)] : [C + (G === "L" ? -1 : 1), X] : Wt(N) ? [C + (N === "L" ? 1 : -1), X + (G === "T" ? 1 : -1)] : [C, X + (G === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Lr = dt(function(C) {
  return C === "LT" || C === "TL" ? [1, 1] : C === "BL" || C === "LB" ? [1, -1] : C === "BR" || C === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Cr = dt(function(C, X) {
  return me(C, X) ? "bend" : Wt(C) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), Ar = dt(function(C) {
  return C.type === "service";
}, "isArchitectureService"), Mr = dt(function(C) {
  return C.type === "junction";
}, "isArchitectureJunction"), Fe = dt((C) => C.data(), "edgeData"), ie = dt((C) => C.data(), "nodeData"), wr = ir.architecture, be = (_a = class {
  constructor() {
  ...
  addService({ id: C, icon: X, in: M, title: G, iconText: N }) {
    ...
    if (M !== void 0) {
      ...
      if (this.registeredIds[M] === void 0) throw new Error(`The service [${C}]'s parent does not exist. Please make sure the parent is created before this service`);
      if (this.registeredIds[M] === "node") throw new Error(`The service [${C}]'s parent is not a group`);
    }
    this.registeredIds[C] = "node", this.nodes[C] = { id: C, type: "service", icon: X, iconText: N, title: G, edges: [], in: M };
  }
  getServices() {
    return Object.values(this.nodes).filter(Ar);
  }
  addJunction({ id: C, in: X }) {
    this.registeredIds[C] = "node", this.nodes[C] = { id: C, type: "junction", edges: [], in: X };
  }
  getJunctions() {
  ...
  addGroup({ id: C, icon: X, in: M, title: G }) {
    ...
    if (M !== void 0) {
      ...
      if (((_b = this.registeredIds) == null ? void 0 : _b[M]) === void 0) throw new Error(`The group [${C}]'s parent does not exist. Please make sure the parent is created before this group`);
      if (((_c = this.registeredIds) == null ? void 0 : _c[M]) === "node") throw new Error(`The group [${C}]'s parent is not a group`);
    }
  ...
  addEdge({ lhsId: C, rhsId: X, lhsDir: M, rhsDir: G, lhsInto: N, rhsInto: d, lhsGroup: h, rhsGroup: a, title: e }) {
    if (!Ie(M)) throw new Error(`Invalid direction given for left hand side of edge ${C}--${X}. Expected (L,R,T,B) got ${String(M)}`);
    if (!Ie(G)) throw new Error(`Invalid direction given for right hand side of edge ${C}--${X}. Expected (L,R,T,B) got ${String(G)}`);
    ...
    if (this.nodes[X] === void 0 && this.groups[X] === void 0) throw new Error(`The right-hand id [${X}] does not yet exist. Please create the service/group before declaring an edge to it.`);
    const r = this.nodes[C].in, l = this.nodes[X].in;
    if (h && r && l && r == l) throw new Error(`The left-hand id [${C}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
    if (a && r && l && r == l) throw new Error(`The right-hand id [${X}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
    const i = { lhsId: C, lhsDir: M, lhsInto: N, lhsGroup: h, rhsId: X, rhsDir: G, rhsInto: d, rhsGroup: a, title: e };
    this.edges.push(i), this.nodes[C] && this.nodes[X] && (this.nodes[C].edges.push(this.edges[this.edges.length - 1]), this.nodes[X].edges.push(this.edges[this.edges.length - 1]));
  }
  getEdges() {
    return this.edges;
  }
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const C = {}, X = Object.entries(this.nodes).reduce((a, [e, r]) => (a[e] = r.edges.reduce((l, i) => {
        var _a2, _b;
        const u = (_a2 = this.getNode(i.lhsId)) == null ? void 0 : _a2.in, t = (_b = this.getNode(i.rhsId)) == null ? void 0 : _b.in;
        if (u && t && u !== t) {
          const o = Cr(i.lhsDir, i.rhsDir);
          o !== "bend" && (C[u] ?? (C[u] = {}), C[u][t] = o, C[t] ?? (C[t] = {}), C[t][u] = o);
        }
        if (i.lhsId === e) {
        ...
        return l;
      }, {}), a), {}), M = Object.keys(X)[0], G = { [M]: 1 }, N = Object.keys(X).reduce((a, e) => e === M ? a : { ...a, [e]: 1 }, {}), d = dt((a) => {
        const e = { [a]: [0, 0] }, r = [a];
        for (; r.length > 0; ) {
          const l = r.shift();
          if (l) {
  ...
  getConfig() {
    return er({ ...wr, ...rr().architecture });
  }
  getConfigField(C) {
    return this.getConfig()[C];
  }
}, dt(_a, "ArchitectureDB"), _a), Or = dt((C, X) => {
  hr(C, X), C.groups.map((M) => X.addGroup(M)), C.services.map((M) => X.addService({ ...M, type: "service" })), C.junctions.map((M) => X.addJunction({ ...M, type: "junction" })), C.edges.map((M) => X.addEdge(M));
}, "populateDb"), Pe = { parser: { yy: void 0 }, parse: dt(async (C) => {
  var _a2;
  const X = await lr("architecture", C);
  Re.debug(X);
  const M = (_a2 = Pe.parser) == null ? void 0 : _a2.yy;
  if (!(M instanceof be)) throw new Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
  Or(X, M);
}, "parse") }, Dr = dt((C) => `
  .edge {
...
}, "drawEdges"), Rr = dt(async function(C, X, M) {
  const N = M.getConfigField("padding") * 0.75, d = M.getConfigField("fontSize"), a = M.getConfigField("iconSize") / 2;
  await Promise.all(X.nodes().map(async (e) => {
    const r = ie(e);
    if (r.type === "group") {
      const { h: l, w: i, x1: u, y1: t } = e.boundingBox();
      C.append("rect").attr("x", u + a).attr("y", t + a).attr("width", i).attr("height", l).attr("class", "node-bkg");
      const o = C.append("g");
      let s = u, c = t;
      if (r.icon) {
        const f = o.append("g");
        f.html(`<g>${await ve(r.icon, { height: N, width: N, fallbackPrefix: ae.prefix })}</g>`), f.attr("transform", "translate(" + (s + a + 1) + ", " + (c + a + 1) + ")"), s += N, c += d / 2 - 1 - 2;
      }
      if (r.label) {
        const f = o.append("g");
        await Ee(f, r.label, { useHtmlLabels: false, width: i, classes: "architecture-service-label" }, ye()), f.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), f.attr("transform", "translate(" + (s + a + 4) + ", " + (c + a + 2) + ")");
      }
    }
  }));
}, "drawGroups"), Sr = dt(async function(C, X, M) {
  const G = ye();
  for (const N of M) {
    const d = X.append("g"), h = C.getConfigField("iconSize");
    if (N.title) {
      const l = d.append("g");
      await Ee(l, N.title, { useHtmlLabels: false, width: h * 1.5, classes: "architecture-service-label" }, G), l.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), l.attr("transform", "translate(" + h / 2 + ", " + h + ")");
    }
    const a = d.append("g");
    if (N.icon) a.html(`<g>${await ve(N.icon, { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`);
    else if (N.iconText) {
      a.html(`<g>${await ve("blank", { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`);
      const u = a.append("g").append("foreignObject").attr("width", h).attr("height", h).append("div").attr("class", "node-icon-text").attr("style", `height: ${h}px;`).append("div").html(ar(N.iconText, G)), t = parseInt(window.getComputedStyle(u.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
    ...
    d.attr("class", "architecture-service");
    const { width: e, height: r } = d._groups[0][0].getBBox();
    N.width = e, N.height = r, C.setElementForId(N.id, d);
  }
  return 0;
}, "drawServices"), Fr = dt(function(C, X, M) {
  M.forEach((G) => {
    const N = X.append("g"), d = C.getConfigField("iconSize");
    N.append("g").append("rect").attr("id", "node-" + G.id).attr("fill-opacity", "0").attr("width", d).attr("height", d), N.attr("class", "architecture-junction");
...
function Ge(C, X, M) {
  C.forEach((G) => {
    X.add({ group: "nodes", data: { type: "service", id: G.id, icon: G.icon, label: G.title, parent: G.in, width: M.getConfigField("iconSize"), height: M.getConfigField("iconSize") }, classes: "node-service" });
  });
}
dt(Ge, "addServices");
function Ue(C, X, M) {
  C.forEach((G) => {
    X.add({ group: "nodes", data: { type: "junction", id: G.id, parent: G.in, width: M.getConfigField("iconSize"), height: M.getConfigField("iconSize") }, classes: "node-junction" });
  });
}
dt(Ue, "addJunctions");
function Ye(C, X) {
  X.nodes().map((M) => {
    ...
    G.x = M.position().x, G.y = M.position().y, C.getElementById(G.id).attr("transform", "translate(" + (G.x || 0) + "," + (G.y || 0) + ")");
  });
}
dt(Ye, "positionNodes");
function Xe(C, X) {
  C.forEach((M) => {
    X.add({ group: "nodes", data: { type: "group", id: M.id, icon: M.icon, label: M.title, parent: M.in }, classes: "node-group" });
  });
}
dt(Xe, "addGroups");
function He(C, X) {
  C.forEach((M) => {
    const { lhsId: G, rhsId: N, lhsInto: d, lhsGroup: h, rhsInto: a, lhsDir: e, rhsDir: r, rhsGroup: l, title: i } = M, u = me(M.lhsDir, M.rhsDir) ? "segments" : "straight", t = { id: `${G}-${N}`, label: i, source: G, sourceDir: e, sourceArrow: d, sourceGroup: h, sourceEndpoint: e === "L" ? "0 50%" : e === "R" ? "100% 50%" : e === "T" ? "50% 0" : "50% 100%", target: N, targetDir: r, targetArrow: a, targetGroup: l, targetEndpoint: r === "L" ? "0 50%" : r === "R" ? "100% 50%" : r === "T" ? "50% 0" : "50% 100%" };
    X.add({ group: "edges", data: t, classes: u });
  });
}
dt(He, "addEdges");
function We(C, X, M) {
  const G = dt((a, e) => Object.entries(a).reduce((r, [l, i]) => {
    var _a2;
    let u = 0;
    const t = Object.entries(i);
    if (t.length === 1) return r[l] = t[0][1], r;
    for (let o = 0; o < t.length - 1; o++) for (let s = o + 1; s < t.length; s++) {
      const [c, f] = t[o], [T, g] = t[s];
      if (((_a2 = M[c]) == null ? void 0 : _a2[T]) === e) r[l] ?? (r[l] = []), r[l] = [...r[l], ...f, ...g];
      else if (c === "default" || T === "default") r[l] ?? (r[l] = []), r[l] = [...r[l], ...f, ...g];
      else {
        const L = `${l}-${u++}`;
        r[L] = f;
        const F = `${l}-${u++}`;
    ...
    const e = {}, r = {};
    return Object.entries(a).forEach(([l, [i, u]]) => {
      var _a2, _b, _c;
      const t = ((_a2 = C.getNode(l)) == null ? void 0 : _a2.in) ?? "default";
      e[u] ?? (e[u] = {}), (_b = e[u])[t] ?? (_b[t] = []), e[u][t].push(l), r[i] ?? (r[i] = {}), (_c = r[i])[t] ?? (_c[t] = []), r[i][t].push(l);
    }), { horiz: Object.values(G(e, "horizontal")).filter((l) => l.length > 1), vert: Object.values(G(r, "vertical")).filter((l) => l.length > 1) };
  }), [d, h] = N.reduce(([a, e], { horiz: r, vert: l }) => [[...a, ...r], [...e, ...l]], [[], []]);
  return { horizontal: d, vertical: h };
}
dt(We, "getAlignments");
function Ve(C, X) {
  const M = [], G = dt((d) => `${d[0]},${d[1]}`, "posToStr"), N = dt((d) => d.split(",").map((h) => parseInt(h)), "strToPos");
  return C.forEach((d) => {
    const h = Object.fromEntries(Object.entries(d).map(([l, i]) => [G(i), l])), a = [G([0, 0])], e = {}, r = { L: [-1, 0], R: [1, 0], T: [0, 1], B: [0, -1] };
    for (; a.length > 0; ) {
      const l = a.shift();
      if (l) {
        e[l] = 1;
        ...
        if (i) {
          ...
          Object.entries(r).forEach(([t, o]) => {
            const s = G([u[0] + o[0], u[1] + o[1]]), c = h[s];
            c && !e[s] && (a.push(s), M.push({ [De[t]]: c, [De[Er(t)]]: i, gap: 1.5 * X.getConfigField("iconSize") }));
          });
        }
      }
    }
...
function ze(C, X, M, G, N, { spatialMaps: d, groupAlignments: h }) {
  return new Promise((a) => {
    ...
    u.one("layoutstop", () => {
      ...
      function t(o, s, c, f) {
        let T, g;
        const { x: v, y: L } = o, { x: F, y: A } = s;
        g = (f - L + (v - c) * (L - A) / (v - F)) / Math.sqrt(1 + Math.pow((L - A) / (v - F), 2)), T = Math.sqrt(Math.pow(f - L, 2) + Math.pow(c - v, 2) - Math.pow(g, 2));
      ...
      for (const o of Object.values(r.edges())) if ((_a2 = o.data) == null ? void 0 : _a2.call(o)) {
        const { x: s, y: c } = o.source().position(), { x: f, y: T } = o.target().position();
        if (s !== f && c !== T) {
          const g = o.sourceEndpoint(), v = o.targetEndpoint(), { sourceDir: L } = Fe(o), [F, A] = qt(L) ? [g.x, v.y] : [v.x, g.y], { weights: b, distances: Z } = t(g, v, F, A);
...
var br = dt(async (C, X, M, G) => {
  const N = G.db, d = N.getServices(), h = N.getJunctions(), a = N.getGroups(), e = N.getEdges(), r = N.getDataStructures(), l = ke(X), i = l.append("g");
  i.attr("class", "architecture-edges");
  const u = l.append("g");
  u.attr("class", "architecture-services");
  const t = l.append("g");
  t.attr("class", "architecture-groups"), await Sr(N, u, d), Fr(N, u, h);
  const o = await ze(d, h, a, e, N, r);
  await Ir(i, o, N), await Rr(t, o, N), Ye(N, o), Ze(void 0, l, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Pr = { draw: br }, zr = { parser: Pe, get db() {
  return new be();
}, renderer: Pr, styles: xr };
export {
  zr as diagram
};
