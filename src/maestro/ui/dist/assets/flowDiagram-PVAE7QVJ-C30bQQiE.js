var _a;
import { g as Yt } from "./chunk-FMBD7UC4-MUrOfgVf.js";
import { _ as A, n as Pt, l as $, c as g1, d as E1, o as qt, r as Ht, u as st, b as Xt, s as Qt, p as Jt, a as Zt, g as $t, q as te, k as ee, t as se, J as ie, v as re, x as et, y as ae, z as ne, A as ue } from "./index-CTgvlc8H.js";
import { g as oe } from "./chunk-55IACEB6-D1tq2uLy.js";
import { s as le } from "./chunk-QN33PNHL-CGhG7p2a.js";
import { c as ce } from "./channel-B440EG6p.js";
var he = "flowchart-", de = (_a = class {
  constructor() {
    this.vertexCounter = 0, this.config = g1(), this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = true, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = Xt, this.setAccDescription = Qt, this.setDiagramTitle = Jt, this.getAccTitle = Zt, this.getAccDescription = $t, this.getDiagramTitle = te, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen("gen-2");
  }
  sanitizeText(t) {
...
` + b + `
    ...
    if (p) {
      const D = u;
      (D == null ? void 0 : D.animate) !== void 0 && (p.animate = D.animate), (D == null ? void 0 : D.animation) !== void 0 && (p.animation = D.animation), (D == null ? void 0 : D.curve) !== void 0 && (p.interpolate = D.curve);
      return;
    }
    let S, g = this.vertices.get(t);
    if (g === void 0 && (g = { id: t, labelType: "text", domId: he + t + "-" + this.vertexCounter, styles: [], classes: [] }, this.vertices.set(t, g)), this.vertexCounter++, i !== void 0 ? (this.config = g1(), S = this.sanitizeText(i.text.trim()), g.labelType = i.type, S.startsWith('"') && S.endsWith('"') && (S = S.substring(1, S.length - 1)), g.text = S) : g.text === void 0 && (g.text = t), r !== void 0 && (g.type = r), a == null ? void 0 : a.forEach((D) => {
      g.styles.push(D);
    }), o == null ? void 0 : o.forEach((D) => {
      g.classes.push(D);
      ...
      if (u.shape) {
        ...
        g.type = u == null ? void 0 : u.shape;
      }
      (u == null ? void 0 : u.label) && (g.text = u == null ? void 0 : u.label), (u == null ? void 0 : u.icon) && (g.icon = u == null ? void 0 : u.icon, !((_a2 = u.label) == null ? void 0 : _a2.trim()) && g.text === t && (g.text = "")), (u == null ? void 0 : u.form) && (g.form = u == null ? void 0 : u.form), (u == null ? void 0 : u.pos) && (g.pos = u == null ? void 0 : u.pos), (u == null ? void 0 : u.img) && (g.img = u == null ? void 0 : u.img, !((_b = u.label) == null ? void 0 : _b.trim()) && g.text === t && (g.text = "")), (u == null ? void 0 : u.constraint) && (g.constraint = u.constraint), u.w && (g.assetWidth = Number(u.w)), u.h && (g.assetHeight = Number(u.h));
    }
  }
  addSingleLink(t, i, r, a) {
    const l = { start: t, end: i, type: void 0, text: "", labelType: "text", classes: [], isUserDefinedId: false, interpolate: this.edges.defaultInterpolate };
    $.info("abc78 Got edge...", l);
    const b = r.text;
    if (b !== void 0 && (l.text = this.sanitizeText(b.text.trim()), l.text.startsWith('"') && l.text.endsWith('"') && (l.text = l.text.substring(1, l.text.length - 1)), l.labelType = b.type), r !== void 0 && (l.type = r.type, l.stroke = r.stroke, l.length = r.length > 10 ? 10 : r.length), a && !this.edges.some((u) => u.id === a)) l.id = a, l.isUserDefinedId = true;
    else {
      const u = this.edges.filter((p) => p.start === l.start && p.end === l.end);
      u.length === 0 ? l.id = et(l.start, l.end, { counter: 0, prefix: "L" }) : l.id = et(l.start, l.end, { counter: u.length + 1, prefix: "L" });
    }
    if (this.edges.length < (this.config.maxEdges ?? 500)) $.info("Pushing edge..."), this.edges.push(l);
...
You have to call mermaid.initialize.`);
  ...
  addLink(t, i, r) {
    ...
    $.info("addLink", t, i, a);
    for (const o of t) for (const d of i) {
  ...
  updateLink(t, i) {
    t.forEach((r) => {
      ...
      r === "default" ? this.edges.defaultStyle = i : (this.edges[r].style = i, (((_b = (_a2 = this.edges[r]) == null ? void 0 : _a2.style) == null ? void 0 : _b.length) ?? 0) > 0 && !((_d = (_c = this.edges[r]) == null ? void 0 : _c.style) == null ? void 0 : _d.some((a) => a == null ? void 0 : a.startsWith("fill"))) && ((_f = (_e = this.edges[r]) == null ? void 0 : _e.style) == null ? void 0 : _f.push("fill:none")));
    });
  }
  addClass(t, i) {
    ...
    t.split(",").forEach((a) => {
      ...
      o === void 0 && (o = { id: a, styles: [], textStyles: [] }, this.classes.set(a, o)), r == null ? void 0 : r.forEach((d) => {
        if (/color/.exec(d)) {
  ...
  setTooltip(t, i) {
    if (i !== void 0) {
      ...
      for (const r of t.split(",")) this.tooltips.set(this.version === "gen-1" ? this.lookUpDomId(r) : r, i);
    }
  }
  setClickFun(t, i, r) {
  ...
  setupToolTips(t) {
    ...
    (i._groups || i)[0][0] === null && (i = E1("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), E1(t).select("svg").selectAll("g.node").on("mouseover", (o) => {
      ...
      const b = (_a2 = o.currentTarget) == null ? void 0 : _a2.getBoundingClientRect();
      i.transition().duration(200).style("opacity", ".9"), i.text(d.attr("title")).style("left", window.scrollX + b.left + (b.right - b.left) / 2 + "px").style("top", window.scrollY + b.bottom + "px"), i.html(i.html().replace(/&lt;br\/&gt;/g, "<br/>")), d.classed("hover", true);
    }).on("mouseout", (o) => {
      i.transition().duration(500).style("opacity", 0), E1(o.currentTarget).classed("hover", false);
    });
  }
  clear(t = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = true, this.version = t, this.config = g1(), ae();
  }
  setGen(t) {
  ...
  addSubGraph(t, i, r) {
    ...
    const l = A((g) => {
      ...
      return { nodeList: g.filter(function(U) {
        const J = typeof U;
        return U.stmt && U.stmt === "dir" ? (x = U.value, false) : U.trim() === "" ? false : J in D ? D[J].hasOwnProperty(U) ? false : D[J][U] = true : K.includes(U) ? false : K.push(U);
      }), dir: x };
    }, "uniq")(i.flat()), b = l.nodeList;
    let u = l.dir;
    const p = g1().flowchart ?? {};
    if (u = u ?? (p.inheritDir ? this.getDirection() ?? g1().direction ?? void 0 : void 0), this.version === "gen-1") for (let g = 0; g < b.length; g++) b[g] = this.lookUpDomId(b[g]);
  ...
  indexNodes2(t, i) {
    ...
    for (; a < r.length; ) {
      ...
      if (d >= 0) {
        ...
        if (l.result) return { result: true, count: o + l.count };
        o = o + l.count;
      }
      a = a + 1;
    }
    return { result: false, count: o };
  }
  getDepthFirstPos(t) {
  ...
  destructLink(t, i) {
    ...
    let a;
    if (i) {
      if (a = this.destructStartLink(i), a.stroke !== r.stroke) return { type: "INVALID", stroke: "INVALID" };
  ...
  exists(t, i) {
    for (const r of t) if (r.nodes.includes(i)) return true;
    return false;
  }
  makeUniq(t, i) {
    const r = [];
  ...
  addNodeFromVertex(t, i, r, a, o, d) {
    var _a2;
    const l = r.get(t.id), b = a.get(t.id) ?? false, u = this.findNode(i, t.id);
    if (u) u.cssStyles = t.styles, u.cssCompiledStyles = this.getCompiledStyles(t.classes), u.cssClasses = t.classes.join(" ");
    else {
      const p = { id: t.id, label: t.text, labelStyle: "", parentId: l, padding: ((_a2 = o.flowchart) == null ? void 0 : _a2.padding) || 8, cssStyles: t.styles, cssCompiledStyles: this.getCompiledStyles(["default", "node", ...t.classes]), cssClasses: "default " + t.classes.join(" "), dir: t.dir, domId: t.domId, look: d, link: t.link, linkTarget: t.linkTarget, tooltip: this.getTooltip(t.id), icon: t.icon, pos: t.pos, img: t.img, assetWidth: t.assetWidth, assetHeight: t.assetHeight, constraint: t.constraint };
      b ? i.push({ ...p, isGroup: true, shape: "rect" }) : i.push({ ...p, isGroup: false, shape: this.getTypeFromVertex(t) });
    }
  }
  getCompiledStyles(t) {
    let i = [];
    for (const r of t) {
      ...
      (a == null ? void 0 : a.styles) && (i = [...i, ...a.styles ?? []].map((o) => o.trim())), (a == null ? void 0 : a.textStyles) && (i = [...i, ...a.textStyles ?? []].map((o) => o.trim()));
    }
    return i;
  }
  getData() {
    ...
    for (let u = a.length - 1; u >= 0; u--) {
      const p = a[u];
      p.nodes.length > 0 && d.set(p.id, true);
      for (const S of p.nodes) o.set(S, p.id);
    }
    for (let u = a.length - 1; u >= 0; u--) {
      const p = a[u];
      i.push({ id: p.id, label: p.title, labelStyle: "", parentId: o.get(p.id), padding: 8, cssCompiledStyles: this.getCompiledStyles(p.classes), cssClasses: p.classes.join(" "), shape: "rect", dir: p.dir, isGroup: true, look: t.look });
    }
    this.getVertices().forEach((u) => {
      this.addNodeFromVertex(u, i, o, d, t, t.look || "classic");
    });
    const b = this.getEdges();
    return b.forEach((u, p) => {
      var _a2;
      const { arrowTypeStart: S, arrowTypeEnd: g } = this.destructEdgeType(u.type), D = [...b.defaultStyle ?? []];
      u.style && D.push(...u.style);
      const K = { id: et(u.start, u.end, { counter: p, prefix: "L" }, u.id), isUserDefinedId: u.isUserDefinedId, start: u.start, end: u.end, type: u.type ?? "normal", label: u.text, labelpos: "c", thickness: u.stroke, minlen: u.length, classes: (u == null ? void 0 : u.stroke) === "invisible" ? "" : "edge-thickness-normal edge-pattern-solid flowchart-link", arrowTypeStart: (u == null ? void 0 : u.stroke) === "invisible" || (u == null ? void 0 : u.type) === "arrow_open" ? "none" : S, arrowTypeEnd: (u == null ? void 0 : u.stroke) === "invisible" || (u == null ? void 0 : u.type) === "arrow_open" ? "none" : g, arrowheadStyle: "fill: #333", cssCompiledStyles: this.getCompiledStyles(u.classes), labelStyle: D, style: D, pattern: u.stroke, look: t.look, animate: u.animate, animation: u.animation, curve: u.interpolate || this.edges.defaultInterpolate || ((_a2 = t.flowchart) == null ? void 0 : _a2.curve) };
      r.push(K);
...
}, A(_a, "FlowDB"), _a), pe = A(function(t, i) {
  return i.db.getClasses();
}, "getClasses"), fe = A(async function(t, i, r, a) {
  var _a2;
  ...
  p.type = a.type, p.layoutAlgorithm = qt(l), p.layoutAlgorithm === "dagre" && l === "elk" && $.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), p.direction = g, p.nodeSpacing = (d == null ? void 0 : d.nodeSpacing) || 50, p.rankSpacing = (d == null ? void 0 : d.rankSpacing) || 50, p.markers = ["point", "circle", "cross"], p.diagramId = i, $.debug("REF1:", p), await Ht(p, S);
  const D = ((_a2 = p.config.flowchart) == null ? void 0 : _a2.diagramPadding) ?? 8;
  st.insertTitle(S, "flowchartTitleText", (d == null ? void 0 : d.titleTopMargin) || 0, a.db.getDiagramTitle()), le(S, D, "flowchart", (d == null ? void 0 : d.useMaxWidth) || false);
  ...
  var t = A(function(f1, c, h, f) {
  ...
  }, "parseError"), parse: A(function(c) {
    var h = this, f = [0], n = [], _ = [null], e = [], G1 = this.table, s = "", v = 0, It = 0, Wt = 2, Rt = 1, zt = e.slice.call(arguments, 1), M = Object.create(this.lexer), k1 = { yy: {} };
    ...
    for (var Y, m1, Q, $1, N1 = {}, q1, h1, Gt, H1; ; ) {
      if (m1 = f[f.length - 1], this.defaultActions[m1] ? Q = this.defaultActions[m1] : ((Y === null || typeof Y > "u") && (Y = Nt()), Q = G1[m1] && G1[m1][Y]), typeof Q > "u" || !Q.length || !Q[0]) {
        var tt = "";
        H1 = [];
        for (q1 in G1[m1]) this.terminals_[q1] && q1 > Wt && H1.push("'" + this.terminals_[q1] + "'");
        M.showPosition ? tt = "Parse error on line " + (v + 1) + `:
` + M.showPosition() + `
Expecting ` + H1.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : tt = "Parse error on line " + (v + 1) + ": Unexpected " + (Y == Rt ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(tt, { text: M.match, token: this.terminals_[Y] || Y, line: M.yylineno, loc: Z1, expected: H1 });
      }
      if (Q[0] instanceof Array && Q.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + m1 + ", token: " + Y);
      switch (Q[0]) {
        case 1:
          f.push(Y), _.push(M.yytext), e.push(M.yylloc), f.push(Q[1]), Y = null, It = M.yyleng, s = M.yytext, v = M.yylineno, Z1 = M.yylloc;
          break;
        case 2:
          if (h1 = this.productions_[Q[1]][1], N1.$ = _[_.length - h1], N1._$ = { first_line: e[e.length - (h1 || 1)].first_line, last_line: e[e.length - 1].last_line, first_column: e[e.length - (h1 || 1)].first_column, last_column: e[e.length - 1].last_column }, jt && (N1._$.range = [e[e.length - (h1 || 1)].range[0], e[e.length - 1].range[1]]), $1 = this.performAction.apply(N1, [s, It, v, k1.yy, Q[1], _, e].concat(zt)), typeof $1 < "u") return $1;
          h1 && (f = f.slice(0, -1 * h1 * 2), _ = _.slice(0, -1 * h1), e = e.slice(0, -1 * h1)), f.push(this.productions_[Q[1]][0]), _.push(N1.$), e.push(N1._$), Gt = G1[f[f.length - 2]][f[f.length - 1]], f.push(Gt);
          break;
        case 3:
          return true;
      }
    ...
    var f1 = { EOF: 1, parseError: A(function(h, f) {
      if (this.yy.parser) this.yy.parser.parseError(h, f);
      else throw new Error(h);
    }, "parseError"), setInput: A(function(c, h) {
      return this.yy = h || this.yy || {}, this._input = c, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: f ? (f.length === n.length ? this.yylloc.first_column : 0) + n[n.length - f.length].length - f[0].length : this.yylloc.first_column - h }, this.options.ranges && (this.yylloc.range = [_[0], _[0] + this.yyleng - h]), this.yyleng = this.yytext.length, this;
...
` + h + "^";
      ...
      for (var _ = this._currentRules(), e = 0; e < _.length; e++) if (f = this._input.match(this.rules[_[e]]), f && (!h || f[0].length > h[0].length)) {
        if (h = f, n = e, this.options.backtrack_lexer) {
          if (c = this.test_match(f, _[e]), c !== false) return c;
          if (this._backtrack) {
            h = false;
            continue;
          } else return false;
      ...
      return h ? (c = this.test_match(h, _[n]), c !== false ? c : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: A(function() {
      var h = this.next();
      return h || this.lex();
    ...
    }, "stateStackSize"), options: {}, performAction: A(function(h, f, n, _) {
      switch (n) {
        case 0:
...
var be = Mt, Ae = A((t, i) => {
  ...
  ${Yt()}
`, "getStyles"), me = ke, Te = { parser: be, get db() {
  return new de();
}, renderer: ge, styles: me, init: A((t) => {
