import { _ as s, c as xt, l as E, d as j, V as kt, W as vt, X as _t, Y as bt, B as wt, $ as St, y as Et } from "./index-CTgvlc8H.js";
import { d as nt } from "./arc-CmKg8NsT.js";
var Q = (function() {
  var n = s(function(x, r, a, c) {
    for (a = a || {}, c = x.length; c--; a[x[c]] = r) ;
    return a;
  }, "o"), t = [6, 8, 10, 11, 12, 14, 16, 17, 20, 21], e = [1, 9], l = [1, 10], i = [1, 11], d = [1, 12], h = [1, 13], f = [1, 16], m = [1, 17], p = { trace: s(function() {
  }, "trace"), yy: {}, symbols_: { error: 2, start: 3, timeline: 4, document: 5, EOF: 6, line: 7, SPACE: 8, statement: 9, NEWLINE: 10, title: 11, acc_title: 12, acc_title_value: 13, acc_descr: 14, acc_descr_value: 15, acc_descr_multiline_value: 16, section: 17, period_statement: 18, event_statement: 19, period: 20, event: 21, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "timeline", 6: "EOF", 8: "SPACE", 10: "NEWLINE", 11: "title", 12: "acc_title", 13: "acc_title_value", 14: "acc_descr", 15: "acc_descr_value", 16: "acc_descr_multiline_value", 17: "section", 20: "period", 21: "event" }, productions_: [0, [3, 3], [5, 0], [5, 2], [7, 2], [7, 1], [7, 1], [7, 1], [9, 1], [9, 2], [9, 2], [9, 1], [9, 1], [9, 1], [9, 1], [18, 1], [19, 1]], performAction: s(function(r, a, c, u, y, o, w) {
    var v = o.length - 1;
    switch (y) {
      case 1:
        return o[v - 1];
    ...
    for (var S, A, I, J, R = {}, B, M, et, O; ; ) {
      if (A = c[c.length - 1], this.defaultActions[A] ? I = this.defaultActions[A] : ((S === null || typeof S > "u") && (S = tt()), I = w[A] && w[A][S]), typeof I > "u" || !I.length || !I[0]) {
        var K = "";
        O = [];
        for (B in w[A]) this.terminals_[B] && B > W && O.push("'" + this.terminals_[B] + "'");
        g.showPosition ? K = "Parse error on line " + (N + 1) + `:
` + g.showPosition() + `
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : K = "Parse error on line " + (N + 1) + ": Unexpected " + (S == U ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(K, { text: g.match, token: this.terminals_[S] || S, line: g.yylineno, loc: $, expected: O });
      }
      if (I[0] instanceof Array && I.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + A + ", token: " + S);
      switch (I[0]) {
        case 1:
          c.push(S), y.push(g.yytext), o.push(g.yylloc), c.push(I[1]), S = null, P = g.yyleng, v = g.yytext, N = g.yylineno, $ = g.yylloc;
          break;
        case 2:
          if (M = this.productions_[I[1]][1], R.$ = y[y.length - M], R._$ = { first_line: o[o.length - (M || 1)].first_line, last_line: o[o.length - 1].last_line, first_column: o[o.length - (M || 1)].first_column, last_column: o[o.length - 1].last_column }, z && (R._$.range = [o[o.length - (M || 1)].range[0], o[o.length - 1].range[1]]), J = this.performAction.apply(R, [v, P, N, b.yy, I[1], y, o].concat(H)), typeof J < "u") return J;
    ...
    var x = { EOF: 1, parseError: s(function(a, c) {
      if (this.yy.parser) this.yy.parser.parseError(a, c);
      else throw new Error(a);
    }, "parseError"), setInput: s(function(r, a) {
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: c ? (c.length === u.length ? this.yylloc.first_column : 0) + u[u.length - c.length].length - c[0].length : this.yylloc.first_column - a }, this.options.ranges && (this.yylloc.range = [y[0], y[0] + this.yyleng - a]), this.yyleng = this.yytext.length, this;
    }, "unput"), more: s(function() {
      return this._more = true, this;
    }, "more"), reject: s(function() {
      if (this.options.backtrack_lexer) this._backtrack = true;
      else return this.parseError("Lexical error on line " + (this.yylineno + 1) + `. You can only invoke reject() in the lexer when the lexer is of the backtracking persuasion (options.backtrack_lexer = true).
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
      return this;
    }, "reject"), less: s(function(r) {
      this.unput(this.match.slice(r));
    }, "less"), pastInput: s(function() {
      var r = this.matched.substr(0, this.matched.length - this.match.length);
      return (r.length > 20 ? "..." : "") + r.substr(-20).replace(/\n/g, "");
    }, "pastInput"), upcomingInput: s(function() {
      var r = this.match;
      return r.length < 20 && (r += this._input.substr(0, 20 - r.length)), (r.substr(0, 20) + (r.length > 20 ? "..." : "")).replace(/\n/g, "");
    }, "upcomingInput"), showPosition: s(function() {
      var r = this.pastInput(), a = new Array(r.length + 1).join("-");
      return r + this.upcomingInput() + `
` + a + "^";
    }, "showPosition"), test_match: s(function(r, a) {
      var c, u, y;
      if (this.options.backtrack_lexer && (y = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (y.yylloc.range = this.yylloc.range.slice(0))), u = r[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + r[0].length }, this.yytext += r[0], this.match += r[0], this.matches = r, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(r[0].length), this.matched += r[0], c = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), c) return c;
      if (this._backtrack) {
        for (var o in y) this[o] = y[o];
        return false;
      }
      return false;
    }, "test_match"), next: s(function() {
      if (this.done) return this.EOF;
      this._input || (this.done = true);
      var r, a, c, u;
      this._more || (this.yytext = "", this.match = "");
      for (var y = this._currentRules(), o = 0; o < y.length; o++) if (c = this._input.match(this.rules[y[o]]), c && (!a || c[0].length > a[0].length)) {
        if (a = c, u = o, this.options.backtrack_lexer) {
          if (r = this.test_match(c, y[o]), r !== false) return r;
          if (this._backtrack) {
            a = false;
            continue;
          } else return false;
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
      ...
      var a = this.next();
      return a || this.lex();
    }, "lex"), begin: s(function(a) {
      this.conditionStack.push(a);
    }, "begin"), popState: s(function() {
      var a = this.conditionStack.length - 1;
      return a > 0 ? this.conditionStack.pop() : this.conditionStack[0];
    }, "popState"), _currentRules: s(function() {
      return this.conditionStack.length && this.conditionStack[this.conditionStack.length - 1] ? this.conditions[this.conditionStack[this.conditionStack.length - 1]].rules : this.conditions.INITIAL.rules;
    }, "_currentRules"), topState: s(function(a) {
      return a = this.conditionStack.length - 1 - Math.abs(a || 0), a >= 0 ? this.conditionStack[a] : "INITIAL";
    }, "topState"), pushState: s(function(a) {
      this.begin(a);
    }, "pushState"), stateStackSize: s(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: s(function(a, c, u, y) {
      switch (u) {
        case 0:
          break;
        case 1:
...
Q.parser = Q;
var Tt = Q, at = {};
wt(at, { addEvent: () => yt, addSection: () => ht, addTask: () => pt, addTaskOrg: () => gt, clear: () => ct, default: () => It, getCommonDb: () => ot, getSections: () => dt, getTasks: () => ut });
var F = "", lt = 0, X = [], G = [], V = [], ot = s(() => St, "getCommonDb"), ct = s(function() {
  X.length = 0, G.length = 0, F = "", V.length = 0, Et();
}, "clear"), ht = s(function(n) {
  F = n, X.push(n);
}, "addSection"), dt = s(function() {
  return X;
}, "getSections"), ut = s(function() {
  let n = it();
  const t = 100;
  let e = 0;
  for (; !n && e < t; ) n = it(), e++;
  return G.push(...V), G;
}, "getTasks"), pt = s(function(n, t, e) {
  const l = { id: lt++, section: F, type: F, task: n, score: t || 0, events: e ? [e] : [] };
  V.push(l);
}, "addTask"), yt = s(function(n) {
  V.find((e) => e.id === lt - 1).events.push(n);
}, "addEvent"), gt = s(function(n) {
  const t = { section: F, type: F, description: n, task: n, classes: [] };
  G.push(t);
}, "addTaskOrg"), it = s(function() {
  const n = s(function(e) {
    return V[e].processed;
  }, "compileTask");
  let t = true;
  for (const [e, l] of V.entries()) n(e), t = t && l.processed;
  return t;
}, "compileTasks"), It = { clear: ct, getCommonDb: ot, addSection: ht, getSections: dt, getTasks: ut, addTask: pt, addTaskOrg: gt, addEvent: yt }, Nt = 12, q = s(function(n, t) {
...
}, "drawLabel"), Ht = s(function(n, t, e) {
  const l = n.append("g"), i = Y();
  i.x = t.x, i.y = t.y, i.fill = t.fill, i.width = e.width, i.height = e.height, i.class = "journey-section section-type-" + t.num, i.rx = 3, i.ry = 3, q(l, i), mt(e)(t.text, l, i.x, i.y, i.width, i.height, { class: "journey-section section-type-" + t.num }, e, t.colour);
}, "drawSection"), rt = -1, Pt = s(function(n, t, e) {
  const l = t.x + e.width / 2, i = n.append("g");
  rt++, i.append("line").attr("id", "task" + rt).attr("x1", l).attr("y1", t.y).attr("x2", l).attr("y2", 450).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Lt(i, { cx: l, cy: 300 + (5 - t.score) * 30, score: t.score });
  const h = Y();
  h.x = t.x, h.y = t.y, h.fill = t.fill, h.width = e.width, h.height = e.height, h.class = "task task-type-" + t.num, h.rx = 3, h.ry = 3, q(i, h), mt(e)(t.task, i, h.x, h.y, h.width, h.height, { class: "task" }, e, t.colour);
}, "drawTask"), At = s(function(n, t) {
  q(n, { x: t.startx, y: t.starty, width: t.stopx - t.startx, height: t.stopy - t.starty, fill: t.fill, class: "rect" }).lower();
}, "drawBackgroundRect"), Ct = s(function() {
  return { x: 0, y: 0, fill: void 0, "text-anchor": "start", width: 100, height: 100, textMargin: 0, rx: 0, ry: 0 };
}, "getTextObj"), Y = s(function() {
  return { x: 0, y: 0, width: 100, anchor: "start", height: 100, rx: 0, ry: 0 };
}, "getNoteRect"), mt = (function() {
  ...
  s(e, "byFo");
  function l(i, d) {
    for (const h in d) h in d && i.attr(h, d[h]);
  }
...
function D(n, t) {
  n.each(function() {
    ...
    for (let k = 0; k < l.length; k++) i = l[l.length - 1 - k], d.push(i), p.text(d.join(" ").trim()), (p.node().getComputedTextLength() > t || i === "<br>") && (d.pop(), p.text(d.join(" ").trim()), i === "<br>" ? d = [""] : d = [i], p = e.append("tspan").attr("x", 0).attr("y", f).attr("dy", h + "em").text(i));
  });
}
s(D, "wrap");
var Ft = s(function(n, t, e, l) {
...
}, "getVirtualNodeHeight"), Wt = s(function(n, t, e) {
...
}, "defaultBkg"), C = { drawRect: q, drawCircle: $t, drawSection: Ht, drawText: ft, drawLabel: Mt, drawTask: Pt, drawBackgroundRect: At, getTextObj: Ct, getNoteRect: Y, initGraphics: Rt, drawNode: Ft, getVirtualNodeHeight: Vt }, zt = s(function(n, t, e, l) {
  var _a, _b, _c;
  const i = xt(), d = ((_a = i.timeline) == null ? void 0 : _a.leftMargin) ?? 50;
  ...
  x.forEach(function(H) {
    const g = { number: w, descr: H, section: w, width: 150, padding: 20, maxHeight: r }, b = C.getVirtualNodeHeight(p, g, i);
    E.debug("sectionHeight before draw", b), r = Math.max(r, b + 20);
  });
  let N = 0, P = 0;
  E.debug("tasks.length", k.length);
  for (const [H, g] of k.entries()) {
    const b = { number: H, descr: g, section: g.section, width: 150, padding: 20, maxHeight: a }, L = C.getVirtualNodeHeight(p, b, i);
    E.debug("taskHeight before draw", L), a = Math.max(a, L + 20), N = Math.max(N, g.events.length);
    let $ = 0;
    for (const z of g.events) {
      const Z = { descr: z, section: g.section, number: g.section, width: 150, padding: 20, maxHeight: 50 };
  ...
  E.debug("maxSectionHeight before draw", r), E.debug("maxTaskHeight before draw", a), x && x.length > 0 ? x.forEach((H) => {
    const g = k.filter((z) => z.section === H), b = { number: w, descr: H, section: w, width: 200 * Math.max(g.length, 1) - 50, padding: 20, maxHeight: r };
    E.debug("sectionNode", b);
    const L = p.append("g"), $ = C.drawNode(L, b, w, i);
    E.debug("sectionNode output", $), L.attr("transform", `translate(${y}, ${u})`), o += r + 50, g.length > 0 && st(p, g, w, y, o, a, i, N, P, r, false), y += 200 * Math.max(g.length, 1), o = u, w++;
  }) : (v = false, st(p, k, w, y, o, a, i, N, P, r, true));
  const W = p.node().getBBox();
  E.debug("bounds", W), _ && p.append("text").text(_).attr("x", W.width / 2 - d).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = v ? r + a + 150 : a + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", d).attr("y1", c).attr("x2", W.width + 3 * d).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), kt(void 0, p, ((_b = i.timeline) == null ? void 0 : _b.padding) ?? 50, ((_c = i.timeline) == null ? void 0 : _c.useMaxWidth) ?? false);
}, "draw"), st = s(function(n, t, e, l, i, d, h, f, m, p, k) {
  var _a;
  for (const _ of t) {
    const x = { descr: _.task, section: e, number: e, width: 150, padding: 20, maxHeight: d };
    E.debug("taskNode", x);
  ...
  i = i - 10;
}, "drawTasks"), Bt = s(function(n, t, e, l, i, d) {
  let h = 0;
  const f = i;
  i = i + 100;
  for (const m of t) {
  ...
  return i = f, h;
}, "drawEvents"), Ot = { setConf: s(() => {
}, "setConf"), draw: zt }, jt = s((n) => {
  let t = "";
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], vt(n["lineColor" + e]) ? n["lineColor" + e] = _t(n["lineColor" + e], 20) : n["lineColor" + e] = bt(n["lineColor" + e], 20);
...
`, "getStyles"), qt = Gt, Jt = { db: at, renderer: Ot, parser: Tt, styles: qt };
export {
  Jt as diagram
};
