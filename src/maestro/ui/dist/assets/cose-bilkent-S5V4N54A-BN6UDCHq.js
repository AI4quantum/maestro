import { aI as lt, _ as V, l as k, d as gt } from "./index-CTgvlc8H.js";
import { c as tt } from "./cytoscape.esm-DtBltrT8.js";
    ...
    (function(I, L) {
      ...
      return (function(N) {
        ...
        function L(o) {
          ...
          var e = I[o] = { i: o, l: false, exports: {} };
          return N[o].call(e.exports, e, e.exports, L), e.l = true, e.exports;
        }
        return L.m = N, L.c = I, L.i = function(o) {
          return o;
        }, L.d = function(o, e, t) {
          L.o(o, e) || Object.defineProperty(o, e, { configurable: false, enumerable: true, get: t });
        }, L.n = function(o) {
        ...
        n.prototype.getEdges = function() {
          ...
          if (r.add(this), this.child != null) for (var p = this.child.getNodes(), v = 0; v < p.length; v++) h = p[v], a = h.withChildren(), a.forEach(function(D) {
            r.add(D);
          });
          return r;
        ...
        function h(p, v, D) {
          o.call(this, D), this.estimatedSize = e.MIN_VALUE, this.margin = t.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = p, v != null && v instanceof i ? this.graphManager = v : v != null && v instanceof Layout && (this.graphManager = v.graphManager);
        }
        ...
        h.prototype.getNodes = function() {
          ...
          if (v == null && D == null) {
            ...
            var T = p;
            if (!(this.getNodes().indexOf(v) > -1 && this.getNodes().indexOf(D) > -1)) throw "Source or target not in graph!";
          ...
          if (p instanceof l) {
            ...
            for (var D = v.edges.slice(), u, T = D.length, y = 0; y < T; y++) u = D[y], u.isInterGraph ? this.graphManager.remove(u) : u.source.owner.remove(u);
        ...
        t.prototype.addRoot = function() {
          ...
          if (g == null && n == null && d == null) {
            ...
            if (r == h) return g.isInterGraph = false, r.add(g, n, d);
            if (g.isInterGraph = true, g.source = n, g.target = d, this.edges.indexOf(g) > -1) throw "Edge already in inter-graph edge list!";
          ...
          for (var i, l = this.edges.length, g = 0; g < l; g++) if (i = this.edges[g], this.isOneAncestorOfOther(i.source, i.target)) return true;
          return false;
        }, N.exports = t;
      }), (function(N, I, L) {
        var o = L(0);
        ...
        e.calcSeparationAmount = function(t, i, l, g) {
          ...
          if (t.intersects(i)) return l[0] = g, l[1] = n, l[2] = d, l[3] = r, true;
          var h = t.getX(), a = t.getY(), p = t.getRight(), v = t.getX(), D = t.getBottom(), u = t.getRight(), T = t.getWidthHalf(), y = t.getHeightHalf(), O = i.getX(), s = i.getY(), f = i.getRight(), c = i.getX(), E = i.getBottom(), A = i.getRight(), m = i.getWidthHalf(), C = i.getHeightHalf(), R = false, M = false;
          if (g === d) {
            if (n > r) return l[0] = g, l[1] = a, l[2] = d, l[3] = E, false;
            if (n < r) return l[0] = g, l[1] = D, l[2] = d, l[3] = s, false;
          } else if (n === r) {
            if (g > d) return l[0] = h, l[1] = n, l[2] = f, l[3] = r, false;
            if (g < d) return l[0] = p, l[1] = n, l[2] = O, l[3] = r, false;
          } else {
            var S = t.height / t.width, Y = i.height / i.width, w = (r - n) / (d - g), x = void 0, F = void 0, U = void 0, P = void 0, _ = void 0, X = void 0;
            if (-S === w ? g > d ? (l[0] = v, l[1] = D, R = true) : (l[0] = p, l[1] = a, R = true) : S === w && (g > d ? (l[0] = h, l[1] = a, R = true) : (l[0] = u, l[1] = D, R = true)), -Y === w ? d > g ? (l[2] = c, l[3] = E, M = true) : (l[2] = f, l[3] = s, M = true) : Y === w && (d > g ? (l[2] = O, l[3] = s, M = true) : (l[2] = A, l[3] = E, M = true)), R && M) return false;
            if (g > d ? n > r ? (x = this.getCardinalDirection(S, w, 4), F = this.getCardinalDirection(Y, w, 2)) : (x = this.getCardinalDirection(-S, w, 3), F = this.getCardinalDirection(-Y, w, 1)) : n > r ? (x = this.getCardinalDirection(-S, w, 1), F = this.getCardinalDirection(-Y, w, 3)) : (x = this.getCardinalDirection(S, w, 2), F = this.getCardinalDirection(Y, w, 4)), !R) switch (x) {
              case 1:
        ...
        var t = function(d) {
          ...
          function n(d) {
            var r = this;
            e(this, n), this.length = 0, this.head = null, this.tail = null, d == null ? void 0 : d.forEach(function(h) {
              return r.push(h);
            });
          }
          return o(n, [{ key: "size", value: function() {
            return this.length;
          } }, { key: "insertBefore", value: function(r, h) {
            return i(h.prev, t(r), h, this);
          } }, { key: "insertAfter", value: function(r, h) {
            return i(h, t(r), h.next, this);
          } }, { key: "insertNodeBefore", value: function(r, h) {
            return i(h.prev, r, h, this);
          } }, { key: "insertNodeAfter", value: function(r, h) {
            return i(h, r, h.next, this);
          } }, { key: "push", value: function(r) {
          ...
          } }, { key: "get_object_at", value: function(r) {
            if (r <= this.length()) {
              for (var h = 1, a = this.head; h < r; ) a = a.next, h++;
              return a.value;
            }
          } }, { key: "set_object_at", value: function(r, h) {
            if (r <= this.length()) {
        ...
        h.RANDOM_SEED = 1, h.prototype = Object.create(r.prototype), h.prototype.getGraphManager = function() {
          ...
          if (a == null) this.update2();
            ...
            var p = a;
            if (p.getChild() != null) for (var v = p.getChild().getNodes(), D = 0; D < v.length; D++) update(v[D]);
          ...
          if (a == null) this.transform(new n(0, 0));
            ...
            if (v != null) {
              ...
              for (var D = this.getAllNodes(), u, T = 0; T < D.length; T++) u = D[T], u.transform(p);
            }
          }
        }, h.prototype.positionNodesRandomly = function(a) {
          if (a == null) this.positionNodesRandomly(this.getGraphManager().getRoot()), this.getGraphManager().getRoot().updateBounds(true);
          else for (var p, v, D = a.getNodes(), u = 0; u < D.length; u++) p = D[u], v = p.getChild(), v == null || v.getNodes().length == 0 ? p.scatter() : (this.positionNodesRandomly(v), p.updateBounds());
        }, h.prototype.getFlatForest = function() {
          for (var a = [], p = true, v = this.graphManager.getRoot().getNodes(), D = true, u = 0; u < v.length; u++) v[u].getChild() != null && (D = false);
          if (!D) return a;
          ...
          for (s = s.concat(v); s.length > 0 && p; ) {
            for (y.push(s[0]); y.length > 0 && p; ) {
              ...
              for (var c = f.getEdges(), u = 0; u < c.length; u++) {
                ...
                if (O.get(f) != E) if (!T.has(E)) y.push(E), O.set(E, f);
                else {
                  p = false;
                  break;
                }
          ...
          (p.length == 1 || p.length == 2) && (u = true, T = p[0]);
          ...
          for (f = f.concat(v); !u; ) {
            ...
            v = v.concat(f), (p.length == 1 || p.length == 2) && (u = true, T = p[0]);
          }
          return T;
        ...
        n.prototype.initParameters = function() {
          ...
          var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, a, p, v, D, u = this.getAllNodes(), T;
          if (this.useFRGridVariant) for (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && r && this.updateGrid(), T = /* @__PURE__ */ new Set(), a = 0; a < u.length; a++) v = u[a], this.calculateRepulsionForceOfANode(v, T, r, h), T.add(v);
          else for (a = 0; a < u.length; a++) for (v = u[a], p = a + 1; p < u.length; p++) D = u[p], v.getOwner() == D.getOwner() && this.calcRepulsionForce(v, D);
          ...
          for (var T = p; T <= v; T++) for (var y = D; y <= u; y++) this.grid[T][y].push(r), r.setGridCoordinates(p, v, D, u);
          ...
          if (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && a || p) {
            ...
            for (var D, u = this.grid, T = r.startX - 1; T < r.finishX + 2; T++) for (var y = r.startY - 1; y < r.finishY + 2; y++) if (!(T < 0 || y < 0 || T >= u.length || y >= u[0].length)) {
              for (var O = 0; O < u[T][y].length; O++) if (D = u[T][y][O], !(r.getOwner() != D.getOwner() || r == D) && !h.has(D) && !v.has(D)) {
        ...
        var t = L(11), i = (function() {
          ...
          return o(l, [{ key: "_quicksort", value: function(n, d, r) {
            if (d < r) {
              var h = this._partition(n, d, r);
              this._quicksort(n, d, h), this._quicksort(n, h + 1, r);
            }
          } }, { key: "_partition", value: function(n, d, r) {
          ...
          } }, { key: "_get", value: function(n, d) {
            return n instanceof t ? n.get_object_at(d) : n[d];
          } }, { key: "_set", value: function(n, d, r) {
            n instanceof t ? n.set_object_at(d, r) : n[d] = r;
          } }, { key: "_swap", value: function(n, d, r) {
            var h = this._get(n, d);
            this._set(n, d, this._get(n, r)), this._set(n, r, h);
          } }, { key: "_defaultCompareFunction", value: function(n, d) {
            return d > n;
          } }]), l;
        })();
        N.exports = i;
        ...
        var t = (function() {
          ...
          return o(i, [{ key: "getScore", value: function() {
            return this.score;
          } }, { key: "getAlignments", value: function() {
            return this.alignments;
          } }, { key: "computeGrids", value: function() {
            for (var g = 1; g < this.jMax; g++) this.grid[0][g] = this.grid[0][g - 1] + this.gap_penalty, this.tracebackGrid[0][g] = [false, false, true];
            for (var n = 1; n < this.iMax; n++) this.grid[n][0] = this.grid[n - 1][0] + this.gap_penalty, this.tracebackGrid[n][0] = [false, true, false];
    ...
    (function(I, L) {
      ...
      return (function(I) {
        ...
        function o(e) {
          ...
          var t = L[e] = { i: e, l: false, exports: {} };
          return I[e].call(t.exports, t, t.exports, o), t.l = true, t.exports;
        }
        return o.m = I, o.c = L, o.i = function(e) {
          return e;
        }, o.d = function(e, t, i) {
          o.o(e, t) || Object.defineProperty(e, t, { configurable: false, enumerable: true, get: i });
        }, o.n = function(e) {
        ...
        y.prototype.newGraphManager = function() {
          ...
          for (A = 0; A < E; A++) f = c[A], f.updateConnected(), f.isConnected || (s = s.concat(f.getNodes()));
          return s;
          ...
          for (c = 0; c < s.length; c++) {
            ...
            if (!f.has(E)) {
              ...
              if (A == m) E.getBendpoints().push(new a()), E.getBendpoints().push(new a()), this.createDummyNodesForBendpoints(E), f.add(E);
              else {
                var C = [];
          ...
          var c = s.getChild();
          if (c == null) return this.toBeTiled[f] = false, false;
          for (var E = c.getNodes(), A = 0; A < E.length; A++) {
            var m = E[A];
            if (this.getNodeDegree(m) > 0) return this.toBeTiled[f] = false, false;
            if (m.getChild() == null) {
              this.toBeTiled[m.id] = false;
              continue;
            }
            if (!this.getToBeTiled(m)) return this.toBeTiled[f] = false, false;
          }
          ...
          var c = n.TILING_PADDING_VERTICAL, E = n.TILING_PADDING_HORIZONTAL, A = { rows: [], rowWidth: [], rowHeight: [], width: 0, height: f, verticalPadding: c, horizontalPadding: E };
          s.sort(function(R, M) {
          ...
          for (var f = -1, c = Number.MAX_VALUE, E = 0; E < s.rows.length; E++) s.rowWidth[E] < c && (f = E, c = s.rowWidth[E]);
          return f;
        }, y.prototype.getLongestRowIndex = function(s) {
          for (var f = -1, c = Number.MIN_VALUE, E = 0; E < s.rows.length; E++) s.rowWidth[E] > c && (f = E, c = s.rowWidth[E]);
          return f;
          ...
          if (s.width - s.rowWidth[c] > m && f != c) {
            ...
            for (var C = Number.MIN_VALUE, R = 0; R < E.length; R++) E[R].height > C && (C = E[R].height);
          ...
          for (var s = [], f = true, c; f; ) {
            ...
            f = false;
            for (var m = 0; m < E.length; m++) c = E[m], c.getEdges().length == 1 && !c.getEdges()[0].isInterGraph && c.getChild() == null && (A.push([c, c.getEdges()[0], c.getOwner()]), f = true);
            if (f == true) {
              for (var C = [], R = 0; R < A.length; R++) A[R][0].getEdges().length == 1 && (C.push(A[R]), A[R][0].getOwner().remove(A[R][0]));
          ...
          for (var f = s.length, c = s[f - 1], E, A = 0; A < c.length; A++) E = c[A], this.findPlaceforPrunedNode(E), E[2].add(E[0]), E[2].add(E[1], E[1].source, E[1].target);
          ...
          if (C > 0) for (var F = A; F <= m; F++) x[0] += this.grid[F][C - 1].length + this.grid[F][C].length - 1;
          if (m < this.grid.length - 1) for (var F = C; F <= R; F++) x[1] += this.grid[m + 1][F].length + this.grid[m][F].length - 1;
          if (R < this.grid[0].length - 1) for (var F = A; F <= m; F++) x[2] += this.grid[F][R + 1].length + this.grid[F][R].length - 1;
          if (A > 0) for (var F = C; F <= R; F++) x[3] += this.grid[A - 1][F].length + this.grid[A][F].length - 1;
  ...
  return J || (J = 1, (function(G, b) {
    (function(I, L) {
      ...
      return (function(I) {
        ...
        var e = o(0).layoutBase.LayoutConstants, t = o(0).layoutBase.FDLayoutConstants, i = o(0).CoSEConstants, l = o(0).CoSELayout, g = o(0).CoSENode, n = o(0).layoutBase.PointD, d = o(0).layoutBase.DimensionD, r = { ready: function() {
        }, stop: function() {
        ...
        a.prototype.run = function() {
          ...
          var M = function(w, x) {
            ...
            }, x = O.options.refresh, F, U = 0; U < x && !F; U++) F = O.stopped || O.layout.tick();
            if (F) {
          ...
          for (var u = {}, T = 0; T < D.length; T++) u[D[T].id()] = true;
          var y = D.filter(function(O, s) {
            typeof O == "number" && (O = s);
            for (var f = O.parent()[0]; f != null; ) {
              if (u[f.id()]) return false;
              f = f.parent()[0];
            }
            return true;
          });
          ...
          for (var y = u.length, O = 0; O < y; O++) {
            var s = u[O], f = s.children(), c, E = s.layoutDimensions({ nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels });
...
function it(G) {
  return new Promise((b) => {
    const N = gt("body").append("div").attr("id", "cy").attr("style", "display:none"), I = tt({ container: document.getElementById("cy"), style: [{ selector: "edge", style: { "curve-style": "bezier" } }] });
...
function nt(G) {
  return G.nodes().map((b) => {
    const N = b.data(), I = b.position(), L = { id: N.id, x: I.x, y: I.y };
...
function ot(G) {
  return G.edges().map((b) => {
    const N = b.data(), I = b._private.rscratch, L = { id: N.id, source: N.source, target: N.target, startX: I.startX, startY: I.startY, midX: I.midX, midY: I.midY, endX: I.endX, endY: I.endY };
    return Object.keys(N).forEach((o) => {
...
async function st(G, b) {
  ...
  try {
    ...
    return k.debug(`Layout completed: ${I.length} nodes, ${L.length} edges`), { nodes: I, edges: L };
  } catch (N) {
...
var Lt = V(async (G, b, { insertCluster: N, insertEdge: I, insertEdgeLabel: L, insertMarkers: o, insertNode: e, log: t, positionEdgeLabel: i }, { algorithm: l }) => {
  ...
  t.debug("Inserting nodes into DOM for dimension calculation"), await Promise.all(G.nodes.map(async (u) => {
    if (u.isGroup) {
      ...
      const T = { ...u };
      g[u.id] = T;
      const y = await e(p, u, { config: G.config, dir: G.direction || "TB" }), O = y.node().getBBox();
  ...
  t.debug("Positioning nodes based on layout results"), D.nodes.forEach((u) => {
    const T = g[u.id];
    (T == null ? void 0 : T.domId) && (T.domId.attr("transform", `translate(${u.x}, ${u.y})`), T.x = u.x, T.y = u.y, t.debug(`Positioned node ${T.id} at center (${u.x}, ${u.y})`));
  }), D.edges.forEach((u) => {
    const T = G.edges.find((y) => y.id === u.id);
    T && (T.points = [{ x: u.startX, y: u.startY }, { x: u.midX, y: u.midY }, { x: u.endX, y: u.endY }]);
    ...
    if (T && y) {
      ...
      if (O) {
        ...
        const s = { ...u }, f = I(h, s, n, G.type, T, y, G.diagramId);
        i(s, f);
      } else {
        const s = { ...u, points: [{ x: T.x || 0, y: T.y || 0 }, { x: y.x || 0, y: y.y || 0 }] }, f = I(h, s, n, G.type, T, y, G.diagramId);
        i(s, f);
      }
    }
