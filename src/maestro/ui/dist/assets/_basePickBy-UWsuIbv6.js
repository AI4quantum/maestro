import { e as x, c as O, g as m, k as P, h as p, j as w, l as A, m as c, n as I, t as N, o as E } from "./_baseUniq-o7e9QmIE.js";
import { aR as g, aA as F, aS as M, aT as T, aU as _, aV as l, aW as $, aX as B, aY as S, aZ as y } from "./index-CTgvlc8H.js";
var R = /\s/;
function G(n) {
...
var b = Object.prototype, Z = b.hasOwnProperty, dn = F(function(n, r) {
  ...
  for (a && M(r[0], r[1], a) && (i = 1); ++t < i; ) for (var f = r[t], e = T(f), s = -1, d = e.length; ++s < d; ) {
    var u = e[s], h = n[u];
...
function tn(n, r, t) {
  for (var i = -1, a = n.length; ++i < a; ) {
    var f = n[i], e = r(f);
    if (e != null && (s === void 0 ? e === e && !x(e) : t(e, s))) var s = e, d = f;
  }
  return d;
}
function on(n) {
