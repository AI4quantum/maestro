  ...
  var e = o(function(P, i, a, c) {
    ...
    for (var S, z, k, be, J = {}, ye, F, Ue, ge; ; ) {
      if (z = c[c.length - 1], this.defaultActions[z] ? k = this.defaultActions[z] : ((S === null || typeof S > "u") && (S = $e()), k = me[z] && me[z][S]), typeof k > "u" || !k.length || !k[0]) {
        var Te = "";
        ge = [];
        for (ye in me[z]) this.terminals_[ye] && ye > Qe && ge.push("'" + this.terminals_[ye] + "'");
        y.showPosition ? Te = "Parse error on line " + (Re + 1) + `:
` + y.showPosition() + `
Expecting ` + ge.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : Te = "Parse error on line " + (Re + 1) + ": Unexpected " + (S == Pe ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(Te, { text: y.match, token: this.terminals_[S] || S, line: y.yylineno, loc: Ie, expected: ge });
      }
      if (k[0] instanceof Array && k.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + z + ", token: " + S);
      switch (k[0]) {
        case 1:
          c.push(S), f.push(y.yytext), t.push(y.yylloc), c.push(k[1]), S = null, Fe = y.yyleng, l = y.yytext, Re = y.yylineno, Ie = y.yylloc;
          break;
        case 2:
          if (F = this.productions_[k[1]][1], J.$ = f[f.length - F], J._$ = { first_line: t[t.length - (F || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (F || 1)].first_column, last_column: t[t.length - 1].last_column }, Ke && (J._$.range = [t[t.length - (F || 1)].range[0], t[t.length - 1].range[1]]), be = this.performAction.apply(J, [l, Fe, Re, G.yy, k[1], f, t].concat(He)), typeof be < "u") return be;
    ...
    var P = { EOF: 1, parseError: o(function(a, c) {
      if (this.yy.parser) this.yy.parser.parseError(a, c);
      else throw new Error(a);
    }, "parseError"), setInput: o(function(i, a) {
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: c ? (c.length === s.length ? this.yylloc.first_column : 0) + s[s.length - c.length].length - c[0].length : this.yylloc.first_column - a }, this.options.ranges && (this.yylloc.range = [f[0], f[0] + this.yyleng - a]), this.yyleng = this.yytext.length, this;
...
` + a + "^";
      ...
      for (var f = this._currentRules(), t = 0; t < f.length; t++) if (c = this._input.match(this.rules[f[t]]), c && (!a || c[0].length > a[0].length)) {
        if (a = c, s = t, this.options.backtrack_lexer) {
          if (i = this.test_match(c, f[t]), i !== false) return i;
          if (this._backtrack) {
            a = false;
            continue;
          } else return false;
      ...
      return a ? (i = this.test_match(a, f[s]), i !== false ? i : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: o(function() {
      var a = this.next();
      return a || this.lex();
    ...
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: o(function(a, c, s, f) {
      switch (s) {
        case 0:
          return "title";
        case 1:
...
var lt = qe, ct = (_a = class {
  ...
  addRelationship(e, u, h) {
    this.relations.push({ type: e, src: u, dst: h });
  }
  getRelationships() {
  ...
  setCssStyle(e, u) {
    for (const h of e) {
      ...
      if (!u || !r) return;
      for (const n of u) n.includes(",") ? r.cssStyles.push(...n.split(",")) : r.cssStyles.push(n);
    }
  }
  setClass(e, u) {
    var _a2;
    for (const h of e) {
      const r = this.requirements.get(h) ?? this.elements.get(h);
      if (r) for (const n of u) {
        r.classes.push(n);
        const E = (_a2 = this.classes.get(n)) == null ? void 0 : _a2.styles;
  ...
  getData() {
    ...
    for (const r of this.relations) {
      let n = 0;
      const E = r.type === this.Relationships.CONTAINS, g = { id: `${r.src}-${r.dst}-${n}`, start: ((_a2 = this.requirements.get(r.src)) == null ? void 0 : _a2.name) ?? ((_b = this.elements.get(r.src)) == null ? void 0 : _b.name), end: ((_c = this.requirements.get(r.dst)) == null ? void 0 : _c.name) ?? ((_d = this.elements.get(r.dst)) == null ? void 0 : _d.name), label: `&lt;&lt;${r.type}&gt;&gt;`, classes: "relationshipLine", style: ["fill:none", E ? "" : "stroke-dasharray: 10,7"], labelpos: "c", thickness: "normal", type: "normal", pattern: E ? "normal" : "dashed", arrowTypeStart: E ? "requirement_contains" : "", arrowTypeEnd: E ? "" : "requirement_arrow", look: e.look };
      h.push(g), n++;
    }
    return { nodes: u, edges: h, other: {}, config: e, direction: this.getDirection() };
  }
}, o(_a, "RequirementDB"), _a), ot = o((e) => `
...
`, "getStyles"), ht = ot, Ye = {};
it(Ye, { draw: () => ut });
var ut = o(async function(e, u, h, r) {
  ...
  R.type = r.type, R.layoutAlgorithm = rt(g), R.nodeSpacing = (E == null ? void 0 : E.nodeSpacing) ?? 50, R.rankSpacing = (E == null ? void 0 : E.rankSpacing) ?? 50, R.markers = ["requirement_contains", "requirement_arrow"], R.diagramId = u, await nt(R, _);
  const b = 8;
  at.insertTitle(_, "requirementDiagramTitleText", (E == null ? void 0 : E.titleTopMargin) ?? 25, r.db.getDiagramTitle()), Ge(_, b, "requirementDiagram", (E == null ? void 0 : E.useMaxWidth) ?? true);
}, "draw"), dt = { parser: lt, get db() {
  return new ct();
}, renderer: Ye, styles: ht };
export {
  dt as diagram
};
