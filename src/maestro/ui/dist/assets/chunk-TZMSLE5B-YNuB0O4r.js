import { _ as n, U as o, j as l } from "./index-CTgvlc8H.js";
var x = n((s, t) => {
...
}, "drawText"), h = n((s, t, e, r) => {
  const a = s.append("image");
  a.attr("x", t), a.attr("y", e);
  const i = l.sanitizeUrl(r);
  a.attr("xlink:href", i);
}, "drawImage"), m = n((s, t, e, r) => {
  const a = s.append("use");
  a.attr("x", t), a.attr("y", e);
  const i = l.sanitizeUrl(r);
  a.attr("xlink:href", `#${i}`);
}, "drawEmbeddedImage"), y = n(() => ({ x: 0, y: 0, width: 100, height: 100, fill: "#EDF2AE", stroke: "#666", anchor: "start", rx: 0, ry: 0 }), "getNoteRect"), p = n(() => ({ x: 0, y: 0, width: 100, height: 100, "text-anchor": "start", style: "#666", textMargin: 0, rx: 0, ry: 0, tspan: true }), "getTextObj");
export {
  d as a,
  p as b,
  m as c,
