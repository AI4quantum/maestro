  ...
  var e = o(function(N, n, a, c) {
    ...
    for (var y, I, b, ot, v = {}, H, E, Ot, J; ; ) {
      if (I = c[c.length - 1], this.defaultActions[I] ? b = this.defaultActions[I] : ((y === null || typeof y > "u") && (y = Tt()), b = G[I] && G[I][y]), typeof b > "u" || !b.length || !b[0]) {
        var ht = "";
        J = [];
        for (H in G[I]) this.terminals_[H] && H > Rt && J.push("'" + this.terminals_[H] + "'");
        f.showPosition ? ht = "Parse error on line " + (q + 1) + `:
` + f.showPosition() + `
Expecting ` + J.join(", ") + ", got '" + (this.terminals_[y] || y) + "'" : ht = "Parse error on line " + (q + 1) + ": Unexpected " + (y == St ? "end of input" : "'" + (this.terminals_[y] || y) + "'"), this.parseError(ht, { text: f.match, token: this.terminals_[y] || y, line: f.yylineno, loc: lt, expected: J });
      }
      if (b[0] instanceof Array && b.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + I + ", token: " + y);
      switch (b[0]) {
        case 1:
          c.push(y), u.push(f.yytext), t.push(f.yylloc), c.push(b[1]), y = null, kt = f.yyleng, s = f.yytext, q = f.yylineno, lt = f.yylloc;
          break;
        case 2:
          if (E = this.productions_[b[1]][1], v.$ = u[u.length - E], v._$ = { first_line: t[t.length - (E || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (E || 1)].first_column, last_column: t[t.length - 1].last_column }, It && (v._$.range = [t[t.length - (E || 1)].range[0], t[t.length - 1].range[1]]), ot = this.performAction.apply(v, [s, kt, q, x.yy, b[1], u, t].concat(xt)), typeof ot < "u") return ot;
    ...
    var N = { EOF: 1, parseError: o(function(a, c) {
      if (this.yy.parser) this.yy.parser.parseError(a, c);
      else throw new Error(a);
    }, "parseError"), setInput: o(function(n, a) {
...
` + a + "^";
    }, "showPosition"), test_match: o(function(n, a) {
      var c, r, u;
      if (this.options.backtrack_lexer && (u = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (u.yylloc.range = this.yylloc.range.slice(0))), r = n[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: r ? r[r.length - 1].length - r[r.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + n[0].length }, this.yytext += n[0], this.match += n[0], this.matches = n, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(n[0].length), this.matched += n[0], c = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), c) return c;
      if (this._backtrack) {
      ...
      for (var u = this._currentRules(), t = 0; t < u.length; t++) if (c = this._input.match(this.rules[u[t]]), c && (!a || c[0].length > a[0].length)) {
        if (a = c, r = t, this.options.backtrack_lexer) {
          if (n = this.test_match(c, u[t]), n !== false) return n;
          if (this._backtrack) {
            a = false;
            continue;
          } else return false;
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    ...
    }, "_currentRules"), topState: o(function(a) {
      return a = this.conditionStack.length - 1 - Math.abs(a || 0), a >= 0 ? this.conditionStack[a] : "INITIAL";
    }, "topState"), pushState: o(function(a) {
      this.begin(a);
    }, "pushState"), stateStackSize: o(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: o(function(a, c, r, u) {
      switch (r) {
        case 0:
...
var Qt = ut, Xt = (_a = class {
  constructor() {
    this.entities = /* @__PURE__ */ new Map(), this.relationships = [], this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.Cardinality = { ZERO_OR_ONE: "ZERO_OR_ONE", ZERO_OR_MORE: "ZERO_OR_MORE", ONE_OR_MORE: "ONE_OR_MORE", ONLY_ONE: "ONLY_ONE", MD_PARENT: "MD_PARENT" }, this.Identification = { NON_IDENTIFYING: "NON_IDENTIFYING", IDENTIFYING: "IDENTIFYING" }, this.setAccTitle = wt, this.getAccTitle = Vt, this.setAccDescription = Lt, this.getAccDescription = Mt, this.setDiagramTitle = Bt, this.getDiagramTitle = Ft, this.getConfig = o(() => $().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  addEntity(e, i = "") {
    var _a2;
  ...
  addAttributes(e, i) {
    ...
    let l;
    for (l = i.length - 1; l >= 0; l--) i[l].keys || (i[l].keys = []), i[l].comment || (i[l].comment = ""), d.attributes.push(i[l]), D.debug("Added attribute ", i[l].name);
  }
  addRelationship(e, i, d, l) {
    const h = this.entities.get(e), p = this.entities.get(d);
    if (!h || !p) return;
    const R = { entityA: h.id, roleA: i, entityB: p.id, relSpec: l };
  ...
  addCssStyles(e, i) {
    for (const d of e) {
      ...
      if (!i || !l) return;
      for (const h of i) l.cssStyles.push(h);
    }
  }
  addClass(e, i) {
    e.forEach((d) => {
  ...
  setClass(e, i) {
    for (const d of e) {
      const l = this.entities.get(d);
      if (l) for (const h of i) l.cssClasses += " " + h;
    }
  }
  clear() {
  ...
  getData() {
    ...
    for (const h of this.relationships) {
      const p = { id: Pt(h.entityA, h.entityB, { prefix: "id", counter: l++ }), type: "normal", curve: "basis", start: h.entityA, end: h.entityB, label: h.roleA, labelpos: "c", thickness: "normal", classes: "relationshipLine", arrowTypeStart: h.relSpec.cardB.toLowerCase(), arrowTypeEnd: h.relSpec.cardA.toLowerCase(), pattern: h.relSpec.relType == "IDENTIFYING" ? "solid" : "dashed", look: d.look };
      i.push(p);
    }
...
Gt(At, { draw: () => qt });
var qt = o(async function(e, i, d, l) {
  ...
  const K = 8;
  jt.insertTitle(m, "erDiagramTitleText", (p == null ? void 0 : p.titleTopMargin) ?? 25, l.db.getDiagramTitle()), Dt(m, K, "erDiagram", (p == null ? void 0 : p.useMaxWidth) ?? true);
}, "draw"), Ht = o((e, i) => {
...
`, "getStyles"), $t = Jt, re = { parser: Qt, get db() {
  return new Xt();
}, renderer: At, styles: $t };
export {
  re as diagram
};
