  ...
  var t = d(function(Y, a, c, r) {
    ...
    for (var x, M, N, _t, W = {}, ut, F, Lt, dt; ; ) {
      if (M = r[r.length - 1], this.defaultActions[M] ? N = this.defaultActions[M] : ((x === null || typeof x > "u") && (x = xt()), N = X[M] && X[M][x]), typeof N > "u" || !N.length || !N[0]) {
        var mt = "";
        dt = [];
        for (ut in X[M]) this.terminals_[ut] && ut > ht && dt.push("'" + this.terminals_[ut] + "'");
        m.showPosition ? mt = "Parse error on line " + (B + 1) + `:
` + m.showPosition() + `
Expecting ` + dt.join(", ") + ", got '" + (this.terminals_[x] || x) + "'" : mt = "Parse error on line " + (B + 1) + ": Unexpected " + (x == J ? "end of input" : "'" + (this.terminals_[x] || x) + "'"), this.parseError(mt, { text: m.match, token: this.terminals_[x] || x, line: m.yylineno, loc: Et, expected: dt });
      }
      if (N[0] instanceof Array && N.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + M + ", token: " + x);
      switch (N[0]) {
        case 1:
          r.push(x), E.push(m.yytext), i.push(m.yylloc), r.push(N[1]), x = null, H = m.yyleng, l = m.yytext, B = m.yylineno, Et = m.yylloc;
          break;
        case 2:
          if (F = this.productions_[N[1]][1], W.$ = E[E.length - F], W._$ = { first_line: i[i.length - (F || 1)].first_line, last_line: i[i.length - 1].last_line, first_column: i[i.length - (F || 1)].first_column, last_column: i[i.length - 1].last_column }, qt && (W._$.range = [i[i.length - (F || 1)].range[0], i[i.length - 1].range[1]]), _t = this.performAction.apply(W, [l, H, B, V.yy, N[1], E, i].concat(gt)), typeof _t < "u") return _t;
          F && (r = r.slice(0, -1 * F * 2), E = E.slice(0, -1 * F), i = i.slice(0, -1 * F)), r.push(this.productions_[N[1]][0]), E.push(W.$), i.push(W._$), Lt = X[r[r.length - 2]][r[r.length - 1]], r.push(Lt);
          break;
        case 3:
          return true;
      }
    ...
    var Y = { EOF: 1, parseError: d(function(c, r) {
      if (this.yy.parser) this.yy.parser.parseError(c, r);
      else throw new Error(c);
    }, "parseError"), setInput: d(function(a, c) {
...
` + c + "^";
    }, "showPosition"), test_match: d(function(a, c) {
      var r, y, E;
      if (this.options.backtrack_lexer && (E = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (E.yylloc.range = this.yylloc.range.slice(0))), y = a[0].match(/(?:\r\n?|\n).*/g), y && (this.yylineno += y.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: y ? y[y.length - 1].length - y[y.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + a[0].length }, this.yytext += a[0], this.match += a[0], this.matches = a, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(a[0].length), this.matched += a[0], r = this.performAction.call(this, this.yy, this, c, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), r) return r;
      if (this._backtrack) {
      ...
      for (var E = this._currentRules(), i = 0; i < E.length; i++) if (r = this._input.match(this.rules[E[i]]), r && (!c || r[0].length > c[0].length)) {
        if (c = r, y = i, this.options.backtrack_lexer) {
          if (a = this.test_match(r, E[i]), a !== false) return a;
          if (this._backtrack) {
            c = false;
            continue;
          } else return false;
      ...
      return c ? (a = this.test_match(c, E[y]), a !== false ? a : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: d(function() {
      var c = this.next();
      return c || this.lex();
    ...
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: d(function(c, r, y, E) {
      switch (y) {
        case 0:
          return 38;
        case 1:
...
var Ge = kt, ue = "TB", Ft = "TB", It = "dir", K = "state", z = "root", vt = "relation", de = "classDef", fe = "style", pe = "applyClass", Z = "default", Yt = "divider", Gt = "fill:none", Bt = "fill: #333", Vt = "c", Mt = "text", Ut = "normal", bt = "rect", Dt = "rectWithTitle", Se = "stateStart", ye = "stateEnd", Ot = "divider", Rt = "roundedWithTitle", ge = "note", Te = "noteGroup", tt = "statediagram", Ee = "state", _e = `${tt}-${Ee}`, jt = "transition", me = "note", be = "note-edge", De = `${jt} ${be}`, ke = `${tt}-${me}`, ve = "cluster", Ce = `${tt}-${ve}`, Ae = "cluster-alt", xe = `${tt}-${Ae}`, Ht = "parent", Wt = "note", Le = "state", Ct = "----", Ie = `${Ct}${Wt}`, Nt = `${Ct}${Ht}`, zt = d((t, e = Ft) => {
  ...
  g.type = s.type, g.layoutAlgorithm = S, g.nodeSpacing = (u == null ? void 0 : u.nodeSpacing) || 50, g.rankSpacing = (u == null ? void 0 : u.rankSpacing) || 50, g.markers = ["barb"], g.diagramId = e, await ee(g, n);
  const T = 8;
  try {
    (typeof s.db.getLinks == "function" ? s.db.getLinks() : /* @__PURE__ */ new Map()).forEach((C, A) => {
      var _a2;
      const k = typeof A == "string" ? A : typeof (A == null ? void 0 : A.id) == "string" ? A.id : "";
      if (!k) {
        _.warn("\u26A0\uFE0F Invalid or missing stateId from key:", JSON.stringify(A));
        return;
      }
      const f = (_a2 = n.node()) == null ? void 0 : _a2.querySelectorAll("g");
      let D;
      if (f == null ? void 0 : f.forEach((I) => {
        var _a3;
        ((_a3 = I.textContent) == null ? void 0 : _a3.trim()) === k && (D = I);
      }), !D) {
      ...
      R.replaceChild(L, D), L.appendChild(D), _.info("\u{1F517} Wrapped node in <a> tag for:", k, C.url);
    });
  } catch (b) {
    _.error("\u274C Error injecting clickable links:", b);
  }
  se.insertTitle(n, "statediagramTitleText", (u == null ? void 0 : u.titleTopMargin) ?? 25, s.db.getDiagramTitle()), te(n, T, tt, (u == null ? void 0 : u.useMaxWidth) ?? true);
}, "draw"), Be = { getClasses: Oe, draw: Re, getDir: zt }, pt = /* @__PURE__ */ new Map(), G = 0;
      ...
      case vt:
        {
          ...
          const T = { id: "edge" + G, start: n.state1.id, end: n.state2.id, arrowhead: "normal", arrowTypeEnd: "arrow_barb", style: Gt, labelStyle: "", label: U.sanitizeText(n.description ?? "", w()), arrowheadStyle: Bt, labelpos: Vt, labelType: Mt, thickness: Ut, classes: jt, look: S };
          h.push(T), G++;
        }
        break;
    }
  });
}, "setupDoc"), wt = d((t, e = Ft) => {
  let o = e;
...
var Q = d((t, e, o, s, h, u, S, g) => {
  ...
  if (_.info("dataFetcher parsedItem", e, T, C), n !== "root") {
    let k = bt;
    e.start === true ? k = Se : e.start === false && (k = ye), e.type !== Z && (k = e.type), pt.get(n) || pt.set(n, { id: n, shape: k, description: U.sanitizeText(n, A), cssClasses: `${b} ${_e}`, cssStyles: C });
    const f = pt.get(n);
    e.description && (Array.isArray(f.description) ? (f.shape = Dt, f.description.push(e.description)) : ((_a2 = f.description) == null ? void 0 : _a2.length) && f.description.length > 0 ? (f.shape = Dt, f.description === n ? f.description = [e.description] : f.description = [f.description, e.description]) : (f.shape = bt, f.description = e.description), f.description = U.sanitizeTextOrArray(f.description, A)), ((_b = f.description) == null ? void 0 : _b.length) === 1 && f.shape === Dt && (f.type === "group" ? f.shape = Rt : f.shape = bt), !f.type && e.doc && (_.info("Setting cluster for XCX", n, wt(e)), f.type = "group", f.isGroup = true, f.dir = wt(e), f.shape = e.type === Yt ? Ot : Rt, f.cssClasses = `${f.cssClasses} ${Ce} ${u ? xe : ""}`);
    const D = { labelStyle: "", shape: f.shape, label: f.description, cssClasses: f.cssClasses, cssCompiledStyles: [], cssStyles: f.cssStyles, id: n, dir: f.dir, domId: St(n, G), type: f.type, isGroup: f.type === "group", padding: 8, rx: 10, ry: 10, look: S };
    if (D.shape === Ot && (D.label = ""), t && t.id !== "root" && (_.trace("Setting node ", n, " to be child of its parent ", t.id), D.parentId = t.id), D.centerLabel = true, e.note) {
      const R = { labelStyle: "", shape: ge, label: e.note.text, cssClasses: ke, cssStyles: [], cssCompiledStyles: [], id: n + Ie + "-" + G, domId: St(n, G, Wt), type: f.type, isGroup: f.type === "group", padding: (_c = A.flowchart) == null ? void 0 : _c.padding, look: S, position: e.note.position }, L = n + Nt, $ = { labelStyle: "", shape: Te, label: e.note.text, cssClasses: f.cssClasses, cssStyles: [], id: n + Nt, domId: St(n, G, Ht), type: "group", isGroup: true, padding: 16, look: S, position: e.note.position };
      G++, $.id = L, R.parentId = L, q(s, $, g), q(s, R, g), q(s, D, g);
      let I = n, P = R.id;
      e.note.position === "left of" && (I = R.id, P = n), h.push({ id: I + "-" + P, start: I, end: P, arrowhead: "none", arrowTypeEnd: "", style: Gt, labelStyle: "", classes: De, arrowheadStyle: Bt, labelpos: Vt, labelType: Mt, thickness: Ut, look: S });
    } else q(s, D, g);
  }
  e.doc && (_.trace("Adding nodes children "), Ne(e, e.doc, o, s, h, !u, S, g));
}, "dataFetcher"), we = d(() => {
  pt.clear(), G = 0;
}, "reset"), v = { START_NODE: "[*]", START_TYPE: "start", END_NODE: "[*]", END_TYPE: "end", COLOR_KEYWORD: "color", FILL_KEYWORD: "fill", BG_FILL: "bgFill", STYLECLASS_SEP: "," }, $t = d(() => /* @__PURE__ */ new Map(), "newClassesList"), Pt = d(() => ({ relations: [], states: /* @__PURE__ */ new Map(), documents: {} }), "newDoc"), ft = d((t) => JSON.parse(JSON.stringify(t)), "clone"), Ve = (_a = class {
  constructor(t) {
  ...
  extract(t) {
    this.clear(true);
    for (const s of Array.isArray(t) ? t : t.doc) switch (s.stmt) {
      case K:
    ...
    we(), Q(void 0, this.getRootDocV2(), e, this.nodes, this.edges, true, o.look, this.classes);
    for (const s of this.nodes) if (Array.isArray(s.label)) {
  ...
  handleStyleDef(t) {
    ...
    for (const s of e) {
      ...
      h && (h.styles = o.map((u) => {
        var _a2;
        return (_a2 = u.replace(/;/g, "")) == null ? void 0 : _a2.trim();
      }));
    }
  }
  setRootDoc(t) {
  ...
  docTranslator(t, e, o) {
    ...
    if (e.stmt === K && (e.id === v.START_NODE ? (e.id = t.id + (o ? "_start" : "_end"), e.start = o) : e.id = e.id.trim()), e.stmt !== z && e.stmt !== K || !e.doc) return;
    const s = [];
    let h = [];
    for (const u of e.doc) if (u.type === Yt) {
      const S = ft(u);
    ...
    e.doc.forEach((u) => this.docTranslator(e, u, true));
  }
  getRootDocV2() {
    return this.docTranslator({ id: z, stmt: z }, { id: z, stmt: z, doc: this.rootDoc }, true), { id: z, doc: this.rootDoc };
  }
  addState(t, e = Z, o = void 0, s = void 0, h = void 0, u = void 0, S = void 0, g = void 0) {
    const n = t == null ? void 0 : t.trim();
    if (!this.currentDocument.states.has(n)) _.info("Adding state ", n, s), this.currentDocument.states.set(n, { stmt: K, id: n, descriptions: [], type: e, doc: o, note: h, classes: [], styles: [], textStyles: [] });
    else {
  ...
  addRelationObjs(t, e, o = "") {
    ...
    this.addState(s, h, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), this.addState(u, S, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles), this.currentDocument.relations.push({ id1: s, id2: u, relationTitle: U.sanitizeText(o, w()) });
  }
  addRelation(t, e, o) {
    if (typeof t == "object" && typeof e == "object") this.addRelationObjs(t, e, o);
      ...
      this.addState(s, h), this.addState(u, S), this.currentDocument.relations.push({ id1: s, id2: u, relationTitle: o ? U.sanitizeText(o, w()) : void 0 });
    }
  }
  addDescription(t, e) {
    var _a2;
    const o = this.currentDocument.states.get(t), s = e.startsWith(":") ? e.replace(":", "").trim() : e;
    (_a2 = o == null ? void 0 : o.descriptions) == null ? void 0 : _a2.push(U.sanitizeText(s, w()));
  }
  cleanupLabel(t) {
  ...
  getDirection() {
    var _a2;
    return ((_a2 = this.getDirectionStatement()) == null ? void 0 : _a2.value) ?? ue;
  }
  setDirection(t) {
  ...
  getData() {
    const t = w();
    return { nodes: this.nodes, edges: this.edges, other: {}, config: t, direction: zt(this.getRootDocV2()) };
  }
  getConfig() {
    return w().state;
  }
}, d(_a, "StateDB"), _a.relationType = { AGGREGATION: 0, EXTENSION: 1, COMPOSITION: 2, DEPENDENCY: 3 }, _a), $e = d((t) => `
