...
I.prototype.has = Ee;
function Ie(n, r) {
  for (var e = -1, t = n == null ? 0 : n.length; ++e < t; ) if (r(n[e], e, n)) return true;
  return false;
}
function En(n, r) {
  return n.has(r);
...
function He(n, r, e, t, f, i, a) {
  switch (e) {
    case je:
      if (n.byteLength != r.byteLength || n.byteOffset != r.byteOffset) return false;
    ...
    case Ue:
      var u = t & Re;
      if (s || (s = H), n.size != r.size && !u) return false;
      var b = a.get(n);
      if (b) return b == r;
      t |= xe, a.set(n, r);
...
function Xe(n, r, e, t, f, i) {
  ...
  for (var o = u; o--; ) {
    var c = s[o];
    if (!(a ? c in r : Ze.call(r, c))) return false;
  }
...
function We(n, r, e, t, f, i) {
  ...
  if (c && !l) return i || (i = new _()), a || jn(n) ? In(n, r, e, t, f, i) : He(n, r, u, e, t, f, i);
  if (!(e & Je)) {
  ...
  return c ? (i || (i = new _()), Xe(n, r, e, t, f, i)) : false;
}
function q(n, r, e, t, f) {
  return n === r ? true : n == null || r == null || !S(n) && !S(r) ? n !== n && r !== r : We(n, r, e, t, q, f);
}
var ze = 1, Ve = 2;
function ke(n, r, e, t) {
  var f = e.length, i = f;
  ...
  for (n = Object(n); f--; ) {
    var a = e[f];
    if (a[2] ? a[1] !== n[a[0]] : !(a[0] in n)) return false;
  }
  for (; ++f < i; ) {
    a = e[f];
    var s = a[0], u = n[s], b = a[1];
    if (a[2]) {
      if (u === void 0 && !(s in n)) return false;
    } else {
      var l = new _(), o;
      if (!(o === void 0 ? q(b, u, ze | Ve, t, l) : o)) return false;
    }
  }
  return true;
}
