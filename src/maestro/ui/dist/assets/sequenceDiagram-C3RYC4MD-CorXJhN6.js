var _a;
import { a as me, b as Kt, g as ct, d as we, c as Xt, e as Jt } from "./chunk-TZMSLE5B-YNuB0O4r.js";
import { _ as f, n as ve, c as st, d as Nt, l as Q, j as ae, e as Ie, f as Le, k as I, b as ee, s as _e, p as Ae, a as ke, g as Pe, q as Ne, t as Se, J as Me, y as Re, i as St, u as W, L as z, M as Lt, N as re, Z as De, O as Ce, P as ie, E as zt } from "./index-CTgvlc8H.js";
import { I as Oe } from "./chunk-QZHKN3VN-CWhFkF1R.js";
var Ht = (function() {
  var e = f(function(pt, v, A, L) {
    for (A = A || {}, L = pt.length; L--; A[pt[L]] = v) ;
    return A;
  }, "o"), t = [1, 2], n = [1, 3], s = [1, 4], r = [2, 4], i = [1, 9], c = [1, 11], h = [1, 13], o = [1, 14], a = [1, 16], p = [1, 17], g = [1, 18], x = [1, 24], y = [1, 25], m = [1, 26], w = [1, 27], k = [1, 28], N = [1, 29], S = [1, 30], O = [1, 31], B = [1, 32], q = [1, 33], H = [1, 34], Z = [1, 35], at = [1, 36], U = [1, 37], G = [1, 38], F = [1, 39], D = [1, 41], $ = [1, 42], K = [1, 43], j = [1, 44], rt = [1, 45], R = [1, 46], E = [1, 4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 49, 50, 52, 53, 55, 60, 61, 62, 63, 71], _ = [2, 71], X = [4, 5, 16, 50, 52, 53], tt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 55, 60, 61, 62, 63, 71], M = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 49, 50, 52, 53, 55, 60, 61, 62, 63, 71], Bt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 48, 50, 52, 53, 55, 60, 61, 62, 63, 71], Qt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 50, 52, 53, 55, 60, 61, 62, 63, 71], ot = [69, 70, 71], lt = [1, 127], Vt = { trace: f(function() {
    ...
    switch (C) {
      ...
      case 16:
        ...
        break;
      case 18:
        this.$ = { type: "sequenceIndex", sequenceIndex: Number(d[u - 2]), sequenceIndexStep: Number(d[u - 1]), sequenceVisible: true, signalType: b.LINETYPE.AUTONUMBER };
        break;
      case 19:
        this.$ = { type: "sequenceIndex", sequenceIndex: Number(d[u - 1]), sequenceIndexStep: 1, sequenceVisible: true, signalType: b.LINETYPE.AUTONUMBER };
        break;
      case 20:
      ...
      case 65:
        ...
        break;
      case 66:
        this.$ = [d[u - 4], d[u - 1], { type: "addMessage", from: d[u - 4].actor, to: d[u - 1].actor, signalType: d[u - 3], msg: d[u], activate: true }, { type: "activeStart", signalType: b.LINETYPE.ACTIVE_START, actor: d[u - 1].actor }];
        break;
      case 67:
        this.$ = [d[u - 4], d[u - 1], { type: "addMessage", from: d[u - 4].actor, to: d[u - 1].actor, signalType: d[u - 3], msg: d[u] }, { type: "activeEnd", signalType: b.LINETYPE.ACTIVE_END, actor: d[u - 4].actor }];
        break;
      case 68:
    ...
    function jt() {
      var et;
      return et = b.pop() || Y.lex() || $t, typeof et != "number" && (et instanceof Array && (b = et, et = b.pop()), et = A.symbols_[et] || et), et;
    }
    f(jt, "lex");
    for (var J, yt, it, Ft, bt = {}, kt, ht, te, Pt; ; ) {
      if (yt = L[L.length - 1], this.defaultActions[yt] ? it = this.defaultActions[yt] : ((J === null || typeof J > "u") && (J = jt()), it = vt[yt] && vt[yt][J]), typeof it > "u" || !it.length || !it[0]) {
        var qt = "";
        Pt = [];
        for (kt in vt[yt]) this.terminals_[kt] && kt > ye && Pt.push("'" + this.terminals_[kt] + "'");
        Y.showPosition ? qt = "Parse error on line " + (At + 1) + `:
` + Y.showPosition() + `
Expecting ` + Pt.join(", ") + ", got '" + (this.terminals_[J] || J) + "'" : qt = "Parse error on line " + (At + 1) + ": Unexpected " + (J == $t ? "end of input" : "'" + (this.terminals_[J] || J) + "'"), this.parseError(qt, { text: Y.match, token: this.terminals_[J] || J, line: Y.yylineno, loc: Wt, expected: Pt });
      }
      if (it[0] instanceof Array && it.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + yt + ", token: " + J);
      switch (it[0]) {
        case 1:
          L.push(J), C.push(Y.yytext), d.push(Y.yylloc), L.push(it[1]), J = null, Zt = Y.yyleng, u = Y.yytext, At = Y.yylineno, Wt = Y.yylloc;
          break;
        case 2:
          if (ht = this.productions_[it[1]][1], bt.$ = C[C.length - ht], bt._$ = { first_line: d[d.length - (ht || 1)].first_line, last_line: d[d.length - 1].last_line, first_column: d[d.length - (ht || 1)].first_column, last_column: d[d.length - 1].last_column }, Ee && (bt._$.range = [d[d.length - (ht || 1)].range[0], d[d.length - 1].range[1]]), Ft = this.performAction.apply(bt, [u, Zt, At, ft.yy, it[1], C, d].concat(Te)), typeof Ft < "u") return Ft;
          ht && (L = L.slice(0, -1 * ht * 2), C = C.slice(0, -1 * ht), d = d.slice(0, -1 * ht)), L.push(this.productions_[it[1]][0]), C.push(bt.$), d.push(bt._$), te = vt[L[L.length - 2]][L[L.length - 1]], L.push(te);
          break;
        case 3:
          return true;
      }
    ...
    var pt = { EOF: 1, parseError: f(function(A, L) {
      if (this.yy.parser) this.yy.parser.parseError(A, L);
      else throw new Error(A);
    }, "parseError"), setInput: f(function(v, A) {
      return this.yy = A || this.yy || {}, this._input = v, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
    }, "setInput"), input: f(function() {
      var v = this._input[0];
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: L ? (L.length === b.length ? this.yylloc.first_column : 0) + b[b.length - L.length].length - L[0].length : this.yylloc.first_column - A }, this.options.ranges && (this.yylloc.range = [C[0], C[0] + this.yyleng - A]), this.yyleng = this.yytext.length, this;
    }, "unput"), more: f(function() {
      return this._more = true, this;
    }, "more"), reject: f(function() {
      if (this.options.backtrack_lexer) this._backtrack = true;
      else return this.parseError("Lexical error on line " + (this.yylineno + 1) + `. You can only invoke reject() in the lexer when the lexer is of the backtracking persuasion (options.backtrack_lexer = true).
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
      return this;
    }, "reject"), less: f(function(v) {
      this.unput(this.match.slice(v));
    }, "less"), pastInput: f(function() {
      var v = this.matched.substr(0, this.matched.length - this.match.length);
      return (v.length > 20 ? "..." : "") + v.substr(-20).replace(/\n/g, "");
    }, "pastInput"), upcomingInput: f(function() {
      var v = this.match;
      return v.length < 20 && (v += this._input.substr(0, 20 - v.length)), (v.substr(0, 20) + (v.length > 20 ? "..." : "")).replace(/\n/g, "");
    }, "upcomingInput"), showPosition: f(function() {
      var v = this.pastInput(), A = new Array(v.length + 1).join("-");
      return v + this.upcomingInput() + `
` + A + "^";
    }, "showPosition"), test_match: f(function(v, A) {
      var L, b, C;
      if (this.options.backtrack_lexer && (C = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (C.yylloc.range = this.yylloc.range.slice(0))), b = v[0].match(/(?:\r\n?|\n).*/g), b && (this.yylineno += b.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: b ? b[b.length - 1].length - b[b.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + v[0].length }, this.yytext += v[0], this.match += v[0], this.matches = v, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(v[0].length), this.matched += v[0], L = this.performAction.call(this, this.yy, this, A, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), L) return L;
      if (this._backtrack) {
        for (var d in C) this[d] = C[d];
        return false;
      }
      return false;
    }, "test_match"), next: f(function() {
      if (this.done) return this.EOF;
      this._input || (this.done = true);
      var v, A, L, b;
      this._more || (this.yytext = "", this.match = "");
      for (var C = this._currentRules(), d = 0; d < C.length; d++) if (L = this._input.match(this.rules[C[d]]), L && (!A || L[0].length > A[0].length)) {
        if (A = L, b = d, this.options.backtrack_lexer) {
          if (v = this.test_match(L, C[d]), v !== false) return v;
          if (this._backtrack) {
            A = false;
            continue;
          } else return false;
      ...
      return A ? (v = this.test_match(A, C[b]), v !== false ? v : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: f(function() {
      var A = this.next();
      return A || this.lex();
    }, "lex"), begin: f(function(A) {
      this.conditionStack.push(A);
    }, "begin"), popState: f(function() {
      var A = this.conditionStack.length - 1;
      return A > 0 ? this.conditionStack.pop() : this.conditionStack[0];
    }, "popState"), _currentRules: f(function() {
      return this.conditionStack.length && this.conditionStack[this.conditionStack.length - 1] ? this.conditions[this.conditionStack[this.conditionStack.length - 1]].rules : this.conditions.INITIAL.rules;
    }, "_currentRules"), topState: f(function(A) {
      return A = this.conditionStack.length - 1 - Math.abs(A || 0), A >= 0 ? this.conditionStack[A] : "INITIAL";
    }, "topState"), pushState: f(function(A) {
      this.begin(A);
    }, "pushState"), stateStackSize: f(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: f(function(A, L, b, C) {
      switch (b) {
        case 0:
          return 5;
        case 1:
  ...
  return f(_t, "Parser"), _t.prototype = Vt, Vt.Parser = _t, new _t();
})();
Ht.parser = Ht;
var Be = Ht, Ve = { SOLID: 0, DOTTED: 1, NOTE: 2, SOLID_CROSS: 3, DOTTED_CROSS: 4, SOLID_OPEN: 5, DOTTED_OPEN: 6, LOOP_START: 10, LOOP_END: 11, ALT_START: 12, ALT_ELSE: 13, ALT_END: 14, OPT_START: 15, OPT_END: 16, ACTIVE_START: 17, ACTIVE_END: 18, PAR_START: 19, PAR_AND: 20, PAR_END: 21, RECT_START: 22, RECT_END: 23, SOLID_POINT: 24, DOTTED_POINT: 25, AUTONUMBER: 26, CRITICAL_START: 27, CRITICAL_OPTION: 28, CRITICAL_END: 29, BREAK_START: 30, BREAK_END: 31, PAR_OVER_START: 32, BIDIRECTIONAL_SOLID: 33, BIDIRECTIONAL_DOTTED: 34 }, Ye = { FILLED: 0, OPEN: 1 }, We = { LEFTOF: 0, RIGHTOF: 1, OVER: 2 }, Mt = { ACTOR: "actor", CONTROL: "control", DATABASE: "database", ENTITY: "entity" }, Fe = (_a = class {
  constructor() {
    this.state = new Oe(() => ({ prevActor: void 0, actors: /* @__PURE__ */ new Map(), createdActors: /* @__PURE__ */ new Map(), destroyedActors: /* @__PURE__ */ new Map(), boxes: [], messages: [], notes: [], sequenceNumbersEnabled: false, wrapEnabled: void 0, currentBox: void 0, lastCreated: void 0, lastDestroyed: void 0 })), this.setAccTitle = ee, this.setAccDescription = _e, this.setDiagramTitle = Ae, this.getAccTitle = ke, this.getAccDescription = Pe, this.getDiagramTitle = Ne, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap(st().wrap), this.LINETYPE = Ve, this.ARROWTYPE = Ye, this.PLACEMENT = We;
  }
  addBox(e) {
  ...
  addActor(e, t, n, s, r) {
    let i = this.state.records.currentBox, c;
    if (r !== void 0) {
      let o;
      r.includes(`
`) ? o = r + `
...
` + r + `
    ...
    s = (c == null ? void 0 : c.type) ?? s;
    const h = this.state.records.actors.get(e);
    if (h) {
      if (this.state.records.currentBox && h.box && this.state.records.currentBox !== h.box) throw new Error(`A same participant should only be defined in one Box: ${h.name} can't be in '${h.box.name}' and in '${this.state.records.currentBox.name}' at the same time.`);
      if (i = h.box ? h.box : this.state.records.currentBox, h.box = i, h && t === h.name && n == null) return;
    }
    if ((n == null ? void 0 : n.text) == null && (n = { text: t, type: s }), (s == null || n.text == null) && (n = { text: t, type: s }), this.state.records.actors.set(e, { box: i, name: t, description: n.text, wrap: n.wrap ?? this.autoWrap(), prevActor: this.state.records.prevActor, links: {}, properties: {}, actorCnt: null, rectData: null, type: s ?? "participant" }), this.state.records.prevActor) {
  ...
  addMessage(e, t, n, s) {
    this.state.records.messages.push({ id: this.state.records.messages.length.toString(), from: e, to: t, message: n.text, wrap: n.wrap ?? this.autoWrap(), answer: s });
  }
  addSignal(e, t, n, s, r = false) {
    if (s === this.LINETYPE.ACTIVE_END && this.activationCount(e ?? "") < 1) {
      const c = new Error("Trying to inactivate an inactive participant (" + e + ")");
      throw c.hash = { text: "->>-", token: "->>-", line: "1", loc: { first_line: 1, last_line: 1, first_column: 1, last_column: 1 }, expected: ["'ACTIVE_PARTICIPANT'"] }, c;
    }
    return this.state.records.messages.push({ id: this.state.records.messages.length.toString(), from: e, to: t, message: (n == null ? void 0 : n.text) ?? "", wrap: (n == null ? void 0 : n.wrap) ?? this.autoWrap(), type: s, activate: r }), true;
  }
  hasAtLeastOneBox() {
  ...
  extractWrap(e) {
    if (e === void 0) return {};
    e = e.trim();
    const t = /^:?wrap:/.exec(e) !== null ? true : /^:?nowrap:/.exec(e) !== null ? false : void 0;
    return { cleanedText: (t === void 0 ? e : e.replace(/^:?(?:no)?wrap:/, "")).trim(), wrap: t };
  }
  autoWrap() {
    var _a2;
    return this.state.records.wrapEnabled !== void 0 ? this.state.records.wrapEnabled : ((_a2 = st().sequence) == null ? void 0 : _a2.wrap) ?? false;
  }
  clear() {
    this.state.reset(), Re();
  }
  parseMessage(e) {
    const t = e.trim(), { wrap: n, cleanedText: s } = this.extractWrap(t), r = { text: s, wrap: n };
    return Q.debug(`parseMessage: ${JSON.stringify(r)}`), r;
  }
  parseBoxData(e) {
    const t = /^((?:rgba?|hsla?)\s*\(.*\)|\w*)(.*)$/.exec(e);
    let n = (t == null ? void 0 : t[1]) ? t[1].trim() : "transparent", s = (t == null ? void 0 : t[2]) ? t[2].trim() : void 0;
    if (window == null ? void 0 : window.CSS) window.CSS.supports("color", n) || (n = "transparent", s = e.trim());
    else {
      const c = new Option().style;
      c.color = n, c.color !== n && (n = "transparent", s = e.trim());
    }
    const { wrap: r, cleanedText: i } = this.extractWrap(s);
    return { text: i ? St(i, st()) : void 0, color: n, wrap: r };
  }
  addNote(e, t, n) {
    const s = { actor: e, placement: t, message: n.text, wrap: n.wrap ?? this.autoWrap() }, r = [].concat(e, e);
    this.state.records.notes.push(s), this.state.records.messages.push({ id: this.state.records.messages.length.toString(), from: r[0], to: r[1], message: n.text, wrap: n.wrap ?? this.autoWrap(), type: this.LINETYPE.NOTE, placement: t });
  }
  addLinks(e, t) {
    ...
    try {
      ...
      Q.error("error while parsing actor link text", s);
    }
  }
  addALink(e, t) {
    const n = this.getActor(e);
    try {
      ...
      const c = r.slice(0, i - 1).trim(), h = r.slice(i + 1).trim();
      s[c] = h, this.insertLinks(n, s);
    } catch (s) {
      Q.error("error while parsing actor link text", s);
    }
  }
  insertLinks(e, t) {
    ...
    else for (const n in t) e.links[n] = t[n];
  }
  addProperties(e, t) {
    const n = this.getActor(e);
    try {
      const s = St(t.text, st()), r = JSON.parse(s);
      this.insertProperties(n, r);
    } catch (s) {
      Q.error("error while parsing actor properties text", s);
    }
  }
  insertProperties(e, t) {
    if (e.properties == null) e.properties = t;
    else for (const n in t) e.properties[n] = t[n];
  }
  boxEnd() {
    this.state.records.currentBox = void 0;
  }
  addDetails(e, t) {
    const n = this.getActor(e), s = document.getElementById(t.text);
    try {
      const r = s.innerHTML, i = JSON.parse(r);
      i.properties && this.insertProperties(n, i.properties), i.links && this.insertLinks(n, i.links);
    } catch (r) {
      Q.error("error while parsing actor details text", r);
    }
  }
...
}, f(_a, "SequenceDB"), _a), qe = f((e) => `.actor {
...
`, "getStyles"), ze = qe, Tt = 36, gt = "actor-top", xt = "actor-bottom", Dt = "actor-box", ut = "actor-man", It = f(function(e, t) {
  return we(e, t);
}, "drawRect"), He = f(function(e, t, n, s, r) {
  ...
  if (x.attr("class", "actorPopupMenuPanel" + p), x.attr("x", h.x), x.attr("y", h.height), x.attr("fill", h.fill), x.attr("stroke", h.stroke), x.attr("width", g), x.attr("height", h.height), x.attr("rx", h.rx), x.attr("ry", h.ry), i != null) {
    var y = 20;
    for (let k in i) {
      var m = a.append("a"), w = ae.sanitizeUrl(i[k]);
      m.attr("xlink:href", w), m.attr("target", "_blank"), ps(s)(k, m, h.x + 10, h.height + y, g, 20, { class: "actor" }, s), y += 30;
    }
  }
  return x.attr("height", y), { height: h.height + y, width: g };
}, "drawPopup"), Ct = f(function(e) {
  return "var pu = document.getElementById('" + e + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle"), Rt = f(async function(e, t, n = null) {
  let s = e.append("foreignObject");
  const r = await ie(t.text, zt()), c = s.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(r).node().getBoundingClientRect();
  ...
  return [s];
}, "drawKatex"), wt = f(function(e, t) {
  let n = 0, s = 0;
  const r = t.text.split(I.lineBreakRegex), [i, c] = re(t.fontSize);
  let h = [], o = 0, a = f(() => t.y, "yfunc");
  ...
  return h;
}, "drawText"), ne = f(function(e, t) {
  function n(r, i, c, h, o) {
    return r + "," + i + " " + (r + c) + "," + i + " " + (r + c) + "," + (i + h - o) + " " + (r + c - o * 1.2) + "," + (i + h) + " " + r + "," + (i + h);
  }
  f(n, "genPoints");
  const s = e.append("polygon");
  return s.attr("points", n(t.x, t.y, t.width, t.height, 7)), s.attr("class", "labelBox"), t.y = t.y + t.height / 2, wt(e, t), s;
}, "drawLabel"), P = -1, oe = f((e, t, n, s) => {
...
}, "fixLifeLineHeights"), Ue = f(function(e, t, n, s) {
  var _a2, _b;
  ...
  const a = ct();
  var p = "actor";
  ((_a2 = t.properties) == null ? void 0 : _a2.class) ? p = t.properties.class : a.fill = "#eaeaea", s ? p += ` ${xt}` : p += ` ${gt}`, a.x = t.x, a.y = r, a.width = t.width, a.height = t.height, a.class = p, a.rx = 3, a.ry = 3, a.name = t.name;
  const g = It(o, a);
  if (t.rectData = a, (_b = t.properties) == null ? void 0 : _b.icon) {
    const y = t.properties.icon.trim();
    y.charAt(0) === "@" ? Xt(o, a.x + a.width - 20, a.y + 10, y.substr(1)) : Jt(o, a.x + a.width - 20, a.y + 10, y);
  }
  dt(n, z(t.description))(t.description, o, a.x, a.y, a.width, a.height, { class: `actor ${Dt}` }, n);
  let x = t.height;
  if (g.node) {
  ...
  return x;
}, "drawActorTypeParticipant"), Ge = f(function(e, t, n, s) {
  var _a2, _b;
  const r = s ? t.stopy : t.starty, i = t.x + t.width / 2, c = r + t.height, h = e.append("g").lower();
  var o = h;
  s || (P++, Object.keys(t.links || {}).length && !n.forceMenus && o.attr("onclick", Ct(`actor${P}_popup`)).attr("cursor", "pointer"), o.append("line").attr("id", "actor" + P).attr("x1", i).attr("y1", c).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), o = h.append("g"), t.actorCnt = P, t.links != null && o.attr("id", "root-" + P));
  const a = ct();
  var p = "actor";
  ((_a2 = t.properties) == null ? void 0 : _a2.class) ? p = t.properties.class : a.fill = "#eaeaea", s ? p += ` ${xt}` : p += ` ${gt}`, a.x = t.x, a.y = r, a.width = t.width, a.height = t.height, a.class = p, a.name = t.name;
  const g = 6, x = { ...a, x: a.x + -g, y: a.y + +g, class: "actor" }, y = It(o, a);
  if (It(o, x), t.rectData = a, (_b = t.properties) == null ? void 0 : _b.icon) {
    const w = t.properties.icon.trim();
    w.charAt(0) === "@" ? Xt(o, a.x + a.width - 20, a.y + 10, w.substr(1)) : Jt(o, a.x + a.width - 20, a.y + 10, w);
  }
  dt(n, z(t.description))(t.description, o, a.x - g, a.y + g, a.width, a.height, { class: `actor ${Dt}` }, n);
  let m = t.height;
  if (y.node) {
  ...
  return m;
}, "drawActorTypeCollections"), Ke = f(function(e, t, n, s) {
  var _a2, _b;
  const r = s ? t.stopy : t.starty, i = t.x + t.width / 2, c = r + t.height, h = e.append("g").lower();
  let o = h;
  s || (P++, Object.keys(t.links || {}).length && !n.forceMenus && o.attr("onclick", Ct(`actor${P}_popup`)).attr("cursor", "pointer"), o.append("line").attr("id", "actor" + P).attr("x1", i).attr("y1", c).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), o = h.append("g"), t.actorCnt = P, t.links != null && o.attr("id", "root-" + P));
  ...
  `).attr("class", p), m.append("path").attr("d", `M ${a.x},${a.y + g}
      a ${x},${g} 0 0 0 0,${a.height}`).attr("stroke", "#666").attr("stroke-width", "1px").attr("class", p), y.attr("transform", `translate(${x}, ${-(a.height / 2)})`), m.attr("transform", `translate(${a.width - x}, ${-a.height / 2})`), t.rectData = a, (_b = t.properties) == null ? void 0 : _b.icon) {
    const N = t.properties.icon.trim(), S = a.x + a.width - 20, O = a.y + 10;
    N.charAt(0) === "@" ? Xt(o, S, O, N.substr(1)) : Jt(o, S, O, N);
  }
  dt(n, z(t.description))(t.description, o, a.x, a.y, a.width, a.height, { class: `actor ${Dt}` }, n);
  let w = t.height;
  ...
  return w;
}, "drawActorTypeQueue"), Xe = f(function(e, t, n, s) {
  var _a2;
  ...
  return t.height = m.height + 2 * (((_a2 = n == null ? void 0 : n.sequence) == null ? void 0 : _a2.labelBoxHeight) ?? 0), dt(n, z(t.description))(t.description, o, p.x, p.y + y + (s ? 5 : 10), p.width, p.height, { class: `actor ${ut}` }, n), t.height;
}, "drawActorTypeControl"), Je = f(function(e, t, n, s) {
  var _a2;
  ...
  const m = o.node().getBBox();
  return t.height = m.height + (((_a2 = n == null ? void 0 : n.sequence) == null ? void 0 : _a2.labelBoxHeight) ?? 0), s || (P++, h.append("line").attr("id", "actor" + P).attr("x1", i).attr("y1", c).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), t.actorCnt = P), dt(n, z(t.description))(t.description, o, p.x, p.y + (s ? (x - r + y - 5) / 2 : (x + y - r) / 2), p.width, p.height, { class: `actor ${ut}` }, n), s ? o.attr("transform", `translate(0, ${y / 2})`) : o.attr("transform", `translate(0, ${y / 2})`), t.height;
}, "drawActorTypeEntity"), Qe = f(function(e, t, n, s) {
  var _a2;
  ...
  const a = ct();
  let p = "actor";
  ((_a2 = t.properties) == null ? void 0 : _a2.class) ? p = t.properties.class : a.fill = "#eaeaea", s ? p += ` ${xt}` : p += ` ${gt}`, a.x = t.x, a.y = r, a.width = t.width, a.height = t.height, a.class = p, a.name = t.name, a.x = t.x, a.y = r;
...
`;
  ...
  return t.height;
}, "drawActorTypeDatabase"), Ze = f(function(e, t, n, s) {
  ...
  return t.height = x.height + (n.sequence.labelBoxHeight ?? 0), dt(n, z(t.description))(t.description, a, g.x, g.y + (s ? h / 2 - 4 : h / 2 + 3), g.width, g.height, { class: `actor ${ut}` }, n), s ? a.attr("transform", `translate(0,${h / 2 + 7})`) : a.attr("transform", `translate(0,${h / 2 + 7})`), t.height;
}, "drawActorTypeBoundary"), $e = f(function(e, t, n, s) {
  ...
  return t.height = x.height, dt(n, z(t.description))(t.description, o, p.x, p.y + 35, p.width, p.height, { class: `actor ${ut}` }, n), t.height;
}, "drawActorTypeActor"), je = f(async function(e, t, n, s) {
  switch (t.type) {
    case "actor":
      return await $e(e, t, n, s);
    case "participant":
      return await Ue(e, t, n, s);
    case "boundary":
...
}, "drawActor"), ts = f(function(e, t, n) {
  const r = e.append("g");
  ce(r, t), t.name && dt(n)(t.name, r, t.x, t.y + n.boxTextMargin + (t.textMaxHeight || 0) / 2, t.width, 0, { class: "text" }, n), r.lower();
}, "drawBox"), es = f(function(e) {
  return e.append("g");
}, "anchorElement"), ss = f(function(e, t, n, s, r) {
...
}, "drawActivation"), as = f(async function(e, t, n, s) {
  const { boxMargin: r, boxTextMargin: i, labelBoxHeight: c, labelBoxWidth: h, messageFontFamily: o, messageFontSize: a, messageFontWeight: p } = s, g = e.append("g"), x = f(function(w, k, N, S) {
  ...
  let y = Kt();
  y.text = n, y.x = t.startx, y.y = t.starty, y.fontFamily = o, y.fontSize = a, y.fontWeight = p, y.anchor = "middle", y.valign = "middle", y.tspan = false, y.width = h || 50, y.height = c || 20, y.textMargin = i, y.class = "labelText", ne(g, y), y = le(), y.text = t.title, y.x = t.startx + h / 2 + (t.stopx - t.startx) / 2, y.y = t.starty + r + i, y.anchor = "middle", y.valign = "middle", y.textMargin = i, y.class = "loopText", y.fontFamily = o, y.fontSize = a, y.fontWeight = p, y.wrap = true;
  let m = z(y.text) ? await Rt(g, y, t) : wt(g, y);
  if (t.sectionTitles !== void 0) {
    for (const [w, k] of Object.entries(t.sectionTitles)) if (k.message) {
      y.text = k.message, y.x = t.startx + (t.stopx - t.startx) / 2, y.y = t.sections[w].y + r + i, y.class = "loopText", y.anchor = "middle", y.valign = "middle", y.tspan = false, y.fontFamily = o, y.fontSize = a, y.fontWeight = p, y.wrap = t.wrap, z(y.text) ? (t.starty = t.sections[w].y, await Rt(g, y, t)) : wt(g, y);
      let N = Math.round(m.map((S) => (S._groups || S)[0][0].getBBox().height).reduce((S, O) => S + O));
      t.sections[w].height += N - (r + i);
    }
  }
  return t.height = Math.round(t.stopy - t.starty), g;
}, "drawLoop"), ce = f(function(e, t) {
  me(e, t);
}, "drawBackgroundRect"), rs = f(function(e) {
...
}, "insertDatabaseIcon"), is = f(function(e) {
...
}, "insertComputerIcon"), ns = f(function(e) {
...
}, "insertClockIcon"), os = f(function(e) {
...
}, "insertArrowHead"), cs = f(function(e) {
...
}, "insertArrowFilledHead"), ls = f(function(e) {
...
}, "insertSequenceNumber"), hs = f(function(e) {
...
}, "insertArrowCrossHead"), le = f(function() {
  ...
  function t(i, c, h, o, a, p, g, x) {
    const { actorFontSize: y, actorFontFamily: m, actorFontWeight: w } = x, [k, N] = re(y), S = i.split(I.lineBreakRegex);
  ...
  async function s(i, c, h, o, a, p, g, x) {
    const y = await Lt(i, zt()), m = c.append("switch"), k = m.append("foreignObject").attr("x", h + a / 2 - y.width / 2).attr("y", o + p / 2 - y.height / 2).attr("width", y.width).attr("height", y.height).append("xhtml:div").style("height", "100%").style("width", "100%");
    k.append("div").style("text-align", "center").style("vertical-align", "middle").html(await ie(i, zt())), t(i, m, h, o, a, p, g, x), r(k, g);
  }
  f(s, "byKatex");
  function r(i, c) {
    for (const h in c) c.hasOwnProperty(h) && i.attr(h, c[h]);
  }
  return f(r, "_setTextAttrs"), function(i, c = false) {
...
}, "getHeight"), clear: f(function() {
  this.actors = [], this.boxes = [], this.loops = [], this.messages = [], this.notes = [];
}, "clear"), addBox: f(function(e) {
  this.boxes.push(e);
}, "addBox"), addActor: f(function(e) {
  this.actors.push(e);
}, "addActor"), addLoop: f(function(e) {
  this.loops.push(e);
}, "addLoop"), addMessage: f(function(e) {
  this.messages.push(e);
}, "addMessage"), addNote: f(function(e) {
  this.notes.push(e);
}, "addNote"), lastActor: f(function() {
  return this.actors[this.actors.length - 1];
}, "lastActor"), lastLoop: f(function() {
  return this.loops[this.loops.length - 1];
}, "lastLoop"), lastMessage: f(function() {
  return this.messages[this.messages.length - 1];
}, "lastMessage"), lastNote: f(function() {
  return this.notes[this.notes.length - 1];
}, "lastNote"), actors: [], boxes: [], loops: [], messages: [], notes: [] }, init: f(function() {
  this.sequenceItems = [], this.activations = [], this.models.clear(), this.data = { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, this.verticalPos = 0, pe(st());
}, "init"), updateVal: f(function(e, t, n, s) {
  e[t] === void 0 ? e[t] = n : e[t] = s(n, e[t]);
}, "updateVal"), updateBounds: f(function(e, t, n, s) {
  const r = this;
  let i = 0;
  function c(h) {
    return f(function(a) {
...
}, "updateBounds"), insert: f(function(e, t, n, s) {
...
}, "insert"), newActivation: f(function(e, t, n) {
  const s = n.get(e.from), r = Ot(e.from).length || 0, i = s.x + s.width / 2 + (r - 1) * l.activationWidth / 2;
  this.activations.push({ startx: i, starty: this.verticalPos + 2, stopx: i + l.activationWidth, stopy: void 0, actor: e.from, anchored: V.anchorElement(t) });
}, "newActivation"), endActivation: f(function(e) {
  const t = this.activations.map(function(n) {
    return n.actor;
  }).lastIndexOf(e.from);
  return this.activations.splice(t, 1)[0];
}, "endActivation"), createLoop: f(function(e = { message: void 0, wrap: false, width: void 0 }, t) {
...
}, "createLoop"), newLoop: f(function(e = { message: void 0, wrap: false, width: void 0 }, t) {
  this.sequenceItems.push(this.createLoop(e, t));
}, "newLoop"), endLoop: f(function() {
  return this.sequenceItems.pop();
}, "endLoop"), isLoopOverlap: f(function() {
  return this.sequenceItems.length ? this.sequenceItems[this.sequenceItems.length - 1].overlap : false;
}, "isLoopOverlap"), addSectionToLoop: f(function(e) {
...
}, "addSectionToLoop"), saveVerticalPos: f(function() {
  this.isLoopOverlap() && (this.savedVerticalPos = this.verticalPos);
}, "saveVerticalPos"), resetVerticalPos: f(function() {
  this.isLoopOverlap() && (this.verticalPos = this.savedVerticalPos);
}, "resetVerticalPos"), bumpVerticalPos: f(function(e) {
  this.verticalPos = this.verticalPos + e, this.data.stopy = I.getMax(this.data.stopy, this.verticalPos);
}, "bumpVerticalPos"), getVerticalPos: f(function() {
  return this.verticalPos;
}, "getVerticalPos"), getBounds: f(function() {
  return { bounds: this.data, models: this.models };
}, "getBounds") }, us = f(async function(e, t) {
  ...
  const s = e.append("g"), r = V.drawRect(s, n), i = Kt();
  ...
  const c = z(i.text) ? await Rt(s, i) : wt(s, i), h = Math.round(c.map((o) => (o._groups || o)[0][0].getBBox().height).reduce((o, a) => o + a));
...
}, "drawNote"), Et = f((e) => ({ fontFamily: e.messageFontFamily, fontSize: e.messageFontSize, fontWeight: e.messageFontWeight }), "messageFont"), mt = f((e) => ({ fontFamily: e.noteFontFamily, fontSize: e.noteFontSize, fontWeight: e.noteFontWeight }), "noteFont"), Ut = f((e) => ({ fontFamily: e.actorFontFamily, fontSize: e.actorFontSize, fontWeight: e.actorFontWeight }), "actorFont");
async function he(e, t) {
  T.bumpVerticalPos(10);
  const { startx: n, stopx: s, message: r } = t, i = I.splitBreaks(r).length, c = z(r), h = c ? await Lt(r, st()) : W.calculateTextDimensions(r, Et(l));
  if (!c) {
    const g = h.height / i;
...
}, "addActorRenderingData"), Gt = f(async function(e, t, n, s) {
  if (s) {
    let r = 0;
    ...
    for (const i of n) {
      ...
      const h = await V.drawActor(e, c, l, true);
      r = I.getMax(r, h);
    }
    T.bumpVerticalPos(r + l.boxMargin);
  } else for (const r of n) {
    const i = t.get(r);
    await V.drawActor(e, i, l, false);
  }
}, "drawActors"), de = f(function(e, t, n, s) {
  let r = 0, i = 0;
  for (const c of n) {
    const h = t.get(c), o = ys(h), a = V.drawPopup(e, h, o, l, l.forceMenus, s);
    a.height > r && (r = a.height), a.width + h.x > i && (i = a.width + h.x);
  }
  return { maxHeight: r, maxWidth: i };
}, "drawActorsPopup"), pe = f(function(e) {
...
}, "setConf"), Ot = f(function(e) {
  return T.activations.filter(function(t) {
    return t.actor === e;
  });
}, "actorActivations"), se = f(function(e, t) {
  const n = t.get(e), s = Ot(e), r = s.reduce(function(c, h) {
...
function nt(e, t, n, s, r) {
  ...
  if (t.id && t.message && e[t.id]) {
    ...
    t.message = W.wrapLabel(`[${t.message}]`, c - 2 * l.wrapPadding, h), t.width = c, t.wrap = true;
...
function ue(e, t, n, s, r, i, c) {
  ...
  const a = [Mt.ACTOR, Mt.CONTROL, Mt.ENTITY, Mt.DATABASE];
  if (i.get(e.to) == s) {
...
f(ue, "adjustCreatedDestroyedData");
var fs = f(async function(e, t, n, s) {
  const { securityLevel: r, sequence: i } = st();
  l = i;
  let c;
  r === "sandbox" && (c = Nt("#i" + t));
  const h = r === "sandbox" ? Nt(c.nodes()[0].contentDocument.body) : Nt("body"), o = r === "sandbox" ? c.nodes()[0].contentDocument : document;
  T.init(), Q.debug(s.db);
  const a = r === "sandbox" ? h.select(`[id="${t}"]`) : Nt(`[id="${t}"]`), p = s.db.getActors(), g = s.db.getCreatedActors(), x = s.db.getDestroyedActors(), y = s.db.getBoxes();
  let m = s.db.getActorKeys();
  const w = s.db.getMessages(), k = s.db.getDiagramTitle(), N = s.db.hasAtLeastOneBox(), S = s.db.hasAtLeastOneBoxWithTitle(), O = await ge(p, w, s);
  if (l.height = await xe(p, O, y), V.insertComputerIcon(a), V.insertDatabaseIcon(a), V.insertClockIcon(a), N && (T.bumpVerticalPos(l.boxMargin), S && T.bumpVerticalPos(y[0].textMaxHeight)), l.hideUnusedParticipants === true) {
    const E = /* @__PURE__ */ new Set();
    w.forEach((_) => {
      E.add(_.from), E.add(_.to);
    }), m = m.filter((_) => E.has(_));
  }
  xs(a, p, g, m, 0, w, false);
  const B = await bs(w, p, O, s);
  V.insertArrowHead(a), V.insertArrowCrossHead(a), V.insertArrowFilledHead(a), V.insertSequenceNumber(a);
  function q(E, _) {
    const X = T.endActivation(E);
    X.starty + 18 > _ && (X.starty = _ - 6, _ += 12), V.drawActivation(a, X, _, l, Ot(E.from).length), T.insert(X.startx, _ - 10, X.stopx, _);
  }
  f(q, "activeEnd");
  let H = 1, Z = 1;
  const at = [], U = [];
  ...
  for (const E of w) {
    ...
    switch (E.type) {
      case s.db.LINETYPE.NOTE:
        T.resetVerticalPos(), X = E.noteModel, await us(a, X);
        break;
      ...
      case s.db.LINETYPE.LOOP_START:
        nt(B, E, l.boxMargin, l.boxMargin + l.boxTextMargin, (M) => T.newLoop(M));
        break;
      ...
      case s.db.LINETYPE.RECT_START:
        nt(B, E, l.boxMargin, l.boxMargin, (M) => T.newLoop(void 0, M.message));
        break;
      ...
      case s.db.LINETYPE.ALT_ELSE:
        nt(B, E, l.boxMargin + l.boxTextMargin, l.boxMargin, (M) => T.addSectionToLoop(M));
        break;
      ...
      case s.db.LINETYPE.PAR_OVER_START:
        nt(B, E, l.boxMargin, l.boxMargin + l.boxTextMargin, (M) => T.newLoop(M)), T.saveVerticalPos();
        break;
      ...
      default:
        try {
          ...
          const M = await he(a, tt);
          ue(E, tt, M, G, p, g, x), at.push({ messageModel: tt, lineStartY: M }), T.models.addMessage(tt);
        } catch (M) {
  ...
  Q.debug("createdActors", g), Q.debug("destroyedActors", x), await Gt(a, p, m, false);
  for (const E of at) await gs(a, E.messageModel, E.lineStartY, s);
  l.mirrorActors && await Gt(a, p, m, true), U.forEach((E) => V.drawBackgroundRect(a, E)), oe(a, p, m, l);
  ...
  const F = de(a, p, m, o), { bounds: D } = T.getBounds();
  ...
  k && a.append("text").text(k).attr("x", (D.stopx - D.startx) / 2 - 2 * l.diagramMarginX).attr("y", -25), Ie(a, K, rt, l.useMaxWidth);
  const R = k ? 40 : 0;
  a.attr("viewBox", D.startx - l.diagramMarginX + " -" + (l.diagramMarginY + R) + " " + rt + " " + (K + R)), Q.debug("models:", T.models);
}, "draw");
async function ge(e, t, n) {
  const s = {};
  for (const r of t) if (e.get(r.to) && e.get(r.from)) {
    const i = e.get(r.to);
    if (r.placement === n.db.PLACEMENT.LEFTOF && !i.prevActor || r.placement === n.db.PLACEMENT.RIGHTOF && !i.nextActor) continue;
    const c = r.placement !== void 0, h = !c, o = c ? mt(l) : Et(l), a = r.wrap ? W.wrapLabel(r.message, l.width - 2 * l.wrapPadding, o) : r.message, g = (z(a) ? await Lt(r.message, st()) : W.calculateTextDimensions(a, o)).width + 2 * l.wrapPadding;
...
f(ge, "getMaxMessageWidthPerActor");
var ys = f(function(e) {
  let t = 0;
  const n = Ut(l);
...
async function xe(e, t, n) {
  ...
  for (const i of e.keys()) {
    const c = e.get(i);
    c.wrap && (c.description = W.wrapLabel(c.description, l.width - 2 * l.wrapPadding, Ut(l)));
    const h = z(c.description) ? await Lt(c.description, st()) : W.calculateTextDimensions(c.description, Ut(l));
...
f(xe, "calculateActorMargins");
var Ts = f(async function(e, t, n) {
  const s = t.get(e.from), r = t.get(e.to), i = s.x, c = r.x, h = e.wrap && e.message;
  let o = z(e.message) ? await Lt(e.message, st()) : W.calculateTextDimensions(h ? W.wrapLabel(e.message, l.width, mt(l)) : e.message, mt(l));
  const a = { width: h ? l.width : I.getMax(l.width, o.width + 2 * l.noteMargin), height: 0, startx: s.x, stopx: 0, starty: 0, stopy: 0, message: e.message };
...
}, "buildNoteModel"), Es = f(function(e, t, n) {
  if (![n.db.LINETYPE.SOLID_OPEN, n.db.LINETYPE.DOTTED_OPEN, n.db.LINETYPE.SOLID, n.db.LINETYPE.DOTTED, n.db.LINETYPE.SOLID_CROSS, n.db.LINETYPE.DOTTED_CROSS, n.db.LINETYPE.SOLID_POINT, n.db.LINETYPE.DOTTED_POINT, n.db.LINETYPE.BIDIRECTIONAL_SOLID, n.db.LINETYPE.BIDIRECTIONAL_DOTTED].includes(e.type)) return {};
  const [s, r] = se(e.from, t), [i, c] = se(e.to, t), h = s <= i;
  let o = h ? r : s, a = h ? i : c;
  const p = Math.abs(i - c) > 2, g = f((w) => h ? -w : w, "adjustValue");
  ...
  e.wrap && e.message && (e.message = W.wrapLabel(e.message, I.getMax(y + 2 * l.wrapPadding, l.width), Et(l)));
  const m = W.calculateTextDimensions(e.message, Et(l));
  return { width: I.getMax(e.wrap ? 0 : m.width + 2 * l.wrapPadding, y + 2 * l.wrapPadding, l.width), height: 0, startx: o, stopx: a, starty: 0, stopy: 0, message: e.message, type: e.type, wrap: e.wrap, fromBounds: Math.min.apply(null, x), toBounds: Math.max.apply(null, x) };
}, "buildMessageModel"), bs = f(async function(e, t, n, s) {
  const r = {}, i = [];
  let c, h, o;
  for (const a of e) {
    switch (a.type) {
      ...
      case s.db.LINETYPE.ACTIVE_START:
        {
          const g = t.get(a.from ? a.from : a.to.actor), x = Ot(a.from ? a.from : a.to.actor).length, y = g.x + g.width / 2 + (x - 1) * l.activationWidth / 2, m = { startx: y, stopx: y + l.activationWidth, actor: a.from, enabled: true };
    ...
    a.placement !== void 0 ? (h = await Ts(a, t, s), a.noteModel = h, i.forEach((g) => {
    ...
    })) : (o = Es(a, t, s), a.msgModel = o, o.startx && o.stopx && i.length > 0 && i.forEach((g) => {
      ...
      } else c.from = I.getMin(o.startx, c.from), c.to = I.getMax(o.stopx, c.to), c.width = I.getMax(c.width, o.width) - l.labelBoxWidth;
    }));
  }
  return T.activations = [], Q.debug("Loop type widths:", r), r;
}, "calculateLoopBounds"), ms = { bounds: T, drawActors: Gt, drawActorsPopup: de, setConf: pe, draw: fs }, Ls = { parser: Be, get db() {
  return new Fe();
}, renderer: ms, styles: ze, init: f((e) => {
  e.sequence || (e.sequence = {}), e.wrap && (e.sequence.wrap = e.wrap, ve({ sequence: { wrap: e.wrap } }));
}, "init") };
export {
  Ls as diagram
};
