var _a, _b;
import { g as oe } from "./chunk-FMBD7UC4-MUrOfgVf.js";
import { _ as d, E as rt, d as O, e as he, l as L, y as de, A as ge, c as R, ai as ue, R as pe, S as fe, O as xe, aj as j, ak as Wt, al as ye, u as $, k as be, am as we, an as xt, i as yt, ao as me } from "./index-CTgvlc8H.js";
import { c as Le } from "./clone-CEDDMd2u.js";
import { G as Se } from "./graph-BtjjCyfS.js";
import { c as ke } from "./channel-B440EG6p.js";
import "./_baseUniq-o7e9QmIE.js";
var bt = (function() {
  var e = d(function(D, y, g, f) {
    for (g = g || {}, f = D.length; f--; g[D[f]] = y) ;
    return g;
  }, "o"), t = [1, 15], a = [1, 7], i = [1, 13], l = [1, 14], s = [1, 19], r = [1, 16], n = [1, 17], c = [1, 18], u = [8, 30], o = [8, 10, 21, 28, 29, 30, 31, 39, 43, 46], x = [1, 23], w = [1, 24], b = [8, 10, 15, 16, 21, 28, 29, 30, 31, 39, 43, 46], S = [8, 10, 15, 16, 21, 27, 28, 29, 30, 31, 39, 43, 46], v = [1, 49], k = { trace: d(function() {
  }, "trace"), yy: {}, symbols_: { error: 2, spaceLines: 3, SPACELINE: 4, NL: 5, separator: 6, SPACE: 7, EOF: 8, start: 9, BLOCK_DIAGRAM_KEY: 10, document: 11, stop: 12, statement: 13, link: 14, LINK: 15, START_LINK: 16, LINK_LABEL: 17, STR: 18, nodeStatement: 19, columnsStatement: 20, SPACE_BLOCK: 21, blockStatement: 22, classDefStatement: 23, cssClassStatement: 24, styleStatement: 25, node: 26, SIZE: 27, COLUMNS: 28, "id-block": 29, end: 30, NODE_ID: 31, nodeShapeNLabel: 32, dirList: 33, DIR: 34, NODE_DSTART: 35, NODE_DEND: 36, BLOCK_ARROW_START: 37, BLOCK_ARROW_END: 38, classDef: 39, CLASSDEF_ID: 40, CLASSDEF_STYLEOPTS: 41, DEFAULT: 42, class: 43, CLASSENTITY_IDS: 44, STYLECLASS: 45, style: 46, STYLE_ENTITY_IDS: 47, STYLE_DEFINITION_DATA: 48, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "SPACELINE", 5: "NL", 7: "SPACE", 8: "EOF", 10: "BLOCK_DIAGRAM_KEY", 15: "LINK", 16: "START_LINK", 17: "LINK_LABEL", 18: "STR", 21: "SPACE_BLOCK", 27: "SIZE", 28: "COLUMNS", 29: "id-block", 30: "end", 31: "NODE_ID", 34: "DIR", 35: "NODE_DSTART", 36: "NODE_DEND", 37: "BLOCK_ARROW_START", 38: "BLOCK_ARROW_END", 39: "classDef", 40: "CLASSDEF_ID", 41: "CLASSDEF_STYLEOPTS", 42: "DEFAULT", 43: "class", 44: "CLASSENTITY_IDS", 45: "STYLECLASS", 46: "style", 47: "STYLE_ENTITY_IDS", 48: "STYLE_DEFINITION_DATA" }, productions_: [0, [3, 1], [3, 2], [3, 2], [6, 1], [6, 1], [6, 1], [9, 3], [12, 1], [12, 1], [12, 2], [12, 2], [11, 1], [11, 2], [14, 1], [14, 4], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [19, 3], [19, 2], [19, 1], [20, 1], [22, 4], [22, 3], [26, 1], [26, 2], [33, 1], [33, 2], [32, 3], [32, 4], [23, 3], [23, 3], [24, 3], [25, 3]], performAction: d(function(y, g, f, m, E, h, W) {
    var p = h.length - 1;
    switch (E) {
      case 4:
    ...
    for (var F, J, H, pt, Q = {}, st, G, Tt, it; ; ) {
      if (J = f[f.length - 1], this.defaultActions[J] ? H = this.defaultActions[J] : ((F === null || typeof F > "u") && (F = Nt()), H = W[J] && W[J][F]), typeof H > "u" || !H.length || !H[0]) {
        var ft = "";
        it = [];
        for (st in W[J]) this.terminals_[st] && st > V && it.push("'" + this.terminals_[st] + "'");
        z.showPosition ? ft = "Parse error on line " + (I + 1) + `:
` + z.showPosition() + `
Expecting ` + it.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : ft = "Parse error on line " + (I + 1) + ": Unexpected " + (F == at ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(ft, { text: z.match, token: this.terminals_[F] || F, line: z.yylineno, loc: ut, expected: it });
      }
      if (H[0] instanceof Array && H.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + J + ", token: " + F);
      switch (H[0]) {
        case 1:
          f.push(F), E.push(z.yytext), h.push(z.yylloc), f.push(H[1]), F = null, Z = z.yyleng, p = z.yytext, I = z.yylineno, ut = z.yylloc;
          break;
        case 2:
          if (G = this.productions_[H[1]][1], Q.$ = E[E.length - G], Q._$ = { first_line: h[h.length - (G || 1)].first_line, last_line: h[h.length - 1].last_line, first_column: h[h.length - (G || 1)].first_column, last_column: h[h.length - 1].last_column }, le && (Q._$.range = [h[h.length - (G || 1)].range[0], h[h.length - 1].range[1]]), pt = this.performAction.apply(Q, [p, Z, I, q.yy, H[1], E, h].concat(ne)), typeof pt < "u") return pt;
    ...
    var D = { EOF: 1, parseError: d(function(g, f) {
      if (this.yy.parser) this.yy.parser.parseError(g, f);
      else throw new Error(g);
    }, "parseError"), setInput: d(function(y, g) {
      return this.yy = g || this.yy || {}, this._input = y, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: f ? (f.length === m.length ? this.yylloc.first_column : 0) + m[m.length - f.length].length - f[0].length : this.yylloc.first_column - g }, this.options.ranges && (this.yylloc.range = [E[0], E[0] + this.yyleng - g]), this.yyleng = this.yytext.length, this;
...
` + g + "^";
    }, "showPosition"), test_match: d(function(y, g) {
      var f, m, E;
      if (this.options.backtrack_lexer && (E = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (E.yylloc.range = this.yylloc.range.slice(0))), m = y[0].match(/(?:\r\n?|\n).*/g), m && (this.yylineno += m.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: m ? m[m.length - 1].length - m[m.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + y[0].length }, this.yytext += y[0], this.match += y[0], this.matches = y, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(y[0].length), this.matched += y[0], f = this.performAction.call(this, this.yy, this, g, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), f) return f;
      if (this._backtrack) {
      ...
      for (var E = this._currentRules(), h = 0; h < E.length; h++) if (f = this._input.match(this.rules[E[h]]), f && (!g || f[0].length > g[0].length)) {
...
bt.parser = bt;
var ve = bt, X = /* @__PURE__ */ new Map(), kt = [], wt = /* @__PURE__ */ new Map(), Bt = "color", Ct = "fill", Ee = "bgFill", Pt = ",", _e = R(), ct = /* @__PURE__ */ new Map(), De = d((e) => be.sanitizeText(e, _e), "sanitizeText"), Ne = d(function(e, t = "") {
  let a = ct.get(e);
  a || (a = { id: e, styles: [], textStyles: [] }, ct.set(e, a)), t == null ? void 0 : t.split(Pt).forEach((i) => {
...
}, "addStyleClass"), Te = d(function(e, t = "") {
  const a = X.get(e);
  t != null && (a.styles = t.split(Pt));
}, "addStyle2Node"), Be = d(function(e, t) {
...
}, "setCssClass"), Yt = d((e, t) => {
  var _a2;
  const a = e.flat(), i = [], s = ((_a2 = a.find((r) => (r == null ? void 0 : r.type) === "column-setting")) == null ? void 0 : _a2.columns) ?? -1;
  for (const r of a) {
    if (typeof s == "number" && s > 0 && r.type !== "column-setting" && typeof r.widthInColumns == "number" && r.widthInColumns > s && L.warn(`Block ${r.id} width ${r.widthInColumns} exceeds configured column width ${s}`), r.label && (r.label = De(r.label)), r.type === "classDef") {
      Ne(r.id, r.css);
      continue;
    }
  ...
  t.children = i;
}, "populateBlockDatabase"), vt = [], et = { id: "root", type: "composite", children: [], columns: -1 }, Ce = d(() => {
...
var It = 0, Ie = d(() => (It++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + It), "generateId"), Oe = d((e) => {
  et.children = e, Yt(e, et), vt = et.children;
}, "setHierarchy"), Re = d((e) => {
  const t = X.get(e);
  return t ? t.columns ? t.columns : t.children ? t.children.length : -1 : -1;
}, "getColumns"), ze = d(() => [...X.values()], "getBlocksFlat"), Ae = d(() => vt || [], "getBlocks"), Me = d(() => kt, "getEdges"), Fe = d((e) => X.get(e), "getBlock"), We = d((e) => {
  X.set(e.id, e);
}, "setBlock"), Pe = d(() => L, "getLogger"), Ye = d(function() {
  return ct;
}, "getClasses"), He = { getConfig: d(() => rt().block, "getConfig"), typeStr2Type: Ht, edgeTypeStr2Type: Kt, edgeStrToEdgeData: Xt, getLogger: Pe, getBlocksFlat: ze, getBlocks: Ae, getEdges: Me, setHierarchy: Oe, getBlock: Fe, setBlock: We, getColumns: Re, getClasses: Ye, clear: Ce, generateId: Ie }, Ke = He, nt = d((e, t) => {
  ...
  ${oe()}
`, "getStyles"), Ue = Xe, je = d((e, t, a, i) => {
  t.forEach((l) => {
    rr[l](e, a, i);
  });
}, "insertMarkers"), Ve = d((e, t, a) => {
...
}, "barb"), rr = { extension: Ve, composition: Ge, aggregation: Ze, dependency: qe, lollipop: Je, point: Qe, circle: $e, cross: tr, barb: er }, ar = je, C = ((_b = (_a = R()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) ?? 8;
function Ut(e, t) {
...
var sr = d((e) => {
  ...
  for (const i of e.children) {
    ...
    L.debug("getMaxChildSize abc95 child:", i.id, "width:", l, "height:", s, "x:", r, "y:", n, i.type), i.type !== "space" && (l > t && (t = l / (e.widthInColumns ?? 1)), s > a && (a = s));
  }
  return { width: t, height: a };
}, "getMaxChildSize");
function ot(e, t, a = 0, i = 0) {
  var _a2, _b2, _c, _d, _e2, _f, _g, _h, _i, _j, _k;
  L.debug("setBlockSizes abc95 (start)", e.id, (_a2 = e == null ? void 0 : e.size) == null ? void 0 : _a2.x, "block width =", e == null ? void 0 : e.size, "siblingWidth", a), ((_b2 = e == null ? void 0 : e.size) == null ? void 0 : _b2.width) || (e.size = { width: a, height: i, x: 0, y: 0 });
  let l = 0, s = 0;
  if (((_c = e.children) == null ? void 0 : _c.length) > 0) {
    ...
    for (const b of e.children) b.size && (L.debug(`abc95 Setting size of children of ${e.id} id=${b.id} ${l} ${s} ${JSON.stringify(b.size)}`), b.size.width = l * (b.widthInColumns ?? 1) + C * ((b.widthInColumns ?? 1) - 1), b.size.height = s, b.size.x = 0, b.size.y = 0, L.debug(`abc95 updating size of ${e.id} children child:${b.id} maxWidth:${l} maxHeight:${s}`));
    ...
    if (x < a) {
      L.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${a} siblingHeight ${i} width ${x}`), x = a, w = i;
      ...
      for (const v of e.children) v.size && (v.size.width = b, v.size.height = S, v.size.x = 0, v.size.y = 0);
    }
    if (L.debug(`abc95 (finale calc) ${e.id} xSize ${u} ySize ${o} columns ${n}${e.children.length} width=${Math.max(x, ((_d = e.size) == null ? void 0 : _d.width) || 0)}`), x < (((_e2 = e == null ? void 0 : e.size) == null ? void 0 : _e2.width) || 0)) {
      x = ((_f = e == null ? void 0 : e.size) == null ? void 0 : _f.width) || 0;
      const b = n > 0 ? Math.min(e.children.length, n) : e.children.length;
      if (b > 0) {
        const S = (x - b * C - C) / b;
        L.debug("abc95 (growing to fit) width", e.id, x, (_g = e.size) == null ? void 0 : _g.width, S);
        for (const v of e.children) v.size && (v.size.width = S);
      }
    }
    e.size = { width: x, height: w, x: 0, y: 0 };
  }
  L.debug("setBlockSizes abc94 (done)", e.id, (_h = e == null ? void 0 : e.size) == null ? void 0 : _h.x, (_i = e == null ? void 0 : e.size) == null ? void 0 : _i.width, (_j = e == null ? void 0 : e.size) == null ? void 0 : _j.y, (_k = e == null ? void 0 : e.size) == null ? void 0 : _k.height);
}
d(ot, "setBlockSizes");
function Et(e, t) {
  var _a2, _b2, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
  L.debug(`abc85 layout blocks (=>layoutBlocks) ${e.id} x: ${(_a2 = e == null ? void 0 : e.size) == null ? void 0 : _a2.x} y: ${(_b2 = e == null ? void 0 : e.size) == null ? void 0 : _b2.y} width: ${(_c = e == null ? void 0 : e.size) == null ? void 0 : _c.width}`);
  const a = e.columns ?? -1;
  if (L.debug("layoutBlocks columns abc95", e.id, "=>", a, e), e.children && e.children.length > 0) {
    const i = ((_e2 = (_d = e == null ? void 0 : e.children[0]) == null ? void 0 : _d.size) == null ? void 0 : _e2.width) ?? 0, l = e.children.length * i + (e.children.length - 1) * C;
    L.debug("widthOfChildren 88", l, "posX");
    let s = 0;
    L.debug("abc91 block?.size?.x", e.id, (_f = e == null ? void 0 : e.size) == null ? void 0 : _f.x);
    let r = ((_g = e == null ? void 0 : e.size) == null ? void 0 : _g.x) ? ((_h = e == null ? void 0 : e.size) == null ? void 0 : _h.x) + (-((_i = e == null ? void 0 : e.size) == null ? void 0 : _i.width) / 2 || 0) : -C, n = 0;
    for (const c of e.children) {
      const u = e;
      if (!c.size) continue;
      const { width: o, height: x } = c.size, { px: w, py: b } = Ut(a, s);
      if (b != n && (n = b, r = ((_j = e == null ? void 0 : e.size) == null ? void 0 : _j.x) ? ((_k = e == null ? void 0 : e.size) == null ? void 0 : _k.x) + (-((_l = e == null ? void 0 : e.size) == null ? void 0 : _l.width) / 2 || 0) : -C, L.debug("New row in layout for block", e.id, " and child ", c.id, n)), L.debug(`abc89 layout blocks (child) id: ${c.id} Pos: ${s} (px, py) ${w},${b} (${(_m = u == null ? void 0 : u.size) == null ? void 0 : _m.x},${(_n = u == null ? void 0 : u.size) == null ? void 0 : _n.y}) parent: ${u.id} width: ${o}${C}`), u.size) {
        const v = o / 2;
        c.size.x = r + C + v, L.debug(`abc91 layout blocks (calc) px, pyid:${c.id} startingPos=X${r} new startingPosX${c.size.x} ${v} padding=${C} width=${o} halfWidth=${v} => x:${c.size.x} y:${c.size.y} ${c.widthInColumns} (width * (child?.w || 1)) / 2 ${o * ((c == null ? void 0 : c.widthInColumns) ?? 1) / 2}`), r = c.size.x + v, c.size.y = u.size.y - u.size.height / 2 + b * (x + C) + x / 2 + C, L.debug(`abc88 layout blocks (calc) px, pyid:${c.id}startingPosX${r}${C}${v}=>x:${c.size.x}y:${c.size.y}${c.widthInColumns}(width * (child?.w || 1)) / 2${o * ((c == null ? void 0 : c.widthInColumns) ?? 1) / 2}`);
      }
      c.children && Et(c);
  ...
  L.debug(`layout blocks (<==layoutBlocks) ${e.id} x: ${(_o = e == null ? void 0 : e.size) == null ? void 0 : _o.x} y: ${(_p = e == null ? void 0 : e.size) == null ? void 0 : _p.y} width: ${(_q = e == null ? void 0 : e.size) == null ? void 0 : _q.width}`);
}
d(Et, "layoutBlocks");
function _t(e, { minX: t, minY: a, maxX: i, maxY: l } = { minX: 0, minY: 0, maxX: 0, maxY: 0 }) {
  ...
  if (e.children) for (const s of e.children) ({ minX: t, minY: a, maxX: i, maxY: l } = _t(s, { minX: t, minY: a, maxX: i, maxY: l }));
...
var ir = d(async (e, t, a, i) => {
  ...
  if (j(s.flowchart.htmlLabels)) {
    ...
    const r = await we(xt(l)), n = { isNode: i, label: r, labelStyle: t.replace("fill:", "color:") };
    return Vt(n, s);
  } else {
...
}, "createLabel"), K = ir, nr = d((e, t, a, i, l) => {
  t.arrowTypeStart && Ot(e, "start", t.arrowTypeStart, a, i, l), t.arrowTypeEnd && Ot(e, "end", t.arrowTypeEnd, a, i, l);
}, "addEdgeMarkers"), lr = { arrow_cross: "cross", arrow_point: "point", arrow_barb: "barb", arrow_circle: "circle", aggregation: "aggregation", extension: "extension", composition: "composition", dependency: "dependency", lollipop: "lollipop" }, Ot = d((e, t, a, i, l, s) => {
  const r = lr[a];
  if (!r) {
...
}, "addEdgeMarker"), Lt = {}, M = {}, cr = d(async (e, t) => {
  const a = R(), i = j(a.flowchart.htmlLabels), l = t.labelType === "markdown" ? Wt(e, t.label, { style: t.labelStyle, useHtmlLabels: i, addSvgBackground: true }, a) : await K(t.label, t.labelStyle), s = e.insert("g").attr("class", "edgeLabel"), r = s.insert("g").attr("class", "label");
...
var or = d((e, t) => {
  ...
  if (e.label) {
    ...
    if (a) {
      ...
      L.debug("Moving label " + e.label + " from (", r, ",", n, ") to (", c.x, ",", c.y, ") abc88"), t.updatedPath && (r = c.x, n = c.y);
    }
  ...
  return e.forEach((s) => {
    if (!hr(t, s) && !l) {
      ...
      a.forEach((c) => {
        n = n || c.x === r.x && c.y === r.y;
      }), a.some((c) => c.x === r.x && c.y === r.y) || a.push(r), l = true;
    } else i = s, l || a.push(s);
  }), a;
}, "cutPathAtIntersect"), gr = d(function(e, t, a, i, l, s, r) {
  let n = a.points;
  L.debug("abc88 InsertEdge: edge=", a, "e=", t);
  let c = false;
  const u = s.node(t.v);
  var o = s.node(t.w);
  (o == null ? void 0 : o.intersect) && (u == null ? void 0 : u.intersect) && (n = n.slice(1, a.points.length - 1), n.unshift(u.intersect(n[0])), n.push(o.intersect(n[n.length - 1]))), a.toCluster && (L.debug("to cluster abc88", i[a.toCluster]), n = Rt(a.points, i[a.toCluster].node), c = true), a.fromCluster && (L.debug("from cluster abc88", i[a.fromCluster]), n = Rt(n.reverse(), i[a.fromCluster].node).reverse(), c = true);
  ...
  let _ = "";
  (R().flowchart.arrowMarkerAbsolute || R().state.arrowMarkerAbsolute) && (_ = xe(true)), nr(B, a, _, r, l);
  let D = {};
  ...
  return t;
}, "expandAndDeduplicateDirections"), pr = d((e, t, a) => {
...
function Qt(e, t, a, i) {
  ...
  if (l = t.y - e.y, r = e.x - t.x, c = t.x * e.y - e.x * t.y, w = l * a.x + r * a.y + c, b = l * i.x + r * i.y + c, !(w !== 0 && b !== 0 && St(w, b)) && (s = i.y - a.y, n = a.x - i.x, u = i.x * a.y - a.x * i.y, o = s * e.x + n * e.y + u, x = s * t.x + n * t.y + u, !(o !== 0 && x !== 0 && St(o, x)) && (S = l * n - s * r, S !== 0))) return v = Math.abs(S / 2), k = r * u - n * c, B = k < 0 ? (k - v) / S : (k + v) / S, k = s * c - l * u, _ = k < 0 ? (k - v) / S : (k + v) / S, { x: B, y: _ };
}
d(Qt, "intersectLine");
function St(e, t) {
  return e * t > 0;
...
function $t(e, t, a) {
  ...
  for (var c = i - e.width / 2 - r, u = l - e.height / 2 - n, o = 0; o < t.length; o++) {
    var x = t[o], w = t[o < t.length - 1 ? o + 1 : 0], b = yr(e, a, { x: c + x.x, y: u + x.y }, { x: c + w.x, y: u + w.y });
    b && s.push(b);
  }
...
var wr = d((e, t) => {
...
}, "intersectRect"), mr = wr, N = { node: fr, circle: xr, ellipse: qt, polygon: br, rect: mr }, A = d(async (e, t, a, i) => {
  const l = R();
  let s;
  ...
  const o = c.node();
  let x;
  t.labelType === "markdown" ? x = Wt(c, yt(xt(u), l), { useHtmlLabels: r, width: t.width || l.flowchart.wrappingWidth, classes: "markdown-node-label" }, l) : x = o.appendChild(await K(yt(xt(u), l), t.labelStyle, false, i));
  let w = x.getBBox();
  const b = t.padding / 2;
...
var Lr = d(async (e, t) => {
  ...
  const { shapeSvg: i, bbox: l, halfPadding: s } = await A(e, t, "node " + t.classes, true);
...
}, "note"), Sr = Lr, zt = d((e) => e ? " " + e : "", "formatClass"), Y = d((e, t) => `${t || "node default"}${zt(e.classes)} ${zt(e.class)}`, "getClassesFromNode"), At = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = l + s, n = [{ x: r / 2, y: 0 }, { x: r, y: -r / 2 }, { x: r / 2, y: -r }, { x: 0, y: -r / 2 }];
  ...
  const a = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), i = 28, l = [{ x: 0, y: i / 2 }, { x: i / 2, y: 0 }, { x: 0, y: -i / 2 }, { x: -i / 2, y: 0 }];
...
}, "choice"), vr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = 4, s = i.height + t.padding, r = s / l, n = i.width + 2 * r + t.padding, c = [{ x: r, y: 0 }, { x: n - r, y: 0 }, { x: n, y: -s / 2 }, { x: n - r, y: -s }, { x: r, y: -s }, { x: 0, y: -s / 2 }], u = U(a, n, s, c);
  return u.attr("style", t.style), T(t, u), t.intersect = function(o) {
    return N.polygon(t, c, o);
  }, a;
}, "hexagon"), Er = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, void 0, true), l = 2, s = i.height + 2 * t.padding, r = s / l, n = i.width + 2 * r + t.padding, c = pr(t.directions, i, t), u = U(a, n, s, c);
  return u.attr("style", t.style), T(t, u), t.intersect = function(o) {
    return N.polygon(t, c, o);
  }, a;
}, "block_arrow"), _r = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: -s / 2, y: 0 }, { x: l, y: 0 }, { x: l, y: -s }, { x: -s / 2, y: -s }, { x: 0, y: -s / 2 }];
  return U(a, l, s, r).attr("style", t.style), t.width = l + s, t.height = s, t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "rect_left_inv_arrow"), Dr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: -2 * s / 6, y: 0 }, { x: l - s / 6, y: 0 }, { x: l + 2 * s / 6, y: -s }, { x: s / 6, y: -s }], n = U(a, l, s, r);
  return n.attr("style", t.style), T(t, n), t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "lean_right"), Nr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: 2 * s / 6, y: 0 }, { x: l + s / 6, y: 0 }, { x: l - 2 * s / 6, y: -s }, { x: -s / 6, y: -s }], n = U(a, l, s, r);
  return n.attr("style", t.style), T(t, n), t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "lean_left"), Tr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: -2 * s / 6, y: 0 }, { x: l + 2 * s / 6, y: 0 }, { x: l - s / 6, y: -s }, { x: s / 6, y: -s }], n = U(a, l, s, r);
  return n.attr("style", t.style), T(t, n), t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "trapezoid"), Br = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: s / 6, y: 0 }, { x: l - s / 6, y: 0 }, { x: l + 2 * s / 6, y: -s }, { x: -2 * s / 6, y: -s }], n = U(a, l, s, r);
  return n.attr("style", t.style), T(t, n), t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "inv_trapezoid"), Cr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: 0, y: 0 }, { x: l + s / 2, y: 0 }, { x: l, y: -s / 2 }, { x: l + s / 2, y: -s }, { x: 0, y: -s }], n = U(a, l, s, r);
  return n.attr("style", t.style), T(t, n), t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "rect_right_inv_arrow"), Ir = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = l / 2, r = s / (2.5 + l / 50), n = i.height + r + t.padding, c = "M 0," + r + " a " + s + "," + r + " 0,0,0 " + l + " 0 a " + s + "," + r + " 0,0,0 " + -l + " 0 l 0," + n + " a " + s + "," + r + " 0,0,0 " + l + " 0 l 0," + -n, u = a.attr("label-offset-y", r).insert("path", ":first-child").attr("style", t.style).attr("d", c).attr("transform", "translate(" + -l / 2 + "," + -(n / 2 + r) + ")");
...
}, "cylinder"), Or = d(async (e, t) => {
  const { shapeSvg: a, bbox: i, halfPadding: l } = await A(e, t, "node " + t.classes + " " + t.class, true), s = a.insert("rect", ":first-child"), r = t.positioned ? t.width : i.width + t.padding, n = t.positioned ? t.height : i.height + t.padding, c = t.positioned ? -r / 2 : -i.width / 2 - l, u = t.positioned ? -n / 2 : -i.height / 2 - l;
  ...
  const { shapeSvg: a, bbox: i, halfPadding: l } = await A(e, t, "node " + t.classes, true), s = a.insert("rect", ":first-child"), r = t.positioned ? t.width : i.width + t.padding, n = t.positioned ? t.height : i.height + t.padding, c = t.positioned ? -r / 2 : -i.width / 2 - l, u = t.positioned ? -n / 2 : -i.height / 2 - l;
...
}, "composite"), zr = d(async (e, t) => {
  const { shapeSvg: a } = await A(e, t, "label", true);
...
var Ar = d(async (e, t) => {
  ...
  let w = u.getBBox();
  const b = r.node().appendChild(await K(x.join ? x.join("<br/>") : x, t.labelStyle, true, true));
  if (j(R().flowchart.htmlLabels)) {
    const v = b.children[0], k = O(b);
    o = v.getBoundingClientRect(), k.attr("width", o.width), k.attr("height", o.height);
  }
  const S = t.padding / 2;
  return O(b).attr("transform", "translate( " + (o.width > w.width ? 0 : (w.width - o.width) / 2) + ", " + (w.height + S + 5) + ")"), O(u).attr("transform", "translate( " + (o.width < w.width ? 0 : -(w.width - o.width) / 2) + ", 0)"), o = r.node().getBBox(), r.attr("transform", "translate(" + -o.width / 2 + ", " + (-o.height / 2 - S + 3) + ")"), l.attr("class", "outer title-state").attr("x", -o.width / 2 - S).attr("y", -o.height / 2 - S).attr("width", o.width + t.padding).attr("height", o.height + t.padding), s.attr("class", "divider").attr("x1", -o.width / 2 - S).attr("x2", o.width / 2 + S).attr("y1", -o.height / 2 - S + w.height + S).attr("y2", -o.height / 2 - S + w.height + S), T(t, l), t.intersect = function(v) {
    return N.rect(t, v);
  }, i;
}, "rectWithTitle"), Mr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.height + t.padding, s = i.width + l / 4 + t.padding, r = a.insert("rect", ":first-child").attr("style", t.style).attr("rx", l / 2).attr("ry", l / 2).attr("x", -s / 2).attr("y", -l / 2).attr("width", s).attr("height", l);
  return T(t, r), t.intersect = function(n) {
    return N.rect(t, n);
  }, a;
}, "stadium"), Fr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i, halfPadding: l } = await A(e, t, Y(t, void 0), true), s = a.insert("circle", ":first-child");
...
}, "circle"), Wr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i, halfPadding: l } = await A(e, t, Y(t, void 0), true), s = 5, r = a.insert("g", ":first-child"), n = r.insert("circle"), c = r.insert("circle");
...
}, "doublecircle"), Pr = d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await A(e, t, Y(t, void 0), true), l = i.width + t.padding, s = i.height + t.padding, r = [{ x: 0, y: 0 }, { x: l, y: 0 }, { x: l, y: -s }, { x: 0, y: -s }, { x: 0, y: 0 }, { x: -8, y: 0 }, { x: l + 8, y: 0 }, { x: l + 8, y: -s }, { x: -8, y: -s }, { x: -8, y: 0 }], n = U(a, l, s, r);
  return n.attr("style", t.style), T(t, n), t.intersect = function(c) {
    return N.polygon(t, r, c);
  }, a;
}, "subroutine"), Yr = d((e, t) => {
  ...
  let b = 0;
  const S = (_a2 = t.classData.annotations) == null ? void 0 : _a2[0], v = t.classData.annotations[0] ? "\xAB" + t.classData.annotations[0] + "\xBB" : "", k = w.node().appendChild(await K(v, t.labelStyle, true, true));
  let B = k.getBBox();
  if (j(R().flowchart.htmlLabels)) {
  ...
  t.classData.members.forEach(async (E) => {
    ...
    const p = w.node().appendChild(await K(W, h.cssStyle ? h.cssStyle : t.labelStyle, true, true));
    let I = p.getBBox();
    if (j(R().flowchart.htmlLabels)) {
  ...
  if (t.classData.methods.forEach(async (E) => {
    ...
    let E = (o - B.width) / 2;
    O(k).attr("transform", "translate( " + (-1 * o / 2 + E) + ", " + -1 * x / 2 + ")"), b = B.height + i;
  }
  let m = (o - y.width) / 2;
  return O(D).attr("transform", "translate( " + (-1 * o / 2 + m) + ", " + (-1 * x / 2 + b) + ")"), b += y.height + i, c.attr("class", "divider").attr("x1", -o / 2 - a).attr("x2", o / 2 + a).attr("y1", -x / 2 - a + l + b).attr("y2", -x / 2 - a + l + b), b += l, g.forEach((E) => {
    O(E).attr("transform", "translate( " + -o / 2 + ", " + (-1 * x / 2 + b + l / 2) + ")");
    const h = E == null ? void 0 : E.getBBox();
    b += ((h == null ? void 0 : h.height) ?? 0) + i;
...
}, "class_box"), Ft = { rhombus: At, composite: Rr, question: At, rect: Or, labelRect: zr, rectWithTitle: Ar, choice: kr, circle: Fr, doublecircle: Wr, stadium: Mr, hexagon: vr, block_arrow: Er, rect_left_inv_arrow: _r, lean_right: Dr, lean_left: Nr, trapezoid: Tr, inv_trapezoid: Br, rect_right_inv_arrow: Cr, cylinder: Ir, start: Yr, end: Hr, note: Sr, subroutine: Pr, fork: Mt, join: Mt, class_box: Kr }, lt = {}, te = d(async (e, t, a) => {
  let i, l;
  if (t.link) {
    let s;
...
function Dt(e, t, a = false) {
  ...
  const i = e;
  let l = "default";
  (((_a2 = i == null ? void 0 : i.classes) == null ? void 0 : _a2.length) || 0) > 0 && (l = ((i == null ? void 0 : i.classes) ?? []).join(" ")), l = l + " flowchart-label";
  let s = 0, r = "", n;
  switch (i.type) {
    case "round":
      s = 5, r = "rect";
  ...
  const c = me((i == null ? void 0 : i.styles) ?? []), u = i.label, o = i.size ?? { width: 0, height: 0, x: 0, y: 0 };
  return { labelStyle: c.labelStyle, shape: r, labelText: u, rx: s, ry: s, class: l, style: c.style, id: i.id, directions: i.directions, width: o.width, height: o.height, x: o.x, y: o.y, positioned: a, intersect: void 0, type: i.type, padding: n ?? ((_c = (_b2 = rt()) == null ? void 0 : _b2.block) == null ? void 0 : _c.padding) ?? 0 };
}
d(Dt, "getNodeFromBlock");
async function ee(e, t, a) {
  const i = Dt(t, a, false);
...
async function re(e, t, a) {
  ...
  if (a.getBlock(i.id).type !== "space") {
    const s = rt();
    await te(e, i, { config: s }), t.intersect = i == null ? void 0 : i.intersect, Xr(i);
  }
}
...
async function ie(e, t, a, i, l) {
  const s = new Se({ multigraph: true, compound: true });
...
var Ur = d(function(e, t) {
...
}, "getClasses"), jr = d(async function(e, t, a, i) {
  ...
  if (await se(S, x, r), await ie(S, b, w, r, t), v) {
    ...
    he(u, _, D, !!y), L.debug("Here Bounds", v, k), u.attr("viewBox", `${k.x - 5} ${k.y - 5} ${k.width + 10} ${k.height + 10}`);
  }
}, "draw"), Vr = { draw: jr, getClasses: Ur }, ta = { parser: ve, db: Ke, renderer: Vr, styles: Ue };
export {
  ta as diagram
};
