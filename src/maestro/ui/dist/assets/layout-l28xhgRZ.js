import { G as g } from "./graph-BtjjCyfS.js";
import { b as Te, p as ce, q as le, g as X, e as ee, l as j, o as Ie, s as Me, c as Se, u as Fe, d as f, i as m, f as _, v as x, r as M } from "./_baseUniq-o7e9QmIE.js";
import { f as O, b as he, a as je, c as Ve, d as Ae, t as V, m as w, e as P, h as ve, g as z, l as T, i as Be } from "./_basePickBy-UWsuIbv6.js";
import { b8 as Ge, b9 as Ye, ba as De, aT as qe, bb as We, aX as pe, aW as we, bc as $e, aS as q, aA as Xe, aZ as ze, aC as Ue, bd as W } from "./index-CTgvlc8H.js";
function He(e) {
...
function xn(e) {
  var n = [], r = {}, t = {};
  function a(i) {
    Object.prototype.hasOwnProperty.call(t, i) || (t[i] = true, r[i] = true, f(e.outEdges(i), function(o) {
...
function _n(e) {
  function n(r) {
    ...
    if (t.length && f(t, n), Object.prototype.hasOwnProperty.call(a, "minRank")) {
      ...
      for (var i = a.minRank, o = a.maxRank + 1; i < o; ++i) ae(e, "borderLeft", "_bl", r, a, i), ae(e, "borderRight", "_br", r, a, i);
    }
  }
  f(e.children(), n);
}
...
function Fn(e, n) {
  ...
  if (i !== t + 1) {
    e.removeEdge(n);
    var s = void 0, c, l;
    for (l = 0, ++t; t < i; ++l, ++t) u.points = [], s = { width: 0, height: 0, edgeLabel: u, edgeObj: n, rank: t }, c = L(e, "edge", s, "_d"), t === d && (s.width = u.width, s.height = u.height, s.dummy = "edge-label", s.labelpos = u.labelpos), e.setEdge(r, c, { weight: u.weight }, o), l === 0 && e.graph().dummyChains.push(c), r = c;
...
function jn(e) {
  f(e.graph().dummyChains, function(n) {
    ...
    for (e.setEdge(r.edgeObj, t); r.dummy; ) a = e.successors(n)[0], e.removeNode(n), t.points.push({ x: r.x, y: r.y }), r.dummy === "edge-label" && (t.x = r.x, t.y = r.y, t.width = r.width, t.height = r.height), n = a, r = e.node(n);
  });
}
function Z(e) {
  var n = {};
  function r(t) {
    ...
    n[t] = true;
    var i = P(w(e.outEdges(t), function(o) {
...
function xe(e, n, r, t, a, i) {
  Object.prototype.hasOwnProperty.call(t, n) || (t[n] = true, r || i.push(n), f(a(n), function(o) {
    xe(e, o, r, t, a, i);
  }), r && i.push(n));
}
function Yn(e, n) {
...
function Ee(e, n, r) {
  ...
  return o || (i = false, o = n.edge(a, r)), u = o.weight, f(n.nodeEdges(r), function(d) {
...
function Oe(e, n, r, t, a) {
  var i = r, o = e.node(t);
  return n[t] = true, f(e.neighbors(t), function(u) {
...
function Ce(e, n, r, t, a, i, o) {
  ...
  e.setParent(d, o), c.borderTop = d, e.setParent(s, o), c.borderBottom = s, f(u, function(l) {
    ...
    e.setEdge(d, v, { weight: b, minlen: N, nestingEdge: true }), e.setEdge(p, s, { weight: b, minlen: N, nestingEdge: true });
...
function er(e, n, r) {
  var t = nr(e), a = new g({ compound: true }).setGraph({ root: t }).setDefaultNodeLabel(function(i) {
    return e.node(i);
  });
...
function tr(e, n, r) {
  for (var t = vn(r, w(r, function(s, c) {
    return c;
  })), a = O(w(n, function(s) {
...
function yr(e, n) {
  if (e.node(n).dummy) return z(e.predecessors(n), function(r) {
...
function Er(e, n, r, t, a) {
  ...
  function d(l, h) {
    for (var v = o.nodes(), p = v.pop(), b = {}; p; ) b[p] ? l(p) : (b[p] = true, v.push(p), v = v.concat(h(p))), p = v.pop();
  }
  function s(l) {
...
var Fr = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], jr = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, Vr = ["acyclicer", "ranker", "rankdir", "align"], Ar = ["width", "height"], Br = { width: 0, height: 0 }, Gr = ["minlen", "weight", "width", "height", "labeloffset"], Yr = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" }, Dr = ["labelpos"];
function qr(e) {
  var n = new g({ multigraph: true, compound: true }), r = D(e.graph());
  return n.setGraph(W({}, jr, Y(r, Fr), I(r, Vr))), f(e.nodes(), function(t) {
    var a = D(e.node(t));
    n.setNode(t, Be(Y(a, Ar), Br)), n.setParent(t, e.parent(t));
  }), f(e.edges(), function(t) {
    var a = D(e.edge(t));
    n.setEdge(t, W({}, Yr, Y(a, Gr), I(a, Dr)));
  }), n;
}
function Wr(e) {
  var n = e.graph();
  ...
  f(n, function(r) {
    ...
    f(r, function(a, i) {
      ...
      o.order = i + t, f(o.selfEdges, function(u) {
        L(e, "selfedge", { width: u.label.width, height: u.label.height, rank: o.rank, order: i + ++t, e: u.e, label: u.label }, "_se");
      }), delete o.selfEdges;
    });
  });
}
function nt(e) {
  f(e.nodes(), function(n) {
    ...
    if (r.dummy === "selfedge") {
      ...
      e.setEdge(r.e, r.label), e.removeNode(n), r.label.points = [{ x: a + 2 * o / 3, y: i - u }, { x: a + 5 * o / 6, y: i - u }, { x: a + o, y: i }, { x: a + 5 * o / 6, y: i + u }, { x: a + 2 * o / 3, y: i + u }], r.label.x = r.x, r.label.y = r.y;
    }
  });
}
function Y(e, n) {
