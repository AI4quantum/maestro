var _a, _b, _c;
import { _ as g, p as mt, q as kt, s as _t, g as xt, b as vt, a as bt, c as ot, z as wt, d as G, V as St, y as Lt, k as Et } from "./index-CTgvlc8H.js";
import { o as At } from "./ordinal-Cboi1Yqb.js";
...
function at(t, n) {
  let i;
  if (n === void 0) for (const a of t) a != null && (i < a || i === void 0 && a >= a) && (i = a);
  else {
    let a = -1;
    for (let h of t) (h = n(h, ++a, t)) != null && (i < h || i === void 0 && h >= h) && (i = h);
  }
  return i;
}
function dt(t, n) {
...
function J(t, n) {
  let i = 0;
  if (n === void 0) for (let a of t) (a = +a) && (i += a);
  else {
    let a = -1;
    for (let h of t) (h = +n(h, ++a, t)) && (i += h);
  }
  return i;
}
function Nt(t) {
...
function ht({ nodes: t }) {
  for (const n of t) {
    let i = n.y0, a = i;
    for (const h of n.sourceLinks) h.y0 = i + h.width / 2, i += h.width;
    for (const h of n.targetLinks) h.y1 = a + h.width / 2, a += h.width;
  }
}
function $t() {
  ...
  function M({ nodes: e, links: f }) {
    for (const [c, r] of e.entries()) r.index = c, r.sourceLinks = [], r.targetLinks = [];
    ...
    if (l != null) for (const { sourceLinks: c, targetLinks: r } of e) c.sort(l), r.sort(l);
  }
  function T({ nodes: e }) {
    for (const f of e) f.value = f.fixedValue === void 0 ? Math.max(J(f.sourceLinks, tt), J(f.targetLinks, tt)) : f.fixedValue;
  }
  function N({ nodes: e }) {
    const f = e.length;
  ...
  function B(e) {
    ...
    for (const u of e) {
      ...
      for (const r of u) {
        ...
        for (const m of r.sourceLinks) m.width = m.value * f;
      }
      c = (a - c + p) / (u.length + 1);
  ...
  function P(e, f, u) {
    for (let c = 1, r = e.length; c < r; ++c) {
      ...
      for (const w of m) {
        let L = 0, R = 0;
        for (const { source: U, value: Z } of w.targetLinks) {
          let W = Z * (w.layer - U.layer);
          L += $(U, w) * W, R += W;
        }
        if (!(R > 0)) continue;
        let F = (L / R - w.y0) * f;
  ...
  function j(e, f, u) {
    for (let c = e.length, r = c - 2; r >= 0; --r) {
      ...
      for (const w of m) {
        let L = 0, R = 0;
        for (const { target: U, value: Z } of w.sourceLinks) {
          let W = Z * (U.layer - w.layer);
          L += I(w, U) * W, R += W;
        }
        if (!(R > 0)) continue;
        let F = (L / R - w.y0) * f;
  ...
  function E({ sourceLinks: e, targetLinks: f }) {
    if (l === void 0) {
      for (const { source: { sourceLinks: u } } of f) u.sort(ct);
      for (const { target: { targetLinks: u } } of e) u.sort(lt);
    }
  }
  function A(e) {
    if (l === void 0) for (const { sourceLinks: f, targetLinks: u } of e) f.sort(ct), u.sort(lt);
  }
  function $(e, f) {
...
var et = Math.PI, nt = 2 * et, V = 1e-6, jt = nt - V;
function it() {
...
it.prototype = pt.prototype = { constructor: it, moveTo: function(t, n) {
  ...
  else if (_ > V) if (!(Math.abs(l * k - s * o) > V) || !h) this._ += "L" + (this._x1 = t) + "," + (this._y1 = n);
  else {
    var x = i - b, y = a - p, v = k * k + s * s, M = x * x + y * y, T = Math.sqrt(v), N = Math.sqrt(_), C = h * Math.tan((et - Math.acos((v + _ - M) / (2 * T * N))) / 2), D = C / N, B = C / T;
    Math.abs(D - 1) > V && (this._ += "L" + (t + D * o) + "," + (n + D * l)), this._ += "A" + h + "," + h + ",0,0," + +(l * x > o * y) + "," + (this._x1 = t + B * k) + "," + (this._y1 = n + B * s);
  }
}, arc: function(t, n, i, a, h, b) {
  t = +t, n = +n, i = +i, b = !!b;
  var p = i * Math.cos(a), k = i * Math.sin(a), s = t + p, o = n + k, l = 1 ^ b, _ = b ? a - h : h - a;
  if (i < 0) throw new Error("negative radius: " + i);
  this._x1 === null ? this._ += "M" + s + "," + o : (Math.abs(this._x1 - s) > V || Math.abs(this._y1 - o) > V) && (this._ += "L" + s + "," + o), i && (_ < 0 && (_ = _ % nt + nt), _ > jt ? this._ += "A" + i + "," + i + ",0,1," + l + "," + (t - p) + "," + (n - k) + "A" + i + "," + i + ",0,1," + l + "," + (this._x1 = s) + "," + (this._y1 = o) : _ > V && (this._ += "A" + i + "," + i + ",0," + +(_ >= et) + "," + l + "," + (this._x1 = t + i * Math.cos(h)) + "," + (this._y1 = n + i * Math.sin(h))));
...
function Wt(t) {
  var n = Ft, i = Ut, a = Bt, h = Rt, b = null;
  function p() {
    var k, s = Vt.call(arguments), o = n.apply(this, s), l = i.apply(this, s);
...
var st = (function() {
  var t = g(function(k, s, o, l) {
  ...
  }, "anonymous"), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, { 5: [1, 3] }, { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: n, 20: i }, { 1: [2, 6], 7: 11, 10: [1, 12] }, t(i, [2, 4], { 9: 13, 5: [1, 14] }), { 12: [1, 15] }, t(a, [2, 8]), t(a, [2, 9]), { 19: [1, 16] }, t(a, [2, 11]), { 1: [2, 1] }, { 1: [2, 5] }, t(i, [2, 2]), { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: n, 20: i }, { 15: 18, 16: 7, 17: 8, 18: n, 20: i }, { 18: [1, 19] }, t(i, [2, 3]), { 12: [1, 20] }, t(a, [2, 10]), { 15: 21, 16: 7, 17: 8, 18: n, 20: i }, t([1, 5, 10], [2, 7])], defaultActions: { 11: [2, 1], 12: [2, 5] }, parseError: g(function(s, o) {
    if (o.recoverable) this.trace(s);
    else {
      var l = new Error(s);
      throw l.hash = o, l;
    }
  }, "parseError"), parse: g(function(s) {
    var o = this, l = [0], _ = [], x = [null], y = [], v = this.table, M = "", T = 0, N = 0, C = 2, D = 1, B = y.slice.call(arguments, 1), S = Object.create(this.lexer), P = { yy: {} };
    for (var j in this.yy) Object.prototype.hasOwnProperty.call(this.yy, j) && (P.yy[j] = this.yy[j]);
    ...
    for (var A, $, I, e, f = {}, u, c, r, m; ; ) {
      if ($ = l[l.length - 1], this.defaultActions[$] ? I = this.defaultActions[$] : ((A === null || typeof A > "u") && (A = E()), I = v[$] && v[$][A]), typeof I > "u" || !I.length || !I[0]) {
        var w = "";
        m = [];
        for (u in v[$]) this.terminals_[u] && u > C && m.push("'" + this.terminals_[u] + "'");
        S.showPosition ? w = "Parse error on line " + (T + 1) + `:
` + S.showPosition() + `
Expecting ` + m.join(", ") + ", got '" + (this.terminals_[A] || A) + "'" : w = "Parse error on line " + (T + 1) + ": Unexpected " + (A == D ? "end of input" : "'" + (this.terminals_[A] || A) + "'"), this.parseError(w, { text: S.match, token: this.terminals_[A] || A, line: S.yylineno, loc: O, expected: m });
      }
      if (I[0] instanceof Array && I.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + $ + ", token: " + A);
      switch (I[0]) {
        case 1:
          l.push(A), x.push(S.yytext), y.push(S.yylloc), l.push(I[1]), A = null, N = S.yyleng, M = S.yytext, T = S.yylineno, O = S.yylloc;
          break;
        case 2:
          if (c = this.productions_[I[1]][1], f.$ = x[x.length - c], f._$ = { first_line: y[y.length - (c || 1)].first_line, last_line: y[y.length - 1].last_line, first_column: y[y.length - (c || 1)].first_column, last_column: y[y.length - 1].last_column }, z && (f._$.range = [y[y.length - (c || 1)].range[0], y[y.length - 1].range[1]]), e = this.performAction.apply(f, [M, N, T, P.yy, I[1], x, y].concat(B)), typeof e < "u") return e;
    ...
    var k = { EOF: 1, parseError: g(function(o, l) {
      if (this.yy.parser) this.yy.parser.parseError(o, l);
      else throw new Error(o);
    }, "parseError"), setInput: g(function(s, o) {
      return this.yy = o || this.yy || {}, this._input = s, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: l ? (l.length === _.length ? this.yylloc.first_column : 0) + _[_.length - l.length].length - l[0].length : this.yylloc.first_column - o }, this.options.ranges && (this.yylloc.range = [x[0], x[0] + this.yyleng - o]), this.yyleng = this.yytext.length, this;
...
` + o + "^";
    }, "showPosition"), test_match: g(function(s, o) {
      var l, _, x;
      if (this.options.backtrack_lexer && (x = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (x.yylloc.range = this.yylloc.range.slice(0))), _ = s[0].match(/(?:\r\n?|\n).*/g), _ && (this.yylineno += _.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: _ ? _[_.length - 1].length - _[_.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + s[0].length }, this.yytext += s[0], this.match += s[0], this.matches = s, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(s[0].length), this.matched += s[0], l = this.performAction.call(this, this.yy, this, o, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), l) return l;
      if (this._backtrack) {
      ...
      for (var x = this._currentRules(), y = 0; y < x.length; y++) if (l = this._input.match(this.rules[x[y]]), l && (!o || l[0].length > o[0].length)) {
        if (o = l, _ = y, this.options.backtrack_lexer) {
          if (s = this.test_match(l, x[y]), s !== false) return s;
          if (this._backtrack) {
            o = false;
            continue;
          } else return false;
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    ...
    }, "_currentRules"), topState: g(function(o) {
      return o = this.conditionStack.length - 1 - Math.abs(o || 0), o >= 0 ? this.conditionStack[o] : "INITIAL";
    }, "topState"), pushState: g(function(o) {
      this.begin(o);
    }, "pushState"), stateStackSize: g(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: g(function(o, l, _, x) {
      switch (_) {
        case 0:
...
st.parser = st;
var H = st, Q = [], K = [], X = /* @__PURE__ */ new Map(), Qt = g(() => {
  Q = [], K = [], X = /* @__PURE__ */ new Map(), Lt();
}, "clear"), Kt = (_a = class {
  constructor(t, n, i = 0) {
    this.source = t, this.target = n, this.value = i;
  }
}, g(_a, "SankeyLink"), _a), Zt = g((t, n, i) => {
  Q.push(new Kt(t, n, i));
}, "addLink"), Jt = (_b = class {
  constructor(t) {
    this.ID = t;
  }
}, g(_b, "SankeyNode"), _b), te = g((t) => {
  t = Et.sanitizeText(t, ot());
  let n = X.get(t);
  return n === void 0 && (n = new Jt(t), X.set(t, n), K.push(n)), n;
}, "findOrCreateNode"), ee = g(() => K, "getNodes"), ne = g(() => Q, "getLinks"), ie = g(() => ({ nodes: K.map((t) => ({ id: t.ID })), links: Q.map((t) => ({ source: t.source.ID, target: t.target.ID, value: t.value })) }), "getGraph"), se = { nodesMap: X, getConfig: g(() => ot().sankey, "getConfig"), getNodes: ee, getLinks: ne, getGraph: ie, addLink: Zt, findOrCreateNode: te, getAccTitle: bt, setAccTitle: vt, getAccDescription: xt, setAccDescription: _t, getDiagramTitle: kt, setDiagramTitle: mt, clear: Qt }, yt = (_c = class {
  static next(n) {
    return new _c(n + ++_c.count);
  }
  constructor(n) {
...
}, g(_c, "Uid"), _c.count = 0, _c), re = { left: It, right: Pt, center: Ct, justify: gt }, oe = g(function(t, n, i, a) {
  const { securityLevel: h, sankey: b } = ot(), p = wt.sankey;
  let k;
  h === "sandbox" && (k = G("#i" + n));
  const s = h === "sandbox" ? G(k.nodes()[0].contentDocument.body) : G("body"), o = h === "sandbox" ? s.select(`[id="${n}"]`) : G(`[id="${n}"]`), l = (b == null ? void 0 : b.width) ?? p.width, _ = (b == null ? void 0 : b.height) ?? p.width, x = (b == null ? void 0 : b.useMaxWidth) ?? p.useMaxWidth, y = (b == null ? void 0 : b.nodeAlignment) ?? p.nodeAlignment, v = (b == null ? void 0 : b.prefix) ?? p.prefix, M = (b == null ? void 0 : b.suffix) ?? p.suffix, T = (b == null ? void 0 : b.showValues) ?? p.showValues, N = a.db.getGraph(), C = re[y];
  $t().nodeId((d) => d.id).nodeWidth(10).nodePadding(10 + (T ? 15 : 0)).nodeAlign(C).extent([[0, 0], [l, _]])(N);
  const S = At(Mt);
...
${v}${Math.round(E * 100) / 100}${M}` : d, "getText");
  ...
  const j = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(N.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), O = (b == null ? void 0 : b.linkColor) ?? "gradient";
  if (O === "gradient") {
