var _a, _b;
import { g as Ze } from "./chunk-FMBD7UC4-MUrOfgVf.js";
import { g as $e } from "./chunk-55IACEB6-D1tq2uLy.js";
import { s as et } from "./chunk-QN33PNHL-CGhG7p2a.js";
import { _ as p, l as ve, c as D, o as tt, r as st, u as Ie, d as J, b as it, a as at, s as nt, g as rt, p as ut, q as lt, k as x, y as ot, x as ct, i as ht, Q as M } from "./index-CTgvlc8H.js";
var Oe = (function() {
  var e = p(function(v, l, o, d) {
    for (o = o || {}, d = v.length; d--; o[v[d]] = l) ;
    return o;
  }, "o"), i = [1, 18], r = [1, 19], u = [1, 20], a = [1, 41], c = [1, 42], A = [1, 26], f = [1, 24], k = [1, 25], _ = [1, 32], he = [1, 33], de = [1, 34], C = [1, 45], pe = [1, 35], Ae = [1, 36], fe = [1, 37], ge = [1, 38], Ce = [1, 27], me = [1, 28], be = [1, 29], Ee = [1, 30], ye = [1, 31], m = [1, 44], b = [1, 46], E = [1, 43], y = [1, 47], Te = [1, 9], h = [1, 8, 9], Z = [1, 58], $ = [1, 59], ee = [1, 60], te = [1, 61], se = [1, 62], ke = [1, 63], De = [1, 64], R = [1, 8, 9, 41], we = [1, 76], V = [1, 8, 9, 12, 13, 22, 39, 41, 44, 68, 69, 70, 71, 72, 73, 74, 79, 81], ie = [1, 8, 9, 12, 13, 18, 20, 22, 39, 41, 44, 50, 60, 68, 69, 70, 71, 72, 73, 74, 79, 81, 86, 100, 102, 103], ae = [13, 60, 86, 100, 102, 103], G = [13, 60, 73, 74, 86, 100, 102, 103], Ve = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103], Fe = [1, 100], U = [1, 117], z = [1, 113], K = [1, 109], Y = [1, 115], Q = [1, 110], W = [1, 111], j = [1, 112], X = [1, 114], q = [1, 116], Pe = [22, 48, 60, 61, 82, 86, 87, 88, 89, 90], Be = [1, 8, 9, 39, 41, 44], ne = [1, 8, 9, 22], Me = [1, 145], Re = [1, 8, 9, 61], N = [1, 8, 9, 22, 48, 60, 61, 82, 86, 87, 88, 89, 90], _e = { trace: p(function() {
    ...
    function ze() {
      var B;
      return B = n.pop() || T.lex() || Ue, typeof B != "number" && (B instanceof Array && (n = B, B = n.pop()), B = o.symbols_[B] || B), B;
    }
    p(ze, "lex");
    for (var F, O, S, Le, P = {}, le, L, Ke, oe; ; ) {
      if (O = d[d.length - 1], this.defaultActions[O] ? S = this.defaultActions[O] : ((F === null || typeof F > "u") && (F = ze()), S = H[O] && H[O][F]), typeof S > "u" || !S.length || !S[0]) {
        var xe = "";
        oe = [];
        for (le in H[O]) this.terminals_[le] && le > Xe && oe.push("'" + this.terminals_[le] + "'");
        T.showPosition ? xe = "Parse error on line " + (ue + 1) + `:
` + T.showPosition() + `
Expecting ` + oe.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : xe = "Parse error on line " + (ue + 1) + ": Unexpected " + (F == Ue ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(xe, { text: T.match, token: this.terminals_[F] || F, line: T.yylineno, loc: Ne, expected: oe });
      }
      if (S[0] instanceof Array && S.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + O + ", token: " + F);
      switch (S[0]) {
        case 1:
          d.push(F), g.push(T.yytext), t.push(T.yylloc), d.push(S[1]), F = null, Ge = T.yyleng, s = T.yytext, ue = T.yylineno, Ne = T.yylloc;
          break;
        case 2:
          if (L = this.productions_[S[1]][1], P.$ = g[g.length - L], P._$ = { first_line: t[t.length - (L || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (L || 1)].first_column, last_column: t[t.length - 1].last_column }, He && (P._$.range = [t[t.length - (L || 1)].range[0], t[t.length - 1].range[1]]), Le = this.performAction.apply(P, [s, Ge, ue, I.yy, S[1], g, t].concat(qe)), typeof Le < "u") return Le;
    ...
    var v = { EOF: 1, parseError: p(function(o, d) {
      if (this.yy.parser) this.yy.parser.parseError(o, d);
      else throw new Error(o);
    }, "parseError"), setInput: p(function(l, o) {
      return this.yy = o || this.yy || {}, this._input = l, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
...
` + o + "^";
    }, "showPosition"), test_match: p(function(l, o) {
      var d, n, g;
      if (this.options.backtrack_lexer && (g = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (g.yylloc.range = this.yylloc.range.slice(0))), n = l[0].match(/(?:\r\n?|\n).*/g), n && (this.yylineno += n.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: n ? n[n.length - 1].length - n[n.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + l[0].length }, this.yytext += l[0], this.match += l[0], this.matches = l, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(l[0].length), this.matched += l[0], d = this.performAction.call(this, this.yy, this, o, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), d) return d;
      if (this._backtrack) {
      ...
      for (var g = this._currentRules(), t = 0; t < g.length; t++) if (d = this._input.match(this.rules[g[t]]), d && (!o || d[0].length > o[0].length)) {
        if (o = d, n = t, this.options.backtrack_lexer) {
          if (l = this.test_match(d, g[t]), l !== false) return l;
          if (this._backtrack) {
            o = false;
            continue;
          } else return false;
      ...
      return o ? (l = this.test_match(o, g[n]), l !== false ? l : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: p(function() {
      var o = this.next();
      return o || this.lex();
    }, "lex"), begin: p(function(o) {
...
var Et = Oe, Ye = ["#", "+", "~", "-", ""], Qe = (_a = class {
  ...
  parseMember(e) {
    ...
    if (this.memberType === "method") {
      ...
      Ye.includes(a) && (this.visibility = a), /[$*]/.exec(c) && (i = c), this.id = e.substring(this.visibility === "" ? 0 : 1, i === "" ? u : u - 1);
    }
...
}, p(_a, "ClassMember"), _a), ce = "classId-", We = 0, w = p((e) => x.sanitizeText(e, D()), "sanitizeText"), yt = (_b = class {
  constructor() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = [], this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.functions = [], this.lineType = { LINE: 0, DOTTED_LINE: 1 }, this.relationType = { AGGREGATION: 0, EXTENSION: 1, COMPOSITION: 2, DEPENDENCY: 3, LOLLIPOP: 4 }, this.setupToolTips = p((e) => {
      let i = J(".mermaidTooltip");
      (i._groups || i)[0][0] === null && (i = J("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), J(e).select("svg").selectAll("g.node").on("mouseover", (a) => {
        const c = J(a.currentTarget);
        if (c.attr("title") === null) return;
        const f = this.getBoundingClientRect();
        i.transition().duration(200).style("opacity", ".9"), i.text(c.attr("title")).style("left", window.scrollX + f.left + (f.right - f.left) / 2 + "px").style("top", window.scrollY + f.top - 14 + document.body.scrollTop + "px"), i.html(i.html().replace(/&lt;br\/&gt;/g, "<br/>")), c.classed("hover", true);
      }).on("mouseout", (a) => {
        i.transition().duration(500).style("opacity", 0), J(a.currentTarget).classed("hover", false);
      });
  ...
  addClass(e) {
    ...
    this.classes.set(a, { id: a, type: u, label: a, text: `${a}${u ? `&lt;${u}&gt;` : ""}`, shape: "classBox", cssClasses: "default", methods: [], members: [], annotations: [], styles: [], domId: ce + a + "-" + We }), We++;
  }
  addInterface(e, i) {
  ...
  addRelation(e) {
    ...
    const i = [this.relationType.LOLLIPOP, this.relationType.AGGREGATION, this.relationType.COMPOSITION, this.relationType.DEPENDENCY, this.relationType.EXTENSION];
    e.relation.type1 === this.relationType.LOLLIPOP && !i.includes(e.relation.type2) ? (this.addClass(e.id2), this.addInterface(e.id1, e.id2), e.id1 = `interface${this.interfaces.length - 1}`) : e.relation.type2 === this.relationType.LOLLIPOP && !i.includes(e.relation.type1) ? (this.addClass(e.id1), this.addInterface(e.id2, e.id1), e.id2 = `interface${this.interfaces.length - 1}`) : (this.addClass(e.id1), this.addClass(e.id2)), e.id1 = this.splitClassNameAndType(e.id1).className, e.id2 = this.splitClassNameAndType(e.id2).className, e.relationTitle1 = x.sanitizeText(e.relationTitle1.trim(), D()), e.relationTitle2 = x.sanitizeText(e.relationTitle2.trim(), D()), this.relations.push(e);
  }
  addAnnotation(e, i) {
  ...
  setClickEvent(e, i, r) {
    e.split(",").forEach((u) => {
      this.setClickFunc(u, i, r), this.classes.get(u).haveCallback = true;
    }), this.setCssClass(e, "clickable");
  }
  setClickFunc(e, i, r) {
  ...
  addNamespace(e) {
    this.namespaces.has(e) || (this.namespaces.set(e, { id: e, classes: /* @__PURE__ */ new Map(), children: {}, domId: ce + e + "-" + this.namespaceCounter }), this.namespaceCounter++);
  }
  getNamespace(e) {
  ...
  addClassesToNamespace(e, i) {
    if (this.namespaces.has(e)) for (const r of i) {
      const { className: u } = this.splitClassNameAndType(r);
  ...
  setCssStyle(e, i) {
    ...
    if (!(!i || !r)) for (const u of i) u.includes(",") ? r.styles.push(...u.split(",")) : r.styles.push(u);
  }
  getArrowMarker(e) {
    let i;
    switch (e) {
  ...
  getData() {
    ...
    for (const a of this.namespaces.keys()) {
      ...
      if (c) {
        const A = { id: c.id, label: c.id, isGroup: true, padding: r.class.padding ?? 16, shape: "rect", cssStyles: ["fill: none", "stroke: black"], look: r.look };
        e.push(A);
      }
    }
    ...
    for (const a of this.notes) {
      u++;
      const c = { id: a.id, label: a.text, isGroup: false, shape: "note", padding: r.class.padding ?? 6, cssStyles: ["text-align: left", "white-space: nowrap", `fill: ${r.themeVariables.noteBkgColor}`, `stroke: ${r.themeVariables.noteBorderColor}`], look: r.look };
      e.push(c);
      const A = ((_a2 = this.classes.get(a.class)) == null ? void 0 : _a2.id) ?? "";
      if (A) {
        const f = { id: `edgeNote${u}`, start: a.id, end: A, type: "normal", thickness: "normal", classes: "relation", arrowTypeStart: "none", arrowTypeEnd: "none", arrowheadStyle: "", labelStyle: [""], style: ["fill: none"], pattern: "dotted", look: r.look };
        i.push(f);
      }
    }
    for (const a of this.interfaces) {
      const c = { id: a.id, label: a.label, isGroup: false, shape: "rect", cssStyles: ["opacity: 0;"], look: r.look };
      e.push(c);
    }
    u = 0;
    for (const a of this.relations) {
      u++;
      const c = { id: ct(a.id1, a.id2, { prefix: "id", counter: u }), start: a.id1, end: a.id2, type: "normal", label: a.title, labelpos: "c", thickness: "normal", classes: "relation", arrowTypeStart: this.getArrowMarker(a.relation.type1), arrowTypeEnd: this.getArrowMarker(a.relation.type2), startLabelRight: a.relationTitle1 === "none" ? "" : a.relationTitle1, endLabelLeft: a.relationTitle2 === "none" ? "" : a.relationTitle2, arrowheadStyle: "", labelStyle: ["display: inline-block"], style: a.style || "", pattern: a.relation.lineType == 1 ? "dashed" : "solid", look: r.look };
      i.push(c);
    }
    return { nodes: e, edges: i, other: {}, config: r, direction: this.getDirection() };
  }
}, p(_b, "ClassDB"), _b), dt = p((e) => `g.classGroup text {
...
.classTitleText {
  ...
  ${Ze()}
`, "getStyles"), Tt = dt, pt = p((e, i = "TB") => {
  if (!e.doc) return i;
  let r = i;
  for (const u of e.doc) u.stmt === "dir" && (r = u.value);
  return r;
}, "getDir"), At = p(function(e, i) {
  return i.db.getClasses();
}, "getClasses"), ft = p(async function(e, i, r, u) {
  ve.info("REF0:"), ve.info("Drawing class diagram (v3)", i);
  const { securityLevel: a, state: c, layout: A } = D(), f = u.db.getData(), k = $e(i, a);
  f.type = u.type, f.layoutAlgorithm = tt(A), f.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, f.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, f.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], f.diagramId = i, await st(f, k);
  const _ = 8;
  Ie.insertTitle(k, "classDiagramTitleText", (c == null ? void 0 : c.titleTopMargin) ?? 25, u.db.getDiagramTitle()), et(k, _, "classDiagram", (c == null ? void 0 : c.useMaxWidth) ?? true);
}, "draw"), kt = { getClasses: At, draw: ft, getDir: pt };
export {
  yt as C,
  Et as a,
  kt as c,
