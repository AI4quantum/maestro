import { a0 as ln, a1 as an, a2 as y, a3 as tn, a4 as H, a5 as q, a6 as _, a7 as un, a8 as B, a9 as rn, aa as L, ab as o, ac as sn, ad as on, ae as fn } from "./index-CTgvlc8H.js";
function cn(l) {
...
function pn(l, h, I, D, v, A, C, a) {
  ...
  if (!(u * u < y)) return u = (n * (h - A) - d * (l - v)) / u, [l + u * O, h + u * i];
}
function W(l, h, I, D, v, A, C) {
  ...
  return x * x + e * e > r * r + G * G && (j = w, z = p), { cx: j, cy: z, x01: -n, y01: -d, x11: j * (v / T - 1), y11: z * (v / T - 1) };
}
function hn() {
  ...
  function i() {
    ...
    if (a || (a = n = O()), s < u && (d = s, s = u, u = d), !(s > y)) a.moveTo(0, 0);
    else if (F > tn - y) a.moveTo(s * H(f), s * q(f)), a.arc(0, 0, s, f, c, !t), u > y && (a.moveTo(u * H(c), u * q(c)), a.arc(0, 0, u, c, f, t));
    else {
      ...
      if (w > y) {
        ...
        if (F < rn) if (E = pn(J, K, X, Y, U, V, N, Q)) {
