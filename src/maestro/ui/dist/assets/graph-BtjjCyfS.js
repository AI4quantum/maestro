import { aA as N, aB as j, aC as f, aD as b, aE as E } from "./index-CTgvlc8H.js";
import { a as v, c as P, k as _, f as g, d, i as l, v as p, r as D } from "./_baseUniq-o7e9QmIE.js";
var w = N(function(o) {
  return v(P(o, 1, j, true));
}), F = "\0", a = "\0", O = "";
class L {
  constructor(e = {}) {
  ...
  setParent(e, t) {
    ...
    if (l(t)) t = a;
      ...
      t += "";
      for (var s = t; !l(s); s = this.parent(s)) if (s === e) throw new Error("Setting " + t + " as parent of " + e + " would create a cycle");
      this.setNode(t);
    }
