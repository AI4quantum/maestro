import { a as gt, g as lt, f as mt, d as xt } from "./chunk-TZMSLE5B-YNuB0O4r.js";
import { g as kt } from "./chunk-FMBD7UC4-MUrOfgVf.js";
import { _ as n, g as _t, s as vt, a as bt, b as wt, q as Tt, p as St, c as R, d as X, e as $t, y as Mt } from "./index-CTgvlc8H.js";
import { d as et } from "./arc-CmKg8NsT.js";
var U = (function() {
  var t = n(function(h, i, a, l) {
    for (a = a || {}, l = h.length; l--; a[h[l]] = i) ;
    return a;
  }, "o"), e = [6, 8, 10, 11, 12, 14, 16, 17, 18], s = [1, 9], c = [1, 10], r = [1, 11], f = [1, 12], u = [1, 13], y = [1, 14], g = { trace: n(function() {
  }, "trace"), yy: {}, symbols_: { error: 2, start: 3, journey: 4, document: 5, EOF: 6, line: 7, SPACE: 8, statement: 9, NEWLINE: 10, title: 11, acc_title: 12, acc_title_value: 13, acc_descr: 14, acc_descr_value: 15, acc_descr_multiline_value: 16, section: 17, taskName: 18, taskData: 19, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "journey", 6: "EOF", 8: "SPACE", 10: "NEWLINE", 11: "title", 12: "acc_title", 13: "acc_title_value", 14: "acc_descr", 15: "acc_descr_value", 16: "acc_descr_multiline_value", 17: "section", 18: "taskName", 19: "taskData" }, productions_: [0, [3, 3], [5, 0], [5, 2], [7, 2], [7, 1], [7, 1], [7, 1], [9, 1], [9, 2], [9, 2], [9, 1], [9, 1], [9, 2]], performAction: n(function(i, a, l, d, p, o, b) {
    var k = o.length - 1;
    switch (p) {
      case 1:
        return o[k - 1];
  ...
  }, "anonymous"), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, t(e, [2, 2], { 5: 3 }), { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: s, 12: c, 14: r, 16: f, 17: u, 18: y }, t(e, [2, 7], { 1: [2, 1] }), t(e, [2, 3]), { 9: 15, 11: s, 12: c, 14: r, 16: f, 17: u, 18: y }, t(e, [2, 5]), t(e, [2, 6]), t(e, [2, 8]), { 13: [1, 16] }, { 15: [1, 17] }, t(e, [2, 11]), t(e, [2, 12]), { 19: [1, 18] }, t(e, [2, 4]), t(e, [2, 9]), t(e, [2, 10]), t(e, [2, 13])], defaultActions: {}, parseError: n(function(i, a) {
    if (a.recoverable) this.trace(i);
    else {
      var l = new Error(i);
      throw l.hash = a, l;
    }
  }, "parseError"), parse: n(function(i) {
...
` + _.showPosition() + `
Expecting ` + z.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : H = "Parse error on line " + (C + 1) + ": Unexpected " + (v == Q ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(H, { text: _.match, token: this.terminals_[v] || v, line: _.yylineno, loc: Y, expected: z });
      }
    ...
    var h = { EOF: 1, parseError: n(function(a, l) {
      if (this.yy.parser) this.yy.parser.parseError(a, l);
      else throw new Error(a);
    }, "parseError"), setInput: n(function(i, a) {
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: l ? (l.length === d.length ? this.yylloc.first_column : 0) + d[d.length - l.length].length - l[0].length : this.yylloc.first_column - a }, this.options.ranges && (this.yylloc.range = [p[0], p[0] + this.yyleng - a]), this.yyleng = this.yytext.length, this;
...
` + a + "^";
    }, "showPosition"), test_match: n(function(i, a) {
      var l, d, p;
      if (this.options.backtrack_lexer && (p = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (p.yylloc.range = this.yylloc.range.slice(0))), d = i[0].match(/(?:\r\n?|\n).*/g), d && (this.yylineno += d.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: d ? d[d.length - 1].length - d[d.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + i[0].length }, this.yytext += i[0], this.match += i[0], this.matches = i, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(i[0].length), this.matched += i[0], l = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), l) return l;
      if (this._backtrack) {
      ...
      for (var p = this._currentRules(), o = 0; o < p.length; o++) if (l = this._input.match(this.rules[p[o]]), l && (!a || l[0].length > a[0].length)) {
        if (a = l, d = o, this.options.backtrack_lexer) {
          if (i = this.test_match(l, p[o]), i !== false) return i;
          if (this._backtrack) {
            a = false;
            continue;
          } else return false;
      ...
      return a ? (i = this.test_match(a, p[d]), i !== false ? i : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: n(function() {
      var a = this.next();
      return a || this.lex();
    }, "lex"), begin: n(function(a) {
    ...
    }, "_currentRules"), topState: n(function(a) {
      return a = this.conditionStack.length - 1 - Math.abs(a || 0), a >= 0 ? this.conditionStack[a] : "INITIAL";
    }, "topState"), pushState: n(function(a) {
      this.begin(a);
    }, "pushState"), stateStackSize: n(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: n(function(a, l, d, p) {
      switch (d) {
        case 0:
          break;
        case 1:
...
U.parser = U;
var Et = U, V = "", Z = [], L = [], B = [], Ct = n(function() {
  Z.length = 0, L.length = 0, V = "", B.length = 0, Mt();
}, "clear"), Pt = n(function(t) {
  V = t, Z.push(t);
}, "addSection"), It = n(function() {
  return Z;
}, "getSections"), At = n(function() {
  let t = it();
  const e = 100;
  let s = 0;
  for (; !t && s < e; ) t = it(), s++;
  return L.push(...B), L;
}, "getTasks"), Ft = n(function() {
  const t = [];
  return L.forEach((s) => {
    s.people && t.push(...s.people);
  }), [...new Set(t)].sort();
}, "updateActors"), Vt = n(function(t, e) {
  const s = e.substr(1).split(":");
  let c = 0, r = [];
  s.length === 1 ? (c = Number(s[0]), r = []) : (c = Number(s[0]), r = s[1].split(","));
  const f = r.map((y) => y.trim()), u = { section: V, type: V, people: f, task: t, score: c };
  B.push(u);
}, "addTask"), Rt = n(function(t) {
  const e = { section: V, type: V, description: t, task: t, classes: [] };
  L.push(e);
}, "addTaskOrg"), it = n(function() {
  ...
  return e;
}, "compileTasks"), Lt = n(function() {
  return Ft();
}, "getActors"), rt = { getConfig: n(() => R().journey, "getConfig"), clear: Ct, setDiagramTitle: St, getDiagramTitle: Tt, setAccTitle: wt, getAccTitle: bt, setAccDescription: vt, getAccDescription: _t, addSection: Pt, getSections: It, getTasks: At, addTask: Vt, addTaskOrg: Rt, getActors: Lt }, Bt = n((t) => `.label {
  ...
  ${kt()}
`, "getStyles"), jt = Bt, J = n(function(t, e) {
  return xt(t, e);
}, "drawRect"), Nt = n(function(t, e) {
...
}, "drawCircle"), ct = n(function(t, e) {
  return mt(t, e);
}, "drawText"), zt = n(function(t, e) {
...
}, "drawSection"), nt = -1, Ot = n(function(t, e, s) {
  const c = e.x + s.width / 2, r = t.append("g");
  nt++, r.append("line").attr("id", "task" + nt).attr("x1", c).attr("y1", e.y).attr("x2", c).attr("y2", 450).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Nt(r, { cx: c, cy: 300 + (5 - e.score) * 30, score: e.score });
  const u = lt();
  u.x = e.x, u.y = e.y, u.fill = e.fill, u.width = s.width, u.height = s.height, u.class = "task task-type-" + e.num, u.rx = 3, u.ry = 3, J(r, u);
  let y = e.x + 14;
  e.people.forEach((g) => {
    const m = e.actors[g].color, x = { cx: y, cy: e.y, r: 7, fill: m, stroke: "#000", title: g, pos: e.actors[g].position };
    ot(r, x), y += 10;
  }), ht(s)(e.task, r, u.x, u.y, u.width, u.height, { class: "task" }, s, e.colour);
}, "drawTask"), Yt = n(function(t, e) {
  gt(t, e);
...
}, "initGraphics"), j = { drawRect: J, drawCircle: ot, drawSection: Wt, drawText: ct, drawLabel: zt, drawTask: Ot, drawBackgroundRect: Yt, initGraphics: qt }, Ht = n(function(t) {
...
function ut(t) {
  ...
  Object.keys(E).forEach((r) => {
    const f = E[r].color, u = { cx: 20, cy: c, r: 7, fill: f, stroke: "#000", pos: E[r].position };
    j.drawCircle(t, u);
      ...
      y = t.append("text").attr("visibility", "hidden"), x.forEach((i) => {
        ...
        if (y.text(a), y.node().getBoundingClientRect().width > s) {
          if (h && m.push(h), h = i, y.text(i), y.node().getBoundingClientRect().width > s) {
            let d = "";
            for (const p of i) d += p, y.text(d + "-"), y.node().getBoundingClientRect().width > s && (m.push(d.slice(0, -1) + "-"), d = p);
            h = d;
          }
        } else h = a;
      }), h && m.push(h), y.remove();
    ...
    m.forEach((x, h) => {
      const i = { x: 40, y: c + 7 + h * 20, fill: "#666", text: x, textMargin: e.boxTextMargin ?? 5 }, l = j.drawText(t, i).node().getBoundingClientRect().width;
      l > W && l > e.leftMargin - l && (W = l);
    }), c += Math.max(20, m.length * 20);
  });
}
n(ut, "drawActorLegend");
var $ = R().journey, P = 0, Xt = n(function(t, e, s, c) {
...
}, "draw"), S = { data: { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, verticalPos: 0, sequenceItems: [], init: n(function() {
  this.sequenceItems = [], this.data = { startx: void 0, stopx: void 0, starty: void 0, stopy: void 0 }, this.verticalPos = 0;
}, "init"), updateVal: n(function(t, e, s, c) {
  t[e] === void 0 ? t[e] = s : t[e] = c(s, t[e]);
}, "updateVal"), updateBounds: n(function(t, e, s, c) {
...
}, "updateBounds"), insert: n(function(t, e, s, c) {
...
}, "insert"), bumpVerticalPos: n(function(t) {
  this.verticalPos = this.verticalPos + t, this.data.stopy = this.verticalPos;
}, "bumpVerticalPos"), getVerticalPos: n(function() {
  return this.verticalPos;
}, "getVerticalPos"), getBounds: n(function() {
  return this.data;
}, "getBounds") }, G = $.sectionFills, st = $.sectionColours, Gt = n(function(t, e, s) {
  const c = R().journey;
  let r = "";
...
}, "drawTasks"), at = { setConf: Ht, draw: Xt }, Qt = { parser: Et, db: rt, renderer: at, styles: jt, init: n((t) => {
