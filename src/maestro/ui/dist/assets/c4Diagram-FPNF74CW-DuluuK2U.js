...
var jt = (function() {
  var e = g(function(_t, x, m, v) {
    ...
    for (var Ht in this.yy) Object.prototype.hasOwnProperty.call(this.yy, Ht) && (kt.yy[Ht] = this.yy[Ht]);
    ...
    for (var I, At, N, Gt, wt = {}, Mt, W, ce, Lt; ; ) {
      if (At = v[v.length - 1], this.defaultActions[At] ? N = this.defaultActions[At] : ((I === null || typeof I > "u") && (I = oe()), N = Rt[At] && Rt[At][I]), typeof N > "u" || !N.length || !N[0]) {
        var Kt = "";
        Lt = [];
        for (Mt in Rt[At]) this.terminals_[Mt] && Mt > Ae && Lt.push("'" + this.terminals_[Mt] + "'");
        D.showPosition ? Kt = "Parse error on line " + (Et + 1) + `:
` + D.showPosition() + `
Expecting ` + Lt.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : Kt = "Parse error on line " + (Et + 1) + ": Unexpected " + (I == le ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(Kt, { text: D.match, token: this.terminals_[I] || I, line: D.yylineno, loc: qt, expected: Lt });
      }
    ...
    var _t = { EOF: 1, parseError: g(function(m, v) {
      if (this.yy.parser) this.yy.parser.parseError(m, v);
      else throw new Error(m);
    }, "parseError"), setInput: g(function(x, m) {
      return this.yy = m || this.yy || {}, this._input = x, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: v ? (v.length === b.length ? this.yylloc.first_column : 0) + b[b.length - v.length].length - v[0].length : this.yylloc.first_column - m }, this.options.ranges && (this.yylloc.range = [R[0], R[0] + this.yyleng - m]), this.yyleng = this.yytext.length, this;
...
` + m + "^";
    }, "showPosition"), test_match: g(function(x, m) {
      var v, b, R;
      if (this.options.backtrack_lexer && (R = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (R.yylloc.range = this.yylloc.range.slice(0))), b = x[0].match(/(?:\r\n?|\n).*/g), b && (this.yylineno += b.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: b ? b[b.length - 1].length - b[b.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + x[0].length }, this.yytext += x[0], this.match += x[0], this.matches = x, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(x[0].length), this.matched += x[0], v = this.performAction.call(this, this.yy, this, m, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), v) return v;
      if (this._backtrack) {
      ...
      for (var R = this._currentRules(), h = 0; h < R.length; h++) if (v = this._input.match(this.rules[R[h]]), v && (!m || v[0].length > m[0].length)) {
        if (m = v, b = h, this.options.backtrack_lexer) {
          if (x = this.test_match(v, R[h]), x !== false) return x;
          if (this._backtrack) {
            m = false;
            continue;
          } else return false;
      ...
      return m ? (x = this.test_match(m, R[b]), x !== false ? x : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: g(function() {
      var m = this.next();
      return m || this.lex();
    }, "lex"), begin: g(function(m) {
...
jt.parser = jt;
var Ye = jt, V = [], xt = [""], B = "global", F = "", X = [{ alias: "global", label: { text: "global" }, type: { text: "global" }, tags: null, link: null, parentBoundary: "" }], Pt = [], ee = "", ae = false, Ut = 4, Ft = 2, ye, je = g(function() {
  return ye;
}, "getC4Type"), Ue = g(function(e) {
  ye = pe(e, Dt());
}, "setC4Type"), Fe = g(function(e, t, s, o, l, a, r, n, i) {
  if (e == null || t === void 0 || t === null || s === void 0 || s === null || o === void 0 || o === null) return;
  let u = {};
  const d = Pt.find((y) => y.from === t && y.to === s);
  if (d ? u = d : Pt.push(u), u.type = e, u.from = t, u.to = s, u.label = { text: o }, l == null) u.techn = { text: "" };
  ...
  u.wrap = mt();
}, "addRel"), Ve = g(function(e, t, s, o, l, a, r) {
  if (t === null || s === null) return;
  let n = {};
  const i = V.find((u) => u.alias === t);
  if (i && t === i.alias ? n = i : (n.alias = t, V.push(n)), s == null ? n.label = { text: "" } : n.label = { text: s }, o == null) n.descr = { text: "" };
...
}, "addPersonOrSystem"), ze = g(function(e, t, s, o, l, a, r, n) {
  if (t === null || s === null) return;
  let i = {};
  const u = V.find((d) => d.alias === t);
  if (u && t === u.alias ? i = u : (i.alias = t, V.push(i)), s == null ? i.label = { text: "" } : i.label = { text: s }, o == null) i.techn = { text: "" };
  else if (typeof o == "object") {
...
}, "addContainer"), Xe = g(function(e, t, s, o, l, a, r, n) {
  if (t === null || s === null) return;
  let i = {};
  const u = V.find((d) => d.alias === t);
  if (u && t === u.alias ? i = u : (i.alias = t, V.push(i)), s == null ? i.label = { text: "" } : i.label = { text: s }, o == null) i.techn = { text: "" };
  ...
  i.wrap = mt(), i.typeC4Shape = { text: e }, i.parentBoundary = B;
}, "addComponent"), We = g(function(e, t, s, o, l) {
  if (e === null || t === null) return;
  let a = {};
  const r = X.find((n) => n.alias === e);
  if (r && e === r.alias ? a = r : (a.alias = e, X.push(a)), t == null ? a.label = { text: "" } : a.label = { text: t }, s == null) a.type = { text: "system" };
...
}, "addPersonOrSystemBoundary"), Qe = g(function(e, t, s, o, l) {
  if (e === null || t === null) return;
  let a = {};
  const r = X.find((n) => n.alias === e);
  if (r && e === r.alias ? a = r : (a.alias = e, X.push(a)), t == null ? a.label = { text: "" } : a.label = { text: t }, s == null) a.type = { text: "container" };
  else if (typeof s == "object") {
    let [n, i] = Object.entries(s)[0];
    a[n] = { text: i };
  } else a.type = { text: s };
  ...
  a.parentBoundary = B, a.wrap = mt(), F = B, B = e, xt.push(F);
}, "addContainerBoundary"), He = g(function(e, t, s, o, l, a, r, n) {
  if (t === null || s === null) return;
  let i = {};
...
}, "addDeploymentNode"), qe = g(function() {
  B = F, xt.pop(), F = xt.pop(), xt.push(F);
}, "popBoundaryParseStack"), Ge = g(function(e, t, s, o, l, a, r, n, i, u, d) {
...
}, "updateElStyle"), Ke = g(function(e, t, s, o, l, a, r) {
...
}, "updateRelStyle"), Je = g(function(e, t, s) {
  let o = Ut, l = Ft;
  if (typeof t == "object") {
  ...
  o >= 1 && (Ut = o), l >= 1 && (Ft = l);
}, "updateLayoutConfig"), Ze = g(function() {
  return Ut;
}, "getC4ShapeInRow"), $e = g(function() {
  return Ft;
}, "getC4BoundaryInRow"), t0 = g(function() {
  return B;
}, "getCurrentBoundaryParse"), e0 = g(function() {
  return F;
}, "getParentBoundaryParse"), ge = g(function(e) {
  return e == null ? V : V.filter((t) => t.parentBoundary === e);
}, "getC4ShapeArray"), a0 = g(function(e) {
  return V.find((t) => t.alias === e);
}, "getC4Shape"), i0 = g(function(e) {
  return Object.keys(ge(e));
}, "getC4ShapeKeys"), be = g(function(e) {
  return e == null ? X : X.filter((t) => t.parentBoundary === e);
}, "getBoundaries"), n0 = be, r0 = g(function() {
  return Pt;
}, "getRels"), s0 = g(function() {
  return ee;
}, "getTitle"), l0 = g(function(e) {
  ae = e;
}, "setWrap"), mt = g(function() {
  return ae;
}, "autoWrap"), o0 = g(function() {
  V = [], X = [{ alias: "global", label: { text: "global" }, type: { text: "global" }, tags: null, link: null, parentBoundary: "" }], F = "", B = "global", xt = [""], Pt = [], xt = [""], ee = "", ae = false, Ut = 4, Ft = 2;
}, "clear"), c0 = { SOLID: 0, DOTTED: 1, NOTE: 2, SOLID_CROSS: 3, DOTTED_CROSS: 4, SOLID_OPEN: 5, DOTTED_OPEN: 6, LOOP_START: 10, LOOP_END: 11, ALT_START: 12, ALT_ELSE: 13, ALT_END: 14, OPT_START: 15, OPT_END: 16, ACTIVE_START: 17, ACTIVE_END: 18, PAR_START: 19, PAR_AND: 20, PAR_END: 21, RECT_START: 22, RECT_END: 23, SOLID_POINT: 24, DOTTED_POINT: 25 }, h0 = { FILLED: 0, OPEN: 1 }, u0 = { LEFTOF: 0, RIGHTOF: 1, OVER: 2 }, d0 = g(function(e) {
  ee = pe(e, Dt());
}, "setTitle"), Zt = { addPersonOrSystem: Ve, addPersonOrSystemBoundary: We, addContainer: ze, addContainerBoundary: Qe, addComponent: Xe, addDeploymentNode: He, popBoundaryParseStack: qe, addRel: Fe, updateElStyle: Ge, updateRelStyle: Ke, updateLayoutConfig: Je, autoWrap: mt, setWrap: l0, getC4ShapeArray: ge, getC4Shape: a0, getC4ShapeKeys: i0, getBoundaries: be, getBoundarys: n0, getCurrentBoundaryParse: t0, getParentBoundaryParse: e0, getRels: r0, getTitle: s0, getC4Type: je, getC4ShapeInRow: Ze, getC4BoundaryInRow: $e, setAccTitle: Be, getAccTitle: Pe, getAccDescription: De, setAccDescription: Se, getConfig: g(() => Dt().c4, "getConfig"), clear: o0, LINETYPE: c0, ARROWTYPE: h0, PLACEMENT: u0, setTitle: d0, setC4Type: Ue }, ie = g(function(e, t) {
  return Re(e, t);
}, "drawRect"), _e = g(function(e, t, s, o, l, a) {
  ...
  for (let a of t) {
    ...
    if (l === 0) {
      ...
      let p = o.append("path");
      p.attr("fill", "none").attr("stroke-width", "1").attr("stroke", n).attr("d", "Mstartx,starty Qcontrolx,controly stopx,stopy ".replaceAll("startx", a.startPoint.x).replaceAll("starty", a.startPoint.y).replaceAll("controlx", a.startPoint.x + (a.endPoint.x - a.startPoint.x) / 2 - (a.endPoint.x - a.startPoint.x) / 4).replaceAll("controly", a.startPoint.y + (a.endPoint.y - a.startPoint.y) / 2).replaceAll("stopx", a.endPoint.x).replaceAll("stopy", a.endPoint.y)), a.type !== "rel_b" && p.attr("marker-end", "url(" + d + "#arrowhead)"), (a.type === "birel" || a.type === "rel_b") && p.attr("marker-start", "url(" + d + "#arrowend)");
    }
    let y = s.messageFont();
    Q(s)(a.label.text, o, Math.min(a.startPoint.x, a.endPoint.x) + Math.abs(a.endPoint.x - a.startPoint.x) / 2 + i, Math.min(a.startPoint.y, a.endPoint.y) + Math.abs(a.endPoint.y - a.startPoint.y) / 2 + u, a.label.width, a.label.height, { fill: r }, y), a.techn && a.techn.text !== "" && (y = s.messageFont(), Q(s)("[" + a.techn.text + "]", o, Math.min(a.startPoint.x, a.endPoint.x) + Math.abs(a.endPoint.x - a.startPoint.x) / 2 + i, Math.min(a.startPoint.y, a.endPoint.y) + Math.abs(a.endPoint.y - a.startPoint.y) / 2 + s.messageFontSize + 5 + u, Math.max(a.label.width, a.techn.width), a.techn.height, { fill: r, "font-style": "italic" }, y));
  }
}, "drawRels"), p0 = g(function(e, t, s) {
  const o = e.append("g");
...
}, "drawBoundary"), y0 = g(function(e, t, s) {
  var _a2;
...
}, "insertDatabaseIcon"), b0 = g(function(e) {
...
}, "insertComputerIcon"), _0 = g(function(e) {
...
}, "insertClockIcon"), x0 = g(function(e) {
...
}, "insertArrowHead"), m0 = g(function(e) {
...
}, "insertArrowEnd"), v0 = g(function(e) {
...
}, "insertArrowFilledHead"), E0 = g(function(e) {
...
}, "insertDynamicNumber"), k0 = g(function(e) {
...
}, "insertArrowCrossHead"), A0 = g((e, t) => ({ fontFamily: e[t + "FontFamily"], fontSize: e[t + "FontSize"], fontWeight: e[t + "FontWeight"] }), "getC4ShapeFont"), Q = (function() {
...
})(), z = { drawRect: ie, drawBoundary: p0, drawC4Shape: y0, drawRels: f0, drawImage: _e, insertArrowHead: x0, insertArrowEnd: m0, insertArrowFilledHead: v0, insertDynamicNumber: E0, insertArrowCrossHead: k0, insertDatabaseIcon: g0, insertComputerIcon: b0, insertClockIcon: _0 }, Vt = 0, zt = 0, xe = 4, $t = 2;
jt.yy = Zt;
var _ = {}, me = (_a = class {
  constructor(e) {
...
}, g(_a, "Bounds"), _a), te = g(function(e) {
...
}, "setConf"), St = g((e, t) => ({ fontFamily: e[t + "FontFamily"], fontSize: e[t + "FontSize"], fontWeight: e[t + "FontWeight"] }), "c4ShapeFont"), Yt = g((e) => ({ fontFamily: e.boundaryFontFamily, fontSize: e.boundaryFontSize, fontWeight: e.boundaryFontWeight }), "boundaryFont"), C0 = g((e) => ({ fontFamily: e.messageFontFamily, fontSize: e.messageFontSize, fontWeight: e.messageFontWeight }), "messageFont");
function j(e, t, s, o, l) {
  if (!t[e].width) if (s) t[e].text = Ne(t[e].text, l, o), t[e].textLines = t[e].text.split(Jt.lineBreakRegex).length, t[e].width = l, t[e].height = ue(t[e].text, o);
  else {
    let a = t[e].text.split(Jt.lineBreakRegex);
    t[e].textLines = a.length;
    let r = 0;
    t[e].height = 0, t[e].width = 0;
    for (const n of a) t[e].width = Math.max(Tt(n, o), t[e].width), r = ue(n, o), t[e].height = t[e].height + r;
  }
}
...
}, "drawBoundary"), Ee = g(function(e, t, s, o) {
  let l = 0;
  for (const a of o) {
    l = 0;
    const r = s[a];
    let n = St(_, r.typeC4Shape.text);
    switch (n.fontSize = n.fontSize - 2, r.typeC4Shape.width = Tt("\xAB" + r.typeC4Shape.text + "\xBB", n), r.typeC4Shape.height = n.fontSize + 2, r.typeC4Shape.Y = _.c4ShapePadding, l = r.typeC4Shape.Y + r.typeC4Shape.height - 4, r.image = { width: 0, height: 0, Y: 0 }, r.typeC4Shape.text) {
      case "person":
      case "external_person":
...
}, g(_b, "Point"), _b), de = g(function(e, t) {
  let s = e.x, o = e.y, l = t.x, a = t.y, r = s + e.width / 2, n = o + e.height / 2, i = Math.abs(s - l), u = Math.abs(o - a), d = u / i, y = e.height / e.width, p = null;
  return o == a && s < l ? p = new Y(s + e.width, n) : o == a && s > l ? p = new Y(s, n) : s == l && o < a ? p = new Y(r, o + e.height) : s == l && o > a && (p = new Y(r, o)), s > l && o < a ? y >= d ? p = new Y(s, n + d * e.width / 2) : p = new Y(r - i / u * e.height / 2, o + e.height) : s < l && o < a ? y >= d ? p = new Y(s + e.width, n + d * e.width / 2) : p = new Y(r + i / u * e.height / 2, o + e.height) : s < l && o > a ? y >= d ? p = new Y(s + e.width, n - d * e.width / 2) : p = new Y(r + e.height / 2 * i / u, o) : s > l && o > a && (y >= d ? p = new Y(s, n - e.width / 2 * d) : p = new Y(r - e.height / 2 * i / u, o)), p;
}, "getIntersectPoint"), w0 = g(function(e, t) {
  let s = { x: 0, y: 0 };
...
}, "getIntersectPoints"), T0 = g(function(e, t, s, o) {
  let l = 0;
  for (let a of t) {
    l = l + 1;
...
function ne(e, t, s, o, l) {
  ...
  for (let [r, n] of o.entries()) {
    ...
    E.length > 0 && ne(e, t, a, E, l), n.alias !== "global" && ve(e, n, a), s.data.stopy = Math.max(a.data.stopy + _.c4ShapeMargin, s.data.stopy), s.data.stopx = Math.max(a.data.stopx + _.c4ShapeMargin, s.data.stopx), Vt = Math.max(Vt, s.data.stopx), zt = Math.max(zt, s.data.stopy);
  }
}
...
var O0 = g(function(e, t, s, o) {
  ...
  let u = new me(o);
  u.setData(_.diagramMarginX, _.diagramMarginX, _.diagramMarginY, _.diagramMarginY), u.data.widthLimit = screen.availWidth, Vt = _.diagramMarginX, zt = _.diagramMarginY;
  ...
  const M = d ? 60 : 0;
  i.attr("viewBox", p.startx - _.diagramMarginX + " -" + (_.diagramMarginY + M) + " " + P + " " + (O + M)), he.debug("models:", p);
}, "draw"), fe = { drawPersonOrSystemArray: Ee, drawBoundary: ve, setConf: te, draw: O0 }, R0 = g((e) => `.person {
    stroke: ${e.personBorder};
    fill: ${e.personBkg};
  }
`, "getStyles"), S0 = R0, B0 = { parser: Ye, db: Zt, renderer: fe, styles: S0, init: g(({ c4: e, wrap: t }) => {
