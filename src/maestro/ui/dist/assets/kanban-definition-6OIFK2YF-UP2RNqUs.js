  ...
  var e = o(function(O, i, n, r) {
    ...
    for (var k, P, x, Q, F = {}, z, C, oe, X; ; ) {
      if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((k === null || typeof k > "u") && (k = ae()), x = M[P] && M[P][k]), typeof x > "u" || !x.length || !x[0]) {
        var Z = "";
        X = [];
        for (z in M[P]) this.terminals_[z] && z > ue && X.push("'" + this.terminals_[z] + "'");
        y.showPosition ? Z = "Parse error on line " + (W + 1) + `:
` + y.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Z = "Parse error on line " + (W + 1) + ": Unexpected " + (k == re ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Z, { text: y.match, token: this.terminals_[k] || k, line: y.yylineno, loc: q, expected: X });
      }
      if (x[0] instanceof Array && x.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + P + ", token: " + k);
      switch (x[0]) {
        case 1:
          r.push(k), h.push(y.yytext), t.push(y.yylloc), r.push(x[1]), k = null, se = y.yyleng, c = y.yytext, W = y.yylineno, q = y.yylloc;
          break;
        case 2:
          if (C = this.productions_[x[1]][1], F.$ = h[h.length - C], F._$ = { first_line: t[t.length - (C || 1)].first_line, last_line: t[t.length - 1].last_line, first_column: t[t.length - (C || 1)].first_column, last_column: t[t.length - 1].last_column }, de && (F._$.range = [t[t.length - (C || 1)].range[0], t[t.length - 1].range[1]]), Q = this.performAction.apply(F, [c, se, W, R.yy, x[1], h, t].concat(ge)), typeof Q < "u") return Q;
    ...
    var O = { EOF: 1, parseError: o(function(n, r) {
      if (this.yy.parser) this.yy.parser.parseError(n, r);
      else throw new Error(n);
    }, "parseError"), setInput: o(function(i, n) {
...
` + n + "^";
      ...
      for (var h = this._currentRules(), t = 0; t < h.length; t++) if (r = this._input.match(this.rules[h[t]]), r && (!n || r[0].length > n[0].length)) {
        if (n = r, a = t, this.options.backtrack_lexer) {
          if (i = this.test_match(r, h[t]), i !== false) return i;
          if (this._backtrack) {
            n = false;
            continue;
          } else return false;
...
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    ...
    }, "_currentRules"), topState: o(function(n) {
      return n = this.conditionStack.length - 1 - Math.abs(n || 0), n >= 0 ? this.conditionStack[n] : "INITIAL";
    }, "topState"), pushState: o(function(n) {
      this.begin(n);
    }, "pushState"), stateStackSize: o(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: o(function(n, r, a, h) {
      switch (a) {
        case 0:
...
$.parser = $;
var xe = $, v = [], ne = [], ee = 0, ie = {}, ve = o(() => {
  v = [], ne = [], ee = 0, ie = {};
}, "clear"), De = o((e) => {
  if (v.length === 0) return null;
  const u = v[0].level;
  let p = null;
  for (let s = v.length - 1; s >= 0; s--) if (v[s].level === u && !p && (p = v[s]), v[s].level < u) throw new Error('Items without section detected, found section ("' + v[s].label + '")');
  return e === (p == null ? void 0 : p.level) ? null : p;
}, "getSection"), he = o(function() {
  return ne;
}, "getSections"), Le = o(function() {
  const e = [], u = [], p = he(), s = U();
  for (const d of p) {
    const E = { id: d.id, label: j(d.label ?? "", s), isGroup: true, ticket: d.ticket, shape: "kanbanSection", level: d.level, look: s.look };
    u.push(E);
    const b = v.filter((l) => l.parentId === d.id);
    for (const l of b) {
      const D = { id: l.id, parentId: d.id, label: j(l.label ?? "", s), isGroup: false, ticket: l == null ? void 0 : l.ticket, priority: l == null ? void 0 : l.priority, assigned: l == null ? void 0 : l.assigned, icon: l == null ? void 0 : l.icon, shape: "kanbanItem", level: l.level, rx: 5, ry: 5, cssStyles: ["text-align: left"] };
      u.push(D);
    }
  }
  return { nodes: u, edges: e, other: {}, config: U() };
}, "getData"), Oe = o((e, u, p, s, d) => {
  var _a, _b;
  const E = U();
  let b = ((_a = E.mindmap) == null ? void 0 : _a.padding) ?? Y.mindmap.padding;
  switch (s) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
  ...
  const l = { id: j(u, E) || "kbn" + ee++, level: e, label: j(p, E), width: ((_b = E.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? Y.mindmap.maxNodeWidth, padding: b, isGroup: false };
  if (d !== void 0) {
    let I;
    d.includes(`
`) ? I = d + `
...
}, "addNode"), f = { DEFAULT: 0, NO_BORDER: 0, ROUNDED_RECT: 1, RECT: 2, CIRCLE: 3, CLOUD: 4, BANG: 5, HEXAGON: 6 }, Ie = o((e, u) => {
...
}, "type2Str"), Te = o(() => te, "getLogger"), Re = o((e) => ie[e], "getElementById"), Pe = { clear: ve, addNode: Oe, getSections: he, getData: Le, nodeType: f, getType: Ie, setElementForId: Ce, decorateNode: we, type2Str: Ae, getLogger: Te, getElementById: Re }, Ve = Pe, Be = o(async (e, u, p, s) => {
  var _a, _b, _c, _d, _e2;
...
` + e);
  ...
  const I = l.append("g");
  I.attr("class", "items");
  const g = E.nodes.filter((m) => m.isGroup);
  let w = 0;
  const _ = 10, G = [];
  let N = 25;
  for (const m of g) {
  ...
  for (const m of g) {
    const A = G[V];
    V = V + 1;
    const L = ((_c = b == null ? void 0 : b.kanban) == null ? void 0 : _c.sectionWidth) || 200, H = -L * 3 / 2 + N;
    let T = H;
  ...
  _e(void 0, l, ((_d = b.mindmap) == null ? void 0 : _d.padding) ?? Y.kanban.padding, ((_e2 = b.mindmap) == null ? void 0 : _e2.useMaxWidth) ?? Y.kanban.useMaxWidth);
}, "draw"), Fe = { draw: Be }, je = o((e) => {
  let u = "";
  for (let s = 0; s < e.THEME_COLOR_LIMIT; s++) e["lineColor" + s] = e["lineColor" + s] || e["cScaleInv" + s], Se(e["lineColor" + s]) ? e["lineColor" + s] = ce(e["lineColor" + s], 20) : e["lineColor" + s] = le(e["lineColor" + s], 20);
  ...
  .kanban-label {
    ...
    ${Ne()}
`, "getStyles"), He = Ge, We = { db: Ve, renderer: Fe, parser: xe, styles: He };
export {
  We as diagram
};
