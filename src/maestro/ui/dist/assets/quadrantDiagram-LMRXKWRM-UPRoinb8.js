var _a, _b;
import { _ as r, s as be, g as Se, q as te, p as _e, a as Ae, b as ke, c as Et, l as qt, d as vt, e as Fe, y as Pe, F as D, K as ve, i as Ce } from "./index-CTgvlc8H.js";
import { l as $t } from "./linear-DE0zFP14.js";
import "./init-Gi6I4Gst.js";
import "./defaultLocale-C4B-KCzX.js";
var Ct = (function() {
  var t = r(function(M, s, l, u) {
  ...
  }, "trace"), yy: {}, symbols_: { error: 2, idStringToken: 3, ALPHA: 4, NUM: 5, NODE_STRING: 6, DOWN: 7, MINUS: 8, DEFAULT: 9, COMMA: 10, COLON: 11, AMP: 12, BRKT: 13, MULT: 14, UNICODE_TEXT: 15, styleComponent: 16, UNIT: 17, SPACE: 18, STYLE: 19, PCT: 20, idString: 21, style: 22, stylesOpt: 23, classDefStatement: 24, CLASSDEF: 25, start: 26, eol: 27, QUADRANT: 28, document: 29, line: 30, statement: 31, axisDetails: 32, quadrantDetails: 33, points: 34, title: 35, title_value: 36, acc_title: 37, acc_title_value: 38, acc_descr: 39, acc_descr_value: 40, acc_descr_multiline_value: 41, section: 42, text: 43, point_start: 44, point_x: 45, point_y: 46, class_name: 47, "X-AXIS": 48, "AXIS-TEXT-DELIMITER": 49, "Y-AXIS": 50, QUADRANT_1: 51, QUADRANT_2: 52, QUADRANT_3: 53, QUADRANT_4: 54, NEWLINE: 55, SEMI: 56, EOF: 57, alphaNumToken: 58, textNoTagsToken: 59, STR: 60, MD_STR: 61, alphaNum: 62, PUNCTUATION: 63, PLUS: 64, EQUALS: 65, DOT: 66, UNDERSCORE: 67, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "ALPHA", 5: "NUM", 6: "NODE_STRING", 7: "DOWN", 8: "MINUS", 9: "DEFAULT", 10: "COMMA", 11: "COLON", 12: "AMP", 13: "BRKT", 14: "MULT", 15: "UNICODE_TEXT", 17: "UNIT", 18: "SPACE", 19: "STYLE", 20: "PCT", 25: "CLASSDEF", 28: "QUADRANT", 35: "title", 36: "title_value", 37: "acc_title", 38: "acc_title_value", 39: "acc_descr", 40: "acc_descr_value", 41: "acc_descr_multiline_value", 42: "section", 44: "point_start", 45: "point_x", 46: "point_y", 47: "class_name", 48: "X-AXIS", 49: "AXIS-TEXT-DELIMITER", 50: "Y-AXIS", 51: "QUADRANT_1", 52: "QUADRANT_2", 53: "QUADRANT_3", 54: "QUADRANT_4", 55: "NEWLINE", 56: "SEMI", 57: "EOF", 60: "STR", 61: "MD_STR", 63: "PUNCTUATION", 64: "PLUS", 65: "EQUALS", 66: "DOT", 67: "UNDERSCORE" }, productions_: [0, [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [16, 1], [21, 1], [21, 2], [22, 1], [22, 2], [23, 1], [23, 3], [24, 5], [26, 2], [26, 2], [26, 2], [29, 0], [29, 2], [30, 2], [31, 0], [31, 1], [31, 2], [31, 1], [31, 1], [31, 1], [31, 2], [31, 2], [31, 2], [31, 1], [31, 1], [34, 4], [34, 5], [34, 5], [34, 6], [32, 4], [32, 3], [32, 2], [32, 4], [32, 3], [32, 2], [33, 2], [33, 2], [33, 2], [33, 2], [27, 1], [27, 1], [27, 1], [43, 1], [43, 2], [43, 1], [43, 1], [62, 1], [62, 2], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [58, 1], [59, 1], [59, 1], [59, 1]], performAction: r(function(s, l, u, d, A, e, ht) {
    var n = e.length - 1;
    switch (A) {
      case 23:
        this.$ = e[n];
    ...
    for (var w, j, N, Ft, st = {}, pt, X, Jt, yt; ; ) {
      if (j = u[u.length - 1], this.defaultActions[j] ? N = this.defaultActions[j] : ((w === null || typeof w > "u") && (w = Zt()), N = ht[j] && ht[j][w]), typeof N > "u" || !N.length || !N[0]) {
        var Pt = "";
        yt = [];
        for (pt in ht[j]) this.terminals_[pt] && pt > ye && yt.push("'" + this.terminals_[pt] + "'");
        E.showPosition ? Pt = "Parse error on line " + (gt + 1) + `:
` + E.showPosition() + `
Expecting ` + yt.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Pt = "Parse error on line " + (gt + 1) + ": Unexpected " + (w == Kt ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Pt, { text: E.match, token: this.terminals_[w] || w, line: E.yylineno, loc: kt, expected: yt });
      }
      if (N[0] instanceof Array && N.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + j + ", token: " + w);
      switch (N[0]) {
        case 1:
          u.push(w), A.push(E.yytext), e.push(E.yylloc), u.push(N[1]), w = null, Gt = E.yyleng, n = E.yytext, gt = E.yylineno, kt = E.yylloc;
          break;
        case 2:
          if (X = this.productions_[N[1]][1], st.$ = A[A.length - X], st._$ = { first_line: e[e.length - (X || 1)].first_line, last_line: e[e.length - 1].last_line, first_column: e[e.length - (X || 1)].first_column, last_column: e[e.length - 1].last_column }, qe && (st._$.range = [e[e.length - (X || 1)].range[0], e[e.length - 1].range[1]]), Ft = this.performAction.apply(st, [n, Gt, gt, Y.yy, N[1], A, e].concat(Te)), typeof Ft < "u") return Ft;
    ...
    var M = { EOF: 1, parseError: r(function(l, u) {
      if (this.yy.parser) this.yy.parser.parseError(l, u);
      else throw new Error(l);
    }, "parseError"), setInput: r(function(s, l) {
...
` + l + "^";
    }, "showPosition"), test_match: r(function(s, l) {
      var u, d, A;
      if (this.options.backtrack_lexer && (A = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (A.yylloc.range = this.yylloc.range.slice(0))), d = s[0].match(/(?:\r\n?|\n).*/g), d && (this.yylineno += d.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: d ? d[d.length - 1].length - d[d.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + s[0].length }, this.yytext += s[0], this.match += s[0], this.matches = s, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(s[0].length), this.matched += s[0], u = this.performAction.call(this, this.yy, this, l, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), u) return u;
      if (this._backtrack) {
      ...
      for (var A = this._currentRules(), e = 0; e < A.length; e++) if (u = this._input.match(this.rules[A[e]]), u && (!l || u[0].length > l[0].length)) {
        if (l = u, d = e, this.options.backtrack_lexer) {
          if (s = this.test_match(u, A[e]), s !== false) return s;
          if (this._backtrack) {
            l = false;
            continue;
          } else return false;
      ...
      return l ? (s = this.test_match(l, A[d]), s !== false ? s : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: r(function() {
      var l = this.next();
      return l || this.lex();
    }, "lex"), begin: r(function(l) {
    ...
    }, "_currentRules"), topState: r(function(l) {
      return l = this.conditionStack.length - 1 - Math.abs(l || 0), l >= 0 ? this.conditionStack[l] : "INITIAL";
    }, "topState"), pushState: r(function(l) {
      this.begin(l);
    }, "pushState"), stateStackSize: r(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: r(function(l, u, d, A) {
      switch (d) {
        case 0:
          break;
        case 1:
...
var Le = Ct, V = ve(), Ee = (_a = class {
  ...
  getDefaultConfig() {
    ...
    return { showXAxis: true, showYAxis: true, showTitle: true, chartHeight: ((_a2 = D.quadrantChart) == null ? void 0 : _a2.chartWidth) || 500, chartWidth: ((_b2 = D.quadrantChart) == null ? void 0 : _b2.chartHeight) || 500, titlePadding: ((_c = D.quadrantChart) == null ? void 0 : _c.titlePadding) || 10, titleFontSize: ((_d = D.quadrantChart) == null ? void 0 : _d.titleFontSize) || 20, quadrantPadding: ((_e2 = D.quadrantChart) == null ? void 0 : _e2.quadrantPadding) || 5, xAxisLabelPadding: ((_f = D.quadrantChart) == null ? void 0 : _f.xAxisLabelPadding) || 5, yAxisLabelPadding: ((_g = D.quadrantChart) == null ? void 0 : _g.yAxisLabelPadding) || 5, xAxisLabelFontSize: ((_h = D.quadrantChart) == null ? void 0 : _h.xAxisLabelFontSize) || 16, yAxisLabelFontSize: ((_i = D.quadrantChart) == null ? void 0 : _i.yAxisLabelFontSize) || 16, quadrantLabelFontSize: ((_j = D.quadrantChart) == null ? void 0 : _j.quadrantLabelFontSize) || 16, quadrantTextTopPadding: ((_k = D.quadrantChart) == null ? void 0 : _k.quadrantTextTopPadding) || 5, pointTextPadding: ((_l = D.quadrantChart) == null ? void 0 : _l.pointTextPadding) || 5, pointLabelFontSize: ((_m = D.quadrantChart) == null ? void 0 : _m.pointLabelFontSize) || 12, pointRadius: ((_n = D.quadrantChart) == null ? void 0 : _n.pointRadius) || 5, xAxisPosition: ((_o = D.quadrantChart) == null ? void 0 : _o.xAxisPosition) || "top", yAxisPosition: ((_p = D.quadrantChart) == null ? void 0 : _p.yAxisPosition) || "left", quadrantInternalBorderStrokeWidth: ((_q = D.quadrantChart) == null ? void 0 : _q.quadrantInternalBorderStrokeWidth) || 1, quadrantExternalBorderStrokeWidth: ((_r = D.quadrantChart) == null ? void 0 : _r.quadrantExternalBorderStrokeWidth) || 2 };
  }
  ...
  build() {
    ...
    return { points: this.getQuadrantPoints(o), quadrants: this.getQuadrants(o), axisLabels: this.getAxisLabels(f, t, a, o), borderLines: this.getBorders(o), title: this.getTitle(p) };
  }
}, r(_a, "QuadrantBuilder"), _a), Tt = (_b = class extends Error {
  constructor(t, a, p) {
    super(`value for ${t} ${a} is invalid, please use a valid ${p}`), this.name = "InvalidStyleError";
  }
}, r(_b, "InvalidStyleError"), _b);
function Lt(t) {
...
function mt(t) {
  ...
  for (const p of t) {
    ...
    if (f === "radius") {
      if (ee(o)) throw new Tt(f, o, "number");
      a.radius = parseInt(o);
    } else if (f === "color") {
      if (Lt(o)) throw new Tt(f, o, "hex code");
      a.color = o;
    } else if (f === "stroke-color") {
      if (Lt(o)) throw new Tt(f, o, "hex code");
      a.strokeColor = o;
    } else if (f === "stroke-width") {
      if (ie(o)) throw new Tt(f, o, "number of pixels (eg. 10px)");
      a.strokeWidth = o;
...
function de(t, a, p, f, o) {
  const x = mt(o);
  z.addPoints([{ x: p, y: f, text: Q(t.text), className: a, ...x }]);
}
r(de, "addPoint");
function ue(t, a) {
  z.addClass(t, mt(a));
...
` + t);
  ...
  let S;
  c === "sandbox" && (S = vt("#i" + a));
  const b = (c === "sandbox" ? vt(S.nodes()[0].contentDocument.body) : vt("body")).select(`[id="${a}"]`), y = b.append("g").attr("class", "main"), T = ((_a2 = h.quadrantChart) == null ? void 0 : _a2.chartWidth) ?? 500, q = ((_b2 = h.quadrantChart) == null ? void 0 : _b2.chartHeight) ?? 500;
  Fe(b, q, T, ((_c = h.quadrantChart) == null ? void 0 : _c.useMaxWidth) ?? true), b.attr("viewBox", "0 0 " + T + " " + q), f.db.setHeight(q), f.db.setWidth(T);
  ...
  lt.append("circle").attr("cx", (i) => i.x).attr("cy", (i) => i.y).attr("r", (i) => i.radius).attr("fill", (i) => i.fill).attr("stroke", (i) => i.strokeColor).attr("stroke-width", (i) => i.strokeWidth), lt.append("text").attr("x", 0).attr("y", 0).text((i) => i.text.text).attr("fill", (i) => i.text.fill).attr("font-size", (i) => i.text.fontSize).attr("dominant-baseline", (i) => o(i.text.horizontalPos)).attr("text-anchor", (i) => x(i.text.verticalPos)).attr("transform", (i) => _(i.text));
}, "draw"), we = { draw: Ie }, Ue = { parser: Le, db: Ve, renderer: we, styles: r(() => "", "styles") };
export {
  Ue as diagram
};
