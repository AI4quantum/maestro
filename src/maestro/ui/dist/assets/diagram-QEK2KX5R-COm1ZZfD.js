import { _ as l, s as k, g as R, q as E, p as F, a as I, b as _, H as D, y as G, D as f, E as C, F as P, l as z, K as H } from "./index-CTgvlc8H.js";
import { p as V } from "./chunk-4BX2VUAB-HC4hRP6X.js";
import { p as W } from "./treemap-75Q7IDZK-BYqNGg4h.js";
import "./_baseUniq-o7e9QmIE.js";
import "./_basePickBy-UWsuIbv6.js";
import "./clone-CEDDMd2u.js";
var h = { showLegend: true, ticks: 5, max: null, min: 0, graticule: "circle" }, w = { axes: [], curves: [], options: h }, m = structuredClone(w), B = P.radar, j = l(() => f({ ...B, ...C().radar }), "getConfig"), b = l(() => m.axes, "getAxes"), q = l(() => m.curves, "getCurves"), K = l(() => m.options, "getOptions"), N = l((a) => {
...
}, "computeCurveEntries"), Y = l((a) => {
  var _a, _b, _c, _d, _e;
  const t = a.reduce((e, r) => (e[r.name] = r, e), {});
  m.options = { showLegend: ((_a = t.showLegend) == null ? void 0 : _a.value) ?? h.showLegend, ticks: ((_b = t.ticks) == null ? void 0 : _b.value) ?? h.ticks, max: ((_c = t.max) == null ? void 0 : _c.value) ?? h.max, min: ((_d = t.min) == null ? void 0 : _d.value) ?? h.min, graticule: ((_e = t.graticule) == null ? void 0 : _e.value) ?? h.graticule };
}, "setOptions"), Z = l(() => {
  G(), m = structuredClone(w);
}, "clear"), $ = { getAxes: b, getCurves: q, getOptions: K, setAxes: N, setCurves: U, setOptions: Y, getConfig: j, clear: Z, setAccTitle: _, getAccTitle: I, setDiagramTitle: F, getDiagramTitle: E, getAccDescription: R, setAccDescription: k }, J = l((a) => {
  V(a, $);
  const { axes: t, curves: e, options: r } = a;
  $.setAxes(t), $.setCurves(e), $.setOptions(r);
}, "populate"), Q = { parse: l(async (a) => {
  ...
  const e = t.width + t.marginLeft + t.marginRight, r = t.height + t.marginTop + t.marginBottom, s = { x: t.marginLeft + t.width / 2, y: t.marginTop + t.height / 2 };
  return a.attr("viewbox", `0 0 ${e} ${r}`).attr("width", e).attr("height", r), a.append("g").attr("transform", `translate(${s.x}, ${s.y})`);
}, "drawFrame"), at = l((a, t, e, r, s) => {
  if (s === "circle") for (let o = 0; o < r; o++) {
    const i = e * (o + 1) / r;
...
function L(a, t) {
  ...
  let r = `M${a[0].x},${a[0].y}`;
  for (let s = 0; s < e; s++) {
    const o = a[(s - 1 + e) % e], i = a[s], n = a[(s + 1) % e], c = a[(s + 2) % e], d = { x: i.x + (n.x - o.x) * t, y: i.y + (n.y - o.y) * t }, u = { x: n.x - (c.x - i.x) * t, y: n.y - (c.y - i.y) * t };
...
var st = { draw: tt }, nt = l((a, t) => {
  ...
  return `
	...
	${nt(t, e)}
	`;
}, "styles"), mt = { parser: Q, db: $, renderer: st, styles: it };
export {
  mt as diagram
};
